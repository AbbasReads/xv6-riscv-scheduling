...
user/_locktest:     file format elf64-littleriscv
...
main(void)
{
  ...
  if(lockinit(id) < 0){
   8:	4505                	li	a0,1
   a:	412000ef          	jal	41c <lockinit>
   e:	0a054263          	bltz	a0,b2 <main+0xb2>
  ...
  18:	98450513          	addi	a0,a0,-1660 # 998 <malloc+0x118>
  1c:	7b0000ef          	jal	7cc <printf>

  // Check lock status before acquiring
  printf("lockcheck: lock held? %d (0=free)\n", lockcheck(id));
  20:	4505                	li	a0,1
  22:	41a000ef          	jal	43c <lockcheck>
  26:	85aa                	mv	a1,a0
  28:	00001517          	auipc	a0,0x1
  2c:	99050513          	addi	a0,a0,-1648 # 9b8 <malloc+0x138>
  30:	79c000ef          	jal	7cc <printf>

  // Acquire lock
  if(lockacquire(id) < 0){
  34:	4505                	li	a0,1
  36:	3ee000ef          	jal	424 <lockacquire>
  3a:	08054563          	bltz	a0,c4 <main+0xc4>
  ...
  44:	9b850513          	addi	a0,a0,-1608 # 9f8 <malloc+0x178>
  48:	784000ef          	jal	7cc <printf>

  // Check lock status after acquiring
  printf("lockcheck: lock held? %d (1=held)\n", lockcheck(id));
  4c:	4505                	li	a0,1
  4e:	3ee000ef          	jal	43c <lockcheck>
  52:	85aa                	mv	a1,a0
  54:	00001517          	auipc	a0,0x1
  58:	9c450513          	addi	a0,a0,-1596 # a18 <malloc+0x198>
  5c:	770000ef          	jal	7cc <printf>

  // Try to acquire already held lock
  int ret = locktry(id);
  60:	4505                	li	a0,1
  62:	3d2000ef          	jal	434 <locktry>
  66:	85aa                	mv	a1,a0
  printf("locktry: tried to acquire held lock, result: %d (0=failed as expected)\n", ret);
  68:	00001517          	auipc	a0,0x1
  6c:	9d850513          	addi	a0,a0,-1576 # a40 <malloc+0x1c0>
  70:	75c000ef          	jal	7cc <printf>

  // Release lock
  if(lockrelease(id) < 0){
  74:	4505                	li	a0,1
  76:	3b6000ef          	jal	42c <lockrelease>
  7a:	04054e63          	bltz	a0,d6 <main+0xd6>
  ...
  84:	a2050513          	addi	a0,a0,-1504 # aa0 <malloc+0x220>
  88:	744000ef          	jal	7cc <printf>

  // Try to acquire free lock
  ret = locktry(id);
  8c:	4505                	li	a0,1
  8e:	3a6000ef          	jal	434 <locktry>
  92:	85aa                	mv	a1,a0
  printf("locktry: tried to acquire free lock, result: %d (1=success)\n", ret);
  94:	00001517          	auipc	a0,0x1
  98:	a2c50513          	addi	a0,a0,-1492 # ac0 <malloc+0x240>
  9c:	730000ef          	jal	7cc <printf>

  printf("Lock test complete!\n");
  a0:	00001517          	auipc	a0,0x1
  a4:	a6050513          	addi	a0,a0,-1440 # b00 <malloc+0x280>
  a8:	724000ef          	jal	7cc <printf>
  exit(0);
  ac:	4501                	li	a0,0
  ae:	2ce000ef          	jal	37c <exit>
    printf("lockinit failed\n");
  b2:	00001517          	auipc	a0,0x1
  b6:	8ce50513          	addi	a0,a0,-1842 # 980 <malloc+0x100>
  ba:	712000ef          	jal	7cc <printf>
    exit(1);
  be:	4505                	li	a0,1
  c0:	2bc000ef          	jal	37c <exit>
    printf("lockacquire failed\n");
  c4:	00001517          	auipc	a0,0x1
  c8:	91c50513          	addi	a0,a0,-1764 # 9e0 <malloc+0x160>
  cc:	700000ef          	jal	7cc <printf>
    exit(1);
  d0:	4505                	li	a0,1
  d2:	2aa000ef          	jal	37c <exit>
    printf("lockrelease failed\n");
  d6:	00001517          	auipc	a0,0x1
  da:	9b250513          	addi	a0,a0,-1614 # a88 <malloc+0x208>
  de:	6ee000ef          	jal	7cc <printf>
    exit(1);
  e2:	4505                	li	a0,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 480:	6a450513          	addi	a0,a0,1700 # b20 <digits>
 484:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 716:	40eb8b93          	addi	s7,s7,1038 # b20 <digits>
 ...
 778:	3a490913          	addi	s2,s2,932 # b18 <malloc+0x298>
        for(; *s; s++)
