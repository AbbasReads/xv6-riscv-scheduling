...
forktest(void)
{
  ...
  34:	49050513          	addi	a0,a0,1168 # 4c0 <setchildlimit+0xa>
  ...
  56:	4be50513          	addi	a0,a0,1214 # 510 <setchildlimit+0x5a>
  ...
  6c:	46850513          	addi	a0,a0,1128 # 4d0 <setchildlimit+0x1a>
  ...
  7e:	46e50513          	addi	a0,a0,1134 # 4e8 <setchildlimit+0x32>
  ...
  ae:	45650513          	addi	a0,a0,1110 # 500 <setchildlimit+0x4a>
...
000000000000040a <recvmsg>:
.global recvmsg
recvmsg:
 li a7, SYS_recvmsg
 40a:	02000893          	li	a7,32
 ecall
 40e:	00000073          	ecall
 ret
 412:	8082                	ret

0000000000000414 <broadcast>:
.global broadcast
broadcast:
 li a7, SYS_broadcast
 414:	02100893          	li	a7,33
 ecall
 418:	00000073          	ecall
 ret
 41c:	8082                	ret
...
getprocsinfo:
 ...
 41e:	02200893          	li	a7,34
 ecall
 422:	00000073          	ecall
 ret
 426:	8082                	ret

0000000000000428 <getppid>:
.global getppid
getppid:
 li a7, SYS_getppid
 428:	02300893          	li	a7,35
 ecall
 42c:	00000073          	ecall
 ret
 430:	8082                	ret

0000000000000432 <sleep2>:
.global sleep2
sleep2:
 li a7, SYS_sleep2
 432:	02400893          	li	a7,36
 ecall
 436:	00000073          	ecall
 ret
 43a:	8082                	ret

000000000000043c <signal>:
.global signal
signal:
 li a7, SYS_signal
 43c:	02500893          	li	a7,37
 ecall
 440:	00000073          	ecall
 ret
 444:	8082                	ret
...
00000000000004b6 <setchildlimit>:
