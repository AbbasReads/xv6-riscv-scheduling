...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      14:	b7078793          	addi	a5,a5,-1168 # 7b80 <malloc+0x2680>
      18:	638c                	ld	a1,0(a5)
      1a:	6790                	ld	a2,8(a5)
      1c:	6b94                	ld	a3,16(a5)
      1e:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      70:	59450513          	addi	a0,a0,1428 # 5600 <malloc+0x100>
      74:	3d4050ef          	jal	5448 <printf>
      exit(1);
      78:	4505                	li	a0,1
      ...
      9a:	8082                	ret
{
      ...
      aa:	57a50513          	addi	a0,a0,1402 # 5620 <malloc+0x120>
      ae:	39a050ef          	jal	5448 <printf>
      exit(1);
      b2:	4505                	li	a0,1
...
00000000000000b8 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ca:	57250513          	addi	a0,a0,1394 # 5638 <malloc+0x138>
  ...
  fd = open("doesnotexist", 0);
      ...
      e0:	57c50513          	addi	a0,a0,1404 # 5658 <malloc+0x158>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      fc:	54850513          	addi	a0,a0,1352 # 5640 <malloc+0x140>
     100:	348050ef          	jal	5448 <printf>
    exit(1);
     104:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     110:	55c50513          	addi	a0,a0,1372 # 5668 <malloc+0x168>
     114:	334050ef          	jal	5448 <printf>
    exit(1);
     118:	4505                	li	a0,1
...
000000000000011e <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     186:	50e50513          	addi	a0,a0,1294 # 5690 <malloc+0x190>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1b0:	50450513          	addi	a0,a0,1284 # 56b0 <malloc+0x1b0>
     1b4:	294050ef          	jal	5448 <printf>
    exit(1);
     1b8:	4505                	li	a0,1
...
0000000000000240 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     260:	47c50513          	addi	a0,a0,1148 # 56d8 <malloc+0x1d8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     274:	468a0a13          	addi	s4,s4,1128 # 56d8 <malloc+0x1d8>
     278:	4b09                	li	s6,2
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2e0:	40c50513          	addi	a0,a0,1036 # 56e8 <malloc+0x1e8>
     2e4:	164050ef          	jal	5448 <printf>
      exit(1);
     2e8:	4505                	li	a0,1
     ...
     2f8:	41450513          	addi	a0,a0,1044 # 5708 <malloc+0x208>
     2fc:	14c050ef          	jal	5448 <printf>
        exit(1);
     300:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     31e:	40650513          	addi	a0,a0,1030 # 5720 <malloc+0x220>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     332:	3f298993          	addi	s3,s3,1010 # 5720 <malloc+0x220>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     36e:	3b650513          	addi	a0,a0,950 # 5720 <malloc+0x220>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     382:	32a58593          	addi	a1,a1,810 # 56a8 <malloc+0x1a8>
     386:	485040ef          	jal	500a <write>
     38a:	4785                	li	a5,1
     38c:	02f50d63          	beq	a0,a5,3c6 <badwrite+0xc0>
    printf("write failed\n");
     390:	00005517          	auipc	a0,0x5
     394:	3b050513          	addi	a0,a0,944 # 5740 <malloc+0x240>
     398:	0b0050ef          	jal	5448 <printf>
    exit(1);
     39c:	4505                	li	a0,1
     39e:	44d040ef          	jal	4fea <exit>
      printf("open junk failed\n");
     3a2:	00005517          	auipc	a0,0x5
     3a6:	38650513          	addi	a0,a0,902 # 5728 <malloc+0x228>
     3aa:	09e050ef          	jal	5448 <printf>
      exit(1);
     3ae:	4505                	li	a0,1
     3b0:	43b040ef          	jal	4fea <exit>
    printf("open junk failed\n");
     3b4:	00005517          	auipc	a0,0x5
     3b8:	37450513          	addi	a0,a0,884 # 5728 <malloc+0x228>
     3bc:	08c050ef          	jal	5448 <printf>
    exit(1);
     3c0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3d0:	35450513          	addi	a0,a0,852 # 5720 <malloc+0x220>
...
00000000000004aa <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     4c8:	6bc78793          	addi	a5,a5,1724 # 7b80 <malloc+0x2680>
     4cc:	638c                	ld	a1,0(a5)
     4ce:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4fa:	25aa8a93          	addi	s5,s5,602 # 5750 <malloc+0x250>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     58c:	1d050513          	addi	a0,a0,464 # 5758 <malloc+0x258>
     590:	6b9040ef          	jal	5448 <printf>
      exit(1);
     594:	4505                	li	a0,1
     ...
     5a2:	1d250513          	addi	a0,a0,466 # 5770 <malloc+0x270>
     5a6:	6a3040ef          	jal	5448 <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	1ec50513          	addi	a0,a0,492 # 57a0 <malloc+0x2a0>
     5bc:	68d040ef          	jal	5448 <printf>
      exit(1);
     5c0:	4505                	li	a0,1
     5c2:	229040ef          	jal	4fea <exit>
      printf("pipe() failed\n");
     5c6:	00005517          	auipc	a0,0x5
     5ca:	20a50513          	addi	a0,a0,522 # 57d0 <malloc+0x2d0>
     5ce:	67b040ef          	jal	5448 <printf>
      exit(1);
     5d2:	4505                	li	a0,1
     ...
     5e0:	20450513          	addi	a0,a0,516 # 57e0 <malloc+0x2e0>
     5e4:	665040ef          	jal	5448 <printf>
      exit(1);
     5e8:	4505                	li	a0,1
...
00000000000005ee <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     60c:	57878793          	addi	a5,a5,1400 # 7b80 <malloc+0x2680>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     640:	1d4b0b13          	addi	s6,s6,468 # 5810 <malloc+0x310>
    ...
    n = write(fds[1], "x", 1);
     ...
     650:	05cb8b93          	addi	s7,s7,92 # 56a8 <malloc+0x1a8>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     6d6:	14650513          	addi	a0,a0,326 # 5818 <malloc+0x318>
     6da:	56f040ef          	jal	5448 <printf>
      exit(1);
     6de:	4505                	li	a0,1
     ...
     6ec:	14850513          	addi	a0,a0,328 # 5830 <malloc+0x330>
     6f0:	559040ef          	jal	5448 <printf>
      exit(1);
     6f4:	4505                	li	a0,1
     6f6:	0f5040ef          	jal	4fea <exit>
      printf("pipe() failed\n");
     6fa:	00005517          	auipc	a0,0x5
     6fe:	0d650513          	addi	a0,a0,214 # 57d0 <malloc+0x2d0>
     702:	547040ef          	jal	5448 <printf>
      exit(1);
     706:	4505                	li	a0,1
     708:	0e3040ef          	jal	4fea <exit>
      printf("pipe write failed\n");
     70c:	00005517          	auipc	a0,0x5
     710:	15450513          	addi	a0,a0,340 # 5860 <malloc+0x360>
     714:	535040ef          	jal	5448 <printf>
      exit(1);
     718:	4505                	li	a0,1
     ...
     726:	15650513          	addi	a0,a0,342 # 5878 <malloc+0x378>
     72a:	51f040ef          	jal	5448 <printf>
      exit(1);
     72e:	4505                	li	a0,1
...
0000000000000734 <truncate1>:
{
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     780:	f1450513          	addi	a0,a0,-236 # 5690 <malloc+0x190>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     7a4:	ef050513          	addi	a0,a0,-272 # 5690 <malloc+0x190>
     7a8:	083040ef          	jal	502a <open>
     7ac:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     7ae:	4581                	li	a1,0
     7b0:	00005517          	auipc	a0,0x5
     7b4:	ee050513          	addi	a0,a0,-288 # 5690 <malloc+0x190>
  ...
  write(fd1, "abcdef", 6);
     ...
     7e6:	12658593          	addi	a1,a1,294 # 5908 <malloc+0x408>
     7ea:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     81c:	e7850513          	addi	a0,a0,-392 # 5690 <malloc+0x190>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     850:	05c50513          	addi	a0,a0,92 # 58a8 <malloc+0x3a8>
     854:	3f5040ef          	jal	5448 <printf>
    exit(1);
     858:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     864:	06850513          	addi	a0,a0,104 # 58c8 <malloc+0x3c8>
     868:	3e1040ef          	jal	5448 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     86c:	8656                	mv	a2,s5
     86e:	85d2                	mv	a1,s4
     870:	00005517          	auipc	a0,0x5
     874:	06850513          	addi	a0,a0,104 # 58d8 <malloc+0x3d8>
     878:	3d1040ef          	jal	5448 <printf>
    exit(1);
     87c:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     888:	07450513          	addi	a0,a0,116 # 58f8 <malloc+0x3f8>
     88c:	3bd040ef          	jal	5448 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     890:	8656                	mv	a2,s5
     892:	85d2                	mv	a1,s4
     894:	00005517          	auipc	a0,0x5
     898:	04450513          	addi	a0,a0,68 # 58d8 <malloc+0x3d8>
     89c:	3ad040ef          	jal	5448 <printf>
    exit(1);
     8a0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     8ae:	06650513          	addi	a0,a0,102 # 5910 <malloc+0x410>
     8b2:	397040ef          	jal	5448 <printf>
    exit(1);
     8b6:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     8c4:	07050513          	addi	a0,a0,112 # 5930 <malloc+0x430>
     8c8:	381040ef          	jal	5448 <printf>
    exit(1);
     8cc:	4505                	li	a0,1
...
00000000000008d2 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     8f2:	06250513          	addi	a0,a0,98 # 5950 <malloc+0x450>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     908:	074a0a13          	addi	s4,s4,116 # 5978 <malloc+0x478>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     90c:	00005b17          	auipc	s6,0x5
     910:	0a4b0b13          	addi	s6,s6,164 # 59b0 <malloc+0x4b0>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     946:	00e50513          	addi	a0,a0,14 # 5950 <malloc+0x450>
  ...
  if(unlink("small") < 0){
     ...
     976:	fde50513          	addi	a0,a0,-34 # 5950 <malloc+0x450>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     99e:	fbe50513          	addi	a0,a0,-66 # 5958 <malloc+0x458>
     9a2:	2a7040ef          	jal	5448 <printf>
    exit(1);
     9a6:	4505                	li	a0,1
     ...
     9b4:	fd850513          	addi	a0,a0,-40 # 5988 <malloc+0x488>
     9b8:	291040ef          	jal	5448 <printf>
      exit(1);
     9bc:	4505                	li	a0,1
     ...
     9ca:	ffa50513          	addi	a0,a0,-6 # 59c0 <malloc+0x4c0>
     9ce:	27b040ef          	jal	5448 <printf>
      exit(1);
     9d2:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     9de:	00e50513          	addi	a0,a0,14 # 59e8 <malloc+0x4e8>
     9e2:	267040ef          	jal	5448 <printf>
    exit(1);
     9e6:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     9f2:	01a50513          	addi	a0,a0,26 # 5a08 <malloc+0x508>
     9f6:	253040ef          	jal	5448 <printf>
    exit(1);
     9fa:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     a06:	01e50513          	addi	a0,a0,30 # 5a20 <malloc+0x520>
     a0a:	23f040ef          	jal	5448 <printf>
    exit(1);
     a0e:	4505                	li	a0,1
...
0000000000000a14 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     a32:	01250513          	addi	a0,a0,18 # 5a40 <malloc+0x540>
  ...
  fd = open("big", O_RDONLY);
     ...
     a76:	fce50513          	addi	a0,a0,-50 # 5a40 <malloc+0x540>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     ab4:	f9850513          	addi	a0,a0,-104 # 5a48 <malloc+0x548>
     ab8:	191040ef          	jal	5448 <printf>
    exit(1);
     abc:	4505                	li	a0,1
     ...
     aca:	fa250513          	addi	a0,a0,-94 # 5a68 <malloc+0x568>
     ace:	17b040ef          	jal	5448 <printf>
      exit(1);
     ad2:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     ade:	fb650513          	addi	a0,a0,-74 # 5a90 <malloc+0x590>
     ae2:	167040ef          	jal	5448 <printf>
    exit(1);
     ae6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     afe:	f4650513          	addi	a0,a0,-186 # 5a40 <malloc+0x540>
     ...
     b26:	f8e50513          	addi	a0,a0,-114 # 5ab0 <malloc+0x5b0>
     b2a:	11f040ef          	jal	5448 <printf>
        exit(1);
     b2e:	4505                	li	a0,1
     ...
     b3c:	fa050513          	addi	a0,a0,-96 # 5ad8 <malloc+0x5d8>
     b40:	109040ef          	jal	5448 <printf>
      exit(1);
     b44:	4505                	li	a0,1
     ...
     b52:	fa250513          	addi	a0,a0,-94 # 5af0 <malloc+0x5f0>
     b56:	0f3040ef          	jal	5448 <printf>
      exit(1);
     b5a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b66:	fb650513          	addi	a0,a0,-74 # 5b18 <malloc+0x618>
     b6a:	0df040ef          	jal	5448 <printf>
    exit(1);
     b6e:	4505                	li	a0,1
...
0000000000000b74 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b8c:	fa850513          	addi	a0,a0,-88 # 5b30 <malloc+0x630>
  ...
  write(fd, "hello", SZ);
     ...
     ba0:	fc458593          	addi	a1,a1,-60 # 5b60 <malloc+0x660>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bb4:	f8050513          	addi	a0,a0,-128 # 5b30 <malloc+0x630>
  ...
  unlink("unlinkread");
     ...
     c3c:	ef850513          	addi	a0,a0,-264 # 5b30 <malloc+0x630>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c58:	eec50513          	addi	a0,a0,-276 # 5b40 <malloc+0x640>
     c5c:	7ec040ef          	jal	5448 <printf>
    exit(1);
     c60:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c6c:	f0050513          	addi	a0,a0,-256 # 5b68 <malloc+0x668>
     c70:	7d8040ef          	jal	5448 <printf>
    exit(1);
     c74:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c80:	f0c50513          	addi	a0,a0,-244 # 5b88 <malloc+0x688>
     c84:	7c4040ef          	jal	5448 <printf>
    exit(1);
     c88:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c94:	f2050513          	addi	a0,a0,-224 # 5bb0 <malloc+0x6b0>
     c98:	7b0040ef          	jal	5448 <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ca8:	f2c50513          	addi	a0,a0,-212 # 5bd0 <malloc+0x6d0>
     cac:	79c040ef          	jal	5448 <printf>
    exit(1);
     cb0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cbc:	f3850513          	addi	a0,a0,-200 # 5bf0 <malloc+0x6f0>
     cc0:	788040ef          	jal	5448 <printf>
    exit(1);
     cc4:	4505                	li	a0,1
...
0000000000000cca <linktest>:
{
  ...
  unlink("lf1");
     ...
     cdc:	f3850513          	addi	a0,a0,-200 # 5c10 <malloc+0x710>
     ce0:	35a040ef          	jal	503a <unlink>
  unlink("lf2");
     ce4:	00005517          	auipc	a0,0x5
     ce8:	f3450513          	addi	a0,a0,-204 # 5c18 <malloc+0x718>
     cec:	34e040ef          	jal	503a <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     cf0:	20200593          	li	a1,514
     cf4:	00005517          	auipc	a0,0x5
     cf8:	f1c50513          	addi	a0,a0,-228 # 5c10 <malloc+0x710>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d0c:	e5858593          	addi	a1,a1,-424 # 5b60 <malloc+0x660>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     de4:	e4050513          	addi	a0,a0,-448 # 5c20 <malloc+0x720>
     de8:	660040ef          	jal	5448 <printf>
    exit(1);
     dec:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     df8:	e4450513          	addi	a0,a0,-444 # 5c38 <malloc+0x738>
     dfc:	64c040ef          	jal	5448 <printf>
    exit(1);
     e00:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     e0c:	e4850513          	addi	a0,a0,-440 # 5c50 <malloc+0x750>
     e10:	638040ef          	jal	5448 <printf>
    exit(1);
     e14:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     e20:	e5450513          	addi	a0,a0,-428 # 5c70 <malloc+0x770>
     e24:	624040ef          	jal	5448 <printf>
    exit(1);
     e28:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     e34:	e7050513          	addi	a0,a0,-400 # 5ca0 <malloc+0x7a0>
     e38:	610040ef          	jal	5448 <printf>
    exit(1);
     e3c:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     e48:	e7450513          	addi	a0,a0,-396 # 5cb8 <malloc+0x7b8>
     e4c:	5fc040ef          	jal	5448 <printf>
    exit(1);
     e50:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e5c:	e7850513          	addi	a0,a0,-392 # 5cd0 <malloc+0x7d0>
     e60:	5e8040ef          	jal	5448 <printf>
    exit(1);
     e64:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e70:	e8c50513          	addi	a0,a0,-372 # 5cf8 <malloc+0x7f8>
     e74:	5d4040ef          	jal	5448 <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e84:	ea850513          	addi	a0,a0,-344 # 5d28 <malloc+0x828>
     e88:	5c0040ef          	jal	5448 <printf>
    exit(1);
     e8c:	4505                	li	a0,1
...
0000000000000e92 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     eae:	e9e98993          	addi	s3,s3,-354 # 5d48 <malloc+0x848>
     eb2:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     eb4:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     ee6:	e7650513          	addi	a0,a0,-394 # 5d58 <malloc+0x858>
     eea:	55e040ef          	jal	5448 <printf>
      exit(1);
     eee:	4505                	li	a0,1
...
0000000000000ef4 <bigdir>:
{
  ...
  unlink("bd");
     ...
     f10:	e6c50513          	addi	a0,a0,-404 # 5d78 <malloc+0x878>
     f14:	126040ef          	jal	503a <unlink>
  fd = open("bd", O_CREATE);
     f18:	20000593          	li	a1,512
     f1c:	00005517          	auipc	a0,0x5
     f20:	e5c50513          	addi	a0,a0,-420 # 5d78 <malloc+0x878>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     f3e:	e3e98993          	addi	s3,s3,-450 # 5d78 <malloc+0x878>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f8a:	df250513          	addi	a0,a0,-526 # 5d78 <malloc+0x878>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     ff6:	d8e50513          	addi	a0,a0,-626 # 5d80 <malloc+0x880>
     ffa:	44e040ef          	jal	5448 <printf>
    exit(1);
     ffe:	4505                	li	a0,1
    ...
    1010:	d9450513          	addi	a0,a0,-620 # 5da0 <malloc+0x8a0>
    1014:	434040ef          	jal	5448 <printf>
      exit(1);
    1018:	4505                	li	a0,1
    ...
    1024:	da850513          	addi	a0,a0,-600 # 5dc8 <malloc+0x8c8>
    1028:	420040ef          	jal	5448 <printf>
      exit(1);
    102c:	4505                	li	a0,1
...
000000000000105e <badarg>:
{
    ...
    1082:	5ba98993          	addi	s3,s3,1466 # 5638 <malloc+0x138>
    argv[0] = (char*)0xffffffff;
...
00000000000010a0 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    10f6:	e2678793          	addi	a5,a5,-474 # 6f18 <malloc+0x1a18>
  ...
  if(pid == 0){
    ...
    114a:	a3a78793          	addi	a5,a5,-1478 # 7b80 <malloc+0x2680>
    ...
    116e:	4ce50513          	addi	a0,a0,1230 # 5638 <malloc+0x138>
    ...
    1182:	cf250513          	addi	a0,a0,-782 # 5e70 <malloc+0x970>
    1186:	2c2040ef          	jal	5448 <printf>
      exit(1);
    118a:	4505                	li	a0,1
    ...
    119a:	c5250513          	addi	a0,a0,-942 # 5de8 <malloc+0x8e8>
    119e:	2aa040ef          	jal	5448 <printf>
    exit(1);
    11a2:	4505                	li	a0,1
    ...
    11b2:	c5a50513          	addi	a0,a0,-934 # 5e08 <malloc+0x908>
    11b6:	292040ef          	jal	5448 <printf>
    exit(1);
    11ba:	4505                	li	a0,1
    ...
    11cc:	c6050513          	addi	a0,a0,-928 # 5e28 <malloc+0x928>
    11d0:	278040ef          	jal	5448 <printf>
    exit(1);
    11d4:	4505                	li	a0,1
    ...
    11e4:	c7050513          	addi	a0,a0,-912 # 5e50 <malloc+0x950>
    11e8:	260040ef          	jal	5448 <printf>
    exit(1);
    11ec:	4505                	li	a0,1
    11ee:	5fd030ef          	jal	4fea <exit>
    printf("fork failed\n");
    11f2:	00006517          	auipc	a0,0x6
    11f6:	27e50513          	addi	a0,a0,638 # 7470 <malloc+0x1f70>
    11fa:	24e040ef          	jal	5448 <printf>
    exit(1);
    11fe:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1230:	c6c50513          	addi	a0,a0,-916 # 5e98 <malloc+0x998>
    1234:	214040ef          	jal	5448 <printf>
    exit(1);
    1238:	4505                	li	a0,1
...
000000000000123e <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    1252:	44250513          	addi	a0,a0,1090 # 5690 <malloc+0x190>
  ...
  if(pid == 0){
    ...
    1282:	41298993          	addi	s3,s3,1042 # 5690 <malloc+0x190>
      int n = write(fd, "1234567890", 10);
    1286:	4a29                	li	s4,10
    1288:	00005b17          	auipc	s6,0x5
    128c:	c70b0b13          	addi	s6,s6,-912 # 5ef8 <malloc+0x9f8>
    ...
    12f2:	bda50513          	addi	a0,a0,-1062 # 5ec8 <malloc+0x9c8>
    12f6:	152040ef          	jal	5448 <printf>
    exit(1);
    12fa:	4505                	li	a0,1
    ...
    1306:	bde50513          	addi	a0,a0,-1058 # 5ee0 <malloc+0x9e0>
    130a:	13e040ef          	jal	5448 <printf>
        exit(1);
    130e:	4505                	li	a0,1
    ...
    131c:	bf050513          	addi	a0,a0,-1040 # 5f08 <malloc+0xa08>
    1320:	128040ef          	jal	5448 <printf>
        exit(1);
    1324:	4505                	li	a0,1
    ...
    1342:	352a0a13          	addi	s4,s4,850 # 5690 <malloc+0x190>
    int n = write(fd, "xxx", 3);
    1346:	498d                	li	s3,3
    1348:	00005b17          	auipc	s6,0x5
    134c:	be0b0b13          	addi	s6,s6,-1056 # 5f28 <malloc+0xa28>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    1350:	85d6                	mv	a1,s5
    1352:	8552                	mv	a0,s4
  ...
  unlink("truncfile");
    ...
    1386:	30e50513          	addi	a0,a0,782 # 5690 <malloc+0x190>
  ...
  exit(xstatus);
    ...
    13a0:	b4450513          	addi	a0,a0,-1212 # 5ee0 <malloc+0x9e0>
    13a4:	0a4040ef          	jal	5448 <printf>
      exit(1);
    13a8:	4505                	li	a0,1
    ...
    13ba:	b7a50513          	addi	a0,a0,-1158 # 5f30 <malloc+0xa30>
    13be:	08a040ef          	jal	5448 <printf>
      exit(1);
    13c2:	4505                	li	a0,1
...
00000000000013c8 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    13d8:	26478793          	addi	a5,a5,612 # 5638 <malloc+0x138>
    13dc:	fcf43023          	sd	a5,-64(s0)
    13e0:	00005797          	auipc	a5,0x5
    13e4:	b7078793          	addi	a5,a5,-1168 # 5f50 <malloc+0xa50>
    13e8:	fcf43423          	sd	a5,-56(s0)
    13ec:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    13f0:	00005517          	auipc	a0,0x5
    13f4:	b6850513          	addi	a0,a0,-1176 # 5f58 <malloc+0xa58>
  ...
  if(pid == 0) {
    ...
    1418:	b4450513          	addi	a0,a0,-1212 # 5f58 <malloc+0xa58>
    ...
    1430:	b4c50513          	addi	a0,a0,-1204 # 5f78 <malloc+0xa78>
    1434:	014040ef          	jal	5448 <printf>
      exit(1);
    1438:	4505                	li	a0,1
    ...
    1446:	a8650513          	addi	a0,a0,-1402 # 5ec8 <malloc+0x9c8>
    144a:	7ff030ef          	jal	5448 <printf>
     exit(1);
    144e:	4505                	li	a0,1
    ...
    145a:	b0a50513          	addi	a0,a0,-1270 # 5f60 <malloc+0xa60>
    145e:	7eb030ef          	jal	5448 <printf>
      exit(1);
    1462:	4505                	li	a0,1
    ...
    1470:	1cc50513          	addi	a0,a0,460 # 5638 <malloc+0x138>
  ...
  if(xstatus != 0)
    ...
    1498:	af450513          	addi	a0,a0,-1292 # 5f88 <malloc+0xa88>
    149c:	7ad030ef          	jal	5448 <printf>
      exit(1);
    14a0:	4505                	li	a0,1
    ...
    14ac:	af850513          	addi	a0,a0,-1288 # 5fa0 <malloc+0xaa0>
    14b0:	799030ef          	jal	5448 <printf>
    14b4:	bfd1                	j	1488 <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    14b6:	4581                	li	a1,0
    14b8:	00005517          	auipc	a0,0x5
    14bc:	aa050513          	addi	a0,a0,-1376 # 5f58 <malloc+0xa58>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    14de:	52e50513          	addi	a0,a0,1326 # 5a08 <malloc+0x508>
    14e2:	767030ef          	jal	5448 <printf>
    exit(1);
    14e6:	4505                	li	a0,1
    ...
    14f2:	9f250513          	addi	a0,a0,-1550 # 5ee0 <malloc+0x9e0>
    14f6:	753030ef          	jal	5448 <printf>
    exit(1);
    14fa:	4505                	li	a0,1
    14fc:	2ef030ef          	jal	4fea <exit>
  unlink("echo-ok");
    1500:	00005517          	auipc	a0,0x5
    1504:	a5850513          	addi	a0,a0,-1448 # 5f58 <malloc+0xa58>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    152a:	a9250513          	addi	a0,a0,-1390 # 5fb8 <malloc+0xab8>
    152e:	71b030ef          	jal	5448 <printf>
    exit(1);
    1532:	4505                	li	a0,1
...
000000000000153e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    15d6:	9fe50513          	addi	a0,a0,-1538 # 5fd0 <malloc+0xad0>
    15da:	66f030ef          	jal	5448 <printf>
    exit(1);
    15de:	4505                	li	a0,1
    ...
    1612:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0x65>
{
    ...
    1650:	99c50513          	addi	a0,a0,-1636 # 5fe8 <malloc+0xae8>
    1654:	5f5030ef          	jal	5448 <printf>
        exit(1);
    1658:	4505                	li	a0,1
    ...
    1664:	9a050513          	addi	a0,a0,-1632 # 6000 <malloc+0xb00>
    1668:	5e1030ef          	jal	5448 <printf>
          return;
    ...
    1696:	98650513          	addi	a0,a0,-1658 # 6018 <malloc+0xb18>
    169a:	5af030ef          	jal	5448 <printf>
      exit(1);
    169e:	4505                	li	a0,1
    ...
    16d2:	96a50513          	addi	a0,a0,-1686 # 6038 <malloc+0xb38>
    16d6:	573030ef          	jal	5448 <printf>
    exit(1);
    16da:	4505                	li	a0,1
...
00000000000016e0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    173a:	79250513          	addi	a0,a0,1938 # 5ec8 <malloc+0x9c8>
    173e:	50b030ef          	jal	5448 <printf>
      exit(1);
    1742:	4505                	li	a0,1
    ...
    174e:	90650513          	addi	a0,a0,-1786 # 6050 <malloc+0xb50>
    1752:	4f7030ef          	jal	5448 <printf>
        exit(1);
    1756:	4505                	li	a0,1
    ...
    1762:	90a50513          	addi	a0,a0,-1782 # 6068 <malloc+0xb68>
    1766:	4e3030ef          	jal	5448 <printf>
        exit(1);
    176a:	4505                	li	a0,1
...
0000000000001776 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    17be:	70e50513          	addi	a0,a0,1806 # 5ec8 <malloc+0x9c8>
    17c2:	487030ef          	jal	5448 <printf>
      exit(1);
    17c6:	4505                	li	a0,1
    ...
    17d6:	6f650513          	addi	a0,a0,1782 # 5ec8 <malloc+0x9c8>
    17da:	46f030ef          	jal	5448 <printf>
        exit(1);
    17de:	4505                	li	a0,1
...
00000000000017e8 <forkfork>:
{
    ...
    1834:	85850513          	addi	a0,a0,-1960 # 6088 <malloc+0xb88>
    1838:	411030ef          	jal	5448 <printf>
      exit(1);
    183c:	4505                	li	a0,1
    183e:	7ac030ef          	jal	4fea <exit>
{
    ...
    1870:	82c50513          	addi	a0,a0,-2004 # 6098 <malloc+0xb98>
    1874:	3d5030ef          	jal	5448 <printf>
      exit(1);
    1878:	4505                	li	a0,1
...
000000000000187e <reparent2>:
{
  ...
  exit(0);
    ...
    18aa:	bca50513          	addi	a0,a0,-1078 # 7470 <malloc+0x1f70>
    18ae:	39b030ef          	jal	5448 <printf>
      exit(1);
    18b2:	4505                	li	a0,1
...
00000000000018c6 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1936:	59650513          	addi	a0,a0,1430 # 5ec8 <malloc+0x9c8>
    193a:	30f030ef          	jal	5448 <printf>
      exit(1);
    193e:	4505                	li	a0,1
    ...
    1962:	60250513          	addi	a0,a0,1538 # 5f60 <malloc+0xa60>
    1966:	2e3030ef          	jal	5448 <printf>
          exit(1);
    196a:	4505                	li	a0,1
    ...
    19c2:	6fa50513          	addi	a0,a0,1786 # 60b8 <malloc+0xbb8>
    19c6:	283030ef          	jal	5448 <printf>
            exit(1);
    19ca:	4505                	li	a0,1
    ...
    1a0c:	6c850513          	addi	a0,a0,1736 # 60d0 <malloc+0xbd0>
    1a10:	239030ef          	jal	5448 <printf>
        exit(1);
    1a14:	4505                	li	a0,1
    ...
    1a28:	6d450513          	addi	a0,a0,1748 # 60f8 <malloc+0xbf8>
    1a2c:	21d030ef          	jal	5448 <printf>
        exit(1);
    1a30:	4505                	li	a0,1
...
0000000000001ab2 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1ad4:	bd850513          	addi	a0,a0,-1064 # 56a8 <malloc+0x1a8>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b14:	b98b0b13          	addi	s6,s6,-1128 # 56a8 <malloc+0x1a8>
      link("cat", "x");
    1b18:	00004c97          	auipc	s9,0x4
    1b1c:	608c8c93          	addi	s9,s9,1544 # 6120 <malloc+0xc20>
    ...
    1b2c:	3a050513          	addi	a0,a0,928 # 5ec8 <malloc+0x9c8>
    1b30:	119030ef          	jal	5448 <printf>
    exit(1);
    1b34:	4505                	li	a0,1
...
0000000000001bac <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1bd8:	59c50513          	addi	a0,a0,1436 # 6170 <malloc+0xc70>
    1bdc:	06d030ef          	jal	5448 <printf>
    exit(1);
    1be0:	4505                	li	a0,1
    ...
    1bf0:	53c50513          	addi	a0,a0,1340 # 6128 <malloc+0xc28>
    1bf4:	055030ef          	jal	5448 <printf>
    exit(1);
    1bf8:	4505                	li	a0,1
    ...
    1c04:	54050513          	addi	a0,a0,1344 # 6140 <malloc+0xc40>
    1c08:	041030ef          	jal	5448 <printf>
      exit(1);
    1c0c:	4505                	li	a0,1
    ...
    1c18:	54450513          	addi	a0,a0,1348 # 6158 <malloc+0xc58>
    1c1c:	02d030ef          	jal	5448 <printf>
    exit(1);
    1c20:	4505                	li	a0,1
...
0000000000001c54 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1cbc:	21050513          	addi	a0,a0,528 # 5ec8 <malloc+0x9c8>
    1cc0:	788030ef          	jal	5448 <printf>
      exit(1);
    1cc4:	4505                	li	a0,1
    ...
    1cd6:	4c650513          	addi	a0,a0,1222 # 6198 <malloc+0xc98>
    1cda:	76e030ef          	jal	5448 <printf>
      exit(1);
    1cde:	4505                	li	a0,1
...
0000000000001cea <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1d4a:	18250513          	addi	a0,a0,386 # 5ec8 <malloc+0x9c8>
    1d4e:	6fa030ef          	jal	5448 <printf>
      exit(1);
    1d52:	4505                	li	a0,1
    ...
    1d6e:	44e50513          	addi	a0,a0,1102 # 61b8 <malloc+0xcb8>
    1d72:	6d6030ef          	jal	5448 <printf>
      exit(1);
    1d76:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1dbe:	41650513          	addi	a0,a0,1046 # 61d0 <malloc+0xcd0>
    1dc2:	686030ef          	jal	5448 <printf>
    exit(1);
    1dc6:	4505                	li	a0,1
    ...
    1dd2:	0fa50513          	addi	a0,a0,250 # 5ec8 <malloc+0x9c8>
    1dd6:	672030ef          	jal	5448 <printf>
    exit(1);
    1dda:	4505                	li	a0,1
...
0000000000001de6 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1dfc:	d8878793          	addi	a5,a5,-632 # 7b80 <malloc+0x2680>
  ...
  exit(0);
    ...
    1e66:	39650513          	addi	a0,a0,918 # 61f8 <malloc+0xcf8>
    1e6a:	5de030ef          	jal	5448 <printf>
      exit(0);
    1e6e:	4501                	li	a0,0
    ...
    1e7a:	05250513          	addi	a0,a0,82 # 5ec8 <malloc+0x9c8>
    1e7e:	5ca030ef          	jal	5448 <printf>
      exit(1);
    1e82:	4505                	li	a0,1
...
0000000000001e8e <manywrites>:
{
  ...
  exit(0);
    ...
    1ef2:	58250513          	addi	a0,a0,1410 # 7470 <malloc+0x1f70>
    1ef6:	552030ef          	jal	5448 <printf>
      exit(1);
    1efa:	4505                	li	a0,1
    ...
    1f92:	28a50513          	addi	a0,a0,650 # 6218 <malloc+0xd18>
    1f96:	4b2030ef          	jal	5448 <printf>
            exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	76250513          	addi	a0,a0,1890 # 5708 <malloc+0x208>
    1fae:	49a030ef          	jal	5448 <printf>
            exit(1);
    1fb2:	4505                	li	a0,1
...
0000000000001fc8 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    202a:	ef278793          	addi	a5,a5,-270 # 6f18 <malloc+0x1a18>
  ...
  if(ret != -1){
    ...
    2064:	1d050513          	addi	a0,a0,464 # 6230 <malloc+0xd30>
    2068:	3e0030ef          	jal	5448 <printf>
    exit(1);
    206c:	4505                	li	a0,1
    ...
    207a:	d7250513          	addi	a0,a0,-654 # 5de8 <malloc+0x8e8>
    207e:	3ca030ef          	jal	5448 <printf>
    exit(1);
    2082:	4505                	li	a0,1
    ...
    2090:	d7c50513          	addi	a0,a0,-644 # 5e08 <malloc+0x908>
    2094:	3b4030ef          	jal	5448 <printf>
    exit(1);
    2098:	4505                	li	a0,1
    ...
    20a8:	d8450513          	addi	a0,a0,-636 # 5e28 <malloc+0x928>
    20ac:	39c030ef          	jal	5448 <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    ...
    20be:	d9650513          	addi	a0,a0,-618 # 5e50 <malloc+0x950>
    20c2:	386030ef          	jal	5448 <printf>
    exit(1);
    20c6:	4505                	li	a0,1
...
00000000000020cc <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    20fa:	17a50513          	addi	a0,a0,378 # 6270 <malloc+0xd70>
  ...
  if(n >= 0){
    ...
    2122:	17250513          	addi	a0,a0,370 # 6290 <malloc+0xd90>
    2126:	322030ef          	jal	5448 <printf>
    exit(1);
    212a:	4505                	li	a0,1
    ...
    2138:	10450513          	addi	a0,a0,260 # 6238 <malloc+0xd38>
    213c:	30c030ef          	jal	5448 <printf>
    exit(1);
    2140:	4505                	li	a0,1
    ...
    214c:	10850513          	addi	a0,a0,264 # 6250 <malloc+0xd50>
    2150:	2f8030ef          	jal	5448 <printf>
    exit(1);
    2154:	4505                	li	a0,1
    2156:	695020ef          	jal	4fea <exit>
    printf("open(rwsbrk) failed\n");
    215a:	00004517          	auipc	a0,0x4
    215e:	11e50513          	addi	a0,a0,286 # 6278 <malloc+0xd78>
    2162:	2e6030ef          	jal	5448 <printf>
    exit(1);
    2166:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2176:	0fe50513          	addi	a0,a0,254 # 6270 <malloc+0xd70>
    217a:	6c1020ef          	jal	503a <unlink>
  fd = open("README", O_RDONLY);
    217e:	4581                	li	a1,0
    2180:	00003517          	auipc	a0,0x3
    2184:	69050513          	addi	a0,a0,1680 # 5810 <malloc+0x310>
  ...
  if(n >= 0){
    ...
    21a6:	11e50513          	addi	a0,a0,286 # 62c0 <malloc+0xdc0>
    21aa:	29e030ef          	jal	5448 <printf>
    exit(1);
    21ae:	4505                	li	a0,1
    21b0:	63b020ef          	jal	4fea <exit>
    printf("open(README) failed\n");
    21b4:	00003517          	auipc	a0,0x3
    21b8:	66450513          	addi	a0,a0,1636 # 5818 <malloc+0x318>
    21bc:	28c030ef          	jal	5448 <printf>
    exit(1);
    21c0:	4505                	li	a0,1
...
00000000000021d2 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2226:	0c650513          	addi	a0,a0,198 # 62e8 <malloc+0xde8>
    222a:	21e030ef          	jal	5448 <printf>
    exit(1);
    222e:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    227e:	08e50513          	addi	a0,a0,142 # 6308 <malloc+0xe08>
    2282:	1c6030ef          	jal	5448 <printf>
    exit(1);
    2286:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    22c8:	0a450513          	addi	a0,a0,164 # 6368 <malloc+0xe68>
    22cc:	17c030ef          	jal	5448 <printf>
    exit(1);
    22d0:	4505                	li	a0,1
    ...
    22e2:	04a50513          	addi	a0,a0,74 # 6328 <malloc+0xe28>
    22e6:	162030ef          	jal	5448 <printf>
      exit(1);
    22ea:	4505                	li	a0,1
    ...
    22f6:	05650513          	addi	a0,a0,86 # 6348 <malloc+0xe48>
    22fa:	14e030ef          	jal	5448 <printf>
    exit(1);
    22fe:	4505                	li	a0,1
...
000000000000231e <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    23e2:	faa50513          	addi	a0,a0,-86 # 6388 <malloc+0xe88>
    23e6:	062030ef          	jal	5448 <printf>
    exit(1);
    23ea:	4505                	li	a0,1
    ...
    23f6:	fde50513          	addi	a0,a0,-34 # 63d0 <malloc+0xed0>
    23fa:	04e030ef          	jal	5448 <printf>
    exit(1);
    23fe:	4505                	li	a0,1
    ...
    240e:	fe650513          	addi	a0,a0,-26 # 63f0 <malloc+0xef0>
    2412:	036030ef          	jal	5448 <printf>
    exit(1);
    2416:	4505                	li	a0,1
    ...
    2426:	00e50513          	addi	a0,a0,14 # 6430 <malloc+0xf30>
    242a:	01e030ef          	jal	5448 <printf>
    exit(1);
    242e:	4505                	li	a0,1
    ...
    243a:	02a50513          	addi	a0,a0,42 # 6460 <malloc+0xf60>
    243e:	00a030ef          	jal	5448 <printf>
    exit(1);
    2442:	4505                	li	a0,1
    ...
    2452:	04a50513          	addi	a0,a0,74 # 6498 <malloc+0xf98>
    2456:	7f3020ef          	jal	5448 <printf>
    exit(1);
    245a:	4505                	li	a0,1
...
0000000000002460 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2480:	04450513          	addi	a0,a0,68 # 64c0 <malloc+0xfc0>
    2484:	3a7020ef          	jal	502a <open>
    2488:	84aa                	mv	s1,a0
  unlink("sbrk");
    248a:	00004517          	auipc	a0,0x4
    248e:	03650513          	addi	a0,a0,54 # 64c0 <malloc+0xfc0>
  ...
  if(pipe((int *) a) != 0){
    ...
    24ce:	ffe50513          	addi	a0,a0,-2 # 64c8 <malloc+0xfc8>
    24d2:	777020ef          	jal	5448 <printf>
    exit(1);
    24d6:	4505                	li	a0,1
    ...
    24e2:	00250513          	addi	a0,a0,2 # 64e0 <malloc+0xfe0>
    24e6:	763020ef          	jal	5448 <printf>
    exit(1);
    24ea:	4505                	li	a0,1
    ...
    24f6:	ade50513          	addi	a0,a0,-1314 # 5fd0 <malloc+0xad0>
    24fa:	74f020ef          	jal	5448 <printf>
    exit(1);
    24fe:	4505                	li	a0,1
...
0000000000002504 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2518:	fe450513          	addi	a0,a0,-28 # 64f8 <malloc+0xff8>
  ...
  close(fd);
    ...
    2550:	99450513          	addi	a0,a0,-1644 # 5ee0 <malloc+0x9e0>
    2554:	6f5020ef          	jal	5448 <printf>
    exit(1);
    2558:	4505                	li	a0,1
...
000000000000255e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2586:	eee50513          	addi	a0,a0,-274 # 7470 <malloc+0x1f70>
    258a:	6bf020ef          	jal	5448 <printf>
    exit(1);
    258e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    25c0:	eb450513          	addi	a0,a0,-332 # 7470 <malloc+0x1f70>
    25c4:	685020ef          	jal	5448 <printf>
    exit(1);
    25c8:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2600:	e7450513          	addi	a0,a0,-396 # 7470 <malloc+0x1f70>
    2604:	645020ef          	jal	5448 <printf>
    exit(1);
    2608:	4505                	li	a0,1
...
00000000000026ea <execout>:
{
  ...
  exit(0);
    ...
    2726:	d4e50513          	addi	a0,a0,-690 # 7470 <malloc+0x1f70>
    272a:	51f020ef          	jal	5448 <printf>
      exit(1);
    272e:	4505                	li	a0,1
...
000000000000279a <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27ca:	dba50513          	addi	a0,a0,-582 # 6580 <malloc+0x1080>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27e0:	e1c50513          	addi	a0,a0,-484 # 65f8 <malloc+0x10f8>
  ...
  unlink("12345678901234");
    ...
    2864:	ca050513          	addi	a0,a0,-864 # 6500 <malloc+0x1000>
    2868:	3e1020ef          	jal	5448 <printf>
    exit(1);
    286c:	4505                	li	a0,1
    ...
    2878:	cd450513          	addi	a0,a0,-812 # 6548 <malloc+0x1048>
    287c:	3cd020ef          	jal	5448 <printf>
    exit(1);
    2880:	4505                	li	a0,1
    ...
    288c:	d2850513          	addi	a0,a0,-728 # 65b0 <malloc+0x10b0>
    2890:	3b9020ef          	jal	5448 <printf>
    exit(1);
    2894:	4505                	li	a0,1
    ...
    28a0:	d8c50513          	addi	a0,a0,-628 # 6628 <malloc+0x1128>
    28a4:	3a5020ef          	jal	5448 <printf>
    exit(1);
    28a8:	4505                	li	a0,1
    ...
    28b4:	dd850513          	addi	a0,a0,-552 # 6688 <malloc+0x1188>
    28b8:	391020ef          	jal	5448 <printf>
    exit(1);
    28bc:	4505                	li	a0,1
    ...
    28c8:	e1c50513          	addi	a0,a0,-484 # 66e0 <malloc+0x11e0>
    28cc:	37d020ef          	jal	5448 <printf>
    exit(1);
    28d0:	4505                	li	a0,1
...
00000000000028d6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    291a:	e0250513          	addi	a0,a0,-510 # 6718 <malloc+0x1218>
    ...
    2950:	ddc50513          	addi	a0,a0,-548 # 6728 <malloc+0x1228>
    2954:	2f5020ef          	jal	5448 <printf>
      break;
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2afe:	c4e50513          	addi	a0,a0,-946 # 6748 <malloc+0x1248>
    2b02:	147020ef          	jal	5448 <printf>
...
0000000000002b08 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2b64:	c2050513          	addi	a0,a0,-992 # 6780 <malloc+0x1280>
    2b68:	0e1020ef          	jal	5448 <printf>
    exit(1);
    2b6c:	4505                	li	a0,1
    ...
    2b78:	c2450513          	addi	a0,a0,-988 # 6798 <malloc+0x1298>
    2b7c:	0cd020ef          	jal	5448 <printf>
    exit(1);
    2b80:	4505                	li	a0,1
    ...
    2b8c:	c4050513          	addi	a0,a0,-960 # 67c8 <malloc+0x12c8>
    2b90:	0b9020ef          	jal	5448 <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    ...
    2ba0:	c5450513          	addi	a0,a0,-940 # 67f0 <malloc+0x12f0>
    2ba4:	0a5020ef          	jal	5448 <printf>
    exit(1);
    2ba8:	4505                	li	a0,1
...
0000000000002bae <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2c00:	2cc50513          	addi	a0,a0,716 # 5ec8 <malloc+0x9c8>
    2c04:	045020ef          	jal	5448 <printf>
    exit(1);
    2c08:	4505                	li	a0,1
    ...
    2c14:	b7050513          	addi	a0,a0,-1168 # 6780 <malloc+0x1280>
    2c18:	031020ef          	jal	5448 <printf>
      exit(1);
    2c1c:	4505                	li	a0,1
    ...
    2c28:	be450513          	addi	a0,a0,-1052 # 6808 <malloc+0x1308>
    2c2c:	01d020ef          	jal	5448 <printf>
      exit(1);
    2c30:	4505                	li	a0,1
    ...
    2c3c:	b9050513          	addi	a0,a0,-1136 # 67c8 <malloc+0x12c8>
    2c40:	009020ef          	jal	5448 <printf>
      exit(1);
    2c44:	4505                	li	a0,1
...
0000000000002c5a <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2cb6:	ace50513          	addi	a0,a0,-1330 # 6780 <malloc+0x1280>
    2cba:	78e020ef          	jal	5448 <printf>
    exit(1);
    2cbe:	4505                	li	a0,1
    ...
    2cca:	b6250513          	addi	a0,a0,-1182 # 6828 <malloc+0x1328>
    2cce:	77a020ef          	jal	5448 <printf>
    exit(1);
    2cd2:	4505                	li	a0,1
    ...
    2cde:	b6e50513          	addi	a0,a0,-1170 # 6848 <malloc+0x1348>
    2ce2:	766020ef          	jal	5448 <printf>
    exit(1);
    2ce6:	4505                	li	a0,1
    ...
    2cf2:	b7250513          	addi	a0,a0,-1166 # 6860 <malloc+0x1360>
    2cf6:	752020ef          	jal	5448 <printf>
    exit(1);
    2cfa:	4505                	li	a0,1
...
0000000000002d00 <subdir>:
{
  ...
  unlink("ff");
    ...
    2d12:	c9a50513          	addi	a0,a0,-870 # 69a8 <malloc+0x14a8>
    2d16:	324020ef          	jal	503a <unlink>
  if(mkdir("dd") != 0){
    2d1a:	00004517          	auipc	a0,0x4
    2d1e:	b5e50513          	addi	a0,a0,-1186 # 6878 <malloc+0x1378>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2d32:	b6a50513          	addi	a0,a0,-1174 # 6898 <malloc+0x1398>
  ...
  write(fd, "ff", 2);
    ...
    2d46:	c6658593          	addi	a1,a1,-922 # 69a8 <malloc+0x14a8>
  ...
  if(unlink("dd") >= 0){
    ...
    2d58:	b2450513          	addi	a0,a0,-1244 # 6878 <malloc+0x1378>
    2d5c:	2de020ef          	jal	503a <unlink>
    2d60:	2c055963          	bgez	a0,3032 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2d64:	00004517          	auipc	a0,0x4
    2d68:	b8c50513          	addi	a0,a0,-1140 # 68f0 <malloc+0x13f0>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2d7c:	ba050513          	addi	a0,a0,-1120 # 6918 <malloc+0x1418>
  ...
  write(fd, "FF", 2);
    ...
    2d90:	bbc58593          	addi	a1,a1,-1092 # 6948 <malloc+0x1448>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2da4:	bb050513          	addi	a0,a0,-1104 # 6950 <malloc+0x1450>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2e8a:	a9250513          	addi	a0,a0,-1390 # 6918 <malloc+0x1418>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2e9e:	c9650513          	addi	a0,a0,-874 # 6b30 <malloc+0x1630>
  ...
  if(unlink("dd") < 0){
    ...
    3010:	87450513          	addi	a0,a0,-1932 # 6880 <malloc+0x1380>
    3014:	434020ef          	jal	5448 <printf>
    exit(1);
    3018:	4505                	li	a0,1
    ...
    3024:	88050513          	addi	a0,a0,-1920 # 68a0 <malloc+0x13a0>
    3028:	420020ef          	jal	5448 <printf>
    exit(1);
    302c:	4505                	li	a0,1
    ...
    3038:	88c50513          	addi	a0,a0,-1908 # 68c0 <malloc+0x13c0>
    303c:	40c020ef          	jal	5448 <printf>
    exit(1);
    3040:	4505                	li	a0,1
    ...
    304c:	8b050513          	addi	a0,a0,-1872 # 68f8 <malloc+0x13f8>
    3050:	3f8020ef          	jal	5448 <printf>
    exit(1);
    3054:	4505                	li	a0,1
    ...
    3060:	8cc50513          	addi	a0,a0,-1844 # 6928 <malloc+0x1428>
    3064:	3e4020ef          	jal	5448 <printf>
    exit(1);
    3068:	4505                	li	a0,1
    ...
    3074:	8f050513          	addi	a0,a0,-1808 # 6960 <malloc+0x1460>
    3078:	3d0020ef          	jal	5448 <printf>
    exit(1);
    307c:	4505                	li	a0,1
    ...
    3088:	8fc50513          	addi	a0,a0,-1796 # 6980 <malloc+0x1480>
    308c:	3bc020ef          	jal	5448 <printf>
    exit(1);
    3090:	4505                	li	a0,1
    ...
    309c:	91850513          	addi	a0,a0,-1768 # 69b0 <malloc+0x14b0>
    30a0:	3a8020ef          	jal	5448 <printf>
    exit(1);
    30a4:	4505                	li	a0,1
    ...
    30b0:	92c50513          	addi	a0,a0,-1748 # 69d8 <malloc+0x14d8>
    30b4:	394020ef          	jal	5448 <printf>
    exit(1);
    30b8:	4505                	li	a0,1
    ...
    30c4:	93850513          	addi	a0,a0,-1736 # 69f8 <malloc+0x14f8>
    30c8:	380020ef          	jal	5448 <printf>
    exit(1);
    30cc:	4505                	li	a0,1
    ...
    30d8:	94c50513          	addi	a0,a0,-1716 # 6a20 <malloc+0x1520>
    30dc:	36c020ef          	jal	5448 <printf>
    exit(1);
    30e0:	4505                	li	a0,1
    ...
    30ec:	96050513          	addi	a0,a0,-1696 # 6a48 <malloc+0x1548>
    30f0:	358020ef          	jal	5448 <printf>
    exit(1);
    30f4:	4505                	li	a0,1
    ...
    3100:	97c50513          	addi	a0,a0,-1668 # 6a78 <malloc+0x1578>
    3104:	344020ef          	jal	5448 <printf>
    exit(1);
    3108:	4505                	li	a0,1
    ...
    3114:	99850513          	addi	a0,a0,-1640 # 6aa8 <malloc+0x15a8>
    3118:	330020ef          	jal	5448 <printf>
    exit(1);
    311c:	4505                	li	a0,1
    ...
    3128:	99c50513          	addi	a0,a0,-1636 # 6ac0 <malloc+0x15c0>
    312c:	31c020ef          	jal	5448 <printf>
    exit(1);
    3130:	4505                	li	a0,1
    ...
    313c:	9a850513          	addi	a0,a0,-1624 # 6ae0 <malloc+0x15e0>
    3140:	308020ef          	jal	5448 <printf>
    exit(1);
    3144:	4505                	li	a0,1
    ...
    3150:	9b450513          	addi	a0,a0,-1612 # 6b00 <malloc+0x1600>
    3154:	2f4020ef          	jal	5448 <printf>
    exit(1);
    3158:	4505                	li	a0,1
    ...
    3164:	9e050513          	addi	a0,a0,-1568 # 6b40 <malloc+0x1640>
    3168:	2e0020ef          	jal	5448 <printf>
    exit(1);
    316c:	4505                	li	a0,1
    ...
    3178:	9fc50513          	addi	a0,a0,-1540 # 6b70 <malloc+0x1670>
    317c:	2cc020ef          	jal	5448 <printf>
    exit(1);
    3180:	4505                	li	a0,1
    ...
    318c:	a0850513          	addi	a0,a0,-1528 # 6b90 <malloc+0x1690>
    3190:	2b8020ef          	jal	5448 <printf>
    exit(1);
    3194:	4505                	li	a0,1
    ...
    31a0:	a1450513          	addi	a0,a0,-1516 # 6bb0 <malloc+0x16b0>
    31a4:	2a4020ef          	jal	5448 <printf>
    exit(1);
    31a8:	4505                	li	a0,1
    ...
    31b4:	a2050513          	addi	a0,a0,-1504 # 6bd0 <malloc+0x16d0>
    31b8:	290020ef          	jal	5448 <printf>
    exit(1);
    31bc:	4505                	li	a0,1
    ...
    31c8:	a3c50513          	addi	a0,a0,-1476 # 6c00 <malloc+0x1700>
    31cc:	27c020ef          	jal	5448 <printf>
    exit(1);
    31d0:	4505                	li	a0,1
    ...
    31dc:	a5050513          	addi	a0,a0,-1456 # 6c28 <malloc+0x1728>
    31e0:	268020ef          	jal	5448 <printf>
    exit(1);
    31e4:	4505                	li	a0,1
    ...
    31f0:	a6450513          	addi	a0,a0,-1436 # 6c50 <malloc+0x1750>
    31f4:	254020ef          	jal	5448 <printf>
    exit(1);
    31f8:	4505                	li	a0,1
    ...
    3204:	a7850513          	addi	a0,a0,-1416 # 6c78 <malloc+0x1778>
    3208:	240020ef          	jal	5448 <printf>
    exit(1);
    320c:	4505                	li	a0,1
    ...
    3218:	a8450513          	addi	a0,a0,-1404 # 6c98 <malloc+0x1798>
    321c:	22c020ef          	jal	5448 <printf>
    exit(1);
    3220:	4505                	li	a0,1
    ...
    322c:	a9050513          	addi	a0,a0,-1392 # 6cb8 <malloc+0x17b8>
    3230:	218020ef          	jal	5448 <printf>
    exit(1);
    3234:	4505                	li	a0,1
    ...
    3240:	aa450513          	addi	a0,a0,-1372 # 6ce0 <malloc+0x17e0>
    3244:	204020ef          	jal	5448 <printf>
    exit(1);
    3248:	4505                	li	a0,1
    ...
    3254:	ab050513          	addi	a0,a0,-1360 # 6d00 <malloc+0x1800>
    3258:	1f0020ef          	jal	5448 <printf>
    exit(1);
    325c:	4505                	li	a0,1
    ...
    3268:	abc50513          	addi	a0,a0,-1348 # 6d20 <malloc+0x1820>
    326c:	1dc020ef          	jal	5448 <printf>
    exit(1);
    3270:	4505                	li	a0,1
    ...
    327c:	ad050513          	addi	a0,a0,-1328 # 6d48 <malloc+0x1848>
    3280:	1c8020ef          	jal	5448 <printf>
    exit(1);
    3284:	4505                	li	a0,1
    ...
    3290:	74c50513          	addi	a0,a0,1868 # 69d8 <malloc+0x14d8>
    3294:	1b4020ef          	jal	5448 <printf>
    exit(1);
    3298:	4505                	li	a0,1
    ...
    32a4:	ac850513          	addi	a0,a0,-1336 # 6d68 <malloc+0x1868>
    32a8:	1a0020ef          	jal	5448 <printf>
    exit(1);
    32ac:	4505                	li	a0,1
    ...
    32b8:	ad450513          	addi	a0,a0,-1324 # 6d88 <malloc+0x1888>
    32bc:	18c020ef          	jal	5448 <printf>
    exit(1);
    32c0:	4505                	li	a0,1
    ...
    32cc:	af050513          	addi	a0,a0,-1296 # 6db8 <malloc+0x18b8>
    32d0:	178020ef          	jal	5448 <printf>
    exit(1);
    32d4:	4505                	li	a0,1
    ...
    32e0:	afc50513          	addi	a0,a0,-1284 # 6dd8 <malloc+0x18d8>
    32e4:	164020ef          	jal	5448 <printf>
    exit(1);
    32e8:	4505                	li	a0,1
...
00000000000032ee <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    337a:	a8250513          	addi	a0,a0,-1406 # 6df8 <malloc+0x18f8>
    337e:	0ca020ef          	jal	5448 <printf>
    exit(1);
    3382:	4505                	li	a0,1
    ...
    338e:	a8650513          	addi	a0,a0,-1402 # 6e10 <malloc+0x1910>
    3392:	0b6020ef          	jal	5448 <printf>
    exit(1);
    3396:	4505                	li	a0,1
    ...
    33a2:	a8a50513          	addi	a0,a0,-1398 # 6e28 <malloc+0x1928>
    33a6:	0a2020ef          	jal	5448 <printf>
    exit(1);
    33aa:	4505                	li	a0,1
    ...
    33b6:	a8e50513          	addi	a0,a0,-1394 # 6e40 <malloc+0x1940>
    33ba:	08e020ef          	jal	5448 <printf>
    exit(1);
    33be:	4505                	li	a0,1
    ...
    33ca:	42a50513          	addi	a0,a0,1066 # 67f0 <malloc+0x12f0>
    33ce:	07a020ef          	jal	5448 <printf>
    exit(1);
    33d2:	4505                	li	a0,1
    ...
    33de:	a8650513          	addi	a0,a0,-1402 # 6e60 <malloc+0x1960>
    33e2:	066020ef          	jal	5448 <printf>
    exit(1);
    33e6:	4505                	li	a0,1
    ...
    33f2:	a9a50513          	addi	a0,a0,-1382 # 6e88 <malloc+0x1988>
    33f6:	052020ef          	jal	5448 <printf>
    exit(1);
    33fa:	4505                	li	a0,1
    ...
    3406:	aa650513          	addi	a0,a0,-1370 # 6ea8 <malloc+0x19a8>
    340a:	03e020ef          	jal	5448 <printf>
    exit(1);
    340e:	4505                	li	a0,1
...
0000000000003414 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    342a:	aa250513          	addi	a0,a0,-1374 # 6ec8 <malloc+0x19c8>
  ...
  if(chdir("dirfile") == 0){
    ...
    343e:	a8e50513          	addi	a0,a0,-1394 # 6ec8 <malloc+0x19c8>
    3442:	419010ef          	jal	505a <chdir>
    3446:	c569                	beqz	a0,3510 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    3448:	4581                	li	a1,0
    344a:	00004517          	auipc	a0,0x4
    344e:	ac650513          	addi	a0,a0,-1338 # 6f10 <malloc+0x1a10>
  ...
  fd = open(".", 0);
    ...
    34ce:	85650513          	addi	a0,a0,-1962 # 5d20 <malloc+0x820>
    34d2:	359010ef          	jal	502a <open>
    34d6:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    34d8:	4605                	li	a2,1
    34da:	00002597          	auipc	a1,0x2
    34de:	1ce58593          	addi	a1,a1,462 # 56a8 <malloc+0x1a8>
  ...
  close(fd);
    ...
    3502:	9d250513          	addi	a0,a0,-1582 # 6ed0 <malloc+0x19d0>
    3506:	743010ef          	jal	5448 <printf>
    exit(1);
    350a:	4505                	li	a0,1
    ...
    3516:	9de50513          	addi	a0,a0,-1570 # 6ef0 <malloc+0x19f0>
    351a:	72f010ef          	jal	5448 <printf>
    exit(1);
    351e:	4505                	li	a0,1
    ...
    352a:	9fa50513          	addi	a0,a0,-1542 # 6f20 <malloc+0x1a20>
    352e:	71b010ef          	jal	5448 <printf>
    exit(1);
    3532:	4505                	li	a0,1
    ...
    353e:	9e650513          	addi	a0,a0,-1562 # 6f20 <malloc+0x1a20>
    3542:	707010ef          	jal	5448 <printf>
    exit(1);
    3546:	4505                	li	a0,1
    ...
    3552:	9fa50513          	addi	a0,a0,-1542 # 6f48 <malloc+0x1a48>
    3556:	6f3010ef          	jal	5448 <printf>
    exit(1);
    355a:	4505                	li	a0,1
    ...
    3566:	a0e50513          	addi	a0,a0,-1522 # 6f70 <malloc+0x1a70>
    356a:	6df010ef          	jal	5448 <printf>
    exit(1);
    356e:	4505                	li	a0,1
    ...
    357a:	a2250513          	addi	a0,a0,-1502 # 6f98 <malloc+0x1a98>
    357e:	6cb010ef          	jal	5448 <printf>
    exit(1);
    3582:	4505                	li	a0,1
    ...
    358e:	a3650513          	addi	a0,a0,-1482 # 6fc0 <malloc+0x1ac0>
    3592:	6b7010ef          	jal	5448 <printf>
    exit(1);
    3596:	4505                	li	a0,1
    ...
    35a2:	a4250513          	addi	a0,a0,-1470 # 6fe0 <malloc+0x1ae0>
    35a6:	6a3010ef          	jal	5448 <printf>
    exit(1);
    35aa:	4505                	li	a0,1
    ...
    35b6:	a5650513          	addi	a0,a0,-1450 # 7008 <malloc+0x1b08>
    35ba:	68f010ef          	jal	5448 <printf>
    exit(1);
    35be:	4505                	li	a0,1
...
00000000000035c4 <iref>:
{
    ...
    35e4:	a40a8a93          	addi	s5,s5,-1472 # 7020 <malloc+0x1b20>
    mkdir("");
    35e8:	00003497          	auipc	s1,0x3
    35ec:	54048493          	addi	s1,s1,1344 # 6b28 <malloc+0x1628>
    link("README", "");
    35f0:	00002b17          	auipc	s6,0x2
    35f4:	220b0b13          	addi	s6,s6,544 # 5810 <malloc+0x310>
    fd = open("", O_CREATE);
    35f8:	20000a13          	li	s4,512
    fd = open("xx", O_CREATE);
    35fc:	00004997          	auipc	s3,0x4
    3600:	91c98993          	addi	s3,s3,-1764 # 6f18 <malloc+0x1a18>
    3604:	a835                	j	3640 <iref+0x7c>
      printf("%s: mkdir irefd failed\n", s);
    3606:	85de                	mv	a1,s7
    3608:	00004517          	auipc	a0,0x4
    360c:	a2050513          	addi	a0,a0,-1504 # 7028 <malloc+0x1b28>
    3610:	639010ef          	jal	5448 <printf>
      exit(1);
    3614:	4505                	li	a0,1
    ...
    3620:	a2450513          	addi	a0,a0,-1500 # 7040 <malloc+0x1b40>
    3624:	625010ef          	jal	5448 <printf>
      exit(1);
    3628:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3684:	1c098993          	addi	s3,s3,448 # 6840 <malloc+0x1340>
    unlink("irefd");
    3688:	00004917          	auipc	s2,0x4
    368c:	99890913          	addi	s2,s2,-1640 # 7020 <malloc+0x1b20>
    chdir("..");
    3690:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    36a4:	14850513          	addi	a0,a0,328 # 67e8 <malloc+0x12e8>
...
00000000000036c2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    36d2:	98a50513          	addi	a0,a0,-1654 # 7058 <malloc+0x1b58>
  ...
  if(pid == 0){
    ...
    36ee:	96e50513          	addi	a0,a0,-1682 # 7058 <malloc+0x1b58>
    ...
    3700:	97c50513          	addi	a0,a0,-1668 # 7078 <malloc+0x1b78>
    3704:	545010ef          	jal	5448 <printf>
      exit(1);
    3708:	4505                	li	a0,1
    ...
    3714:	95050513          	addi	a0,a0,-1712 # 7060 <malloc+0x1b60>
    3718:	531010ef          	jal	5448 <printf>
    exit(1);
    371c:	4505                	li	a0,1
    ...
    3728:	7a450513          	addi	a0,a0,1956 # 5ec8 <malloc+0x9c8>
    372c:	51d010ef          	jal	5448 <printf>
    exit(1);
    3730:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3746:	91650513          	addi	a0,a0,-1770 # 7058 <malloc+0x1b58>
    374a:	0f1010ef          	jal	503a <unlink>
    374e:	c919                	beqz	a0,3764 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    3750:	85a6                	mv	a1,s1
    3752:	00003517          	auipc	a0,0x3
    3756:	96650513          	addi	a0,a0,-1690 # 60b8 <malloc+0xbb8>
    375a:	4ef010ef          	jal	5448 <printf>
    exit(1);
    375e:	4505                	li	a0,1
...
0000000000003774 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3784:	92050513          	addi	a0,a0,-1760 # 70a0 <malloc+0x1ba0>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    37a4:	90050513          	addi	a0,a0,-1792 # 70a0 <malloc+0x1ba0>
  ...
  pause(10); // one second
    ...
    37cc:	8c050513          	addi	a0,a0,-1856 # 6088 <malloc+0xb88>
    37d0:	479010ef          	jal	5448 <printf>
    exit(1);
    37d4:	4505                	li	a0,1
    ...
    37e0:	8c450513          	addi	a0,a0,-1852 # 70a0 <malloc+0x1ba0>
    ...
    37fc:	8a850513          	addi	a0,a0,-1880 # 70a0 <malloc+0x1ba0>
...
0000000000003810 <killstatus>:
{
  ...
  exit(0);
    ...
    386a:	66250513          	addi	a0,a0,1634 # 5ec8 <malloc+0x9c8>
    386e:	3db010ef          	jal	5448 <printf>
      exit(1);
    3872:	4505                	li	a0,1
    ...
    3884:	83050513          	addi	a0,a0,-2000 # 70b0 <malloc+0x1bb0>
    3888:	3c1010ef          	jal	5448 <printf>
       exit(1);
    388c:	4505                	li	a0,1
...
0000000000003892 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    38b8:	7d450513          	addi	a0,a0,2004 # 6088 <malloc+0xb88>
    38bc:	38d010ef          	jal	5448 <printf>
    exit(1);
    38c0:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    38da:	5f250513          	addi	a0,a0,1522 # 5ec8 <malloc+0x9c8>
    38de:	36b010ef          	jal	5448 <printf>
    exit(1);
    38e2:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    390a:	da258593          	addi	a1,a1,-606 # 56a8 <malloc+0x1a8>
    ...
    392c:	5a050513          	addi	a0,a0,1440 # 5ec8 <malloc+0x9c8>
    3930:	319010ef          	jal	5448 <printf>
     exit(1);
    3934:	4505                	li	a0,1
    ...
    3940:	79450513          	addi	a0,a0,1940 # 70d0 <malloc+0x1bd0>
    3944:	305010ef          	jal	5448 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3970:	77c50513          	addi	a0,a0,1916 # 70e8 <malloc+0x1be8>
    3974:	2d5010ef          	jal	5448 <printf>
}
  ...
  printf("kill... ");
    ...
    3994:	77050513          	addi	a0,a0,1904 # 7100 <malloc+0x1c00>
    3998:	2b1010ef          	jal	5448 <printf>
  kill(pid1);
    399c:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    39b2:	76250513          	addi	a0,a0,1890 # 7110 <malloc+0x1c10>
    39b6:	293010ef          	jal	5448 <printf>
  wait(0);
    39ba:	4501                	li	a0,0
...
00000000000039ce <reparent>:
{
  ...
  exit(0);
    ...
    3a12:	4ba50513          	addi	a0,a0,1210 # 5ec8 <malloc+0x9c8>
    3a16:	233010ef          	jal	5448 <printf>
      exit(1);
    3a1a:	4505                	li	a0,1
    ...
    3a26:	62e50513          	addi	a0,a0,1582 # 6050 <malloc+0xb50>
    3a2a:	21f010ef          	jal	5448 <printf>
        exit(1);
    3a2e:	4505                	li	a0,1
...
0000000000003a4e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3a8e:	54650513          	addi	a0,a0,1350 # 5fd0 <malloc+0xad0>
    3a92:	1b7010ef          	jal	5448 <printf>
    exit(1);
    3a96:	4505                	li	a0,1
    ...
    3ab8:	de458593          	addi	a1,a1,-540 # 7898 <malloc+0x2398>
    ...
    3ad6:	64e58593          	addi	a1,a1,1614 # 7120 <malloc+0x1c20>
  ...
  c = sbrk(PGSIZE);
    ...
    3b30:	5fc50513          	addi	a0,a0,1532 # 7128 <malloc+0x1c28>
    3b34:	115010ef          	jal	5448 <printf>
  ...
  if(pid == 0){
    ...
    3b7a:	60250513          	addi	a0,a0,1538 # 7178 <malloc+0x1c78>
    3b7e:	0cb010ef          	jal	5448 <printf>
    exit(1);
    3b82:	4505                	li	a0,1
    ...
    3b8e:	5ce50513          	addi	a0,a0,1486 # 7158 <malloc+0x1c58>
    3b92:	0b7010ef          	jal	5448 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba2:	32a50513          	addi	a0,a0,810 # 5ec8 <malloc+0x9c8>
    3ba6:	0a3010ef          	jal	5448 <printf>
    exit(1);
    3baa:	4505                	li	a0,1
...
0000000000003be2 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3c26:	6084                	ld	s1,0(s1)
      free(m1);
    3c28:	053010ef          	jal	547a <free>
    while(m1){
    3c2c:	fce5                	bnez	s1,3c24 <mem+0x42>
    m1 = malloc(1024*20);
    3c2e:	6515                	lui	a0,0x5
    3c30:	0d1010ef          	jal	5500 <malloc>
    if(m1 == 0){
    3c34:	c511                	beqz	a0,3c40 <mem+0x5e>
    free(m1);
    3c36:	045010ef          	jal	547a <free>
    exit(0);
    3c3a:	4501                	li	a0,0
    ...
    3c46:	56650513          	addi	a0,a0,1382 # 71a8 <malloc+0x1ca8>
    3c4a:	7fe010ef          	jal	5448 <printf>
      exit(1);
    3c4e:	4505                	li	a0,1
...
0000000000003c5a <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3c6e:	55e50513          	addi	a0,a0,1374 # 71c8 <malloc+0x1cc8>
    3c72:	3c8010ef          	jal	503a <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3c76:	20200593          	li	a1,514
    3c7a:	00003517          	auipc	a0,0x3
    3c7e:	54e50513          	addi	a0,a0,1358 # 71c8 <malloc+0x1cc8>
  ...
  if(pid == 0) {
    ...
    3ce6:	4f650513          	addi	a0,a0,1270 # 71d8 <malloc+0x1cd8>
    3cea:	75e010ef          	jal	5448 <printf>
    exit(1);
    3cee:	4505                	li	a0,1
    ...
    3cfc:	50850513          	addi	a0,a0,1288 # 7200 <malloc+0x1d00>
    3d00:	748010ef          	jal	5448 <printf>
      exit(1);
    3d04:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3d30:	49c50513          	addi	a0,a0,1180 # 71c8 <malloc+0x1cc8>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3d68:	4bc50513          	addi	a0,a0,1212 # 7220 <malloc+0x1d20>
    3d6c:	6dc010ef          	jal	5448 <printf>
    exit(1);
    3d70:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3d98:	43450513          	addi	a0,a0,1076 # 71c8 <malloc+0x1cc8>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3dba:	49250513          	addi	a0,a0,1170 # 7248 <malloc+0x1d48>
    3dbe:	68a010ef          	jal	5448 <printf>
    exit(1);
    3dc2:	4505                	li	a0,1
...
0000000000003dc8 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3dec:	47878793          	addi	a5,a5,1144 # 7260 <malloc+0x1d60>
    3df0:	f6f43823          	sd	a5,-144(s0)
    3df4:	00003797          	auipc	a5,0x3
    3df8:	47478793          	addi	a5,a5,1140 # 7268 <malloc+0x1d68>
    3dfc:	f6f43c23          	sd	a5,-136(s0)
    3e00:	00003797          	auipc	a5,0x3
    3e04:	47078793          	addi	a5,a5,1136 # 7270 <malloc+0x1d70>
    3e08:	f8f43023          	sd	a5,-128(s0)
    3e0c:	00003797          	auipc	a5,0x3
    3e10:	46c78793          	addi	a5,a5,1132 # 7278 <malloc+0x1d78>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e76:	05650513          	addi	a0,a0,86 # 5ec8 <malloc+0x9c8>
    3e7a:	5ce010ef          	jal	5448 <printf>
      exit(1);
    3e7e:	4505                	li	a0,1
    ...
    3ed6:	08e50513          	addi	a0,a0,142 # 5f60 <malloc+0xa60>
    3eda:	56e010ef          	jal	5448 <printf>
        exit(1);
    3ede:	4505                	li	a0,1
    3ee0:	10a010ef          	jal	4fea <exit>
          printf("write failed %d\n", n);
    3ee4:	00003517          	auipc	a0,0x3
    3ee8:	39c50513          	addi	a0,a0,924 # 7280 <malloc+0x1d80>
    3eec:	55c010ef          	jal	5448 <printf>
          exit(1);
    3ef0:	4505                	li	a0,1
    ...
    3f02:	39a50513          	addi	a0,a0,922 # 7298 <malloc+0x1d98>
    3f06:	542010ef          	jal	5448 <printf>
          exit(1);
    3f0a:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3f6c:	34050513          	addi	a0,a0,832 # 72a8 <malloc+0x1da8>
    3f70:	4d8010ef          	jal	5448 <printf>
      exit(1);
    3f74:	4505                	li	a0,1
...
0000000000003f98 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3fda:	2eac8c93          	addi	s9,s9,746 # 72c0 <malloc+0x1dc0>
      wait(&xstatus);
  ...
  for(i = 0; i < N; i++){
    ...
    402e:	29e50513          	addi	a0,a0,670 # 72c8 <malloc+0x1dc8>
    4032:	416010ef          	jal	5448 <printf>
        exit(1);
    4036:	4505                	li	a0,1
    ...
    4044:	28050513          	addi	a0,a0,640 # 72c0 <malloc+0x1dc0>
  ...
  fd = open(".", 0);
    ...
    406c:	cb850513          	addi	a0,a0,-840 # 5d20 <malloc+0x820>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    40da:	21250513          	addi	a0,a0,530 # 72e8 <malloc+0x1de8>
    40de:	36a010ef          	jal	5448 <printf>
        exit(1);
    40e2:	4505                	li	a0,1
    ...
    40f2:	21a50513          	addi	a0,a0,538 # 7308 <malloc+0x1e08>
    40f6:	352010ef          	jal	5448 <printf>
        exit(1);
    40fa:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4124:	21050513          	addi	a0,a0,528 # 7330 <malloc+0x1e30>
    4128:	320010ef          	jal	5448 <printf>
    exit(1);
    412c:	4505                	li	a0,1
    ...
    4138:	d9450513          	addi	a0,a0,-620 # 5ec8 <malloc+0x9c8>
    413c:	30c010ef          	jal	5448 <printf>
      exit(1);
    4140:	4505                	li	a0,1
...
0000000000004278 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    4292:	0da50513          	addi	a0,a0,218 # 7368 <malloc+0x1e68>
    4296:	5a5000ef          	jal	503a <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    429a:	20200593          	li	a1,514
    429e:	00003517          	auipc	a0,0x3
    42a2:	0ca50513          	addi	a0,a0,202 # 7368 <malloc+0x1e68>
  ...
  fd = open("bigfile.dat", 0);
    ...
    42ea:	08250513          	addi	a0,a0,130 # 7368 <malloc+0x1e68>
  ...
  for(i = 0; ; i++){
    ...
    4344:	03850513          	addi	a0,a0,56 # 7378 <malloc+0x1e78>
    4348:	100010ef          	jal	5448 <printf>
    exit(1);
    434c:	4505                	li	a0,1
    ...
    4358:	04450513          	addi	a0,a0,68 # 7398 <malloc+0x1e98>
    435c:	0ec010ef          	jal	5448 <printf>
      exit(1);
    4360:	4505                	li	a0,1
    ...
    436c:	05050513          	addi	a0,a0,80 # 73b8 <malloc+0x1eb8>
    4370:	0d8010ef          	jal	5448 <printf>
    exit(1);
    4374:	4505                	li	a0,1
    ...
    4380:	05c50513          	addi	a0,a0,92 # 73d8 <malloc+0x1ed8>
    4384:	0c4010ef          	jal	5448 <printf>
      exit(1);
    4388:	4505                	li	a0,1
    ...
    4394:	06850513          	addi	a0,a0,104 # 73f8 <malloc+0x1ef8>
    4398:	0b0010ef          	jal	5448 <printf>
      exit(1);
    439c:	4505                	li	a0,1
    ...
    43a8:	06c50513          	addi	a0,a0,108 # 7410 <malloc+0x1f10>
    43ac:	09c010ef          	jal	5448 <printf>
      exit(1);
    43b0:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    43ca:	fa250513          	addi	a0,a0,-94 # 7368 <malloc+0x1e68>
    ...
    43ec:	04850513          	addi	a0,a0,72 # 7430 <malloc+0x1f30>
    43f0:	058010ef          	jal	5448 <printf>
    exit(1);
    43f4:	4505                	li	a0,1
...
00000000000043fa <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    440a:	04a50513          	addi	a0,a0,74 # 7450 <malloc+0x1f50>
  ...
  fd = open("bigarg-ok", 0);
    ...
    4430:	02450513          	addi	a0,a0,36 # 7450 <malloc+0x1f50>
  ...
  close(fd);
    ...
    448e:	1ae50513          	addi	a0,a0,430 # 5638 <malloc+0x138>
    4492:	391000ef          	jal	5022 <exec>
    fd = open("bigarg-ok", O_CREATE);
    4496:	20000593          	li	a1,512
    449a:	00003517          	auipc	a0,0x3
    449e:	fb650513          	addi	a0,a0,-74 # 7450 <malloc+0x1f50>
    ...
    44b6:	fae50513          	addi	a0,a0,-82 # 7460 <malloc+0x1f60>
    44ba:	78f000ef          	jal	5448 <printf>
    exit(1);
    44be:	4505                	li	a0,1
    ...
    44ce:	fb650513          	addi	a0,a0,-74 # 7480 <malloc+0x1f80>
    44d2:	777000ef          	jal	5448 <printf>
    exit(1);
    44d6:	4505                	li	a0,1
...
00000000000044dc <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4526:	f7e50513          	addi	a0,a0,-130 # 74a0 <malloc+0x1fa0>
    452a:	71f000ef          	jal	5448 <printf>
    exit(1);
    452e:	4505                	li	a0,1
    4530:	2bb000ef          	jal	4fea <exit>
      printf("failed to read value from memory\n");
    4534:	00003517          	auipc	a0,0x3
    4538:	f8450513          	addi	a0,a0,-124 # 74b8 <malloc+0x1fb8>
    453c:	70d000ef          	jal	5448 <printf>
      exit(1);
    4540:	4505                	li	a0,1
...
0000000000004546 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    45b4:	ef050513          	addi	a0,a0,-272 # 74a0 <malloc+0x1fa0>
    45b8:	691000ef          	jal	5448 <printf>
    exit(1);
    45bc:	4505                	li	a0,1
    45be:	22d000ef          	jal	4fea <exit>
      printf("error forking\n");
    45c2:	00003517          	auipc	a0,0x3
    45c6:	f1e50513          	addi	a0,a0,-226 # 74e0 <malloc+0x1fe0>
    45ca:	67f000ef          	jal	5448 <printf>
      exit(1);
    45ce:	4505                	li	a0,1
    ...
    45ea:	f0a50513          	addi	a0,a0,-246 # 74f0 <malloc+0x1ff0>
    45ee:	65b000ef          	jal	5448 <printf>
        exit(1);
    45f2:	4505                	li	a0,1
...
00000000000045f8 <lazy_copy>:
{
    ...
    4642:	eca50513          	addi	a0,a0,-310 # 7508 <malloc+0x2008>
    4646:	603000ef          	jal	5448 <printf>
      exit(1);
    464a:	4505                	li	a0,1
    464c:	19f000ef          	jal	4fea <exit>
  unsigned long bad[] = {
    4650:	00003797          	auipc	a5,0x3
    4654:	53078793          	addi	a5,a5,1328 # 7b80 <malloc+0x2680>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    4684:	190a8a93          	addi	s5,s5,400 # 5810 <malloc+0x310>
    ...
    4694:	090b0b13          	addi	s6,s6,144 # 5720 <malloc+0x220>
    int fd = open("README", 0);
    4698:	4581                	li	a1,0
    469a:	8556                	mv	a0,s5
  ...
  exit(0);
    ...
    46f0:	e4c50513          	addi	a0,a0,-436 # 7538 <malloc+0x2038>
    46f4:	555000ef          	jal	5448 <printf>
    46f8:	4505                	li	a0,1
    46fa:	0f1000ef          	jal	4fea <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    46fe:	00003517          	auipc	a0,0x3
    4702:	e5250513          	addi	a0,a0,-430 # 7550 <malloc+0x2050>
    4706:	543000ef          	jal	5448 <printf>
    470a:	4505                	li	a0,1
    470c:	0df000ef          	jal	4fea <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    4710:	00003517          	auipc	a0,0x3
    4714:	e5050513          	addi	a0,a0,-432 # 7560 <malloc+0x2060>
    4718:	531000ef          	jal	5448 <printf>
    471c:	4505                	li	a0,1
    471e:	0cd000ef          	jal	4fea <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    4722:	00003517          	auipc	a0,0x3
    4726:	e5650513          	addi	a0,a0,-426 # 7578 <malloc+0x2078>
    472a:	51f000ef          	jal	5448 <printf>
    472e:	4505                	li	a0,1
...
0000000000004734 <lazy_sbrk>:
{
  ...
  if (p1 < 0 || p1 != p) {
    ...
    4786:	e0e50513          	addi	a0,a0,-498 # 7590 <malloc+0x2090>
    478a:	4bf000ef          	jal	5448 <printf>
    exit(1);
    478e:	4505                	li	a0,1
  ...
  if (p < 0 || (uint64)p != TRAPFRAME-PGSIZE) {
    ...
    47ae:	e1650513          	addi	a0,a0,-490 # 75c0 <malloc+0x20c0>
    47b2:	497000ef          	jal	5448 <printf>
    exit(1);
    47b6:	4505                	li	a0,1
  ...
  if (p[1] != 0) {
    ...
    47d4:	e2850513          	addi	a0,a0,-472 # 75f8 <malloc+0x20f8>
    47d8:	471000ef          	jal	5448 <printf>
    exit(1);
    47dc:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    47f4:	e3050513          	addi	a0,a0,-464 # 7620 <malloc+0x2120>
    47f8:	451000ef          	jal	5448 <printf>
    exit(1);
    47fc:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4814:	e3850513          	addi	a0,a0,-456 # 7648 <malloc+0x2148>
    4818:	431000ef          	jal	5448 <printf>
    exit(1);
    481c:	4505                	li	a0,1
...
0000000000004828 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    484a:	e3250513          	addi	a0,a0,-462 # 7678 <malloc+0x2178>
    484e:	3fb000ef          	jal	5448 <printf>
  for(nfiles = 0; ; nfiles++){
    4852:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4900:	d8c50513          	addi	a0,a0,-628 # 7688 <malloc+0x2188>
    4904:	345000ef          	jal	5448 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4920:	d7c50513          	addi	a0,a0,-644 # 7698 <malloc+0x2198>
    4924:	325000ef          	jal	5448 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    49e4:	cd850513          	addi	a0,a0,-808 # 76b8 <malloc+0x21b8>
    49e8:	261000ef          	jal	5448 <printf>
}
    ...
    4a36:	c7650513          	addi	a0,a0,-906 # 76a8 <malloc+0x21a8>
    4a3a:	20f000ef          	jal	5448 <printf>
    close(fd);
    4a3e:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4a60:	c7450513          	addi	a0,a0,-908 # 76d0 <malloc+0x21d0>
    4a64:	1e5000ef          	jal	5448 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4a84:	c7850513          	addi	a0,a0,-904 # 76f8 <malloc+0x21f8>
    4a88:	1c1000ef          	jal	5448 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4aa4:	c4050513          	addi	a0,a0,-960 # 76e0 <malloc+0x21e0>
    4aa8:	1a1000ef          	jal	5448 <printf>
    exit(1);
    4aac:	4505                	li	a0,1
    ...
    4ac0:	c4450513          	addi	a0,a0,-956 # 7700 <malloc+0x2200>
    4ac4:	185000ef          	jal	5448 <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    4b12:	bfa50513          	addi	a0,a0,-1030 # 7708 <malloc+0x2208>
    4b16:	133000ef          	jal	5448 <printf>
          return -1;
    4b1a:	59fd                	li	s3,-1
...
drivetests(int quick, int continuous, char *justone) {
    ...
    4bb0:	b74c0c13          	addi	s8,s8,-1164 # 7720 <malloc+0x2220>
    ...
    4bca:	b92d8d93          	addi	s11,s11,-1134 # 7758 <malloc+0x2258>
    ...
    4bdc:	b6050513          	addi	a0,a0,-1184 # 7738 <malloc+0x2238>
    4be0:	069000ef          	jal	5448 <printf>
    ...
    4c4e:	b3e50513          	addi	a0,a0,-1218 # 7788 <malloc+0x2288>
    4c52:	7f6000ef          	jal	5448 <printf>
      return 1;
    4c56:	4505                	li	a0,1
  return 0;
}
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4cb4:	af058593          	addi	a1,a1,-1296 # 77a0 <malloc+0x22a0>
  ...
  int continuous = 0;
    ...
    4d08:	aac50513          	addi	a0,a0,-1364 # 77b0 <malloc+0x22b0>
    4d0c:	73c000ef          	jal	5448 <printf>
    exit(1);
    4d10:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4d26:	abe50513          	addi	a0,a0,-1346 # 77e0 <malloc+0x22e0>
    4d2a:	71e000ef          	jal	5448 <printf>
  exit(0);
    4d2e:	4501                	li	a0,0
...
putc(int fd, char c)
{
    50a2:	1101                	addi	sp,sp,-32
    50a4:	ec06                	sd	ra,24(sp)
    50a6:	e822                	sd	s0,16(sp)
    50a8:	1000                	addi	s0,sp,32
    50aa:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    50ae:	4605                	li	a2,1
    50b0:	fef40593          	addi	a1,s0,-17
    50b4:	f57ff0ef          	jal	500a <write>
}
    50b8:	60e2                	ld	ra,24(sp)
    50ba:	6442                	ld	s0,16(sp)
    50bc:	6105                	addi	sp,sp,32
    50be:	8082                	ret

00000000000050c0 <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
    50c0:	715d                	addi	sp,sp,-80
    50c2:	e486                	sd	ra,72(sp)
    50c4:	e0a2                	sd	s0,64(sp)
    50c6:	f84a                	sd	s2,48(sp)
    50c8:	f44e                	sd	s3,40(sp)
    50ca:	0880                	addi	s0,sp,80
    50cc:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
    50ce:	c6d1                	beqz	a3,515a <printint+0x9a>
    50d0:	0805d563          	bgez	a1,515a <printint+0x9a>
    neg = 1;
    x = -xx;
    50d4:	40b005b3          	neg	a1,a1
    neg = 1;
    50d8:	4305                	li	t1,1
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
    50e2:	00003817          	auipc	a6,0x3
    50e6:	b4680813          	addi	a6,a6,-1210 # 7c28 <digits>
    50ea:	88ba                	mv	a7,a4
    50ec:	0017051b          	addiw	a0,a4,1
    50f0:	872a                	mv	a4,a0
    50f2:	02c5f7b3          	remu	a5,a1,a2
    50f6:	97c2                	add	a5,a5,a6
    50f8:	0007c783          	lbu	a5,0(a5)
    50fc:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5100:	87ae                	mv	a5,a1
    5102:	02c5d5b3          	divu	a1,a1,a2
    5106:	0685                	addi	a3,a3,1
    5108:	fec7f1e3          	bgeu	a5,a2,50ea <printint+0x2a>
  if(neg)
    510c:	00030c63          	beqz	t1,5124 <printint+0x64>
    buf[i++] = '-';
    5110:	fd050793          	addi	a5,a0,-48
    5114:	00878533          	add	a0,a5,s0
    5118:	02d00793          	li	a5,45
    511c:	fef50423          	sb	a5,-24(a0)
    5120:	0028871b          	addiw	a4,a7,2

  while(--i >= 0)
    5124:	02e05563          	blez	a4,514e <printint+0x8e>
    5128:	fc26                	sd	s1,56(sp)
    512a:	377d                	addiw	a4,a4,-1
    512c:	00e984b3          	add	s1,s3,a4
    5130:	19fd                	addi	s3,s3,-1 # fff <bigdir+0x10b>
    5132:	99ba                	add	s3,s3,a4
    5134:	1702                	slli	a4,a4,0x20
    5136:	9301                	srli	a4,a4,0x20
    5138:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    513c:	0004c583          	lbu	a1,0(s1)
    5140:	854a                	mv	a0,s2
    5142:	f61ff0ef          	jal	50a2 <putc>
  while(--i >= 0)
    5146:	14fd                	addi	s1,s1,-1
    5148:	ff349ae3          	bne	s1,s3,513c <printint+0x7c>
    514c:	74e2                	ld	s1,56(sp)
}
    514e:	60a6                	ld	ra,72(sp)
    5150:	6406                	ld	s0,64(sp)
    5152:	7942                	ld	s2,48(sp)
    5154:	79a2                	ld	s3,40(sp)
    5156:	6161                	addi	sp,sp,80
    5158:	8082                	ret
  neg = 0;
    515a:	4301                	li	t1,0
    515c:	bfbd                	j	50da <printint+0x1a>

000000000000515e <vprintf>:
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
    ...
    5160:	ec86                	sd	ra,88(sp)
    5162:	e8a2                	sd	s0,80(sp)
    5164:	e4a6                	sd	s1,72(sp)
    5166:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5168:	0005c483          	lbu	s1,0(a1)
    516c:	22048363          	beqz	s1,5392 <vprintf+0x234>
    5170:	e0ca                	sd	s2,64(sp)
    5172:	fc4e                	sd	s3,56(sp)
    5174:	f852                	sd	s4,48(sp)
    5176:	f456                	sd	s5,40(sp)
    5178:	f05a                	sd	s6,32(sp)
    517a:	ec5e                	sd	s7,24(sp)
    517c:	e862                	sd	s8,16(sp)
    517e:	8b2a                	mv	s6,a0
    5180:	8a2e                	mv	s4,a1
    5182:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    518a:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    518e:	06400c13          	li	s8,100
    5192:	a00d                	j	51b4 <vprintf+0x56>
        putc(fd, c0);
    5194:	85a6                	mv	a1,s1
    5196:	855a                	mv	a0,s6
    5198:	f0bff0ef          	jal	50a2 <putc>
    519c:	a019                	j	51a2 <vprintf+0x44>
    } else if(state == '%'){
    519e:	03598363          	beq	s3,s5,51c4 <vprintf+0x66>
  for(i = 0; fmt[i]; i++){
    51a2:	0019079b          	addiw	a5,s2,1
    51a6:	893e                	mv	s2,a5
    51a8:	873e                	mv	a4,a5
    51aa:	97d2                	add	a5,a5,s4
    51ac:	0007c483          	lbu	s1,0(a5)
    51b0:	1c048a63          	beqz	s1,5384 <vprintf+0x226>
    c0 = fmt[i] & 0xff;
    51b4:	0004879b          	sext.w	a5,s1
    if(state == 0){
    51b8:	fe0993e3          	bnez	s3,519e <vprintf+0x40>
      if(c0 == '%'){
    51bc:	fd579ce3          	bne	a5,s5,5194 <vprintf+0x36>
        state = '%';
    51c0:	89be                	mv	s3,a5
    51c2:	b7c5                	j	51a2 <vprintf+0x44>
      if(c0) c1 = fmt[i+1] & 0xff;
    51c4:	00ea06b3          	add	a3,s4,a4
    51c8:	0016c603          	lbu	a2,1(a3)
      if(c1) c2 = fmt[i+2] & 0xff;
    51cc:	1c060863          	beqz	a2,539c <vprintf+0x23e>
      if(c0 == 'd'){
    51d0:	03878763          	beq	a5,s8,51fe <vprintf+0xa0>
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    51d4:	f9478693          	addi	a3,a5,-108
    51d8:	0016b693          	seqz	a3,a3
    51dc:	f9c60593          	addi	a1,a2,-100
    51e0:	e99d                	bnez	a1,5216 <vprintf+0xb8>
    51e2:	ca95                	beqz	a3,5216 <vprintf+0xb8>
    ...
    51f0:	855a                	mv	a0,s6
    51f2:	ecfff0ef          	jal	50c0 <printint>
        i += 1;
    ...
    51f8:	8ba6                	mv	s7,s1
      ...
      state = 0;
    51fa:	4981                	li	s3,0
    51fc:	b75d                	j	51a2 <vprintf+0x44>
        printint(fd, va_arg(ap, int), 10, 1);
    51fe:	008b8493          	addi	s1,s7,8
    5202:	4685                	li	a3,1
    5204:	4629                	li	a2,10
    5206:	000ba583          	lw	a1,0(s7)
    520a:	855a                	mv	a0,s6
    520c:	eb5ff0ef          	jal	50c0 <printint>
    5210:	8ba6                	mv	s7,s1
      state = 0;
    5212:	4981                	li	s3,0
    5214:	b779                	j	51a2 <vprintf+0x44>
      if(c1) c2 = fmt[i+2] & 0xff;
    5216:	9752                	add	a4,a4,s4
    5218:	00274583          	lbu	a1,2(a4)
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    521c:	f9460713          	addi	a4,a2,-108
    5220:	00173713          	seqz	a4,a4
    5224:	8f75                	and	a4,a4,a3
    5226:	f9c58513          	addi	a0,a1,-100
    522a:	18051363          	bnez	a0,53b0 <vprintf+0x252>
    522e:	18070163          	beqz	a4,53b0 <vprintf+0x252>
        printint(fd, va_arg(ap, uint64), 10, 1);
    5232:	008b8493          	addi	s1,s7,8
    5236:	4685                	li	a3,1
    5238:	4629                	li	a2,10
    523a:	000bb583          	ld	a1,0(s7)
    523e:	855a                	mv	a0,s6
    5240:	e81ff0ef          	jal	50c0 <printint>
        i += 2;
    5244:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    5246:	8ba6                	mv	s7,s1
      state = 0;
    5248:	4981                	li	s3,0
        i += 2;
    524a:	bfa1                	j	51a2 <vprintf+0x44>
        printint(fd, va_arg(ap, uint32), 10, 0);
    524c:	008b8493          	addi	s1,s7,8
    5250:	4681                	li	a3,0
    5252:	4629                	li	a2,10
    5254:	000be583          	lwu	a1,0(s7)
    5258:	855a                	mv	a0,s6
    525a:	e67ff0ef          	jal	50c0 <printint>
    525e:	8ba6                	mv	s7,s1
      state = 0;
    5260:	4981                	li	s3,0
    5262:	b781                	j	51a2 <vprintf+0x44>
    ...
    5270:	855a                	mv	a0,s6
    5272:	e4fff0ef          	jal	50c0 <printint>
        i += 1;
    5276:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 10, 0);
    5278:	8ba6                	mv	s7,s1
      state = 0;
    527a:	4981                	li	s3,0
    527c:	b71d                	j	51a2 <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 10, 0);
    527e:	008b8493          	addi	s1,s7,8
    5282:	4681                	li	a3,0
    5284:	4629                	li	a2,10
    5286:	000bb583          	ld	a1,0(s7)
    528a:	855a                	mv	a0,s6
    528c:	e35ff0ef          	jal	50c0 <printint>
        i += 2;
    5290:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    5292:	8ba6                	mv	s7,s1
      state = 0;
    5294:	4981                	li	s3,0
        i += 2;
    5296:	b731                	j	51a2 <vprintf+0x44>
        printint(fd, va_arg(ap, uint32), 16, 0);
    5298:	008b8493          	addi	s1,s7,8
    529c:	4681                	li	a3,0
    529e:	4641                	li	a2,16
    52a0:	000be583          	lwu	a1,0(s7)
    52a4:	855a                	mv	a0,s6
    52a6:	e1bff0ef          	jal	50c0 <printint>
    52aa:	8ba6                	mv	s7,s1
      state = 0;
    52ac:	4981                	li	s3,0
    52ae:	bdd5                	j	51a2 <vprintf+0x44>
    ...
    52bc:	855a                	mv	a0,s6
    52be:	e03ff0ef          	jal	50c0 <printint>
        i += 1;
    52c2:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 16, 0);
    52c4:	8ba6                	mv	s7,s1
      state = 0;
    52c6:	4981                	li	s3,0
    52c8:	bde9                	j	51a2 <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 16, 0);
    52ca:	008b8493          	addi	s1,s7,8
    52ce:	4681                	li	a3,0
    52d0:	4641                	li	a2,16
    52d2:	000bb583          	ld	a1,0(s7)
    52d6:	855a                	mv	a0,s6
    52d8:	de9ff0ef          	jal	50c0 <printint>
        i += 2;
    52dc:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    52de:	8ba6                	mv	s7,s1
      state = 0;
    52e0:	4981                	li	s3,0
        i += 2;
    52e2:	b5c1                	j	51a2 <vprintf+0x44>
    52e4:	e466                	sd	s9,8(sp)
        printptr(fd, va_arg(ap, uint64));
    52e6:	008b8793          	addi	a5,s7,8
    52ea:	8cbe                	mv	s9,a5
    52ec:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    52f0:	03000593          	li	a1,48
    52f4:	855a                	mv	a0,s6
    52f6:	dadff0ef          	jal	50a2 <putc>
  putc(fd, 'x');
    52fa:	07800593          	li	a1,120
    52fe:	855a                	mv	a0,s6
    5300:	da3ff0ef          	jal	50a2 <putc>
    5304:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5306:	00003b97          	auipc	s7,0x3
    530a:	922b8b93          	addi	s7,s7,-1758 # 7c28 <digits>
    530e:	03c9d793          	srli	a5,s3,0x3c
    5312:	97de                	add	a5,a5,s7
    5314:	0007c583          	lbu	a1,0(a5)
    5318:	855a                	mv	a0,s6
    531a:	d89ff0ef          	jal	50a2 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    531e:	0992                	slli	s3,s3,0x4
    5320:	34fd                	addiw	s1,s1,-1
    5322:	f4f5                	bnez	s1,530e <vprintf+0x1b0>
        printptr(fd, va_arg(ap, uint64));
    5324:	8be6                	mv	s7,s9
      state = 0;
    5326:	4981                	li	s3,0
    5328:	6ca2                	ld	s9,8(sp)
    532a:	bda5                	j	51a2 <vprintf+0x44>
        putc(fd, va_arg(ap, uint32));
    532c:	008b8493          	addi	s1,s7,8
    5330:	000bc583          	lbu	a1,0(s7)
    5334:	855a                	mv	a0,s6
    5336:	d6dff0ef          	jal	50a2 <putc>
    533a:	8ba6                	mv	s7,s1
      state = 0;
    533c:	4981                	li	s3,0
    533e:	b595                	j	51a2 <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
    5340:	008b8993          	addi	s3,s7,8
    5344:	000bb483          	ld	s1,0(s7)
    5348:	cc91                	beqz	s1,5364 <vprintf+0x206>
        for(; *s; s++)
    534a:	0004c583          	lbu	a1,0(s1)
    534e:	c985                	beqz	a1,537e <vprintf+0x220>
          putc(fd, *s);
    5350:	855a                	mv	a0,s6
    5352:	d51ff0ef          	jal	50a2 <putc>
        for(; *s; s++)
    5356:	0485                	addi	s1,s1,1
    5358:	0004c583          	lbu	a1,0(s1)
    535c:	f9f5                	bnez	a1,5350 <vprintf+0x1f2>
        if((s = va_arg(ap, char*)) == 0)
    535e:	8bce                	mv	s7,s3
      state = 0;
    5360:	4981                	li	s3,0
    5362:	b581                	j	51a2 <vprintf+0x44>
          s = "(null)";
    5364:	00003497          	auipc	s1,0x3
    5368:	81448493          	addi	s1,s1,-2028 # 7b78 <malloc+0x2678>
        for(; *s; s++)
    536c:	02800593          	li	a1,40
    5370:	b7c5                	j	5350 <vprintf+0x1f2>
        putc(fd, '%');
    5372:	85be                	mv	a1,a5
    5374:	855a                	mv	a0,s6
    5376:	d2dff0ef          	jal	50a2 <putc>
      state = 0;
    537a:	4981                	li	s3,0
    537c:	b51d                	j	51a2 <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
    537e:	8bce                	mv	s7,s3
      state = 0;
    5380:	4981                	li	s3,0
    5382:	b505                	j	51a2 <vprintf+0x44>
    5384:	6906                	ld	s2,64(sp)
    5386:	79e2                	ld	s3,56(sp)
    5388:	7a42                	ld	s4,48(sp)
    538a:	7aa2                	ld	s5,40(sp)
    538c:	7b02                	ld	s6,32(sp)
    538e:	6be2                	ld	s7,24(sp)
    5390:	6c42                	ld	s8,16(sp)
    }
  }
}
    5392:	60e6                	ld	ra,88(sp)
    5394:	6446                	ld	s0,80(sp)
    5396:	64a6                	ld	s1,72(sp)
    5398:	6125                	addi	sp,sp,96
    539a:	8082                	ret
      if(c0 == 'd'){
    539c:	06400713          	li	a4,100
    53a0:	e4e78fe3          	beq	a5,a4,51fe <vprintf+0xa0>
      } else if(c0 == 'l' && c1 == 'd'){
    53a4:	f9478693          	addi	a3,a5,-108
    53a8:	0016b693          	seqz	a3,a3
      c1 = c2 = 0;
    53ac:	85b2                	mv	a1,a2
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    53ae:	4701                	li	a4,0
      } else if(c0 == 'u'){
    53b0:	07500513          	li	a0,117
    53b4:	e8a78ce3          	beq	a5,a0,524c <vprintf+0xee>
      } else if(c0 == 'l' && c1 == 'u'){
    53b8:	f8b60513          	addi	a0,a2,-117
    53bc:	e119                	bnez	a0,53c2 <vprintf+0x264>
    53be:	ea0693e3          	bnez	a3,5264 <vprintf+0x106>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    53c2:	f8b58513          	addi	a0,a1,-117
    53c6:	e119                	bnez	a0,53cc <vprintf+0x26e>
    53c8:	ea071be3          	bnez	a4,527e <vprintf+0x120>
      } else if(c0 == 'x'){
    53cc:	07800513          	li	a0,120
    53d0:	eca784e3          	beq	a5,a0,5298 <vprintf+0x13a>
      } else if(c0 == 'l' && c1 == 'x'){
    53d4:	f8860613          	addi	a2,a2,-120
    53d8:	e219                	bnez	a2,53de <vprintf+0x280>
    53da:	ec069be3          	bnez	a3,52b0 <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    53de:	f8858593          	addi	a1,a1,-120
    53e2:	e199                	bnez	a1,53e8 <vprintf+0x28a>
    53e4:	ee0713e3          	bnez	a4,52ca <vprintf+0x16c>
      } else if(c0 == 'p'){
    53e8:	07000713          	li	a4,112
    53ec:	eee78ce3          	beq	a5,a4,52e4 <vprintf+0x186>
      } else if(c0 == 'c'){
    53f0:	06300713          	li	a4,99
    53f4:	f2e78ce3          	beq	a5,a4,532c <vprintf+0x1ce>
      } else if(c0 == 's'){
    53f8:	07300713          	li	a4,115
    53fc:	f4e782e3          	beq	a5,a4,5340 <vprintf+0x1e2>
      } else if(c0 == '%'){
    5400:	02500713          	li	a4,37
    5404:	f6e787e3          	beq	a5,a4,5372 <vprintf+0x214>
        putc(fd, '%');
    5408:	02500593          	li	a1,37
    540c:	855a                	mv	a0,s6
    540e:	c95ff0ef          	jal	50a2 <putc>
        putc(fd, c0);
    5412:	85a6                	mv	a1,s1
    5414:	855a                	mv	a0,s6
    5416:	c8dff0ef          	jal	50a2 <putc>
      state = 0;
    541a:	4981                	li	s3,0
    541c:	b359                	j	51a2 <vprintf+0x44>

000000000000541e <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    541e:	715d                	addi	sp,sp,-80
    5420:	ec06                	sd	ra,24(sp)
    5422:	e822                	sd	s0,16(sp)
    5424:	1000                	addi	s0,sp,32
    5426:	e010                	sd	a2,0(s0)
    5428:	e414                	sd	a3,8(s0)
    542a:	e818                	sd	a4,16(s0)
    542c:	ec1c                	sd	a5,24(s0)
    542e:	03043023          	sd	a6,32(s0)
    5432:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5436:	8622                	mv	a2,s0
    5438:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    543c:	d23ff0ef          	jal	515e <vprintf>
}
    5440:	60e2                	ld	ra,24(sp)
    5442:	6442                	ld	s0,16(sp)
    5444:	6161                	addi	sp,sp,80
    5446:	8082                	ret

0000000000005448 <printf>:

void
printf(const char *fmt, ...)
{
    5448:	711d                	addi	sp,sp,-96
    544a:	ec06                	sd	ra,24(sp)
    544c:	e822                	sd	s0,16(sp)
    544e:	1000                	addi	s0,sp,32
    5450:	e40c                	sd	a1,8(s0)
    5452:	e810                	sd	a2,16(s0)
    5454:	ec14                	sd	a3,24(s0)
    5456:	f018                	sd	a4,32(s0)
    5458:	f41c                	sd	a5,40(s0)
    545a:	03043823          	sd	a6,48(s0)
    545e:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5462:	00840613          	addi	a2,s0,8
    5466:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    546a:	85aa                	mv	a1,a0
    546c:	4505                	li	a0,1
    546e:	cf1ff0ef          	jal	515e <vprintf>
}
...
free(void *ap)
{
    ...
    547c:	e406                	sd	ra,8(sp)
    547e:	e022                	sd	s0,0(sp)
    5480:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5482:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5486:	00003797          	auipc	a5,0x3
    548a:	00a7b783          	ld	a5,10(a5) # 8490 <freep>
    548e:	a039                	j	549c <free+0x22>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5490:	6398                	ld	a4,0(a5)
    5492:	00e7e463          	bltu	a5,a4,549a <free+0x20>
    5496:	00e6ea63          	bltu	a3,a4,54aa <free+0x30>
{
    549a:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    549c:	fed7fae3          	bgeu	a5,a3,5490 <free+0x16>
    54a0:	6398                	ld	a4,0(a5)
    54a2:	00e6e463          	bltu	a3,a4,54aa <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    54a6:	fee7eae3          	bltu	a5,a4,549a <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
    54aa:	ff852583          	lw	a1,-8(a0)
    54ae:	6390                	ld	a2,0(a5)
    54b0:	02059813          	slli	a6,a1,0x20
    54b4:	01c85713          	srli	a4,a6,0x1c
    54b8:	9736                	add	a4,a4,a3
    54ba:	02e60563          	beq	a2,a4,54e4 <free+0x6a>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    54be:	fec53823          	sd	a2,-16(a0)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    54c2:	4790                	lw	a2,8(a5)
    54c4:	02061593          	slli	a1,a2,0x20
    54c8:	01c5d713          	srli	a4,a1,0x1c
    54cc:	973e                	add	a4,a4,a5
    54ce:	02e68263          	beq	a3,a4,54f2 <free+0x78>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    54d2:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    54d4:	00003717          	auipc	a4,0x3
    54d8:	faf73e23          	sd	a5,-68(a4) # 8490 <freep>
}
    54dc:	60a2                	ld	ra,8(sp)
    54de:	6402                	ld	s0,0(sp)
    54e0:	0141                	addi	sp,sp,16
    54e2:	8082                	ret
    bp->s.size += p->s.ptr->s.size;
    54e4:	4618                	lw	a4,8(a2)
    54e6:	9f2d                	addw	a4,a4,a1
    54e8:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    54ec:	6398                	ld	a4,0(a5)
    54ee:	6310                	ld	a2,0(a4)
    54f0:	b7f9                	j	54be <free+0x44>
    p->s.size += bp->s.size;
    54f2:	ff852703          	lw	a4,-8(a0)
    54f6:	9f31                	addw	a4,a4,a2
    54f8:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    54fa:	ff053683          	ld	a3,-16(a0)
    54fe:	bfd1                	j	54d2 <free+0x58>

0000000000005500 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5500:	7139                	addi	sp,sp,-64
    5502:	fc06                	sd	ra,56(sp)
    5504:	f822                	sd	s0,48(sp)
    5506:	f04a                	sd	s2,32(sp)
    5508:	ec4e                	sd	s3,24(sp)
    550a:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    550c:	02051993          	slli	s3,a0,0x20
    5510:	0209d993          	srli	s3,s3,0x20
    5514:	09bd                	addi	s3,s3,15
    5516:	0049d993          	srli	s3,s3,0x4
    551a:	2985                	addiw	s3,s3,1
    551c:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    551e:	00003517          	auipc	a0,0x3
    5522:	f7253503          	ld	a0,-142(a0) # 8490 <freep>
    5526:	c905                	beqz	a0,5556 <malloc+0x56>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5528:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    552a:	4798                	lw	a4,8(a5)
    552c:	09377663          	bgeu	a4,s3,55b8 <malloc+0xb8>
    5530:	f426                	sd	s1,40(sp)
    5532:	e852                	sd	s4,16(sp)
    5534:	e456                	sd	s5,8(sp)
    5536:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    5538:	8a4e                	mv	s4,s3
    553a:	6705                	lui	a4,0x1
    553c:	00e9f363          	bgeu	s3,a4,5542 <malloc+0x42>
    5540:	6a05                	lui	s4,0x1
    5542:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5546:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    554a:	00003497          	auipc	s1,0x3
    554e:	f4648493          	addi	s1,s1,-186 # 8490 <freep>
  if(p == SBRK_ERROR)
    5552:	5afd                	li	s5,-1
    5554:	a83d                	j	5592 <malloc+0x92>
    5556:	f426                	sd	s1,40(sp)
    5558:	e852                	sd	s4,16(sp)
    555a:	e456                	sd	s5,8(sp)
    555c:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    555e:	00009797          	auipc	a5,0x9
    5562:	75a78793          	addi	a5,a5,1882 # ecb8 <base>
    5566:	00003717          	auipc	a4,0x3
    556a:	f2f73523          	sd	a5,-214(a4) # 8490 <freep>
    556e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5570:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5574:	b7d1                	j	5538 <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    5576:	6398                	ld	a4,0(a5)
    5578:	e118                	sd	a4,0(a0)
    557a:	a899                	j	55d0 <malloc+0xd0>
  hp->s.size = nu;
    557c:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5580:	0541                	addi	a0,a0,16
    5582:	ef9ff0ef          	jal	547a <free>
  return freep;
    5586:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    5588:	c125                	beqz	a0,55e8 <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    558a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    558c:	4798                	lw	a4,8(a5)
    558e:	03277163          	bgeu	a4,s2,55b0 <malloc+0xb0>
    if(p == freep)
    5592:	6098                	ld	a4,0(s1)
    5594:	853e                	mv	a0,a5
    5596:	fef71ae3          	bne	a4,a5,558a <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
    559a:	8552                	mv	a0,s4
    559c:	a1bff0ef          	jal	4fb6 <sbrk>
  if(p == SBRK_ERROR)
    55a0:	fd551ee3          	bne	a0,s5,557c <malloc+0x7c>
        return 0;
    55a4:	4501                	li	a0,0
    55a6:	74a2                	ld	s1,40(sp)
    55a8:	6a42                	ld	s4,16(sp)
    55aa:	6aa2                	ld	s5,8(sp)
    55ac:	6b02                	ld	s6,0(sp)
    55ae:	a03d                	j	55dc <malloc+0xdc>
    55b0:	74a2                	ld	s1,40(sp)
    55b2:	6a42                	ld	s4,16(sp)
    55b4:	6aa2                	ld	s5,8(sp)
    55b6:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    55b8:	fae90fe3          	beq	s2,a4,5576 <malloc+0x76>
        p->s.size -= nunits;
    55bc:	4137073b          	subw	a4,a4,s3
    55c0:	c798                	sw	a4,8(a5)
        p += p->s.size;
    55c2:	02071693          	slli	a3,a4,0x20
    55c6:	01c6d713          	srli	a4,a3,0x1c
    55ca:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    55cc:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    55d0:	00003717          	auipc	a4,0x3
    55d4:	eca73023          	sd	a0,-320(a4) # 8490 <freep>
      return (void*)(p + 1);
    55d8:	01078513          	addi	a0,a5,16
  }
}
    55dc:	70e2                	ld	ra,56(sp)
    55de:	7442                	ld	s0,48(sp)
    55e0:	7902                	ld	s2,32(sp)
    55e2:	69e2                	ld	s3,24(sp)
    55e4:	6121                	addi	sp,sp,64
    55e6:	8082                	ret
    55e8:	74a2                	ld	s1,40(sp)
    55ea:	6a42                	ld	s4,16(sp)
    55ec:	6aa2                	ld	s5,8(sp)
    55ee:	6b02                	ld	s6,0(sp)
    55f0:	b7f5                	j	55dc <malloc+0xdc>
