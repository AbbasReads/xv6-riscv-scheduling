...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    51f8:	00004797          	auipc	a5,0x4
    51fc:	2987b783          	ld	a5,664(a5) # 9490 <freep>
    ...
    5224:	00e6ea63          	bltu	a3,a4,5238 <free+0x4a>
{
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    5262:	00004717          	auipc	a4,0x4
    5266:	22f73723          	sd	a5,558(a4) # 9490 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    5290:	20453503          	ld	a0,516(a0) # 9490 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    52bc:	00004917          	auipc	s2,0x4
    52c0:	1d490913          	addi	s2,s2,468 # 9490 <freep>
  if(p == SBRK_ERROR)
    52c4:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    52d0:	0000b797          	auipc	a5,0xb
    52d4:	9e878793          	addi	a5,a5,-1560 # fcb8 <base>
    52d8:	00004717          	auipc	a4,0x4
    52dc:	1af73c23          	sd	a5,440(a4) # 9490 <freep>
  ...
  if(p == SBRK_ERROR)
    ...
    5342:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5346:	00004717          	auipc	a4,0x4
    534a:	14a73523          	sd	a0,330(a4) # 9490 <freep>
      return (void*)(p + 1);
