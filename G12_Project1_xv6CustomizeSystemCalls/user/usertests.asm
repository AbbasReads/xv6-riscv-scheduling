...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	8e278793          	addi	a5,a5,-1822 # 78f0 <malloc+0x2680>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	30a50513          	addi	a0,a0,778 # 5370 <malloc+0x100>
      6e:	14e050ef          	jal	51bc <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	2f050513          	addi	a0,a0,752 # 5390 <malloc+0x120>
      a8:	114050ef          	jal	51bc <printf>
      exit(1);
      ac:	4505                	li	a0,1
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	2e850513          	addi	a0,a0,744 # 53a8 <malloc+0x138>
      c8:	50d040ef          	jal	4dd4 <open>
  if(fd < 0){
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	2f250513          	addi	a0,a0,754 # 53c8 <malloc+0x158>
      de:	4f7040ef          	jal	4dd4 <open>
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	2be50513          	addi	a0,a0,702 # 53b0 <malloc+0x140>
      fa:	0c2050ef          	jal	51bc <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	2d250513          	addi	a0,a0,722 # 53d8 <malloc+0x168>
     10e:	0ae050ef          	jal	51bc <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     12c:	2d850513          	addi	a0,a0,728 # 5400 <malloc+0x190>
     130:	4b5040ef          	jal	4de4 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     134:	60100593          	li	a1,1537
     138:	00005517          	auipc	a0,0x5
     13c:	2c850513          	addi	a0,a0,712 # 5400 <malloc+0x190>
     140:	495040ef          	jal	4dd4 <open>
     144:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     146:	4611                	li	a2,4
     148:	00005597          	auipc	a1,0x5
     14c:	2c858593          	addi	a1,a1,712 # 5410 <malloc+0x1a0>
     150:	445040ef          	jal	4d94 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     154:	40100593          	li	a1,1025
     158:	00005517          	auipc	a0,0x5
     15c:	2a850513          	addi	a0,a0,680 # 5400 <malloc+0x190>
     160:	475040ef          	jal	4dd4 <open>
     164:	892a                	mv	s2,a0
  int n = write(fd1, "x", 1);
     166:	4605                	li	a2,1
     168:	00005597          	auipc	a1,0x5
     16c:	2b058593          	addi	a1,a1,688 # 5418 <malloc+0x1a8>
     170:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     180:	28450513          	addi	a0,a0,644 # 5400 <malloc+0x190>
     184:	461040ef          	jal	4de4 <unlink>
  close(fd1);
     188:	8526                	mv	a0,s1
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	27a50513          	addi	a0,a0,634 # 5420 <malloc+0x1b0>
     1ae:	00e050ef          	jal	51bc <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
000000000000022c <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     248:	20450513          	addi	a0,a0,516 # 5448 <malloc+0x1d8>
     24c:	399040ef          	jal	4de4 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     250:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     254:	00005a97          	auipc	s5,0x5
     258:	1f4a8a93          	addi	s5,s5,500 # 5448 <malloc+0x1d8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	19650513          	addi	a0,a0,406 # 5458 <malloc+0x1e8>
     2ca:	6f3040ef          	jal	51bc <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e0:	19c50513          	addi	a0,a0,412 # 5478 <malloc+0x208>
     2e4:	6d9040ef          	jal	51bc <printf>
        exit(1);
     2e8:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	19250513          	addi	a0,a0,402 # 5490 <malloc+0x220>
     306:	2df040ef          	jal	4de4 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	18298993          	addi	s3,s3,386 # 5490 <malloc+0x220>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	14650513          	addi	a0,a0,326 # 5490 <malloc+0x220>
     352:	283040ef          	jal	4dd4 <open>
     356:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	0ba58593          	addi	a1,a1,186 # 5418 <malloc+0x1a8>
     366:	22f040ef          	jal	4d94 <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	14050513          	addi	a0,a0,320 # 54b0 <malloc+0x240>
     378:	645040ef          	jal	51bc <printf>
    exit(1);
     37c:	4505                	li	a0,1
     37e:	1f7040ef          	jal	4d74 <exit>
      printf("open junk failed\n");
     382:	00005517          	auipc	a0,0x5
     386:	11650513          	addi	a0,a0,278 # 5498 <malloc+0x228>
     38a:	633040ef          	jal	51bc <printf>
      exit(1);
     38e:	4505                	li	a0,1
     390:	1e5040ef          	jal	4d74 <exit>
    printf("open junk failed\n");
     394:	00005517          	auipc	a0,0x5
     398:	10450513          	addi	a0,a0,260 # 5498 <malloc+0x228>
     39c:	621040ef          	jal	51bc <printf>
    exit(1);
     3a0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3b0:	0e450513          	addi	a0,a0,228 # 5490 <malloc+0x220>
     3b4:	231040ef          	jal	4de4 <unlink>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	46078793          	addi	a5,a5,1120 # 78f0 <malloc+0x2680>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	002a0a13          	addi	s4,s4,2 # 54c0 <malloc+0x250>
    uint64 addr = addrs[ai];
     4c6:	00093983          	ld	s3,0(s2)
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     4ca:	20100593          	li	a1,513
     4ce:	8552                	mv	a0,s4
     4d0:	105040ef          	jal	4dd4 <open>
     4d4:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	f8450513          	addi	a0,a0,-124 # 54c8 <malloc+0x258>
     54c:	471040ef          	jal	51bc <printf>
      exit(1);
     550:	4505                	li	a0,1
     ...
     55e:	f8650513          	addi	a0,a0,-122 # 54e0 <malloc+0x270>
     562:	45b040ef          	jal	51bc <printf>
      exit(1);
     566:	4505                	li	a0,1
     ...
     574:	fa050513          	addi	a0,a0,-96 # 5510 <malloc+0x2a0>
     578:	445040ef          	jal	51bc <printf>
      exit(1);
     57c:	4505                	li	a0,1
     57e:	7f6040ef          	jal	4d74 <exit>
      printf("pipe() failed\n");
     582:	00005517          	auipc	a0,0x5
     586:	fbe50513          	addi	a0,a0,-66 # 5540 <malloc+0x2d0>
     58a:	433040ef          	jal	51bc <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     59c:	fb850513          	addi	a0,a0,-72 # 5550 <malloc+0x2e0>
     5a0:	41d040ef          	jal	51bc <printf>
      exit(1);
     5a4:	4505                	li	a0,1
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	33278793          	addi	a5,a5,818 # 78f0 <malloc+0x2680>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	f8ea0a13          	addi	s4,s4,-114 # 5580 <malloc+0x310>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	e1ea8a93          	addi	s5,s5,-482 # 5418 <malloc+0x1a8>
    uint64 addr = addrs[ai];
     602:	00093983          	ld	s3,0(s2)
    int fd = open("README", 0);
     606:	4581                	li	a1,0
     608:	8552                	mv	a0,s4
     60a:	7ca040ef          	jal	4dd4 <open>
     60e:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	f0a50513          	addi	a0,a0,-246 # 5588 <malloc+0x318>
     686:	337040ef          	jal	51bc <printf>
      exit(1);
     68a:	4505                	li	a0,1
     ...
     698:	f0c50513          	addi	a0,a0,-244 # 55a0 <malloc+0x330>
     69c:	321040ef          	jal	51bc <printf>
      exit(1);
     6a0:	4505                	li	a0,1
     6a2:	6d2040ef          	jal	4d74 <exit>
      printf("pipe() failed\n");
     6a6:	00005517          	auipc	a0,0x5
     6aa:	e9a50513          	addi	a0,a0,-358 # 5540 <malloc+0x2d0>
     6ae:	30f040ef          	jal	51bc <printf>
      exit(1);
     6b2:	4505                	li	a0,1
     6b4:	6c0040ef          	jal	4d74 <exit>
      printf("pipe write failed\n");
     6b8:	00005517          	auipc	a0,0x5
     6bc:	f1850513          	addi	a0,a0,-232 # 55d0 <malloc+0x360>
     6c0:	2fd040ef          	jal	51bc <printf>
      exit(1);
     6c4:	4505                	li	a0,1
     ...
     6d2:	f1a50513          	addi	a0,a0,-230 # 55e8 <malloc+0x378>
     6d6:	2e7040ef          	jal	51bc <printf>
      exit(1);
     6da:	4505                	li	a0,1
...
00000000000006e0 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     6f8:	d0c50513          	addi	a0,a0,-756 # 5400 <malloc+0x190>
     6fc:	6e8040ef          	jal	4de4 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     700:	60100593          	li	a1,1537
     704:	00005517          	auipc	a0,0x5
     708:	cfc50513          	addi	a0,a0,-772 # 5400 <malloc+0x190>
     70c:	6c8040ef          	jal	4dd4 <open>
     710:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     712:	4611                	li	a2,4
     714:	00005597          	auipc	a1,0x5
     718:	cfc58593          	addi	a1,a1,-772 # 5410 <malloc+0x1a0>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72c:	cd850513          	addi	a0,a0,-808 # 5400 <malloc+0x190>
     730:	6a4040ef          	jal	4dd4 <open>
     734:	84aa                	mv	s1,a0
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	cb450513          	addi	a0,a0,-844 # 5400 <malloc+0x190>
     754:	680040ef          	jal	4dd4 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	ca450513          	addi	a0,a0,-860 # 5400 <malloc+0x190>
     764:	670040ef          	jal	4dd4 <open>
     768:	892a                	mv	s2,a0
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	eea58593          	addi	a1,a1,-278 # 5678 <malloc+0x408>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	c3c50513          	addi	a0,a0,-964 # 5400 <malloc+0x190>
     7cc:	618040ef          	jal	4de4 <unlink>
  close(fd1);
     7d0:	854e                	mv	a0,s3
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	e2050513          	addi	a0,a0,-480 # 5618 <malloc+0x3a8>
     800:	1bd040ef          	jal	51bc <printf>
    exit(1);
     804:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	e2c50513          	addi	a0,a0,-468 # 5638 <malloc+0x3c8>
     814:	1a9040ef          	jal	51bc <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	e2c50513          	addi	a0,a0,-468 # 5648 <malloc+0x3d8>
     824:	199040ef          	jal	51bc <printf>
    exit(1);
     828:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	e3850513          	addi	a0,a0,-456 # 5668 <malloc+0x3f8>
     838:	185040ef          	jal	51bc <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	e0850513          	addi	a0,a0,-504 # 5648 <malloc+0x3d8>
     848:	175040ef          	jal	51bc <printf>
    exit(1);
     84c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	e2a50513          	addi	a0,a0,-470 # 5680 <malloc+0x410>
     85e:	15f040ef          	jal	51bc <printf>
    exit(1);
     862:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	e3450513          	addi	a0,a0,-460 # 56a0 <malloc+0x430>
     874:	149040ef          	jal	51bc <printf>
    exit(1);
     878:	4505                	li	a0,1
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	e2850513          	addi	a0,a0,-472 # 56c0 <malloc+0x450>
     8a0:	534040ef          	jal	4dd4 <open>
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	e3c98993          	addi	s3,s3,-452 # 56e8 <malloc+0x478>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	e6ca8a93          	addi	s5,s5,-404 # 5720 <malloc+0x4b0>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f2:	dd250513          	addi	a0,a0,-558 # 56c0 <malloc+0x450>
     8f6:	4de040ef          	jal	4dd4 <open>
     8fa:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(unlink("small") < 0){
     ...
     922:	da250513          	addi	a0,a0,-606 # 56c0 <malloc+0x450>
     926:	4be040ef          	jal	4de4 <unlink>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	d8450513          	addi	a0,a0,-636 # 56c8 <malloc+0x458>
     94c:	071040ef          	jal	51bc <printf>
    exit(1);
     950:	4505                	li	a0,1
     ...
     95e:	d9e50513          	addi	a0,a0,-610 # 56f8 <malloc+0x488>
     962:	05b040ef          	jal	51bc <printf>
      exit(1);
     966:	4505                	li	a0,1
     ...
     974:	dc050513          	addi	a0,a0,-576 # 5730 <malloc+0x4c0>
     978:	045040ef          	jal	51bc <printf>
      exit(1);
     97c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	dd450513          	addi	a0,a0,-556 # 5758 <malloc+0x4e8>
     98c:	031040ef          	jal	51bc <printf>
    exit(1);
     990:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	de050513          	addi	a0,a0,-544 # 5778 <malloc+0x508>
     9a0:	01d040ef          	jal	51bc <printf>
    exit(1);
     9a4:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	de450513          	addi	a0,a0,-540 # 5790 <malloc+0x520>
     9b4:	009040ef          	jal	51bc <printf>
    exit(1);
     9b8:	4505                	li	a0,1
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	dda50513          	addi	a0,a0,-550 # 57b0 <malloc+0x540>
     9de:	3f6040ef          	jal	4dd4 <open>
     9e2:	89aa                	mv	s3,a0
  for(i = 0; i < MAXFILE; i++){
     9e4:	4481                	li	s1,0
    ((int*)buf)[0] = i;
  ...
  fd = open("big", O_RDONLY);
     ...
     a20:	d9450513          	addi	a0,a0,-620 # 57b0 <malloc+0x540>
     a24:	3b0040ef          	jal	4dd4 <open>
     a28:	89aa                	mv	s3,a0
  n = 0;
     a2a:	4481                	li	s1,0
    i = read(fd, buf, BSIZE);
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	d5c50513          	addi	a0,a0,-676 # 57b8 <malloc+0x548>
     a64:	758040ef          	jal	51bc <printf>
    exit(1);
     a68:	4505                	li	a0,1
     ...
     a76:	d6650513          	addi	a0,a0,-666 # 57d8 <malloc+0x568>
     a7a:	742040ef          	jal	51bc <printf>
      exit(1);
     a7e:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	d7a50513          	addi	a0,a0,-646 # 5800 <malloc+0x590>
     a8e:	72e040ef          	jal	51bc <printf>
    exit(1);
     a92:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     aaa:	d0a50513          	addi	a0,a0,-758 # 57b0 <malloc+0x540>
     aae:	336040ef          	jal	4de4 <unlink>
     ...
     ad0:	d5450513          	addi	a0,a0,-684 # 5820 <malloc+0x5b0>
     ad4:	6e8040ef          	jal	51bc <printf>
        exit(1);
     ad8:	4505                	li	a0,1
     ...
     ae6:	d6650513          	addi	a0,a0,-666 # 5848 <malloc+0x5d8>
     aea:	6d2040ef          	jal	51bc <printf>
      exit(1);
     aee:	4505                	li	a0,1
     ...
     afc:	d6850513          	addi	a0,a0,-664 # 5860 <malloc+0x5f0>
     b00:	6bc040ef          	jal	51bc <printf>
      exit(1);
     b04:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	d7c50513          	addi	a0,a0,-644 # 5888 <malloc+0x618>
     b14:	6a8040ef          	jal	51bc <printf>
    exit(1);
     b18:	4505                	li	a0,1
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	d6e50513          	addi	a0,a0,-658 # 58a0 <malloc+0x630>
     b3a:	29a040ef          	jal	4dd4 <open>
  if(fd < 0){
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	d8a58593          	addi	a1,a1,-630 # 58d0 <malloc+0x660>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b5e:	d4650513          	addi	a0,a0,-698 # 58a0 <malloc+0x630>
     b62:	272040ef          	jal	4dd4 <open>
     b66:	84aa                	mv	s1,a0
  if(fd < 0){
     b68:	0a054463          	bltz	a0,c10 <unlinkread+0xf2>
  if(unlink("unlinkread") != 0){
     b6c:	00005517          	auipc	a0,0x5
     b70:	d3450513          	addi	a0,a0,-716 # 58a0 <malloc+0x630>
     b74:	270040ef          	jal	4de4 <unlink>
     b78:	e555                	bnez	a0,c24 <unlinkread+0x106>
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     b7a:	20200593          	li	a1,514
     b7e:	00005517          	auipc	a0,0x5
     b82:	d2250513          	addi	a0,a0,-734 # 58a0 <malloc+0x630>
     b86:	24e040ef          	jal	4dd4 <open>
     b8a:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     b8c:	460d                	li	a2,3
     b8e:	00005597          	auipc	a1,0x5
     b92:	d8a58593          	addi	a1,a1,-630 # 5918 <malloc+0x6a8>
  ...
  unlink("unlinkread");
     ...
     be6:	cbe50513          	addi	a0,a0,-834 # 58a0 <malloc+0x630>
     bea:	1fa040ef          	jal	4de4 <unlink>
}
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	cb250513          	addi	a0,a0,-846 # 58b0 <malloc+0x640>
     c06:	5b6040ef          	jal	51bc <printf>
    exit(1);
     c0a:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	cc650513          	addi	a0,a0,-826 # 58d8 <malloc+0x668>
     c1a:	5a2040ef          	jal	51bc <printf>
    exit(1);
     c1e:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	cd250513          	addi	a0,a0,-814 # 58f8 <malloc+0x688>
     c2e:	58e040ef          	jal	51bc <printf>
    exit(1);
     c32:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	ce650513          	addi	a0,a0,-794 # 5920 <malloc+0x6b0>
     c42:	57a040ef          	jal	51bc <printf>
    exit(1);
     c46:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	cf250513          	addi	a0,a0,-782 # 5940 <malloc+0x6d0>
     c56:	566040ef          	jal	51bc <printf>
    exit(1);
     c5a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	cfe50513          	addi	a0,a0,-770 # 5960 <malloc+0x6f0>
     c6a:	552040ef          	jal	51bc <printf>
    exit(1);
     c6e:	4505                	li	a0,1
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	cfe50513          	addi	a0,a0,-770 # 5980 <malloc+0x710>
     c8a:	15a040ef          	jal	4de4 <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	cfa50513          	addi	a0,a0,-774 # 5988 <malloc+0x718>
     c96:	14e040ef          	jal	4de4 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	ce250513          	addi	a0,a0,-798 # 5980 <malloc+0x710>
     ca6:	12e040ef          	jal	4dd4 <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	c1e58593          	addi	a1,a1,-994 # 58d0 <malloc+0x660>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     cce:	cbe58593          	addi	a1,a1,-834 # 5988 <malloc+0x718>
     cd2:	00005517          	auipc	a0,0x5
     cd6:	cae50513          	addi	a0,a0,-850 # 5980 <malloc+0x710>
     cda:	11a040ef          	jal	4df4 <link>
     cde:	0c054963          	bltz	a0,db0 <linktest+0x13c>
  unlink("lf1");
     ce2:	00005517          	auipc	a0,0x5
     ce6:	c9e50513          	addi	a0,a0,-866 # 5980 <malloc+0x710>
     cea:	0fa040ef          	jal	4de4 <unlink>
  if(open("lf1", 0) >= 0){
     cee:	4581                	li	a1,0
     cf0:	00005517          	auipc	a0,0x5
     cf4:	c9050513          	addi	a0,a0,-880 # 5980 <malloc+0x710>
     cf8:	0dc040ef          	jal	4dd4 <open>
     cfc:	0c055463          	bgez	a0,dc4 <linktest+0x150>
  fd = open("lf2", 0);
     d00:	4581                	li	a1,0
     d02:	00005517          	auipc	a0,0x5
     d06:	c8650513          	addi	a0,a0,-890 # 5988 <malloc+0x718>
     d0a:	0ca040ef          	jal	4dd4 <open>
     d0e:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     d32:	c5a58593          	addi	a1,a1,-934 # 5988 <malloc+0x718>
     d36:	852e                	mv	a0,a1
     d38:	0bc040ef          	jal	4df4 <link>
     d3c:	0c055263          	bgez	a0,e00 <linktest+0x18c>
  unlink("lf2");
     d40:	00005517          	auipc	a0,0x5
     d44:	c4850513          	addi	a0,a0,-952 # 5988 <malloc+0x718>
     d48:	09c040ef          	jal	4de4 <unlink>
  if(link("lf2", "lf1") >= 0){
     d4c:	00005597          	auipc	a1,0x5
     d50:	c3458593          	addi	a1,a1,-972 # 5980 <malloc+0x710>
     d54:	00005517          	auipc	a0,0x5
     d58:	c3450513          	addi	a0,a0,-972 # 5988 <malloc+0x718>
     d5c:	098040ef          	jal	4df4 <link>
     d60:	0a055a63          	bgez	a0,e14 <linktest+0x1a0>
  if(link(".", "lf1") >= 0){
     d64:	00005597          	auipc	a1,0x5
     d68:	c1c58593          	addi	a1,a1,-996 # 5980 <malloc+0x710>
     d6c:	00005517          	auipc	a0,0x5
     d70:	d2450513          	addi	a0,a0,-732 # 5a90 <malloc+0x820>
     d74:	080040ef          	jal	4df4 <link>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	c0650513          	addi	a0,a0,-1018 # 5990 <malloc+0x720>
     d92:	42a040ef          	jal	51bc <printf>
    exit(1);
     d96:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	c0a50513          	addi	a0,a0,-1014 # 59a8 <malloc+0x738>
     da6:	416040ef          	jal	51bc <printf>
    exit(1);
     daa:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	c0e50513          	addi	a0,a0,-1010 # 59c0 <malloc+0x750>
     dba:	402040ef          	jal	51bc <printf>
    exit(1);
     dbe:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	c1a50513          	addi	a0,a0,-998 # 59e0 <malloc+0x770>
     dce:	3ee040ef          	jal	51bc <printf>
    exit(1);
     dd2:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	c3650513          	addi	a0,a0,-970 # 5a10 <malloc+0x7a0>
     de2:	3da040ef          	jal	51bc <printf>
    exit(1);
     de6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	c3a50513          	addi	a0,a0,-966 # 5a28 <malloc+0x7b8>
     df6:	3c6040ef          	jal	51bc <printf>
    exit(1);
     dfa:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	c3e50513          	addi	a0,a0,-962 # 5a40 <malloc+0x7d0>
     e0a:	3b2040ef          	jal	51bc <printf>
    exit(1);
     e0e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	c5250513          	addi	a0,a0,-942 # 5a68 <malloc+0x7f8>
     e1e:	39e040ef          	jal	51bc <printf>
    exit(1);
     e22:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	c6e50513          	addi	a0,a0,-914 # 5a98 <malloc+0x828>
     e32:	38a040ef          	jal	51bc <printf>
    exit(1);
     e36:	4505                	li	a0,1
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	c6498993          	addi	s3,s3,-924 # 5ab8 <malloc+0x848>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	c3c50513          	addi	a0,a0,-964 # 5ac8 <malloc+0x858>
     e94:	328040ef          	jal	51bc <printf>
      exit(1);
     e98:	4505                	li	a0,1
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	c3450513          	addi	a0,a0,-972 # 5ae8 <malloc+0x878>
     ebc:	729030ef          	jal	4de4 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	c2450513          	addi	a0,a0,-988 # 5ae8 <malloc+0x878>
     ecc:	709030ef          	jal	4dd4 <open>
  if(fd < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	c0aa0a13          	addi	s4,s4,-1014 # 5ae8 <malloc+0x878>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	bbc50513          	addi	a0,a0,-1092 # 5ae8 <malloc+0x878>
     f34:	6b1030ef          	jal	4de4 <unlink>
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	b5c50513          	addi	a0,a0,-1188 # 5af0 <malloc+0x880>
     f9c:	220040ef          	jal	51bc <printf>
    exit(1);
     fa0:	4505                	li	a0,1
     ...
     fb2:	b6250513          	addi	a0,a0,-1182 # 5b10 <malloc+0x8a0>
     fb6:	206040ef          	jal	51bc <printf>
      exit(1);
     fba:	4505                	li	a0,1
     ...
     fc6:	b7650513          	addi	a0,a0,-1162 # 5b38 <malloc+0x8c8>
     fca:	1f2040ef          	jal	51bc <printf>
      exit(1);
     fce:	4505                	li	a0,1
...
0000000000001000 <badarg>:
{
    ...
    101e:	38e98993          	addi	s3,s3,910 # 53a8 <malloc+0x138>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    10e8:	80c78793          	addi	a5,a5,-2036 # 78f0 <malloc+0x2680>
    ...
    110c:	2a050513          	addi	a0,a0,672 # 53a8 <malloc+0x138>
    1110:	4bd030ef          	jal	4dcc <exec>
    if(ret != -1){
    1114:	57fd                	li	a5,-1
    ...
    1120:	ac450513          	addi	a0,a0,-1340 # 5be0 <malloc+0x970>
    1124:	098040ef          	jal	51bc <printf>
      exit(1);
    1128:	4505                	li	a0,1
    ...
    1138:	a2450513          	addi	a0,a0,-1500 # 5b58 <malloc+0x8e8>
    113c:	080040ef          	jal	51bc <printf>
    exit(1);
    1140:	4505                	li	a0,1
    ...
    1150:	a2c50513          	addi	a0,a0,-1492 # 5b78 <malloc+0x908>
    1154:	068040ef          	jal	51bc <printf>
    exit(1);
    1158:	4505                	li	a0,1
    ...
    116a:	a3250513          	addi	a0,a0,-1486 # 5b98 <malloc+0x928>
    116e:	04e040ef          	jal	51bc <printf>
    exit(1);
    1172:	4505                	li	a0,1
    ...
    1182:	a4250513          	addi	a0,a0,-1470 # 5bc0 <malloc+0x950>
    1186:	036040ef          	jal	51bc <printf>
    exit(1);
    118a:	4505                	li	a0,1
    118c:	3e9030ef          	jal	4d74 <exit>
    printf("fork failed\n");
    1190:	00006517          	auipc	a0,0x6
    1194:	05050513          	addi	a0,a0,80 # 71e0 <malloc+0x1f70>
    1198:	024040ef          	jal	51bc <printf>
    exit(1);
    119c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11ce:	a3e50513          	addi	a0,a0,-1474 # 5c08 <malloc+0x998>
    11d2:	7eb030ef          	jal	51bc <printf>
    exit(1);
    11d6:	4505                	li	a0,1
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	21450513          	addi	a0,a0,532 # 5400 <malloc+0x190>
    11f4:	3e1030ef          	jal	4dd4 <open>
  ...
  if(pid == 0){
    ...
    1216:	1eea0a13          	addi	s4,s4,494 # 5400 <malloc+0x190>
      int n = write(fd, "1234567890", 10);
    121a:	00005a97          	auipc	s5,0x5
    121e:	a4ea8a93          	addi	s5,s5,-1458 # 5c68 <malloc+0x9f8>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    1226:	3af030ef          	jal	4dd4 <open>
    122a:	84aa                	mv	s1,a0
      if(fd < 0){
    ...
    127a:	9c250513          	addi	a0,a0,-1598 # 5c38 <malloc+0x9c8>
    127e:	73f030ef          	jal	51bc <printf>
    exit(1);
    1282:	4505                	li	a0,1
    ...
    128e:	9c650513          	addi	a0,a0,-1594 # 5c50 <malloc+0x9e0>
    1292:	72b030ef          	jal	51bc <printf>
        exit(1);
    1296:	4505                	li	a0,1
    ...
    12a4:	9d850513          	addi	a0,a0,-1576 # 5c78 <malloc+0xa08>
    12a8:	715030ef          	jal	51bc <printf>
        exit(1);
    12ac:	4505                	li	a0,1
    ...
    12c2:	142a0a13          	addi	s4,s4,322 # 5400 <malloc+0x190>
    int n = write(fd, "xxx", 3);
    12c6:	00005a97          	auipc	s5,0x5
    12ca:	9d2a8a93          	addi	s5,s5,-1582 # 5c98 <malloc+0xa28>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    12ce:	60100593          	li	a1,1537
    12d2:	8552                	mv	a0,s4
    12d4:	301030ef          	jal	4dd4 <open>
    12d8:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  unlink("truncfile");
    ...
    1304:	10050513          	addi	a0,a0,256 # 5400 <malloc+0x190>
    1308:	2dd030ef          	jal	4de4 <unlink>
  exit(xstatus);
    ...
    131a:	93a50513          	addi	a0,a0,-1734 # 5c50 <malloc+0x9e0>
    131e:	69f030ef          	jal	51bc <printf>
      exit(1);
    1322:	4505                	li	a0,1
    ...
    1330:	97450513          	addi	a0,a0,-1676 # 5ca0 <malloc+0xa30>
    1334:	689030ef          	jal	51bc <printf>
      exit(1);
    1338:	4505                	li	a0,1
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	05e78793          	addi	a5,a5,94 # 53a8 <malloc+0x138>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00005797          	auipc	a5,0x5
    135a:	96a78793          	addi	a5,a5,-1686 # 5cc0 <malloc+0xa50>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00005517          	auipc	a0,0x5
    136a:	96250513          	addi	a0,a0,-1694 # 5cc8 <malloc+0xa58>
    136e:	277030ef          	jal	4de4 <unlink>
  pid = fork();
  ...
  if(pid == 0) {
    ...
    138e:	93e50513          	addi	a0,a0,-1730 # 5cc8 <malloc+0xa58>
    1392:	243030ef          	jal	4dd4 <open>
    if(fd < 0) {
    ...
    13a6:	94650513          	addi	a0,a0,-1722 # 5ce8 <malloc+0xa78>
    13aa:	613030ef          	jal	51bc <printf>
      exit(1);
    13ae:	4505                	li	a0,1
    ...
    13bc:	88050513          	addi	a0,a0,-1920 # 5c38 <malloc+0x9c8>
    13c0:	5fd030ef          	jal	51bc <printf>
     exit(1);
    13c4:	4505                	li	a0,1
    ...
    13d0:	90450513          	addi	a0,a0,-1788 # 5cd0 <malloc+0xa60>
    13d4:	5e9030ef          	jal	51bc <printf>
      exit(1);
    13d8:	4505                	li	a0,1
    ...
    13e6:	fc650513          	addi	a0,a0,-58 # 53a8 <malloc+0x138>
    13ea:	1e3030ef          	jal	4dcc <exec>
  ...
  if(xstatus != 0)
    ...
    140e:	8ee50513          	addi	a0,a0,-1810 # 5cf8 <malloc+0xa88>
    1412:	5ab030ef          	jal	51bc <printf>
      exit(1);
    1416:	4505                	li	a0,1
    ...
    1422:	8f250513          	addi	a0,a0,-1806 # 5d10 <malloc+0xaa0>
    1426:	597030ef          	jal	51bc <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00005517          	auipc	a0,0x5
    1432:	89a50513          	addi	a0,a0,-1894 # 5cc8 <malloc+0xa58>
    1436:	19f030ef          	jal	4dd4 <open>
  if(fd < 0) {
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1454:	32850513          	addi	a0,a0,808 # 5778 <malloc+0x508>
    1458:	565030ef          	jal	51bc <printf>
    exit(1);
    145c:	4505                	li	a0,1
    ...
    1468:	7ec50513          	addi	a0,a0,2028 # 5c50 <malloc+0x9e0>
    146c:	551030ef          	jal	51bc <printf>
    exit(1);
    1470:	4505                	li	a0,1
    1472:	103030ef          	jal	4d74 <exit>
  unlink("echo-ok");
    1476:	00005517          	auipc	a0,0x5
    147a:	85250513          	addi	a0,a0,-1966 # 5cc8 <malloc+0xa58>
    147e:	167030ef          	jal	4de4 <unlink>
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	88c50513          	addi	a0,a0,-1908 # 5d28 <malloc+0xab8>
    14a4:	519030ef          	jal	51bc <printf>
    exit(1);
    14a8:	4505                	li	a0,1
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	7f850513          	addi	a0,a0,2040 # 5d40 <malloc+0xad0>
    1550:	46d030ef          	jal	51bc <printf>
    exit(1);
    1554:	4505                	li	a0,1
    ...
    1582:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	79650513          	addi	a0,a0,1942 # 5d58 <malloc+0xae8>
    15ca:	3f3030ef          	jal	51bc <printf>
        exit(1);
    15ce:	4505                	li	a0,1
    ...
    15da:	79a50513          	addi	a0,a0,1946 # 5d70 <malloc+0xb00>
    15de:	3df030ef          	jal	51bc <printf>
          return;
    ...
    160a:	78250513          	addi	a0,a0,1922 # 5d88 <malloc+0xb18>
    160e:	3af030ef          	jal	51bc <printf>
      exit(1);
    1612:	4505                	li	a0,1
    ...
    1642:	76a50513          	addi	a0,a0,1898 # 5da8 <malloc+0xb38>
    1646:	377030ef          	jal	51bc <printf>
    exit(1);
    164a:	4505                	li	a0,1
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	59850513          	addi	a0,a0,1432 # 5c38 <malloc+0x9c8>
    16a8:	315030ef          	jal	51bc <printf>
      exit(1);
    16ac:	4505                	li	a0,1
    ...
    16b8:	70c50513          	addi	a0,a0,1804 # 5dc0 <malloc+0xb50>
    16bc:	301030ef          	jal	51bc <printf>
        exit(1);
    16c0:	4505                	li	a0,1
    ...
    16cc:	71050513          	addi	a0,a0,1808 # 5dd8 <malloc+0xb68>
    16d0:	2ed030ef          	jal	51bc <printf>
        exit(1);
    16d4:	4505                	li	a0,1
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	51450513          	addi	a0,a0,1300 # 5c38 <malloc+0x9c8>
    172c:	291030ef          	jal	51bc <printf>
      exit(1);
    1730:	4505                	li	a0,1
    ...
    1740:	4fc50513          	addi	a0,a0,1276 # 5c38 <malloc+0x9c8>
    1744:	279030ef          	jal	51bc <printf>
        exit(1);
    1748:	4505                	li	a0,1
...
0000000000001752 <forkfork>:
{
    ...
    179e:	65e50513          	addi	a0,a0,1630 # 5df8 <malloc+0xb88>
    17a2:	21b030ef          	jal	51bc <printf>
      exit(1);
    17a6:	4505                	li	a0,1
    17a8:	5cc030ef          	jal	4d74 <exit>
{
    ...
    17da:	63250513          	addi	a0,a0,1586 # 5e08 <malloc+0xb98>
    17de:	1df030ef          	jal	51bc <printf>
      exit(1);
    17e2:	4505                	li	a0,1
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	9d050513          	addi	a0,a0,-1584 # 71e0 <malloc+0x1f70>
    1818:	1a5030ef          	jal	51bc <printf>
      exit(1);
    181c:	4505                	li	a0,1
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	3a650513          	addi	a0,a0,934 # 5c38 <malloc+0x9c8>
    189a:	123030ef          	jal	51bc <printf>
      exit(1);
    189e:	4505                	li	a0,1
    ...
    18ba:	41a50513          	addi	a0,a0,1050 # 5cd0 <malloc+0xa60>
    18be:	0ff030ef          	jal	51bc <printf>
          exit(1);
    18c2:	4505                	li	a0,1
    ...
    190a:	4da030ef          	jal	4de4 <unlink>
    190e:	fa055de3          	bgez	a0,18c8 <createdelete+0x98>
            printf("%s: unlink failed\n", s);
    1912:	85e6                	mv	a1,s9
    1914:	00004517          	auipc	a0,0x4
    1918:	51450513          	addi	a0,a0,1300 # 5e28 <malloc+0xbb8>
    191c:	0a1030ef          	jal	51bc <printf>
            exit(1);
    1920:	4505                	li	a0,1
    ...
    193c:	50850513          	addi	a0,a0,1288 # 5e40 <malloc+0xbd0>
    1940:	07d030ef          	jal	51bc <printf>
        exit(1);
    1944:	4505                	li	a0,1
    ...
    198e:	4de50513          	addi	a0,a0,1246 # 5e68 <malloc+0xbf8>
    1992:	02b030ef          	jal	51bc <printf>
        exit(1);
    1996:	4505                	li	a0,1
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	9f450513          	addi	a0,a0,-1548 # 5418 <malloc+0x1a8>
    1a2c:	3b8030ef          	jal	4de4 <unlink>
  pid = fork();
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	9c0b0b13          	addi	s6,s6,-1600 # 5418 <malloc+0x1a8>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	430c0c13          	addi	s8,s8,1072 # 5e90 <malloc+0xc20>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	1cc50513          	addi	a0,a0,460 # 5c38 <malloc+0x9c8>
    1a74:	748030ef          	jal	51bc <printf>
    exit(1);
    1a78:	4505                	li	a0,1
  ...
  for(i = 0; i < 100; i++){
    ...
    1aa4:	01778663          	beq	a5,s7,1ab0 <linkunlink+0xa8>
      unlink("x");
    1aa8:	855a                	mv	a0,s6
    1aaa:	33a030ef          	jal	4de4 <unlink>
    1aae:	bff9                	j	1a8c <linkunlink+0x84>
      link("cat", "x");
    1ab0:	85da                	mv	a1,s6
    1ab2:	8562                	mv	a0,s8
    1ab4:	340030ef          	jal	4df4 <link>
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	3d450513          	addi	a0,a0,980 # 5ee0 <malloc+0xc70>
    1b14:	6a8030ef          	jal	51bc <printf>
    exit(1);
    1b18:	4505                	li	a0,1
    ...
    1b28:	37450513          	addi	a0,a0,884 # 5e98 <malloc+0xc28>
    1b2c:	690030ef          	jal	51bc <printf>
    exit(1);
    1b30:	4505                	li	a0,1
    ...
    1b3c:	37850513          	addi	a0,a0,888 # 5eb0 <malloc+0xc40>
    1b40:	67c030ef          	jal	51bc <printf>
      exit(1);
    1b44:	4505                	li	a0,1
    ...
    1b50:	37c50513          	addi	a0,a0,892 # 5ec8 <malloc+0xc58>
    1b54:	668030ef          	jal	51bc <printf>
    exit(1);
    1b58:	4505                	li	a0,1
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	04e50513          	addi	a0,a0,78 # 5c38 <malloc+0x9c8>
    1bf2:	5ca030ef          	jal	51bc <printf>
      exit(1);
    1bf6:	4505                	li	a0,1
    ...
    1c08:	30450513          	addi	a0,a0,772 # 5f08 <malloc+0xc98>
    1c0c:	5b0030ef          	jal	51bc <printf>
      exit(1);
    1c10:	4505                	li	a0,1
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	fc650513          	addi	a0,a0,-58 # 5c38 <malloc+0x9c8>
    1c7a:	542030ef          	jal	51bc <printf>
      exit(1);
    1c7e:	4505                	li	a0,1
    ...
    1c9a:	29250513          	addi	a0,a0,658 # 5f28 <malloc+0xcb8>
    1c9e:	51e030ef          	jal	51bc <printf>
      exit(1);
    1ca2:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	25a50513          	addi	a0,a0,602 # 5f40 <malloc+0xcd0>
    1cee:	4ce030ef          	jal	51bc <printf>
    exit(1);
    1cf2:	4505                	li	a0,1
    ...
    1cfe:	f3e50513          	addi	a0,a0,-194 # 5c38 <malloc+0x9c8>
    1d02:	4ba030ef          	jal	51bc <printf>
    exit(1);
    1d06:	4505                	li	a0,1
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	bce78793          	addi	a5,a5,-1074 # 78f0 <malloc+0x2680>
  ...
  exit(0);
    ...
    1d8e:	1de50513          	addi	a0,a0,478 # 5f68 <malloc+0xcf8>
    1d92:	42a030ef          	jal	51bc <printf>
      exit(0);
    1d96:	4501                	li	a0,0
    ...
    1da2:	e9a50513          	addi	a0,a0,-358 # 5c38 <malloc+0x9c8>
    1da6:	416030ef          	jal	51bc <printf>
      exit(1);
    1daa:	4505                	li	a0,1
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	3d650513          	addi	a0,a0,982 # 71e0 <malloc+0x1f70>
    1e12:	3aa030ef          	jal	51bc <printf>
      exit(1);
    1e16:	4505                	li	a0,1
    ...
    1ea0:	0ec50513          	addi	a0,a0,236 # 5f88 <malloc+0xd18>
    1ea4:	318030ef          	jal	51bc <printf>
            exit(1);
    1ea8:	4505                	li	a0,1
    ...
    1eb8:	5c450513          	addi	a0,a0,1476 # 5478 <malloc+0x208>
    1ebc:	300030ef          	jal	51bc <printf>
            exit(1);
    1ec0:	4505                	li	a0,1
...
0000000000001eca <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    1f66:	03e50513          	addi	a0,a0,62 # 5fa0 <malloc+0xd30>
    1f6a:	252030ef          	jal	51bc <printf>
    exit(1);
    1f6e:	4505                	li	a0,1
    ...
    1f7c:	be050513          	addi	a0,a0,-1056 # 5b58 <malloc+0x8e8>
    1f80:	23c030ef          	jal	51bc <printf>
    exit(1);
    1f84:	4505                	li	a0,1
    ...
    1f92:	bea50513          	addi	a0,a0,-1046 # 5b78 <malloc+0x908>
    1f96:	226030ef          	jal	51bc <printf>
    exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	bf250513          	addi	a0,a0,-1038 # 5b98 <malloc+0x928>
    1fae:	20e030ef          	jal	51bc <printf>
    exit(1);
    1fb2:	4505                	li	a0,1
    ...
    1fc0:	c0450513          	addi	a0,a0,-1020 # 5bc0 <malloc+0x950>
    1fc4:	1f8030ef          	jal	51bc <printf>
    exit(1);
    1fc8:	4505                	li	a0,1
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	fe850513          	addi	a0,a0,-24 # 5fe0 <malloc+0xd70>
    2000:	5d5020ef          	jal	4dd4 <open>
    2004:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  if(n >= 0){
    ...
    2024:	fe050513          	addi	a0,a0,-32 # 6000 <malloc+0xd90>
    2028:	194030ef          	jal	51bc <printf>
    exit(1);
    202c:	4505                	li	a0,1
    ...
    203a:	f7250513          	addi	a0,a0,-142 # 5fa8 <malloc+0xd38>
    203e:	17e030ef          	jal	51bc <printf>
    exit(1);
    2042:	4505                	li	a0,1
    ...
    204e:	f7650513          	addi	a0,a0,-138 # 5fc0 <malloc+0xd50>
    2052:	16a030ef          	jal	51bc <printf>
    exit(1);
    2056:	4505                	li	a0,1
    2058:	51d020ef          	jal	4d74 <exit>
    printf("open(rwsbrk) failed\n");
    205c:	00004517          	auipc	a0,0x4
    2060:	f8c50513          	addi	a0,a0,-116 # 5fe8 <malloc+0xd78>
    2064:	158030ef          	jal	51bc <printf>
    exit(1);
    2068:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2078:	f6c50513          	addi	a0,a0,-148 # 5fe0 <malloc+0xd70>
    207c:	569020ef          	jal	4de4 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	4fe50513          	addi	a0,a0,1278 # 5580 <malloc+0x310>
    208a:	54b020ef          	jal	4dd4 <open>
    208e:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  if(n >= 0){
    ...
    20a8:	f8c50513          	addi	a0,a0,-116 # 6030 <malloc+0xdc0>
    20ac:	110030ef          	jal	51bc <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    20b2:	4c3020ef          	jal	4d74 <exit>
    printf("open(README) failed\n");
    20b6:	00003517          	auipc	a0,0x3
    20ba:	4d250513          	addi	a0,a0,1234 # 5588 <malloc+0x318>
    20be:	0fe030ef          	jal	51bc <printf>
    exit(1);
    20c2:	4505                	li	a0,1
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	f3850513          	addi	a0,a0,-200 # 6058 <malloc+0xde8>
    2128:	094030ef          	jal	51bc <printf>
    exit(1);
    212c:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	f0850513          	addi	a0,a0,-248 # 6078 <malloc+0xe08>
    2178:	044030ef          	jal	51bc <printf>
    exit(1);
    217c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    21c0:	f1c50513          	addi	a0,a0,-228 # 60d8 <malloc+0xe68>
    21c4:	7f9020ef          	jal	51bc <printf>
    exit(1);
    21c8:	4505                	li	a0,1
    ...
    21da:	ec250513          	addi	a0,a0,-318 # 6098 <malloc+0xe28>
    21de:	7df020ef          	jal	51bc <printf>
      exit(1);
    21e2:	4505                	li	a0,1
    ...
    21ee:	ece50513          	addi	a0,a0,-306 # 60b8 <malloc+0xe48>
    21f2:	7cb020ef          	jal	51bc <printf>
    exit(1);
    21f6:	4505                	li	a0,1
...
0000000000002216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22d6:	e2650513          	addi	a0,a0,-474 # 60f8 <malloc+0xe88>
    22da:	6e3020ef          	jal	51bc <printf>
    exit(1);
    22de:	4505                	li	a0,1
    ...
    22ea:	e5a50513          	addi	a0,a0,-422 # 6140 <malloc+0xed0>
    22ee:	6cf020ef          	jal	51bc <printf>
    exit(1);
    22f2:	4505                	li	a0,1
    ...
    2302:	e6250513          	addi	a0,a0,-414 # 6160 <malloc+0xef0>
    2306:	6b7020ef          	jal	51bc <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    231a:	e8a50513          	addi	a0,a0,-374 # 61a0 <malloc+0xf30>
    231e:	69f020ef          	jal	51bc <printf>
    exit(1);
    2322:	4505                	li	a0,1
    ...
    232e:	ea650513          	addi	a0,a0,-346 # 61d0 <malloc+0xf60>
    2332:	68b020ef          	jal	51bc <printf>
    exit(1);
    2336:	4505                	li	a0,1
    ...
    2346:	ec650513          	addi	a0,a0,-314 # 6208 <malloc+0xf98>
    234a:	673020ef          	jal	51bc <printf>
    exit(1);
    234e:	4505                	li	a0,1
...
0000000000002354 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2374:	ec050513          	addi	a0,a0,-320 # 6230 <malloc+0xfc0>
    2378:	25d020ef          	jal	4dd4 <open>
    237c:	84aa                	mv	s1,a0
  unlink("sbrk");
    237e:	00004517          	auipc	a0,0x4
    2382:	eb250513          	addi	a0,a0,-334 # 6230 <malloc+0xfc0>
    2386:	25f020ef          	jal	4de4 <unlink>
  if(fd < 0)  {
  ...
  if(pipe((int *) a) != 0){
    ...
    23c2:	e7a50513          	addi	a0,a0,-390 # 6238 <malloc+0xfc8>
    23c6:	5f7020ef          	jal	51bc <printf>
    exit(1);
    23ca:	4505                	li	a0,1
    ...
    23d6:	e7e50513          	addi	a0,a0,-386 # 6250 <malloc+0xfe0>
    23da:	5e3020ef          	jal	51bc <printf>
    exit(1);
    23de:	4505                	li	a0,1
    ...
    23ea:	95a50513          	addi	a0,a0,-1702 # 5d40 <malloc+0xad0>
    23ee:	5cf020ef          	jal	51bc <printf>
    exit(1);
    23f2:	4505                	li	a0,1
...
00000000000023f8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    240c:	e6050513          	addi	a0,a0,-416 # 6268 <malloc+0xff8>
    2410:	1c5020ef          	jal	4dd4 <open>
  if (fd < 0) {
  ...
  close(fd);
    ...
    2444:	81050513          	addi	a0,a0,-2032 # 5c50 <malloc+0x9e0>
    2448:	575020ef          	jal	51bc <printf>
    exit(1);
    244c:	4505                	li	a0,1
...
0000000000002452 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    247a:	d6a50513          	addi	a0,a0,-662 # 71e0 <malloc+0x1f70>
    247e:	53f020ef          	jal	51bc <printf>
    exit(1);
    2482:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24b4:	d3050513          	addi	a0,a0,-720 # 71e0 <malloc+0x1f70>
    24b8:	505020ef          	jal	51bc <printf>
    exit(1);
    24bc:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24f4:	cf050513          	addi	a0,a0,-784 # 71e0 <malloc+0x1f70>
    24f8:	4c5020ef          	jal	51bc <printf>
    exit(1);
    24fc:	4505                	li	a0,1
...
00000000000025de <execout>:
{
  ...
  exit(0);
    ...
    2614:	bd050513          	addi	a0,a0,-1072 # 71e0 <malloc+0x1f70>
    2618:	3a5020ef          	jal	51bc <printf>
      exit(1);
    261c:	4505                	li	a0,1
...
000000000000267a <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    268a:	dba50513          	addi	a0,a0,-582 # 6440 <malloc+0x11d0>
    268e:	76e020ef          	jal	4dfc <mkdir>
    2692:	e555                	bnez	a0,273e <fourteen+0xc4>
  if(mkdir("12345678901234/123456789012345") != 0){
    2694:	00004517          	auipc	a0,0x4
    2698:	c0450513          	addi	a0,a0,-1020 # 6298 <malloc+0x1028>
    269c:	760020ef          	jal	4dfc <mkdir>
    26a0:	e94d                	bnez	a0,2752 <fourteen+0xd8>
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    26a2:	20000593          	li	a1,512
    26a6:	00004517          	auipc	a0,0x4
    26aa:	c4a50513          	addi	a0,a0,-950 # 62f0 <malloc+0x1080>
    26ae:	726020ef          	jal	4dd4 <open>
  if(fd < 0){
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26c0:	cac50513          	addi	a0,a0,-852 # 6368 <malloc+0x10f8>
    26c4:	710020ef          	jal	4dd4 <open>
  if(fd < 0){
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    26d4:	d0850513          	addi	a0,a0,-760 # 63d8 <malloc+0x1168>
    26d8:	724020ef          	jal	4dfc <mkdir>
    26dc:	c94d                	beqz	a0,278e <fourteen+0x114>
  if(mkdir("123456789012345/12345678901234") == 0){
    26de:	00004517          	auipc	a0,0x4
    26e2:	d5250513          	addi	a0,a0,-686 # 6430 <malloc+0x11c0>
    26e6:	716020ef          	jal	4dfc <mkdir>
    26ea:	cd45                	beqz	a0,27a2 <fourteen+0x128>
  unlink("123456789012345/12345678901234");
    26ec:	00004517          	auipc	a0,0x4
    26f0:	d4450513          	addi	a0,a0,-700 # 6430 <malloc+0x11c0>
    26f4:	6f0020ef          	jal	4de4 <unlink>
  unlink("12345678901234/12345678901234");
    26f8:	00004517          	auipc	a0,0x4
    26fc:	ce050513          	addi	a0,a0,-800 # 63d8 <malloc+0x1168>
    2700:	6e4020ef          	jal	4de4 <unlink>
  unlink("12345678901234/12345678901234/12345678901234");
    2704:	00004517          	auipc	a0,0x4
    2708:	c6450513          	addi	a0,a0,-924 # 6368 <malloc+0x10f8>
    270c:	6d8020ef          	jal	4de4 <unlink>
  unlink("123456789012345/123456789012345/123456789012345");
    2710:	00004517          	auipc	a0,0x4
    2714:	be050513          	addi	a0,a0,-1056 # 62f0 <malloc+0x1080>
    2718:	6cc020ef          	jal	4de4 <unlink>
  unlink("12345678901234/123456789012345");
    271c:	00004517          	auipc	a0,0x4
    2720:	b7c50513          	addi	a0,a0,-1156 # 6298 <malloc+0x1028>
    2724:	6c0020ef          	jal	4de4 <unlink>
  unlink("12345678901234");
    2728:	00004517          	auipc	a0,0x4
    272c:	d1850513          	addi	a0,a0,-744 # 6440 <malloc+0x11d0>
    2730:	6b4020ef          	jal	4de4 <unlink>
}
    ...
    2744:	b3050513          	addi	a0,a0,-1232 # 6270 <malloc+0x1000>
    2748:	275020ef          	jal	51bc <printf>
    exit(1);
    274c:	4505                	li	a0,1
    ...
    2758:	b6450513          	addi	a0,a0,-1180 # 62b8 <malloc+0x1048>
    275c:	261020ef          	jal	51bc <printf>
    exit(1);
    2760:	4505                	li	a0,1
    ...
    276c:	bb850513          	addi	a0,a0,-1096 # 6320 <malloc+0x10b0>
    2770:	24d020ef          	jal	51bc <printf>
    exit(1);
    2774:	4505                	li	a0,1
    ...
    2780:	c1c50513          	addi	a0,a0,-996 # 6398 <malloc+0x1128>
    2784:	239020ef          	jal	51bc <printf>
    exit(1);
    2788:	4505                	li	a0,1
    ...
    2794:	c6850513          	addi	a0,a0,-920 # 63f8 <malloc+0x1188>
    2798:	225020ef          	jal	51bc <printf>
    exit(1);
    279c:	4505                	li	a0,1
    ...
    27a8:	cac50513          	addi	a0,a0,-852 # 6450 <malloc+0x11e0>
    27ac:	211020ef          	jal	51bc <printf>
    exit(1);
    27b0:	4505                	li	a0,1
...
00000000000027b6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    27f0:	c9c50513          	addi	a0,a0,-868 # 6488 <malloc+0x1218>
    27f4:	5f0020ef          	jal	4de4 <unlink>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    281c:	c8050513          	addi	a0,a0,-896 # 6498 <malloc+0x1228>
    2820:	19d020ef          	jal	51bc <printf>
      break;
  ...
  for(int i = 0; i < nzz; i++){
    ...
    2870:	574020ef          	jal	4de4 <unlink>
    int fd = open(name, O_CREATE|O_RDWR|O_TRUNC);
    2874:	60200593          	li	a1,1538
    2878:	ba040513          	addi	a0,s0,-1120
    287c:	558020ef          	jal	4dd4 <open>
    if(fd < 0)
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    2892:	bfa50513          	addi	a0,a0,-1030 # 6488 <malloc+0x1218>
    2896:	566020ef          	jal	4dfc <mkdir>
    289a:	12050063          	beqz	a0,29ba <diskfull+0x204>
  unlink("diskfulldir");
    289e:	00004517          	auipc	a0,0x4
    28a2:	bea50513          	addi	a0,a0,-1046 # 6488 <malloc+0x1218>
    28a6:	53e020ef          	jal	4de4 <unlink>
  for(int i = 0; i < nzz; i++){
    28aa:	4481                	li	s1,0
    name[0] = 'z';
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2986:	45e020ef          	jal	4de4 <unlink>
    int fd = open(name, O_CREATE|O_RDWR|O_TRUNC);
    298a:	60200593          	li	a1,1538
    298e:	b8040513          	addi	a0,s0,-1152
    2992:	442020ef          	jal	4dd4 <open>
    2996:	892a                	mv	s2,a0
    if(fd < 0){
    ...
    29c0:	afc50513          	addi	a0,a0,-1284 # 64b8 <malloc+0x1248>
    29c4:	7f8020ef          	jal	51bc <printf>
...
00000000000029ca <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    29da:	b1250513          	addi	a0,a0,-1262 # 64e8 <malloc+0x1278>
    29de:	41e020ef          	jal	4dfc <mkdir>
    29e2:	02054f63          	bltz	a0,2a20 <iputtest+0x56>
  if(chdir("iputdir") < 0){
    29e6:	00004517          	auipc	a0,0x4
    29ea:	b0250513          	addi	a0,a0,-1278 # 64e8 <malloc+0x1278>
    29ee:	416020ef          	jal	4e04 <chdir>
    29f2:	04054163          	bltz	a0,2a34 <iputtest+0x6a>
  if(unlink("../iputdir") < 0){
    29f6:	00004517          	auipc	a0,0x4
    29fa:	b3250513          	addi	a0,a0,-1230 # 6528 <malloc+0x12b8>
    29fe:	3e6020ef          	jal	4de4 <unlink>
    2a02:	04054363          	bltz	a0,2a48 <iputtest+0x7e>
  if(chdir("/") < 0){
    2a06:	00004517          	auipc	a0,0x4
    2a0a:	b5250513          	addi	a0,a0,-1198 # 6558 <malloc+0x12e8>
    2a0e:	3f6020ef          	jal	4e04 <chdir>
    ...
    2a26:	ace50513          	addi	a0,a0,-1330 # 64f0 <malloc+0x1280>
    2a2a:	792020ef          	jal	51bc <printf>
    exit(1);
    2a2e:	4505                	li	a0,1
    ...
    2a3a:	ad250513          	addi	a0,a0,-1326 # 6508 <malloc+0x1298>
    2a3e:	77e020ef          	jal	51bc <printf>
    exit(1);
    2a42:	4505                	li	a0,1
    ...
    2a4e:	aee50513          	addi	a0,a0,-1298 # 6538 <malloc+0x12c8>
    2a52:	76a020ef          	jal	51bc <printf>
    exit(1);
    2a56:	4505                	li	a0,1
    ...
    2a62:	b0250513          	addi	a0,a0,-1278 # 6560 <malloc+0x12f0>
    2a66:	756020ef          	jal	51bc <printf>
    exit(1);
    2a6a:	4505                	li	a0,1
...
0000000000002a70 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2a8a:	a6250513          	addi	a0,a0,-1438 # 64e8 <malloc+0x1278>
    2a8e:	36e020ef          	jal	4dfc <mkdir>
    2a92:	02054f63          	bltz	a0,2ad0 <exitiputtest+0x60>
    if(chdir("iputdir") < 0){
    2a96:	00004517          	auipc	a0,0x4
    2a9a:	a5250513          	addi	a0,a0,-1454 # 64e8 <malloc+0x1278>
    2a9e:	366020ef          	jal	4e04 <chdir>
    2aa2:	04054163          	bltz	a0,2ae4 <exitiputtest+0x74>
    if(unlink("../iputdir") < 0){
    2aa6:	00004517          	auipc	a0,0x4
    2aaa:	a8250513          	addi	a0,a0,-1406 # 6528 <malloc+0x12b8>
    2aae:	336020ef          	jal	4de4 <unlink>
    ...
    2ac2:	17a50513          	addi	a0,a0,378 # 5c38 <malloc+0x9c8>
    2ac6:	6f6020ef          	jal	51bc <printf>
    exit(1);
    2aca:	4505                	li	a0,1
    ...
    2ad6:	a1e50513          	addi	a0,a0,-1506 # 64f0 <malloc+0x1280>
    2ada:	6e2020ef          	jal	51bc <printf>
      exit(1);
    2ade:	4505                	li	a0,1
    ...
    2aea:	a9250513          	addi	a0,a0,-1390 # 6578 <malloc+0x1308>
    2aee:	6ce020ef          	jal	51bc <printf>
      exit(1);
    2af2:	4505                	li	a0,1
    ...
    2afe:	a3e50513          	addi	a0,a0,-1474 # 6538 <malloc+0x12c8>
    2b02:	6ba020ef          	jal	51bc <printf>
      exit(1);
    2b06:	4505                	li	a0,1
...
0000000000002b1c <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    2b2c:	a6850513          	addi	a0,a0,-1432 # 6590 <malloc+0x1320>
    2b30:	2cc020ef          	jal	4dfc <mkdir>
    2b34:	02054f63          	bltz	a0,2b72 <dirtest+0x56>
  if(chdir("dir0") < 0){
    2b38:	00004517          	auipc	a0,0x4
    2b3c:	a5850513          	addi	a0,a0,-1448 # 6590 <malloc+0x1320>
    2b40:	2c4020ef          	jal	4e04 <chdir>
    2b44:	04054163          	bltz	a0,2b86 <dirtest+0x6a>
  if(chdir("..") < 0){
    2b48:	00004517          	auipc	a0,0x4
    2b4c:	a6850513          	addi	a0,a0,-1432 # 65b0 <malloc+0x1340>
    2b50:	2b4020ef          	jal	4e04 <chdir>
    2b54:	04054363          	bltz	a0,2b9a <dirtest+0x7e>
  if(unlink("dir0") < 0){
    2b58:	00004517          	auipc	a0,0x4
    2b5c:	a3850513          	addi	a0,a0,-1480 # 6590 <malloc+0x1320>
    2b60:	284020ef          	jal	4de4 <unlink>
    ...
    2b78:	97c50513          	addi	a0,a0,-1668 # 64f0 <malloc+0x1280>
    2b7c:	640020ef          	jal	51bc <printf>
    exit(1);
    2b80:	4505                	li	a0,1
    ...
    2b8c:	a1050513          	addi	a0,a0,-1520 # 6598 <malloc+0x1328>
    2b90:	62c020ef          	jal	51bc <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    ...
    2ba0:	a1c50513          	addi	a0,a0,-1508 # 65b8 <malloc+0x1348>
    2ba4:	618020ef          	jal	51bc <printf>
    exit(1);
    2ba8:	4505                	li	a0,1
    ...
    2bb4:	a2050513          	addi	a0,a0,-1504 # 65d0 <malloc+0x1360>
    2bb8:	604020ef          	jal	51bc <printf>
    exit(1);
    2bbc:	4505                	li	a0,1
...
0000000000002bc2 <subdir>:
{
  ...
  unlink("ff");
    ...
    2bd4:	b4850513          	addi	a0,a0,-1208 # 6718 <malloc+0x14a8>
    2bd8:	20c020ef          	jal	4de4 <unlink>
  if(mkdir("dd") != 0){
    2bdc:	00004517          	auipc	a0,0x4
    2be0:	a0c50513          	addi	a0,a0,-1524 # 65e8 <malloc+0x1378>
    2be4:	218020ef          	jal	4dfc <mkdir>
    2be8:	2e051263          	bnez	a0,2ecc <subdir+0x30a>
  fd = open("dd/ff", O_CREATE | O_RDWR);
    2bec:	20200593          	li	a1,514
    2bf0:	00004517          	auipc	a0,0x4
    2bf4:	a1850513          	addi	a0,a0,-1512 # 6608 <malloc+0x1398>
    2bf8:	1dc020ef          	jal	4dd4 <open>
    2bfc:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    2c08:	b1458593          	addi	a1,a1,-1260 # 6718 <malloc+0x14a8>
  ...
  if(unlink("dd") >= 0){
    ...
    2c1a:	9d250513          	addi	a0,a0,-1582 # 65e8 <malloc+0x1378>
    2c1e:	1c6020ef          	jal	4de4 <unlink>
    2c22:	2c055963          	bgez	a0,2ef4 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c26:	00004517          	auipc	a0,0x4
    2c2a:	a3a50513          	addi	a0,a0,-1478 # 6660 <malloc+0x13f0>
    2c2e:	1ce020ef          	jal	4dfc <mkdir>
    2c32:	2c051b63          	bnez	a0,2f08 <subdir+0x346>
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    2c36:	20200593          	li	a1,514
    2c3a:	00004517          	auipc	a0,0x4
    2c3e:	a4e50513          	addi	a0,a0,-1458 # 6688 <malloc+0x1418>
    2c42:	192020ef          	jal	4dd4 <open>
    2c46:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    2c52:	a6a58593          	addi	a1,a1,-1430 # 66b8 <malloc+0x1448>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c66:	a5e50513          	addi	a0,a0,-1442 # 66c0 <malloc+0x1450>
    2c6a:	16a020ef          	jal	4dd4 <open>
    2c6e:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2ca2:	a7258593          	addi	a1,a1,-1422 # 6710 <malloc+0x14a0>
    2ca6:	00004517          	auipc	a0,0x4
    2caa:	9e250513          	addi	a0,a0,-1566 # 6688 <malloc+0x1418>
    2cae:	146020ef          	jal	4df4 <link>
    2cb2:	2a051363          	bnez	a0,2f58 <subdir+0x396>
  if(unlink("dd/dd/ff") != 0){
    2cb6:	00004517          	auipc	a0,0x4
    2cba:	9d250513          	addi	a0,a0,-1582 # 6688 <malloc+0x1418>
    2cbe:	126020ef          	jal	4de4 <unlink>
    2cc2:	2a051563          	bnez	a0,2f6c <subdir+0x3aa>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    2cc6:	4581                	li	a1,0
    2cc8:	00004517          	auipc	a0,0x4
    2ccc:	9c050513          	addi	a0,a0,-1600 # 6688 <malloc+0x1418>
    2cd0:	104020ef          	jal	4dd4 <open>
    2cd4:	2a055663          	bgez	a0,2f80 <subdir+0x3be>
  if(chdir("dd") != 0){
    2cd8:	00004517          	auipc	a0,0x4
    2cdc:	91050513          	addi	a0,a0,-1776 # 65e8 <malloc+0x1378>
    2ce0:	124020ef          	jal	4e04 <chdir>
    2ce4:	2a051863          	bnez	a0,2f94 <subdir+0x3d2>
  if(chdir("dd/../../dd") != 0){
    2ce8:	00004517          	auipc	a0,0x4
    2cec:	ac050513          	addi	a0,a0,-1344 # 67a8 <malloc+0x1538>
    2cf0:	114020ef          	jal	4e04 <chdir>
    2cf4:	2a051a63          	bnez	a0,2fa8 <subdir+0x3e6>
  if(chdir("dd/../../../dd") != 0){
    2cf8:	00004517          	auipc	a0,0x4
    2cfc:	ae050513          	addi	a0,a0,-1312 # 67d8 <malloc+0x1568>
    2d00:	104020ef          	jal	4e04 <chdir>
    2d04:	2a051c63          	bnez	a0,2fbc <subdir+0x3fa>
  if(chdir("./..") != 0){
    2d08:	00004517          	auipc	a0,0x4
    2d0c:	b0850513          	addi	a0,a0,-1272 # 6810 <malloc+0x15a0>
    2d10:	0f4020ef          	jal	4e04 <chdir>
    2d14:	2a051e63          	bnez	a0,2fd0 <subdir+0x40e>
  fd = open("dd/dd/ffff", 0);
    2d18:	4581                	li	a1,0
    2d1a:	00004517          	auipc	a0,0x4
    2d1e:	9f650513          	addi	a0,a0,-1546 # 6710 <malloc+0x14a0>
    2d22:	0b2020ef          	jal	4dd4 <open>
    2d26:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d4c:	94050513          	addi	a0,a0,-1728 # 6688 <malloc+0x1418>
    2d50:	084020ef          	jal	4dd4 <open>
    2d54:	2a055c63          	bgez	a0,300c <subdir+0x44a>
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    2d58:	20200593          	li	a1,514
    2d5c:	00004517          	auipc	a0,0x4
    2d60:	b4450513          	addi	a0,a0,-1212 # 68a0 <malloc+0x1630>
    2d64:	070020ef          	jal	4dd4 <open>
    2d68:	2a055c63          	bgez	a0,3020 <subdir+0x45e>
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    2d6c:	20200593          	li	a1,514
    2d70:	00004517          	auipc	a0,0x4
    2d74:	b6050513          	addi	a0,a0,-1184 # 68d0 <malloc+0x1660>
    2d78:	05c020ef          	jal	4dd4 <open>
    2d7c:	2a055c63          	bgez	a0,3034 <subdir+0x472>
  if(open("dd", O_CREATE) >= 0){
    2d80:	20000593          	li	a1,512
    2d84:	00004517          	auipc	a0,0x4
    2d88:	86450513          	addi	a0,a0,-1948 # 65e8 <malloc+0x1378>
    2d8c:	048020ef          	jal	4dd4 <open>
    2d90:	2a055c63          	bgez	a0,3048 <subdir+0x486>
  if(open("dd", O_RDWR) >= 0){
    2d94:	4589                	li	a1,2
    2d96:	00004517          	auipc	a0,0x4
    2d9a:	85250513          	addi	a0,a0,-1966 # 65e8 <malloc+0x1378>
    2d9e:	036020ef          	jal	4dd4 <open>
    2da2:	2a055d63          	bgez	a0,305c <subdir+0x49a>
  if(open("dd", O_WRONLY) >= 0){
    2da6:	4585                	li	a1,1
    2da8:	00004517          	auipc	a0,0x4
    2dac:	84050513          	addi	a0,a0,-1984 # 65e8 <malloc+0x1378>
    2db0:	024020ef          	jal	4dd4 <open>
    2db4:	2a055e63          	bgez	a0,3070 <subdir+0x4ae>
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2db8:	00004597          	auipc	a1,0x4
    2dbc:	ba858593          	addi	a1,a1,-1112 # 6960 <malloc+0x16f0>
    2dc0:	00004517          	auipc	a0,0x4
    2dc4:	ae050513          	addi	a0,a0,-1312 # 68a0 <malloc+0x1630>
    2dc8:	02c020ef          	jal	4df4 <link>
    2dcc:	2a050c63          	beqz	a0,3084 <subdir+0x4c2>
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    2dd0:	00004597          	auipc	a1,0x4
    2dd4:	b9058593          	addi	a1,a1,-1136 # 6960 <malloc+0x16f0>
    2dd8:	00004517          	auipc	a0,0x4
    2ddc:	af850513          	addi	a0,a0,-1288 # 68d0 <malloc+0x1660>
    2de0:	014020ef          	jal	4df4 <link>
    2de4:	2a050a63          	beqz	a0,3098 <subdir+0x4d6>
  if(link("dd/ff", "dd/dd/ffff") == 0){
    2de8:	00004597          	auipc	a1,0x4
    2dec:	92858593          	addi	a1,a1,-1752 # 6710 <malloc+0x14a0>
    2df0:	00004517          	auipc	a0,0x4
    2df4:	81850513          	addi	a0,a0,-2024 # 6608 <malloc+0x1398>
    2df8:	7fd010ef          	jal	4df4 <link>
    2dfc:	2a050863          	beqz	a0,30ac <subdir+0x4ea>
  if(mkdir("dd/ff/ff") == 0){
    2e00:	00004517          	auipc	a0,0x4
    2e04:	aa050513          	addi	a0,a0,-1376 # 68a0 <malloc+0x1630>
    2e08:	7f5010ef          	jal	4dfc <mkdir>
    2e0c:	2a050a63          	beqz	a0,30c0 <subdir+0x4fe>
  if(mkdir("dd/xx/ff") == 0){
    2e10:	00004517          	auipc	a0,0x4
    2e14:	ac050513          	addi	a0,a0,-1344 # 68d0 <malloc+0x1660>
    2e18:	7e5010ef          	jal	4dfc <mkdir>
    2e1c:	2a050c63          	beqz	a0,30d4 <subdir+0x512>
  if(mkdir("dd/dd/ffff") == 0){
    2e20:	00004517          	auipc	a0,0x4
    2e24:	8f050513          	addi	a0,a0,-1808 # 6710 <malloc+0x14a0>
    2e28:	7d5010ef          	jal	4dfc <mkdir>
    2e2c:	2a050e63          	beqz	a0,30e8 <subdir+0x526>
  if(unlink("dd/xx/ff") == 0){
    2e30:	00004517          	auipc	a0,0x4
    2e34:	aa050513          	addi	a0,a0,-1376 # 68d0 <malloc+0x1660>
    2e38:	7ad010ef          	jal	4de4 <unlink>
    2e3c:	2c050063          	beqz	a0,30fc <subdir+0x53a>
  if(unlink("dd/ff/ff") == 0){
    2e40:	00004517          	auipc	a0,0x4
    2e44:	a6050513          	addi	a0,a0,-1440 # 68a0 <malloc+0x1630>
    2e48:	79d010ef          	jal	4de4 <unlink>
    2e4c:	2c050263          	beqz	a0,3110 <subdir+0x54e>
  if(chdir("dd/ff") == 0){
    2e50:	00003517          	auipc	a0,0x3
    2e54:	7b850513          	addi	a0,a0,1976 # 6608 <malloc+0x1398>
    2e58:	7ad010ef          	jal	4e04 <chdir>
    2e5c:	2c050463          	beqz	a0,3124 <subdir+0x562>
  if(chdir("dd/xx") == 0){
    2e60:	00004517          	auipc	a0,0x4
    2e64:	c5050513          	addi	a0,a0,-944 # 6ab0 <malloc+0x1840>
    2e68:	79d010ef          	jal	4e04 <chdir>
    2e6c:	2c050663          	beqz	a0,3138 <subdir+0x576>
  if(unlink("dd/dd/ffff") != 0){
    2e70:	00004517          	auipc	a0,0x4
    2e74:	8a050513          	addi	a0,a0,-1888 # 6710 <malloc+0x14a0>
    2e78:	76d010ef          	jal	4de4 <unlink>
    2e7c:	2c051863          	bnez	a0,314c <subdir+0x58a>
  if(unlink("dd/ff") != 0){
    2e80:	00003517          	auipc	a0,0x3
    2e84:	78850513          	addi	a0,a0,1928 # 6608 <malloc+0x1398>
    2e88:	75d010ef          	jal	4de4 <unlink>
    2e8c:	2c051a63          	bnez	a0,3160 <subdir+0x59e>
  if(unlink("dd") == 0){
    2e90:	00003517          	auipc	a0,0x3
    2e94:	75850513          	addi	a0,a0,1880 # 65e8 <malloc+0x1378>
    2e98:	74d010ef          	jal	4de4 <unlink>
    2e9c:	2c050c63          	beqz	a0,3174 <subdir+0x5b2>
  if(unlink("dd/dd") < 0){
    2ea0:	00004517          	auipc	a0,0x4
    2ea4:	c8050513          	addi	a0,a0,-896 # 6b20 <malloc+0x18b0>
    2ea8:	73d010ef          	jal	4de4 <unlink>
    2eac:	2c054e63          	bltz	a0,3188 <subdir+0x5c6>
  if(unlink("dd") < 0){
    2eb0:	00003517          	auipc	a0,0x3
    2eb4:	73850513          	addi	a0,a0,1848 # 65e8 <malloc+0x1378>
    2eb8:	72d010ef          	jal	4de4 <unlink>
    ...
    2ed2:	72250513          	addi	a0,a0,1826 # 65f0 <malloc+0x1380>
    2ed6:	2e6020ef          	jal	51bc <printf>
    exit(1);
    2eda:	4505                	li	a0,1
    ...
    2ee6:	72e50513          	addi	a0,a0,1838 # 6610 <malloc+0x13a0>
    2eea:	2d2020ef          	jal	51bc <printf>
    exit(1);
    2eee:	4505                	li	a0,1
    ...
    2efa:	73a50513          	addi	a0,a0,1850 # 6630 <malloc+0x13c0>
    2efe:	2be020ef          	jal	51bc <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    ...
    2f0e:	75e50513          	addi	a0,a0,1886 # 6668 <malloc+0x13f8>
    2f12:	2aa020ef          	jal	51bc <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f22:	77a50513          	addi	a0,a0,1914 # 6698 <malloc+0x1428>
    2f26:	296020ef          	jal	51bc <printf>
    exit(1);
    2f2a:	4505                	li	a0,1
    ...
    2f36:	79e50513          	addi	a0,a0,1950 # 66d0 <malloc+0x1460>
    2f3a:	282020ef          	jal	51bc <printf>
    exit(1);
    2f3e:	4505                	li	a0,1
    ...
    2f4a:	7aa50513          	addi	a0,a0,1962 # 66f0 <malloc+0x1480>
    2f4e:	26e020ef          	jal	51bc <printf>
    exit(1);
    2f52:	4505                	li	a0,1
    ...
    2f5e:	7c650513          	addi	a0,a0,1990 # 6720 <malloc+0x14b0>
    2f62:	25a020ef          	jal	51bc <printf>
    exit(1);
    2f66:	4505                	li	a0,1
    ...
    2f72:	7da50513          	addi	a0,a0,2010 # 6748 <malloc+0x14d8>
    2f76:	246020ef          	jal	51bc <printf>
    exit(1);
    2f7a:	4505                	li	a0,1
    ...
    2f86:	7e650513          	addi	a0,a0,2022 # 6768 <malloc+0x14f8>
    2f8a:	232020ef          	jal	51bc <printf>
    exit(1);
    2f8e:	4505                	li	a0,1
    ...
    2f9a:	7fa50513          	addi	a0,a0,2042 # 6790 <malloc+0x1520>
    2f9e:	21e020ef          	jal	51bc <printf>
    exit(1);
    2fa2:	4505                	li	a0,1
    ...
    2fae:	80e50513          	addi	a0,a0,-2034 # 67b8 <malloc+0x1548>
    2fb2:	20a020ef          	jal	51bc <printf>
    exit(1);
    2fb6:	4505                	li	a0,1
    ...
    2fc2:	82a50513          	addi	a0,a0,-2006 # 67e8 <malloc+0x1578>
    2fc6:	1f6020ef          	jal	51bc <printf>
    exit(1);
    2fca:	4505                	li	a0,1
    ...
    2fd6:	84650513          	addi	a0,a0,-1978 # 6818 <malloc+0x15a8>
    2fda:	1e2020ef          	jal	51bc <printf>
    exit(1);
    2fde:	4505                	li	a0,1
    ...
    2fea:	84a50513          	addi	a0,a0,-1974 # 6830 <malloc+0x15c0>
    2fee:	1ce020ef          	jal	51bc <printf>
    exit(1);
    2ff2:	4505                	li	a0,1
    ...
    2ffe:	85650513          	addi	a0,a0,-1962 # 6850 <malloc+0x15e0>
    3002:	1ba020ef          	jal	51bc <printf>
    exit(1);
    3006:	4505                	li	a0,1
    ...
    3012:	86250513          	addi	a0,a0,-1950 # 6870 <malloc+0x1600>
    3016:	1a6020ef          	jal	51bc <printf>
    exit(1);
    301a:	4505                	li	a0,1
    ...
    3026:	88e50513          	addi	a0,a0,-1906 # 68b0 <malloc+0x1640>
    302a:	192020ef          	jal	51bc <printf>
    exit(1);
    302e:	4505                	li	a0,1
    ...
    303a:	8aa50513          	addi	a0,a0,-1878 # 68e0 <malloc+0x1670>
    303e:	17e020ef          	jal	51bc <printf>
    exit(1);
    3042:	4505                	li	a0,1
    ...
    304e:	8b650513          	addi	a0,a0,-1866 # 6900 <malloc+0x1690>
    3052:	16a020ef          	jal	51bc <printf>
    exit(1);
    3056:	4505                	li	a0,1
    ...
    3062:	8c250513          	addi	a0,a0,-1854 # 6920 <malloc+0x16b0>
    3066:	156020ef          	jal	51bc <printf>
    exit(1);
    306a:	4505                	li	a0,1
    ...
    3076:	8ce50513          	addi	a0,a0,-1842 # 6940 <malloc+0x16d0>
    307a:	142020ef          	jal	51bc <printf>
    exit(1);
    307e:	4505                	li	a0,1
    ...
    308a:	8ea50513          	addi	a0,a0,-1814 # 6970 <malloc+0x1700>
    308e:	12e020ef          	jal	51bc <printf>
    exit(1);
    3092:	4505                	li	a0,1
    ...
    309e:	8fe50513          	addi	a0,a0,-1794 # 6998 <malloc+0x1728>
    30a2:	11a020ef          	jal	51bc <printf>
    exit(1);
    30a6:	4505                	li	a0,1
    ...
    30b2:	91250513          	addi	a0,a0,-1774 # 69c0 <malloc+0x1750>
    30b6:	106020ef          	jal	51bc <printf>
    exit(1);
    30ba:	4505                	li	a0,1
    ...
    30c6:	92650513          	addi	a0,a0,-1754 # 69e8 <malloc+0x1778>
    30ca:	0f2020ef          	jal	51bc <printf>
    exit(1);
    30ce:	4505                	li	a0,1
    ...
    30da:	93250513          	addi	a0,a0,-1742 # 6a08 <malloc+0x1798>
    30de:	0de020ef          	jal	51bc <printf>
    exit(1);
    30e2:	4505                	li	a0,1
    ...
    30ee:	93e50513          	addi	a0,a0,-1730 # 6a28 <malloc+0x17b8>
    30f2:	0ca020ef          	jal	51bc <printf>
    exit(1);
    30f6:	4505                	li	a0,1
    ...
    3102:	95250513          	addi	a0,a0,-1710 # 6a50 <malloc+0x17e0>
    3106:	0b6020ef          	jal	51bc <printf>
    exit(1);
    310a:	4505                	li	a0,1
    ...
    3116:	95e50513          	addi	a0,a0,-1698 # 6a70 <malloc+0x1800>
    311a:	0a2020ef          	jal	51bc <printf>
    exit(1);
    311e:	4505                	li	a0,1
    ...
    312a:	96a50513          	addi	a0,a0,-1686 # 6a90 <malloc+0x1820>
    312e:	08e020ef          	jal	51bc <printf>
    exit(1);
    3132:	4505                	li	a0,1
    ...
    313e:	97e50513          	addi	a0,a0,-1666 # 6ab8 <malloc+0x1848>
    3142:	07a020ef          	jal	51bc <printf>
    exit(1);
    3146:	4505                	li	a0,1
    ...
    3152:	5fa50513          	addi	a0,a0,1530 # 6748 <malloc+0x14d8>
    3156:	066020ef          	jal	51bc <printf>
    exit(1);
    315a:	4505                	li	a0,1
    ...
    3166:	97650513          	addi	a0,a0,-1674 # 6ad8 <malloc+0x1868>
    316a:	052020ef          	jal	51bc <printf>
    exit(1);
    316e:	4505                	li	a0,1
    ...
    317a:	98250513          	addi	a0,a0,-1662 # 6af8 <malloc+0x1888>
    317e:	03e020ef          	jal	51bc <printf>
    exit(1);
    3182:	4505                	li	a0,1
    ...
    318e:	99e50513          	addi	a0,a0,-1634 # 6b28 <malloc+0x18b8>
    3192:	02a020ef          	jal	51bc <printf>
    exit(1);
    3196:	4505                	li	a0,1
    ...
    31a2:	9aa50513          	addi	a0,a0,-1622 # 6b48 <malloc+0x18d8>
    31a6:	016020ef          	jal	51bc <printf>
    exit(1);
    31aa:	4505                	li	a0,1
...
00000000000031b0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    31c0:	9a450513          	addi	a0,a0,-1628 # 6b60 <malloc+0x18f0>
    31c4:	439010ef          	jal	4dfc <mkdir>
    31c8:	e53d                	bnez	a0,3236 <rmdot+0x86>
  if(chdir("dots") != 0){
    31ca:	00004517          	auipc	a0,0x4
    31ce:	99650513          	addi	a0,a0,-1642 # 6b60 <malloc+0x18f0>
    31d2:	433010ef          	jal	4e04 <chdir>
    31d6:	e935                	bnez	a0,324a <rmdot+0x9a>
  if(unlink(".") == 0){
    31d8:	00003517          	auipc	a0,0x3
    31dc:	8b850513          	addi	a0,a0,-1864 # 5a90 <malloc+0x820>
    31e0:	405010ef          	jal	4de4 <unlink>
    31e4:	cd2d                	beqz	a0,325e <rmdot+0xae>
  if(unlink("..") == 0){
    31e6:	00003517          	auipc	a0,0x3
    31ea:	3ca50513          	addi	a0,a0,970 # 65b0 <malloc+0x1340>
    31ee:	3f7010ef          	jal	4de4 <unlink>
    31f2:	c141                	beqz	a0,3272 <rmdot+0xc2>
  if(chdir("/") != 0){
    31f4:	00003517          	auipc	a0,0x3
    31f8:	36450513          	addi	a0,a0,868 # 6558 <malloc+0x12e8>
    31fc:	409010ef          	jal	4e04 <chdir>
    3200:	e159                	bnez	a0,3286 <rmdot+0xd6>
  if(unlink("dots/.") == 0){
    3202:	00004517          	auipc	a0,0x4
    3206:	9c650513          	addi	a0,a0,-1594 # 6bc8 <malloc+0x1958>
    320a:	3db010ef          	jal	4de4 <unlink>
    320e:	c551                	beqz	a0,329a <rmdot+0xea>
  if(unlink("dots/..") == 0){
    3210:	00004517          	auipc	a0,0x4
    3214:	9e050513          	addi	a0,a0,-1568 # 6bf0 <malloc+0x1980>
    3218:	3cd010ef          	jal	4de4 <unlink>
    321c:	c949                	beqz	a0,32ae <rmdot+0xfe>
  if(unlink("dots") != 0){
    321e:	00004517          	auipc	a0,0x4
    3222:	94250513          	addi	a0,a0,-1726 # 6b60 <malloc+0x18f0>
    3226:	3bf010ef          	jal	4de4 <unlink>
    ...
    323c:	93050513          	addi	a0,a0,-1744 # 6b68 <malloc+0x18f8>
    3240:	77d010ef          	jal	51bc <printf>
    exit(1);
    3244:	4505                	li	a0,1
    ...
    3250:	93450513          	addi	a0,a0,-1740 # 6b80 <malloc+0x1910>
    3254:	769010ef          	jal	51bc <printf>
    exit(1);
    3258:	4505                	li	a0,1
    ...
    3264:	93850513          	addi	a0,a0,-1736 # 6b98 <malloc+0x1928>
    3268:	755010ef          	jal	51bc <printf>
    exit(1);
    326c:	4505                	li	a0,1
    ...
    3278:	93c50513          	addi	a0,a0,-1732 # 6bb0 <malloc+0x1940>
    327c:	741010ef          	jal	51bc <printf>
    exit(1);
    3280:	4505                	li	a0,1
    ...
    328c:	2d850513          	addi	a0,a0,728 # 6560 <malloc+0x12f0>
    3290:	72d010ef          	jal	51bc <printf>
    exit(1);
    3294:	4505                	li	a0,1
    ...
    32a0:	93450513          	addi	a0,a0,-1740 # 6bd0 <malloc+0x1960>
    32a4:	719010ef          	jal	51bc <printf>
    exit(1);
    32a8:	4505                	li	a0,1
    ...
    32b4:	94850513          	addi	a0,a0,-1720 # 6bf8 <malloc+0x1988>
    32b8:	705010ef          	jal	51bc <printf>
    exit(1);
    32bc:	4505                	li	a0,1
    ...
    32c8:	95450513          	addi	a0,a0,-1708 # 6c18 <malloc+0x19a8>
    32cc:	6f1010ef          	jal	51bc <printf>
    exit(1);
    32d0:	4505                	li	a0,1
...
00000000000032d6 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    32ec:	95050513          	addi	a0,a0,-1712 # 6c38 <malloc+0x19c8>
    32f0:	2e5010ef          	jal	4dd4 <open>
  if(fd < 0){
  ...
  if(chdir("dirfile") == 0){
    ...
    3300:	93c50513          	addi	a0,a0,-1732 # 6c38 <malloc+0x19c8>
    3304:	301010ef          	jal	4e04 <chdir>
    3308:	c569                	beqz	a0,33d2 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    330a:	4581                	li	a1,0
    330c:	00004517          	auipc	a0,0x4
    3310:	97450513          	addi	a0,a0,-1676 # 6c80 <malloc+0x1a10>
    3314:	2c1010ef          	jal	4dd4 <open>
  if(fd >= 0){
    3318:	0c055763          	bgez	a0,33e6 <dirfile+0x110>
  fd = open("dirfile/xx", O_CREATE);
    331c:	20000593          	li	a1,512
    3320:	00004517          	auipc	a0,0x4
    3324:	96050513          	addi	a0,a0,-1696 # 6c80 <malloc+0x1a10>
    3328:	2ad010ef          	jal	4dd4 <open>
  if(fd >= 0){
    332c:	0c055763          	bgez	a0,33fa <dirfile+0x124>
  if(mkdir("dirfile/xx") == 0){
    3330:	00004517          	auipc	a0,0x4
    3334:	95050513          	addi	a0,a0,-1712 # 6c80 <malloc+0x1a10>
    3338:	2c5010ef          	jal	4dfc <mkdir>
    333c:	0c050963          	beqz	a0,340e <dirfile+0x138>
  if(unlink("dirfile/xx") == 0){
    3340:	00004517          	auipc	a0,0x4
    3344:	94050513          	addi	a0,a0,-1728 # 6c80 <malloc+0x1a10>
    3348:	29d010ef          	jal	4de4 <unlink>
    334c:	0c050b63          	beqz	a0,3422 <dirfile+0x14c>
  if(link("README", "dirfile/xx") == 0){
    3350:	00004597          	auipc	a1,0x4
    3354:	93058593          	addi	a1,a1,-1744 # 6c80 <malloc+0x1a10>
    3358:	00002517          	auipc	a0,0x2
    335c:	22850513          	addi	a0,a0,552 # 5580 <malloc+0x310>
    3360:	295010ef          	jal	4df4 <link>
    3364:	0c050963          	beqz	a0,3436 <dirfile+0x160>
  if(unlink("dirfile") != 0){
    3368:	00004517          	auipc	a0,0x4
    336c:	8d050513          	addi	a0,a0,-1840 # 6c38 <malloc+0x19c8>
    3370:	275010ef          	jal	4de4 <unlink>
    3374:	0c051b63          	bnez	a0,344a <dirfile+0x174>
  fd = open(".", O_RDWR);
    3378:	4589                	li	a1,2
    337a:	00002517          	auipc	a0,0x2
    337e:	71650513          	addi	a0,a0,1814 # 5a90 <malloc+0x820>
    3382:	253010ef          	jal	4dd4 <open>
  if(fd >= 0){
    3386:	0c055c63          	bgez	a0,345e <dirfile+0x188>
  fd = open(".", 0);
    338a:	4581                	li	a1,0
    338c:	00002517          	auipc	a0,0x2
    3390:	70450513          	addi	a0,a0,1796 # 5a90 <malloc+0x820>
    3394:	241010ef          	jal	4dd4 <open>
    3398:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    339a:	4605                	li	a2,1
    339c:	00002597          	auipc	a1,0x2
    33a0:	07c58593          	addi	a1,a1,124 # 5418 <malloc+0x1a8>
  ...
  close(fd);
    ...
    33c4:	88050513          	addi	a0,a0,-1920 # 6c40 <malloc+0x19d0>
    33c8:	5f5010ef          	jal	51bc <printf>
    exit(1);
    33cc:	4505                	li	a0,1
    ...
    33d8:	88c50513          	addi	a0,a0,-1908 # 6c60 <malloc+0x19f0>
    33dc:	5e1010ef          	jal	51bc <printf>
    exit(1);
    33e0:	4505                	li	a0,1
    ...
    33ec:	8a850513          	addi	a0,a0,-1880 # 6c90 <malloc+0x1a20>
    33f0:	5cd010ef          	jal	51bc <printf>
    exit(1);
    33f4:	4505                	li	a0,1
    ...
    3400:	89450513          	addi	a0,a0,-1900 # 6c90 <malloc+0x1a20>
    3404:	5b9010ef          	jal	51bc <printf>
    exit(1);
    3408:	4505                	li	a0,1
    ...
    3414:	8a850513          	addi	a0,a0,-1880 # 6cb8 <malloc+0x1a48>
    3418:	5a5010ef          	jal	51bc <printf>
    exit(1);
    341c:	4505                	li	a0,1
    ...
    3428:	8bc50513          	addi	a0,a0,-1860 # 6ce0 <malloc+0x1a70>
    342c:	591010ef          	jal	51bc <printf>
    exit(1);
    3430:	4505                	li	a0,1
    ...
    343c:	8d050513          	addi	a0,a0,-1840 # 6d08 <malloc+0x1a98>
    3440:	57d010ef          	jal	51bc <printf>
    exit(1);
    3444:	4505                	li	a0,1
    ...
    3450:	8e450513          	addi	a0,a0,-1820 # 6d30 <malloc+0x1ac0>
    3454:	569010ef          	jal	51bc <printf>
    exit(1);
    3458:	4505                	li	a0,1
    ...
    3464:	8f050513          	addi	a0,a0,-1808 # 6d50 <malloc+0x1ae0>
    3468:	555010ef          	jal	51bc <printf>
    exit(1);
    346c:	4505                	li	a0,1
    ...
    3478:	90450513          	addi	a0,a0,-1788 # 6d78 <malloc+0x1b08>
    347c:	541010ef          	jal	51bc <printf>
    exit(1);
    3480:	4505                	li	a0,1
...
0000000000003486 <iref>:
{
    ...
    34a4:	8f0a0a13          	addi	s4,s4,-1808 # 6d90 <malloc+0x1b20>
    mkdir("");
    34a8:	00003497          	auipc	s1,0x3
    34ac:	3f048493          	addi	s1,s1,1008 # 6898 <malloc+0x1628>
    link("README", "");
    34b0:	00002a97          	auipc	s5,0x2
    34b4:	0d0a8a93          	addi	s5,s5,208 # 5580 <malloc+0x310>
    fd = open("xx", O_CREATE);
    34b8:	00003997          	auipc	s3,0x3
    34bc:	7d098993          	addi	s3,s3,2000 # 6c88 <malloc+0x1a18>
    34c0:	a835                	j	34fc <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34c2:	85da                	mv	a1,s6
    34c4:	00004517          	auipc	a0,0x4
    34c8:	8d450513          	addi	a0,a0,-1836 # 6d98 <malloc+0x1b28>
    34cc:	4f1010ef          	jal	51bc <printf>
      exit(1);
    34d0:	4505                	li	a0,1
    ...
    34dc:	8d850513          	addi	a0,a0,-1832 # 6db0 <malloc+0x1b40>
    34e0:	4dd010ef          	jal	51bc <printf>
      exit(1);
    34e4:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3544:	07098993          	addi	s3,s3,112 # 65b0 <malloc+0x1340>
    unlink("irefd");
    3548:	00004917          	auipc	s2,0x4
    354c:	84890913          	addi	s2,s2,-1976 # 6d90 <malloc+0x1b20>
    chdir("..");
    3550:	854e                	mv	a0,s3
    3552:	0b3010ef          	jal	4e04 <chdir>
    unlink("irefd");
    3556:	854a                	mv	a0,s2
    3558:	08d010ef          	jal	4de4 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    355c:	34fd                	addiw	s1,s1,-1
    355e:	f8ed                	bnez	s1,3550 <iref+0xca>
  chdir("/");
    3560:	00003517          	auipc	a0,0x3
    3564:	ff850513          	addi	a0,a0,-8 # 6558 <malloc+0x12e8>
    3568:	09d010ef          	jal	4e04 <chdir>
}
...
0000000000003580 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3590:	83c50513          	addi	a0,a0,-1988 # 6dc8 <malloc+0x1b58>
    3594:	069010ef          	jal	4dfc <mkdir>
  ...
  if(pid == 0){
    ...
    35ac:	82050513          	addi	a0,a0,-2016 # 6dc8 <malloc+0x1b58>
    35b0:	025010ef          	jal	4dd4 <open>
    if(fd >= 0){
    35b4:	04054063          	bltz	a0,35f4 <openiputtest+0x74>
      printf("%s: open directory for write succeeded\n", s);
    35b8:	85a6                	mv	a1,s1
    35ba:	00004517          	auipc	a0,0x4
    35be:	82e50513          	addi	a0,a0,-2002 # 6de8 <malloc+0x1b78>
    35c2:	3fb010ef          	jal	51bc <printf>
      exit(1);
    35c6:	4505                	li	a0,1
    ...
    35d2:	80250513          	addi	a0,a0,-2046 # 6dd0 <malloc+0x1b60>
    35d6:	3e7010ef          	jal	51bc <printf>
    exit(1);
    35da:	4505                	li	a0,1
    ...
    35e6:	65650513          	addi	a0,a0,1622 # 5c38 <malloc+0x9c8>
    35ea:	3d3010ef          	jal	51bc <printf>
    exit(1);
    35ee:	4505                	li	a0,1
  ...
  pause(1);
    35fa:	4505                	li	a0,1
    35fc:	029010ef          	jal	4e24 <pause>
  if(unlink("oidir") != 0){
    3600:	00003517          	auipc	a0,0x3
    3604:	7c850513          	addi	a0,a0,1992 # 6dc8 <malloc+0x1b58>
    3608:	7dc010ef          	jal	4de4 <unlink>
    360c:	c919                	beqz	a0,3622 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    360e:	85a6                	mv	a1,s1
    3610:	00003517          	auipc	a0,0x3
    3614:	81850513          	addi	a0,a0,-2024 # 5e28 <malloc+0xbb8>
    3618:	3a5010ef          	jal	51bc <printf>
    exit(1);
    361c:	4505                	li	a0,1
...
0000000000003632 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3642:	7d250513          	addi	a0,a0,2002 # 6e10 <malloc+0x1ba0>
    3646:	79e010ef          	jal	4de4 <unlink>
  int pid = fork();
  ...
  pause(20); // two seconds
    3654:	4551                	li	a0,20
    3656:	7ce010ef          	jal	4e24 <pause>
  close(open("stopforking", O_CREATE|O_RDWR));
    365a:	20200593          	li	a1,514
    365e:	00003517          	auipc	a0,0x3
    3662:	7b250513          	addi	a0,a0,1970 # 6e10 <malloc+0x1ba0>
    3666:	76e010ef          	jal	4dd4 <open>
  ...
  pause(10); // one second
    ...
    368a:	77250513          	addi	a0,a0,1906 # 5df8 <malloc+0xb88>
    368e:	32f010ef          	jal	51bc <printf>
    exit(1);
    3692:	4505                	li	a0,1
    3694:	6e0010ef          	jal	4d74 <exit>
      int fd = open("stopforking", 0);
    3698:	00003497          	auipc	s1,0x3
    369c:	77848493          	addi	s1,s1,1912 # 6e10 <malloc+0x1ba0>
    36a0:	4581                	li	a1,0
    36a2:	8526                	mv	a0,s1
    36a4:	730010ef          	jal	4dd4 <open>
      if(fd >= 0){
    ...
    36bc:	75850513          	addi	a0,a0,1880 # 6e10 <malloc+0x1ba0>
    36c0:	714010ef          	jal	4dd4 <open>
...
00000000000036d0 <killstatus>:
{
    ...
    pause(1);
    36f4:	4505                	li	a0,1
    36f6:	72e010ef          	jal	4e24 <pause>
    kill(pid1);
    36fa:	8526                	mv	a0,s1
    36fc:	6c8010ef          	jal	4dc4 <kill>
    wait(&xst);
  ...
  exit(0);
    ...
    3722:	51a50513          	addi	a0,a0,1306 # 5c38 <malloc+0x9c8>
    3726:	297010ef          	jal	51bc <printf>
      exit(1);
    372a:	4505                	li	a0,1
    372c:	648010ef          	jal	4d74 <exit>
        getpid();
    3730:	6e4010ef          	jal	4e14 <getpid>
      while(1) {
    3734:	bff5                	j	3730 <killstatus+0x60>
       printf("%s: status should be -1\n", s);
    3736:	85d2                	mv	a1,s4
    3738:	00003517          	auipc	a0,0x3
    373c:	6e850513          	addi	a0,a0,1768 # 6e20 <malloc+0x1bb0>
    3740:	27d010ef          	jal	51bc <printf>
       exit(1);
    3744:	4505                	li	a0,1
...
000000000000374a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3770:	68c50513          	addi	a0,a0,1676 # 5df8 <malloc+0xb88>
    3774:	249010ef          	jal	51bc <printf>
    exit(1);
    3778:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3792:	4aa50513          	addi	a0,a0,1194 # 5c38 <malloc+0x9c8>
    3796:	227010ef          	jal	51bc <printf>
    exit(1);
    379a:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    37c2:	c5a58593          	addi	a1,a1,-934 # 5418 <malloc+0x1a8>
    ...
    37e4:	45850513          	addi	a0,a0,1112 # 5c38 <malloc+0x9c8>
    37e8:	1d5010ef          	jal	51bc <printf>
     exit(1);
    37ec:	4505                	li	a0,1
    ...
    37f8:	64c50513          	addi	a0,a0,1612 # 6e40 <malloc+0x1bd0>
    37fc:	1c1010ef          	jal	51bc <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3828:	63450513          	addi	a0,a0,1588 # 6e58 <malloc+0x1be8>
    382c:	191010ef          	jal	51bc <printf>
}
  ...
  printf("kill... ");
    ...
    384c:	62850513          	addi	a0,a0,1576 # 6e70 <malloc+0x1c00>
    3850:	16d010ef          	jal	51bc <printf>
  kill(pid1);
    3854:	8526                	mv	a0,s1
    3856:	56e010ef          	jal	4dc4 <kill>
  kill(pid2);
    385a:	854e                	mv	a0,s3
    385c:	568010ef          	jal	4dc4 <kill>
  kill(pid3);
    3860:	8552                	mv	a0,s4
    3862:	562010ef          	jal	4dc4 <kill>
  printf("wait... ");
    3866:	00003517          	auipc	a0,0x3
    386a:	61a50513          	addi	a0,a0,1562 # 6e80 <malloc+0x1c10>
    386e:	14f010ef          	jal	51bc <printf>
  wait(0);
    3872:	4501                	li	a0,0
...
0000000000003886 <reparent>:
{
  ...
  exit(0);
    ...
    38ca:	37250513          	addi	a0,a0,882 # 5c38 <malloc+0x9c8>
    38ce:	0ef010ef          	jal	51bc <printf>
      exit(1);
    38d2:	4505                	li	a0,1
    ...
    38de:	4e650513          	addi	a0,a0,1254 # 5dc0 <malloc+0xb50>
    38e2:	0db010ef          	jal	51bc <printf>
        exit(1);
    38e6:	4505                	li	a0,1
...
0000000000003906 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3942:	40250513          	addi	a0,a0,1026 # 5d40 <malloc+0xad0>
    3946:	077010ef          	jal	51bc <printf>
    exit(1);
    394a:	4505                	li	a0,1
  ...
  c = sbrk(PGSIZE);
    ...
    39da:	4c250513          	addi	a0,a0,1218 # 6e98 <malloc+0x1c28>
    39de:	7de010ef          	jal	51bc <printf>
  ...
  if(pid == 0){
    ...
    3a24:	4c850513          	addi	a0,a0,1224 # 6ee8 <malloc+0x1c78>
    3a28:	794010ef          	jal	51bc <printf>
    exit(1);
    3a2c:	4505                	li	a0,1
    ...
    3a38:	49450513          	addi	a0,a0,1172 # 6ec8 <malloc+0x1c58>
    3a3c:	780010ef          	jal	51bc <printf>
    exit(1);
    3a40:	4505                	li	a0,1
    ...
    3a4c:	1f050513          	addi	a0,a0,496 # 5c38 <malloc+0x9c8>
    3a50:	76c010ef          	jal	51bc <printf>
    exit(1);
    3a54:	4505                	li	a0,1
...
0000000000003a8a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3ace:	6084                	ld	s1,0(s1)
      free(m1);
    3ad0:	71e010ef          	jal	51ee <free>
    while(m1){
    3ad4:	fce5                	bnez	s1,3acc <mem+0x42>
    m1 = malloc(1024*20);
    3ad6:	6515                	lui	a0,0x5
    3ad8:	798010ef          	jal	5270 <malloc>
    if(m1 == 0){
    3adc:	c511                	beqz	a0,3ae8 <mem+0x5e>
    free(m1);
    3ade:	710010ef          	jal	51ee <free>
    exit(0);
    3ae2:	4501                	li	a0,0
    ...
    3aee:	42e50513          	addi	a0,a0,1070 # 6f18 <malloc+0x1ca8>
    3af2:	6ca010ef          	jal	51bc <printf>
      exit(1);
    3af6:	4505                	li	a0,1
...
0000000000003b02 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b12:	42a50513          	addi	a0,a0,1066 # 6f38 <malloc+0x1cc8>
    3b16:	2ce010ef          	jal	4de4 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b1a:	20200593          	li	a1,514
    3b1e:	00003517          	auipc	a0,0x3
    3b22:	41a50513          	addi	a0,a0,1050 # 6f38 <malloc+0x1cc8>
    3b26:	2ae010ef          	jal	4dd4 <open>
  if(fd < 0){
  ...
  if(pid == 0) {
    ...
    3b8c:	3c050513          	addi	a0,a0,960 # 6f48 <malloc+0x1cd8>
    3b90:	62c010ef          	jal	51bc <printf>
    exit(1);
    3b94:	4505                	li	a0,1
    ...
    3ba0:	3d450513          	addi	a0,a0,980 # 6f70 <malloc+0x1d00>
    3ba4:	618010ef          	jal	51bc <printf>
      exit(1);
    3ba8:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3bd0:	36c50513          	addi	a0,a0,876 # 6f38 <malloc+0x1cc8>
    3bd4:	200010ef          	jal	4dd4 <open>
    3bd8:	8baa                	mv	s7,a0
  nc = np = 0;
    3bda:	8ace                	mv	s5,s3
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3c08:	38c50513          	addi	a0,a0,908 # 6f90 <malloc+0x1d20>
    3c0c:	5b0010ef          	jal	51bc <printf>
    exit(1);
    3c10:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3c38:	30450513          	addi	a0,a0,772 # 6f38 <malloc+0x1cc8>
    3c3c:	1a8010ef          	jal	4de4 <unlink>
  if(nc == N*SZ && np == N*SZ){
    ...
    3c5a:	36250513          	addi	a0,a0,866 # 6fb8 <malloc+0x1d48>
    3c5e:	55e010ef          	jal	51bc <printf>
    exit(1);
    3c62:	4505                	li	a0,1
...
0000000000003c6e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c92:	34278793          	addi	a5,a5,834 # 6fd0 <malloc+0x1d60>
    3c96:	f6f43823          	sd	a5,-144(s0)
    3c9a:	00003797          	auipc	a5,0x3
    3c9e:	33e78793          	addi	a5,a5,830 # 6fd8 <malloc+0x1d68>
    3ca2:	f6f43c23          	sd	a5,-136(s0)
    3ca6:	00003797          	auipc	a5,0x3
    3caa:	33a78793          	addi	a5,a5,826 # 6fe0 <malloc+0x1d70>
    3cae:	f8f43023          	sd	a5,-128(s0)
    3cb2:	00003797          	auipc	a5,0x3
    3cb6:	33678793          	addi	a5,a5,822 # 6fe8 <malloc+0x1d78>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d18:	f2450513          	addi	a0,a0,-220 # 5c38 <malloc+0x9c8>
    3d1c:	4a0010ef          	jal	51bc <printf>
      exit(1);
    3d20:	4505                	li	a0,1
    ...
    3d7a:	f5a50513          	addi	a0,a0,-166 # 5cd0 <malloc+0xa60>
    3d7e:	43e010ef          	jal	51bc <printf>
        exit(1);
    3d82:	4505                	li	a0,1
    3d84:	7f1000ef          	jal	4d74 <exit>
          printf("write failed %d\n", n);
    3d88:	00003517          	auipc	a0,0x3
    3d8c:	26850513          	addi	a0,a0,616 # 6ff0 <malloc+0x1d80>
    3d90:	42c010ef          	jal	51bc <printf>
          exit(1);
    3d94:	4505                	li	a0,1
    ...
    3da6:	26650513          	addi	a0,a0,614 # 7008 <malloc+0x1d98>
    3daa:	412010ef          	jal	51bc <printf>
          exit(1);
    3dae:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e16:	20650513          	addi	a0,a0,518 # 7018 <malloc+0x1da8>
    3e1a:	3a2010ef          	jal	51bc <printf>
      exit(1);
    3e1e:	4505                	li	a0,1
...
0000000000003e42 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e70:	1c4b8b93          	addi	s7,s7,452 # 7030 <malloc+0x1dc0>
  for(i = 0; i < N; i++){
    ...
    3e9a:	73b000ef          	jal	4dd4 <open>
      if(fd < 0){
    3e9e:	1e055063          	bgez	a0,407e <concreate+0x23c>
        printf("concreate create %s failed\n", file);
    3ea2:	fa840593          	addi	a1,s0,-88
    3ea6:	00003517          	auipc	a0,0x3
    3eaa:	19250513          	addi	a0,a0,402 # 7038 <malloc+0x1dc8>
    3eae:	30e010ef          	jal	51bc <printf>
        exit(1);
    3eb2:	4505                	li	a0,1
    ...
    3ec0:	17450513          	addi	a0,a0,372 # 7030 <malloc+0x1dc0>
    3ec4:	731000ef          	jal	4df4 <link>
      exit(0);
    3ec8:	4501                	li	a0,0
  ...
  fd = open(".", 0);
    ...
    3ee8:	bac50513          	addi	a0,a0,-1108 # 5a90 <malloc+0x820>
    3eec:	6e9000ef          	jal	4dd4 <open>
    3ef0:	892a                	mv	s2,a0
  n = 0;
    3ef2:	8aa6                	mv	s5,s1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f58:	10450513          	addi	a0,a0,260 # 7058 <malloc+0x1de8>
    3f5c:	260010ef          	jal	51bc <printf>
        exit(1);
    3f60:	4505                	li	a0,1
    ...
    3f70:	10c50513          	addi	a0,a0,268 # 7078 <malloc+0x1e08>
    3f74:	248010ef          	jal	51bc <printf>
        exit(1);
    3f78:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    3f9c:	10850513          	addi	a0,a0,264 # 70a0 <malloc+0x1e30>
    3fa0:	21c010ef          	jal	51bc <printf>
    exit(1);
    3fa4:	4505                	li	a0,1
    ...
    3fb0:	c8c50513          	addi	a0,a0,-884 # 5c38 <malloc+0x9c8>
    3fb4:	208010ef          	jal	51bc <printf>
      exit(1);
    3fb8:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    404a:	59b000ef          	jal	4de4 <unlink>
      unlink(file);
    404e:	fa840513          	addi	a0,s0,-88
    4052:	593000ef          	jal	4de4 <unlink>
      unlink(file);
    4056:	fa840513          	addi	a0,s0,-88
    405a:	58b000ef          	jal	4de4 <unlink>
      unlink(file);
    405e:	fa840513          	addi	a0,s0,-88
    4062:	583000ef          	jal	4de4 <unlink>
      unlink(file);
    4066:	fa840513          	addi	a0,s0,-88
    406a:	57b000ef          	jal	4de4 <unlink>
      unlink(file);
    406e:	fa840513          	addi	a0,s0,-88
    4072:	573000ef          	jal	4de4 <unlink>
...
00000000000040e6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40fe:	fde50513          	addi	a0,a0,-34 # 70d8 <malloc+0x1e68>
    4102:	4e3000ef          	jal	4de4 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    4106:	20200593          	li	a1,514
    410a:	00003517          	auipc	a0,0x3
    410e:	fce50513          	addi	a0,a0,-50 # 70d8 <malloc+0x1e68>
    4112:	4c3000ef          	jal	4dd4 <open>
    4116:	89aa                	mv	s3,a0
  for(i = 0; i < N; i++){
    4118:	4481                	li	s1,0
    memset(buf, i, SZ);
  ...
  fd = open("bigfile.dat", 0);
    ...
    415a:	f8250513          	addi	a0,a0,-126 # 70d8 <malloc+0x1e68>
    415e:	477000ef          	jal	4dd4 <open>
    4162:	8a2a                	mv	s4,a0
  total = 0;
    4164:	4981                	li	s3,0
  for(i = 0; ; i++){
  ...
  for(i = 0; ; i++){
    ...
    41b6:	f3650513          	addi	a0,a0,-202 # 70e8 <malloc+0x1e78>
    41ba:	002010ef          	jal	51bc <printf>
    exit(1);
    41be:	4505                	li	a0,1
    ...
    41ca:	f4250513          	addi	a0,a0,-190 # 7108 <malloc+0x1e98>
    41ce:	7ef000ef          	jal	51bc <printf>
      exit(1);
    41d2:	4505                	li	a0,1
    ...
    41de:	f4e50513          	addi	a0,a0,-178 # 7128 <malloc+0x1eb8>
    41e2:	7db000ef          	jal	51bc <printf>
    exit(1);
    41e6:	4505                	li	a0,1
    ...
    41f2:	f5a50513          	addi	a0,a0,-166 # 7148 <malloc+0x1ed8>
    41f6:	7c7000ef          	jal	51bc <printf>
      exit(1);
    41fa:	4505                	li	a0,1
    ...
    4206:	f6650513          	addi	a0,a0,-154 # 7168 <malloc+0x1ef8>
    420a:	7b3000ef          	jal	51bc <printf>
      exit(1);
    420e:	4505                	li	a0,1
    ...
    421a:	f6a50513          	addi	a0,a0,-150 # 7180 <malloc+0x1f10>
    421e:	79f000ef          	jal	51bc <printf>
      exit(1);
    4222:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    423c:	ea050513          	addi	a0,a0,-352 # 70d8 <malloc+0x1e68>
    4240:	3a5000ef          	jal	4de4 <unlink>
}
    ...
    425c:	f4850513          	addi	a0,a0,-184 # 71a0 <malloc+0x1f30>
    4260:	75d000ef          	jal	51bc <printf>
    exit(1);
    4264:	4505                	li	a0,1
...
000000000000426a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    427a:	f4a50513          	addi	a0,a0,-182 # 71c0 <malloc+0x1f50>
    427e:	367000ef          	jal	4de4 <unlink>
  pid = fork();
  ...
  fd = open("bigarg-ok", 0);
    ...
    42a0:	f2450513          	addi	a0,a0,-220 # 71c0 <malloc+0x1f50>
    42a4:	331000ef          	jal	4dd4 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    42fa:	0b250513          	addi	a0,a0,178 # 53a8 <malloc+0x138>
    42fe:	2cf000ef          	jal	4dcc <exec>
    fd = open("bigarg-ok", O_CREATE);
    4302:	20000593          	li	a1,512
    4306:	00003517          	auipc	a0,0x3
    430a:	eba50513          	addi	a0,a0,-326 # 71c0 <malloc+0x1f50>
    430e:	2c7000ef          	jal	4dd4 <open>
    close(fd);
    ...
    4322:	eb250513          	addi	a0,a0,-334 # 71d0 <malloc+0x1f60>
    4326:	697000ef          	jal	51bc <printf>
    exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	eba50513          	addi	a0,a0,-326 # 71f0 <malloc+0x1f80>
    433e:	67f000ef          	jal	51bc <printf>
    exit(1);
    4342:	4505                	li	a0,1
...
0000000000004348 <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4392:	e8250513          	addi	a0,a0,-382 # 7210 <malloc+0x1fa0>
    4396:	627000ef          	jal	51bc <printf>
    exit(1);
    439a:	4505                	li	a0,1
    439c:	1d9000ef          	jal	4d74 <exit>
      printf("failed to read value from memory\n");
    43a0:	00003517          	auipc	a0,0x3
    43a4:	e8850513          	addi	a0,a0,-376 # 7228 <malloc+0x1fb8>
    43a8:	615000ef          	jal	51bc <printf>
      exit(1);
    43ac:	4505                	li	a0,1
...
00000000000043b2 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    441a:	dfa50513          	addi	a0,a0,-518 # 7210 <malloc+0x1fa0>
    441e:	59f000ef          	jal	51bc <printf>
    exit(1);
    4422:	4505                	li	a0,1
    4424:	151000ef          	jal	4d74 <exit>
      printf("error forking\n");
    4428:	00003517          	auipc	a0,0x3
    442c:	e2850513          	addi	a0,a0,-472 # 7250 <malloc+0x1fe0>
    4430:	58d000ef          	jal	51bc <printf>
      exit(1);
    4434:	4505                	li	a0,1
    ...
    4450:	e1450513          	addi	a0,a0,-492 # 7260 <malloc+0x1ff0>
    4454:	569000ef          	jal	51bc <printf>
        exit(1);
    4458:	4505                	li	a0,1
...
000000000000445e <lazy_copy>:
{
    ...
    44a6:	dd650513          	addi	a0,a0,-554 # 7278 <malloc+0x2008>
    44aa:	513000ef          	jal	51bc <printf>
      exit(1);
    44ae:	4505                	li	a0,1
    44b0:	0c5000ef          	jal	4d74 <exit>
  unsigned long bad[] = {
    44b4:	00003797          	auipc	a5,0x3
    44b8:	43c78793          	addi	a5,a5,1084 # 78f0 <malloc+0x2680>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    44ec:	098a0a13          	addi	s4,s4,152 # 5580 <malloc+0x310>
    fd = open("junk", O_CREATE|O_RDWR|O_TRUNC);
    44f0:	00001a97          	auipc	s5,0x1
    44f4:	fa0a8a93          	addi	s5,s5,-96 # 5490 <malloc+0x220>
    int fd = open("README", 0);
    44f8:	4581                	li	a1,0
    44fa:	8552                	mv	a0,s4
    44fc:	0d9000ef          	jal	4dd4 <open>
    4500:	84aa                	mv	s1,a0
  ...
  exit(0);
    ...
    4552:	d5a50513          	addi	a0,a0,-678 # 72a8 <malloc+0x2038>
    4556:	467000ef          	jal	51bc <printf>
    455a:	4505                	li	a0,1
    455c:	019000ef          	jal	4d74 <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    4560:	00003517          	auipc	a0,0x3
    4564:	d6050513          	addi	a0,a0,-672 # 72c0 <malloc+0x2050>
    4568:	455000ef          	jal	51bc <printf>
    456c:	4505                	li	a0,1
    456e:	007000ef          	jal	4d74 <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    4572:	00003517          	auipc	a0,0x3
    4576:	d5e50513          	addi	a0,a0,-674 # 72d0 <malloc+0x2060>
    457a:	443000ef          	jal	51bc <printf>
    457e:	4505                	li	a0,1
    4580:	7f4000ef          	jal	4d74 <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    4584:	00003517          	auipc	a0,0x3
    4588:	d6450513          	addi	a0,a0,-668 # 72e8 <malloc+0x2078>
    458c:	431000ef          	jal	51bc <printf>
    4590:	4505                	li	a0,1
...
0000000000004596 <lazy_sbrk>:
{
  ...
  if (p1 < 0 || p1 != p) {
    ...
    45e4:	d2050513          	addi	a0,a0,-736 # 7300 <malloc+0x2090>
    45e8:	3d5000ef          	jal	51bc <printf>
    exit(1);
    45ec:	4505                	li	a0,1
  ...
  if (p < 0 || (uint64)p != TRAPFRAME-PGSIZE) {
    ...
    460c:	d2850513          	addi	a0,a0,-728 # 7330 <malloc+0x20c0>
    4610:	3ad000ef          	jal	51bc <printf>
    exit(1);
    4614:	4505                	li	a0,1
  ...
  if (p[1] != 0) {
    ...
    4632:	d3a50513          	addi	a0,a0,-710 # 7368 <malloc+0x20f8>
    4636:	387000ef          	jal	51bc <printf>
    exit(1);
    463a:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4652:	d4250513          	addi	a0,a0,-702 # 7390 <malloc+0x2120>
    4656:	367000ef          	jal	51bc <printf>
    exit(1);
    465a:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4672:	d4a50513          	addi	a0,a0,-694 # 73b8 <malloc+0x2148>
    4676:	347000ef          	jal	51bc <printf>
    exit(1);
    467a:	4505                	li	a0,1
...
0000000000004686 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    46a6:	d4650513          	addi	a0,a0,-698 # 73e8 <malloc+0x2178>
    46aa:	313000ef          	jal	51bc <printf>
  for(nfiles = 0; ; nfiles++){
    46ae:	4481                	li	s1,0
    name[0] = 'f';
    ...
    46c2:	d3ac8c93          	addi	s9,s9,-710 # 73f8 <malloc+0x2188>
    name[0] = 'f';
    ...
    470a:	8566                	mv	a0,s9
    470c:	2b1000ef          	jal	51bc <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    4710:	20200593          	li	a1,514
    4714:	f6040513          	addi	a0,s0,-160
    4718:	6bc000ef          	jal	4dd4 <open>
    471c:	892a                	mv	s2,a0
    if(fd < 0){
    ...
    472a:	ce250513          	addi	a0,a0,-798 # 7408 <malloc+0x2198>
    472e:	28f000ef          	jal	51bc <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4798:	c9450513          	addi	a0,a0,-876 # 7428 <malloc+0x21b8>
    479c:	221000ef          	jal	51bc <printf>
}
    ...
    47e6:	c3650513          	addi	a0,a0,-970 # 7418 <malloc+0x21a8>
    47ea:	1d3000ef          	jal	51bc <printf>
    close(fd);
    47ee:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4810:	c3450513          	addi	a0,a0,-972 # 7440 <malloc+0x21d0>
    4814:	1a9000ef          	jal	51bc <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4834:	c3850513          	addi	a0,a0,-968 # 7468 <malloc+0x21f8>
    4838:	185000ef          	jal	51bc <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4854:	c0050513          	addi	a0,a0,-1024 # 7450 <malloc+0x21e0>
    4858:	165000ef          	jal	51bc <printf>
    exit(1);
    485c:	4505                	li	a0,1
    ...
    4870:	c0450513          	addi	a0,a0,-1020 # 7470 <malloc+0x2200>
    4874:	149000ef          	jal	51bc <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    48c2:	bba50513          	addi	a0,a0,-1094 # 7478 <malloc+0x2208>
    48c6:	0f7000ef          	jal	51bc <printf>
          return -1;
    48ca:	59fd                	li	s3,-1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    495a:	b3ac0c13          	addi	s8,s8,-1222 # 7490 <malloc+0x2220>
    int free0 = countfree();
    int free1 = 0;
    int ntests = 0;
    int n;
    ...
    4974:	b38d8d93          	addi	s11,s11,-1224 # 74a8 <malloc+0x2238>
      } else {
        ntests += n;
      }
    }
    ...
    497c:	b50d0d13          	addi	s10,s10,-1200 # 74c8 <malloc+0x2258>
    ...
    49f6:	b0650513          	addi	a0,a0,-1274 # 74f8 <malloc+0x2288>
    49fa:	7c2000ef          	jal	51bc <printf>
      return 1;
    49fe:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4a60:	ab458593          	addi	a1,a1,-1356 # 7510 <malloc+0x22a0>
  ...
  int continuous = 0;
    ...
    4ab4:	a7050513          	addi	a0,a0,-1424 # 7520 <malloc+0x22b0>
    4ab8:	704000ef          	jal	51bc <printf>
    exit(1);
    4abc:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4ad2:	a8250513          	addi	a0,a0,-1406 # 7550 <malloc+0x22e0>
    4ad6:	6e6000ef          	jal	51bc <printf>
  exit(0);
    4ada:	4501                	li	a0,0
...
sbrk(int n) {
  ...
  return sys_sbrk(n, SBRK_EAGER);
    4d48:	4585                	li	a1,1
    4d4a:	0d2000ef          	jal	4e1c <sys_sbrk>
}
...
sbrklazy(int n) {
  ...
  return sys_sbrk(n, SBRK_LAZY);
    4d5e:	4589                	li	a1,2
    4d60:	0bc000ef          	jal	4e1c <sys_sbrk>
}
...
putc(int fd, char c)
{
    ...
    4e36:	ec06                	sd	ra,24(sp)
    4e38:	e822                	sd	s0,16(sp)
    4e3a:	1000                	addi	s0,sp,32
    4e3c:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4e40:	4605                	li	a2,1
    4e42:	fef40593          	addi	a1,s0,-17
    4e46:	f4fff0ef          	jal	4d94 <write>
}
    4e4a:	60e2                	ld	ra,24(sp)
    4e4c:	6442                	ld	s0,16(sp)
    4e4e:	6105                	addi	sp,sp,32
    4e50:	8082                	ret

0000000000004e52 <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
    4e52:	715d                	addi	sp,sp,-80
    4e54:	e486                	sd	ra,72(sp)
    4e56:	e0a2                	sd	s0,64(sp)
    4e58:	f84a                	sd	s2,48(sp)
    4e5a:	0880                	addi	s0,sp,80
    4e5c:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4e5e:	c299                	beqz	a3,4e64 <printint+0x12>
    4e60:	0805c363          	bltz	a1,4ee6 <printint+0x94>
  neg = 0;
    4e64:	4881                	li	a7,0
    4e66:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    ...
    4e70:	b2c50513          	addi	a0,a0,-1236 # 7998 <digits>
    4e74:	883e                	mv	a6,a5
    4e76:	2785                	addiw	a5,a5,1
    4e78:	02c5f733          	remu	a4,a1,a2
    4e7c:	972a                	add	a4,a4,a0
    4e7e:	00074703          	lbu	a4,0(a4)
    4e82:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
    4e86:	872e                	mv	a4,a1
    4e88:	02c5d5b3          	divu	a1,a1,a2
    4e8c:	0685                	addi	a3,a3,1
    4e8e:	fec773e3          	bgeu	a4,a2,4e74 <printint+0x22>
  if(neg)
    4e92:	00088b63          	beqz	a7,4ea8 <printint+0x56>
    buf[i++] = '-';
    4e96:	fd078793          	addi	a5,a5,-48
    4e9a:	97a2                	add	a5,a5,s0
    4e9c:	02d00713          	li	a4,45
    4ea0:	fee78423          	sb	a4,-24(a5)
    4ea4:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
    4ea8:	02f05a63          	blez	a5,4edc <printint+0x8a>
    4eac:	fc26                	sd	s1,56(sp)
    4eae:	f44e                	sd	s3,40(sp)
    4eb0:	fb840713          	addi	a4,s0,-72
    4eb4:	00f704b3          	add	s1,a4,a5
    4eb8:	fff70993          	addi	s3,a4,-1
    4ebc:	99be                	add	s3,s3,a5
    4ebe:	37fd                	addiw	a5,a5,-1
    4ec0:	1782                	slli	a5,a5,0x20
    4ec2:	9381                	srli	a5,a5,0x20
    4ec4:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
    4ec8:	fff4c583          	lbu	a1,-1(s1)
    4ecc:	854a                	mv	a0,s2
    4ece:	f67ff0ef          	jal	4e34 <putc>
  while(--i >= 0)
    4ed2:	14fd                	addi	s1,s1,-1
    4ed4:	ff349ae3          	bne	s1,s3,4ec8 <printint+0x76>
    4ed8:	74e2                	ld	s1,56(sp)
    4eda:	79a2                	ld	s3,40(sp)
}
    4edc:	60a6                	ld	ra,72(sp)
    4ede:	6406                	ld	s0,64(sp)
    4ee0:	7942                	ld	s2,48(sp)
    4ee2:	6161                	addi	sp,sp,80
    4ee4:	8082                	ret
    x = -xx;
    4ee6:	40b005b3          	neg	a1,a1
    neg = 1;
    4eea:	4885                	li	a7,1
    x = -xx;
    4eec:	bfad                	j	4e66 <printint+0x14>

0000000000004eee <vprintf>:
}
...
{
    4eee:	711d                	addi	sp,sp,-96
    4ef0:	ec86                	sd	ra,88(sp)
    4ef2:	e8a2                	sd	s0,80(sp)
    4ef4:	e0ca                	sd	s2,64(sp)
    4ef6:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4ef8:	0005c903          	lbu	s2,0(a1)
    4efc:	28090663          	beqz	s2,5188 <vprintf+0x29a>
    4f00:	e4a6                	sd	s1,72(sp)
    4f02:	fc4e                	sd	s3,56(sp)
    4f04:	f852                	sd	s4,48(sp)
    4f06:	f456                	sd	s5,40(sp)
    4f08:	f05a                	sd	s6,32(sp)
    4f0a:	ec5e                	sd	s7,24(sp)
    4f0c:	e862                	sd	s8,16(sp)
    4f0e:	e466                	sd	s9,8(sp)
    4f10:	8b2a                	mv	s6,a0
    4f12:	8a2e                	mv	s4,a1
    4f14:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4f1c:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4f20:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4f24:	06c00c93          	li	s9,108
    4f28:	a005                	j	4f48 <vprintf+0x5a>
        putc(fd, c0);
    4f2a:	85ca                	mv	a1,s2
    4f2c:	855a                	mv	a0,s6
    4f2e:	f07ff0ef          	jal	4e34 <putc>
    4f32:	a019                	j	4f38 <vprintf+0x4a>
    } else if(state == '%'){
    4f34:	03598263          	beq	s3,s5,4f58 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
    4f38:	2485                	addiw	s1,s1,1
    4f3a:	8726                	mv	a4,s1
    4f3c:	009a07b3          	add	a5,s4,s1
    4f40:	0007c903          	lbu	s2,0(a5)
    4f44:	22090a63          	beqz	s2,5178 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
    4f48:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4f4c:	fe0994e3          	bnez	s3,4f34 <vprintf+0x46>
      if(c0 == '%'){
    4f50:	fd579de3          	bne	a5,s5,4f2a <vprintf+0x3c>
        state = '%';
    4f54:	89be                	mv	s3,a5
    4f56:	b7cd                	j	4f38 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4f58:	00ea06b3          	add	a3,s4,a4
    4f5c:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4f60:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4f62:	c681                	beqz	a3,4f6a <vprintf+0x7c>
    4f64:	9752                	add	a4,a4,s4
    4f66:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4f6a:	05878363          	beq	a5,s8,4fb0 <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
    4f6e:	05978d63          	beq	a5,s9,4fc8 <vprintf+0xda>
    ...
    4f72:	07500713          	li	a4,117
    4f76:	0ee78763          	beq	a5,a4,5064 <vprintf+0x176>
    ...
    4f7a:	07800713          	li	a4,120
    4f7e:	12e78963          	beq	a5,a4,50b0 <vprintf+0x1c2>
    ...
    4f82:	07000713          	li	a4,112
    4f86:	14e78e63          	beq	a5,a4,50e2 <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
    4f8a:	06300713          	li	a4,99
    4f8e:	18e78e63          	beq	a5,a4,512a <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
    4f92:	07300713          	li	a4,115
    4f96:	1ae78463          	beq	a5,a4,513e <vprintf+0x250>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4f9a:	02500713          	li	a4,37
    4f9e:	04e79563          	bne	a5,a4,4fe8 <vprintf+0xfa>
        putc(fd, '%');
    4fa2:	02500593          	li	a1,37
    4fa6:	855a                	mv	a0,s6
    4fa8:	e8dff0ef          	jal	4e34 <putc>
      ...
      state = 0;
    4fac:	4981                	li	s3,0
    4fae:	b769                	j	4f38 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
    4fb0:	008b8913          	addi	s2,s7,8
    4fb4:	4685                	li	a3,1
    4fb6:	4629                	li	a2,10
    4fb8:	000ba583          	lw	a1,0(s7)
    4fbc:	855a                	mv	a0,s6
    4fbe:	e95ff0ef          	jal	4e52 <printint>
    4fc2:	8bca                	mv	s7,s2
      state = 0;
    4fc4:	4981                	li	s3,0
    4fc6:	bf8d                	j	4f38 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    4fc8:	06400793          	li	a5,100
    4fcc:	02f68963          	beq	a3,a5,4ffe <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4fd0:	06c00793          	li	a5,108
    4fd4:	04f68263          	beq	a3,a5,5018 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
    4fd8:	07500793          	li	a5,117
    4fdc:	0af68063          	beq	a3,a5,507c <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
    4fe0:	07800793          	li	a5,120
    4fe4:	0ef68263          	beq	a3,a5,50c8 <vprintf+0x1da>
        putc(fd, '%');
    4fe8:	02500593          	li	a1,37
    4fec:	855a                	mv	a0,s6
    4fee:	e47ff0ef          	jal	4e34 <putc>
        putc(fd, c0);
    4ff2:	85ca                	mv	a1,s2
    4ff4:	855a                	mv	a0,s6
    4ff6:	e3fff0ef          	jal	4e34 <putc>
      state = 0;
    4ffa:	4981                	li	s3,0
    4ffc:	bf35                	j	4f38 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4ffe:	008b8913          	addi	s2,s7,8
    5002:	4685                	li	a3,1
    5004:	4629                	li	a2,10
    5006:	000bb583          	ld	a1,0(s7)
    500a:	855a                	mv	a0,s6
    500c:	e47ff0ef          	jal	4e52 <printint>
        i += 1;
    5010:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    5012:	8bca                	mv	s7,s2
      state = 0;
    5014:	4981                	li	s3,0
        i += 1;
    5016:	b70d                	j	4f38 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    5018:	06400793          	li	a5,100
    501c:	02f60763          	beq	a2,a5,504a <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    5020:	07500793          	li	a5,117
    5024:	06f60963          	beq	a2,a5,5096 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    5028:	07800793          	li	a5,120
    502c:	faf61ee3          	bne	a2,a5,4fe8 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    503c:	855a                	mv	a0,s6
    503e:	e15ff0ef          	jal	4e52 <printint>
        i += 2;
    ...
    5046:	4981                	li	s3,0
        i += 2;
    5048:	bdc5                	j	4f38 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    504a:	008b8913          	addi	s2,s7,8
    504e:	4685                	li	a3,1
    5050:	4629                	li	a2,10
    5052:	000bb583          	ld	a1,0(s7)
    5056:	855a                	mv	a0,s6
    5058:	dfbff0ef          	jal	4e52 <printint>
        i += 2;
    505c:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    505e:	8bca                	mv	s7,s2
      state = 0;
    5060:	4981                	li	s3,0
        i += 2;
    5062:	bdd9                	j	4f38 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 10, 0);
    5064:	008b8913          	addi	s2,s7,8
    5068:	4681                	li	a3,0
    506a:	4629                	li	a2,10
    506c:	000be583          	lwu	a1,0(s7)
    5070:	855a                	mv	a0,s6
    5072:	de1ff0ef          	jal	4e52 <printint>
    5076:	8bca                	mv	s7,s2
      state = 0;
    5078:	4981                	li	s3,0
    507a:	bd7d                	j	4f38 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    507c:	008b8913          	addi	s2,s7,8
    5080:	4681                	li	a3,0
    5082:	4629                	li	a2,10
    5084:	000bb583          	ld	a1,0(s7)
    5088:	855a                	mv	a0,s6
    508a:	dc9ff0ef          	jal	4e52 <printint>
        i += 1;
    508e:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 0);
    5090:	8bca                	mv	s7,s2
      state = 0;
    5092:	4981                	li	s3,0
        i += 1;
    5094:	b555                	j	4f38 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5096:	008b8913          	addi	s2,s7,8
    509a:	4681                	li	a3,0
    509c:	4629                	li	a2,10
    509e:	000bb583          	ld	a1,0(s7)
    50a2:	855a                	mv	a0,s6
    50a4:	dafff0ef          	jal	4e52 <printint>
        i += 2;
    50a8:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    50aa:	8bca                	mv	s7,s2
      state = 0;
    50ac:	4981                	li	s3,0
        i += 2;
    50ae:	b569                	j	4f38 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
    50b0:	008b8913          	addi	s2,s7,8
    50b4:	4681                	li	a3,0
    50b6:	4641                	li	a2,16
    50b8:	000be583          	lwu	a1,0(s7)
    50bc:	855a                	mv	a0,s6
    50be:	d95ff0ef          	jal	4e52 <printint>
    50c2:	8bca                	mv	s7,s2
      state = 0;
    50c4:	4981                	li	s3,0
    50c6:	bd8d                	j	4f38 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    50c8:	008b8913          	addi	s2,s7,8
    50cc:	4681                	li	a3,0
    50ce:	4641                	li	a2,16
    50d0:	000bb583          	ld	a1,0(s7)
    50d4:	855a                	mv	a0,s6
    50d6:	d7dff0ef          	jal	4e52 <printint>
        i += 1;
    50da:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 16, 0);
    50dc:	8bca                	mv	s7,s2
      state = 0;
    50de:	4981                	li	s3,0
        i += 1;
    50e0:	bda1                	j	4f38 <vprintf+0x4a>
    50e2:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    50e4:	008b8d13          	addi	s10,s7,8
    50e8:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    50ec:	03000593          	li	a1,48
    50f0:	855a                	mv	a0,s6
    50f2:	d43ff0ef          	jal	4e34 <putc>
  putc(fd, 'x');
    50f6:	07800593          	li	a1,120
    50fa:	855a                	mv	a0,s6
    50fc:	d39ff0ef          	jal	4e34 <putc>
    5100:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5102:	00003b97          	auipc	s7,0x3
    5106:	896b8b93          	addi	s7,s7,-1898 # 7998 <digits>
    510a:	03c9d793          	srli	a5,s3,0x3c
    510e:	97de                	add	a5,a5,s7
    5110:	0007c583          	lbu	a1,0(a5)
    5114:	855a                	mv	a0,s6
    5116:	d1fff0ef          	jal	4e34 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    511a:	0992                	slli	s3,s3,0x4
    511c:	397d                	addiw	s2,s2,-1
    511e:	fe0916e3          	bnez	s2,510a <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
    5122:	8bea                	mv	s7,s10
      state = 0;
    5124:	4981                	li	s3,0
    5126:	6d02                	ld	s10,0(sp)
    5128:	bd01                	j	4f38 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
    512a:	008b8913          	addi	s2,s7,8
    512e:	000bc583          	lbu	a1,0(s7)
    5132:	855a                	mv	a0,s6
    5134:	d01ff0ef          	jal	4e34 <putc>
    5138:	8bca                	mv	s7,s2
      state = 0;
    513a:	4981                	li	s3,0
    513c:	bbf5                	j	4f38 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    513e:	008b8993          	addi	s3,s7,8
    5142:	000bb903          	ld	s2,0(s7)
    5146:	00090f63          	beqz	s2,5164 <vprintf+0x276>
        for(; *s; s++)
    514a:	00094583          	lbu	a1,0(s2)
    514e:	c195                	beqz	a1,5172 <vprintf+0x284>
          putc(fd, *s);
    5150:	855a                	mv	a0,s6
    5152:	ce3ff0ef          	jal	4e34 <putc>
        for(; *s; s++)
    5156:	0905                	addi	s2,s2,1
    5158:	00094583          	lbu	a1,0(s2)
    515c:	f9f5                	bnez	a1,5150 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    515e:	8bce                	mv	s7,s3
      state = 0;
    5160:	4981                	li	s3,0
    5162:	bbd9                	j	4f38 <vprintf+0x4a>
          s = "(null)";
    5164:	00002917          	auipc	s2,0x2
    5168:	78490913          	addi	s2,s2,1924 # 78e8 <malloc+0x2678>
        for(; *s; s++)
    516c:	02800593          	li	a1,40
    5170:	b7c5                	j	5150 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    5172:	8bce                	mv	s7,s3
      state = 0;
    5174:	4981                	li	s3,0
    5176:	b3c9                	j	4f38 <vprintf+0x4a>
    5178:	64a6                	ld	s1,72(sp)
    517a:	79e2                	ld	s3,56(sp)
    517c:	7a42                	ld	s4,48(sp)
    517e:	7aa2                	ld	s5,40(sp)
    5180:	7b02                	ld	s6,32(sp)
    5182:	6be2                	ld	s7,24(sp)
    5184:	6c42                	ld	s8,16(sp)
    5186:	6ca2                	ld	s9,8(sp)
    }
  }
}
    5188:	60e6                	ld	ra,88(sp)
    518a:	6446                	ld	s0,80(sp)
    518c:	6906                	ld	s2,64(sp)
    518e:	6125                	addi	sp,sp,96
    5190:	8082                	ret

0000000000005192 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5192:	715d                	addi	sp,sp,-80
    5194:	ec06                	sd	ra,24(sp)
    5196:	e822                	sd	s0,16(sp)
    5198:	1000                	addi	s0,sp,32
    519a:	e010                	sd	a2,0(s0)
    519c:	e414                	sd	a3,8(s0)
    519e:	e818                	sd	a4,16(s0)
    51a0:	ec1c                	sd	a5,24(s0)
    51a2:	03043023          	sd	a6,32(s0)
    51a6:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    51aa:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    51ae:	8622                	mv	a2,s0
    51b0:	d3fff0ef          	jal	4eee <vprintf>
}
    51b4:	60e2                	ld	ra,24(sp)
    51b6:	6442                	ld	s0,16(sp)
    51b8:	6161                	addi	sp,sp,80
    51ba:	8082                	ret

00000000000051bc <printf>:

void
printf(const char *fmt, ...)
{
    51bc:	711d                	addi	sp,sp,-96
    51be:	ec06                	sd	ra,24(sp)
    51c0:	e822                	sd	s0,16(sp)
    51c2:	1000                	addi	s0,sp,32
    51c4:	e40c                	sd	a1,8(s0)
    51c6:	e810                	sd	a2,16(s0)
    51c8:	ec14                	sd	a3,24(s0)
    51ca:	f018                	sd	a4,32(s0)
    51cc:	f41c                	sd	a5,40(s0)
    51ce:	03043823          	sd	a6,48(s0)
    51d2:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    51d6:	00840613          	addi	a2,s0,8
    51da:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    51de:	85aa                	mv	a1,a0
    51e0:	4505                	li	a0,1
    51e2:	d0dff0ef          	jal	4eee <vprintf>
}
    51e6:	60e2                	ld	ra,24(sp)
    51e8:	6442                	ld	s0,16(sp)
    51ea:	6125                	addi	sp,sp,96
    51ec:	8082                	ret

00000000000051ee <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    51f4:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    51f8:	00003797          	auipc	a5,0x3
    51fc:	2987b783          	ld	a5,664(a5) # 8490 <freep>
    5200:	a02d                	j	522a <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5202:	4618                	lw	a4,8(a2)
    5204:	9f2d                	addw	a4,a4,a1
    5206:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    520a:	6398                	ld	a4,0(a5)
    520c:	6310                	ld	a2,0(a4)
    520e:	a83d                	j	524c <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5210:	ff852703          	lw	a4,-8(a0)
    5214:	9f31                	addw	a4,a4,a2
    5216:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5218:	ff053683          	ld	a3,-16(a0)
    521c:	a091                	j	5260 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    521e:	6398                	ld	a4,0(a5)
    5220:	00e7e463          	bltu	a5,a4,5228 <free+0x3a>
    5224:	00e6ea63          	bltu	a3,a4,5238 <free+0x4a>
{
    5228:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    522a:	fed7fae3          	bgeu	a5,a3,521e <free+0x30>
    522e:	6398                	ld	a4,0(a5)
    5230:	00e6e463          	bltu	a3,a4,5238 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5234:	fee7eae3          	bltu	a5,a4,5228 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5238:	ff852583          	lw	a1,-8(a0)
    523c:	6390                	ld	a2,0(a5)
    523e:	02059813          	slli	a6,a1,0x20
    5242:	01c85713          	srli	a4,a6,0x1c
    5246:	9736                	add	a4,a4,a3
    5248:	fae60de3          	beq	a2,a4,5202 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    524c:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5250:	4790                	lw	a2,8(a5)
    5252:	02061593          	slli	a1,a2,0x20
    5256:	01c5d713          	srli	a4,a1,0x1c
    525a:	973e                	add	a4,a4,a5
    525c:	fae68ae3          	beq	a3,a4,5210 <free+0x22>
    p->s.ptr = bp->s.ptr;
    5260:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5262:	00003717          	auipc	a4,0x3
    5266:	22f73723          	sd	a5,558(a4) # 8490 <freep>
}
    526a:	6422                	ld	s0,8(sp)
    526c:	0141                	addi	sp,sp,16
    526e:	8082                	ret

0000000000005270 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5270:	7139                	addi	sp,sp,-64
    5272:	fc06                	sd	ra,56(sp)
    5274:	f822                	sd	s0,48(sp)
    5276:	f426                	sd	s1,40(sp)
    5278:	ec4e                	sd	s3,24(sp)
    527a:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    527c:	02051493          	slli	s1,a0,0x20
    5280:	9081                	srli	s1,s1,0x20
    5282:	04bd                	addi	s1,s1,15
    5284:	8091                	srli	s1,s1,0x4
    5286:	0014899b          	addiw	s3,s1,1
    528a:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    528c:	00003517          	auipc	a0,0x3
    5290:	20453503          	ld	a0,516(a0) # 8490 <freep>
    5294:	c915                	beqz	a0,52c8 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5296:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5298:	4798                	lw	a4,8(a5)
    529a:	08977a63          	bgeu	a4,s1,532e <malloc+0xbe>
    529e:	f04a                	sd	s2,32(sp)
    52a0:	e852                	sd	s4,16(sp)
    52a2:	e456                	sd	s5,8(sp)
    52a4:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    52a6:	8a4e                	mv	s4,s3
    52a8:	0009871b          	sext.w	a4,s3
    52ac:	6685                	lui	a3,0x1
    52ae:	00d77363          	bgeu	a4,a3,52b4 <malloc+0x44>
    52b2:	6a05                	lui	s4,0x1
    52b4:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    52b8:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    52bc:	00003917          	auipc	s2,0x3
    52c0:	1d490913          	addi	s2,s2,468 # 8490 <freep>
  if(p == SBRK_ERROR)
    52c4:	5afd                	li	s5,-1
    52c6:	a081                	j	5306 <malloc+0x96>
    52c8:	f04a                	sd	s2,32(sp)
    52ca:	e852                	sd	s4,16(sp)
    52cc:	e456                	sd	s5,8(sp)
    52ce:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    52d0:	0000a797          	auipc	a5,0xa
    52d4:	9e878793          	addi	a5,a5,-1560 # ecb8 <base>
    52d8:	00003717          	auipc	a4,0x3
    52dc:	1af73c23          	sd	a5,440(a4) # 8490 <freep>
    52e0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    52e2:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    52e6:	b7c1                	j	52a6 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    52e8:	6398                	ld	a4,0(a5)
    52ea:	e118                	sd	a4,0(a0)
    52ec:	a8a9                	j	5346 <malloc+0xd6>
  hp->s.size = nu;
    52ee:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    52f2:	0541                	addi	a0,a0,16
    52f4:	efbff0ef          	jal	51ee <free>
  return freep;
    52f8:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    52fc:	c12d                	beqz	a0,535e <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    52fe:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5300:	4798                	lw	a4,8(a5)
    5302:	02977263          	bgeu	a4,s1,5326 <malloc+0xb6>
    if(p == freep)
    5306:	00093703          	ld	a4,0(s2)
    530a:	853e                	mv	a0,a5
    530c:	fef719e3          	bne	a4,a5,52fe <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    5310:	8552                	mv	a0,s4
    5312:	a2fff0ef          	jal	4d40 <sbrk>
  if(p == SBRK_ERROR)
    5316:	fd551ce3          	bne	a0,s5,52ee <malloc+0x7e>
        return 0;
    531a:	4501                	li	a0,0
    ...
    5324:	a03d                	j	5352 <malloc+0xe2>
    5326:	7902                	ld	s2,32(sp)
    5328:	6a42                	ld	s4,16(sp)
    532a:	6aa2                	ld	s5,8(sp)
    532c:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    532e:	fae48de3          	beq	s1,a4,52e8 <malloc+0x78>
        p->s.size -= nunits;
    5332:	4137073b          	subw	a4,a4,s3
    5336:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5338:	02071693          	slli	a3,a4,0x20
    533c:	01c6d713          	srli	a4,a3,0x1c
    5340:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5342:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5346:	00003717          	auipc	a4,0x3
    534a:	14a73523          	sd	a0,330(a4) # 8490 <freep>
      return (void*)(p + 1);
    534e:	01078513          	addi	a0,a5,16
  }
}
    5352:	70e2                	ld	ra,56(sp)
    5354:	7442                	ld	s0,48(sp)
    5356:	74a2                	ld	s1,40(sp)
    5358:	69e2                	ld	s3,24(sp)
    535a:	6121                	addi	sp,sp,64
    535c:	8082                	ret
    535e:	7902                	ld	s2,32(sp)
    5360:	6a42                	ld	s4,16(sp)
    5362:	6aa2                	ld	s5,8(sp)
    5364:	6b02                	ld	s6,0(sp)
    5366:	b7f5                	j	5352 <malloc+0xe2>
