...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      14:	be078793          	addi	a5,a5,-1056 # 7bf0 <malloc+0x2672>
      18:	638c                	ld	a1,0(a5)
      1a:	6790                	ld	a2,8(a5)
      1c:	6b94                	ld	a3,16(a5)
      1e:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      70:	60450513          	addi	a0,a0,1540 # 5670 <malloc+0xf2>
      74:	452050ef          	jal	54c6 <printf>
      exit(1);
      78:	4505                	li	a0,1
      ...
      9a:	8082                	ret
{
      ...
      aa:	5ea50513          	addi	a0,a0,1514 # 5690 <malloc+0x112>
      ae:	418050ef          	jal	54c6 <printf>
      exit(1);
      b2:	4505                	li	a0,1
...
00000000000000b8 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ca:	5e250513          	addi	a0,a0,1506 # 56a8 <malloc+0x12a>
      ce:	7e9040ef          	jal	50b6 <open>
  if(fd < 0){
  ...
  fd = open("doesnotexist", 0);
      ...
      e0:	5ec50513          	addi	a0,a0,1516 # 56c8 <malloc+0x14a>
      e4:	7d3040ef          	jal	50b6 <open>
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      fc:	5b850513          	addi	a0,a0,1464 # 56b0 <malloc+0x132>
     100:	3c6050ef          	jal	54c6 <printf>
    exit(1);
     104:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     110:	5cc50513          	addi	a0,a0,1484 # 56d8 <malloc+0x15a>
     114:	3b2050ef          	jal	54c6 <printf>
    exit(1);
     118:	4505                	li	a0,1
...
000000000000011e <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     132:	5d250513          	addi	a0,a0,1490 # 5700 <malloc+0x182>
     136:	791040ef          	jal	50c6 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13a:	60100593          	li	a1,1537
     13e:	00005517          	auipc	a0,0x5
     142:	5c250513          	addi	a0,a0,1474 # 5700 <malloc+0x182>
     146:	771040ef          	jal	50b6 <open>
     14a:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     14c:	4611                	li	a2,4
     14e:	00005597          	auipc	a1,0x5
     152:	5c258593          	addi	a1,a1,1474 # 5710 <malloc+0x192>
     156:	6b5040ef          	jal	500a <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     15a:	40100593          	li	a1,1025
     15e:	00005517          	auipc	a0,0x5
     162:	5a250513          	addi	a0,a0,1442 # 5700 <malloc+0x182>
     166:	751040ef          	jal	50b6 <open>
     16a:	892a                	mv	s2,a0
  int n = write(fd1, "x", 1);
     16c:	4605                	li	a2,1
     16e:	00005597          	auipc	a1,0x5
     172:	5aa58593          	addi	a1,a1,1450 # 5718 <malloc+0x19a>
     176:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     186:	57e50513          	addi	a0,a0,1406 # 5700 <malloc+0x182>
     18a:	73d040ef          	jal	50c6 <unlink>
  close(fd1);
     18e:	8526                	mv	a0,s1
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1b0:	57450513          	addi	a0,a0,1396 # 5720 <malloc+0x1a2>
     1b4:	312050ef          	jal	54c6 <printf>
    exit(1);
     1b8:	4505                	li	a0,1
...
0000000000000240 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     260:	4ec50513          	addi	a0,a0,1260 # 5748 <malloc+0x1ca>
     264:	663040ef          	jal	50c6 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     268:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     26c:	20200b93          	li	s7,514
     270:	00005a17          	auipc	s4,0x5
     274:	4d8a0a13          	addi	s4,s4,1240 # 5748 <malloc+0x1ca>
     278:	4b09                	li	s6,2
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2e0:	47c50513          	addi	a0,a0,1148 # 5758 <malloc+0x1da>
     2e4:	1e2050ef          	jal	54c6 <printf>
      exit(1);
     2e8:	4505                	li	a0,1
     ...
     2f8:	48450513          	addi	a0,a0,1156 # 5778 <malloc+0x1fa>
     2fc:	1ca050ef          	jal	54c6 <printf>
        exit(1);
     300:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     31e:	47650513          	addi	a0,a0,1142 # 5790 <malloc+0x212>
     322:	5a5040ef          	jal	50c6 <unlink>
     326:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     32a:	20100a93          	li	s5,513
     32e:	00005997          	auipc	s3,0x5
     332:	46298993          	addi	s3,s3,1122 # 5790 <malloc+0x212>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     36e:	42650513          	addi	a0,a0,1062 # 5790 <malloc+0x212>
     372:	545040ef          	jal	50b6 <open>
     376:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(write(fd, "x", 1) != 1){
     ...
     382:	39a58593          	addi	a1,a1,922 # 5718 <malloc+0x19a>
     386:	485040ef          	jal	500a <write>
     38a:	4785                	li	a5,1
     38c:	02f50d63          	beq	a0,a5,3c6 <badwrite+0xc0>
    printf("write failed\n");
     390:	00005517          	auipc	a0,0x5
     394:	42050513          	addi	a0,a0,1056 # 57b0 <malloc+0x232>
     398:	12e050ef          	jal	54c6 <printf>
    exit(1);
     39c:	4505                	li	a0,1
     39e:	44d040ef          	jal	4fea <exit>
      printf("open junk failed\n");
     3a2:	00005517          	auipc	a0,0x5
     3a6:	3f650513          	addi	a0,a0,1014 # 5798 <malloc+0x21a>
     3aa:	11c050ef          	jal	54c6 <printf>
      exit(1);
     3ae:	4505                	li	a0,1
     3b0:	43b040ef          	jal	4fea <exit>
    printf("open junk failed\n");
     3b4:	00005517          	auipc	a0,0x5
     3b8:	3e450513          	addi	a0,a0,996 # 5798 <malloc+0x21a>
     3bc:	10a050ef          	jal	54c6 <printf>
    exit(1);
     3c0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3d0:	3c450513          	addi	a0,a0,964 # 5790 <malloc+0x212>
     3d4:	4f3040ef          	jal	50c6 <unlink>
...
outofinodes(char *s)
{
  ...
  for(int i = 0; i < nzz; i++){
    ...
    unlink(name);
     432:	854a                	mv	a0,s2
     434:	493040ef          	jal	50c6 <unlink>
    int fd = open(name, O_CREATE|O_RDWR|O_TRUNC);
     438:	85d2                	mv	a1,s4
     43a:	854a                	mv	a0,s2
     43c:	47b040ef          	jal	50b6 <open>
    if(fd < 0){
...
00000000000004aa <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     4c8:	72c78793          	addi	a5,a5,1836 # 7bf0 <malloc+0x2672>
     4cc:	638c                	ld	a1,0(a5)
     4ce:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4fa:	2caa8a93          	addi	s5,s5,714 # 57c0 <malloc+0x242>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     58c:	24050513          	addi	a0,a0,576 # 57c8 <malloc+0x24a>
     590:	737040ef          	jal	54c6 <printf>
      exit(1);
     594:	4505                	li	a0,1
     ...
     5a2:	24250513          	addi	a0,a0,578 # 57e0 <malloc+0x262>
     5a6:	721040ef          	jal	54c6 <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	25c50513          	addi	a0,a0,604 # 5810 <malloc+0x292>
     5bc:	70b040ef          	jal	54c6 <printf>
      exit(1);
     5c0:	4505                	li	a0,1
     5c2:	229040ef          	jal	4fea <exit>
      printf("pipe() failed\n");
     5c6:	00005517          	auipc	a0,0x5
     5ca:	27a50513          	addi	a0,a0,634 # 5840 <malloc+0x2c2>
     5ce:	6f9040ef          	jal	54c6 <printf>
      exit(1);
     5d2:	4505                	li	a0,1
     ...
     5e0:	27450513          	addi	a0,a0,628 # 5850 <malloc+0x2d2>
     5e4:	6e3040ef          	jal	54c6 <printf>
      exit(1);
     5e8:	4505                	li	a0,1
...
00000000000005ee <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     60c:	5e878793          	addi	a5,a5,1512 # 7bf0 <malloc+0x2672>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     640:	244b0b13          	addi	s6,s6,580 # 5880 <malloc+0x302>
    ...
    n = write(fds[1], "x", 1);
     ...
     650:	0ccb8b93          	addi	s7,s7,204 # 5718 <malloc+0x19a>
    uint64 addr = addrs[ai];
     654:	00093983          	ld	s3,0(s2)
    int fd = open("README", 0);
     658:	4581                	li	a1,0
     65a:	855a                	mv	a0,s6
     65c:	25b040ef          	jal	50b6 <open>
     660:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     6d6:	1b650513          	addi	a0,a0,438 # 5888 <malloc+0x30a>
     6da:	5ed040ef          	jal	54c6 <printf>
      exit(1);
     6de:	4505                	li	a0,1
     ...
     6ec:	1b850513          	addi	a0,a0,440 # 58a0 <malloc+0x322>
     6f0:	5d7040ef          	jal	54c6 <printf>
      exit(1);
     6f4:	4505                	li	a0,1
     6f6:	0f5040ef          	jal	4fea <exit>
      printf("pipe() failed\n");
     6fa:	00005517          	auipc	a0,0x5
     6fe:	14650513          	addi	a0,a0,326 # 5840 <malloc+0x2c2>
     702:	5c5040ef          	jal	54c6 <printf>
      exit(1);
     706:	4505                	li	a0,1
     708:	0e3040ef          	jal	4fea <exit>
      printf("pipe write failed\n");
     70c:	00005517          	auipc	a0,0x5
     710:	1c450513          	addi	a0,a0,452 # 58d0 <malloc+0x352>
     714:	5b3040ef          	jal	54c6 <printf>
      exit(1);
     718:	4505                	li	a0,1
     ...
     726:	1c650513          	addi	a0,a0,454 # 58e8 <malloc+0x36a>
     72a:	59d040ef          	jal	54c6 <printf>
      exit(1);
     72e:	4505                	li	a0,1
...
0000000000000734 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     74c:	fb850513          	addi	a0,a0,-72 # 5700 <malloc+0x182>
     750:	177040ef          	jal	50c6 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     754:	60100593          	li	a1,1537
     758:	00005517          	auipc	a0,0x5
     75c:	fa850513          	addi	a0,a0,-88 # 5700 <malloc+0x182>
     760:	157040ef          	jal	50b6 <open>
     764:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     766:	4611                	li	a2,4
     768:	00005597          	auipc	a1,0x5
     76c:	fa858593          	addi	a1,a1,-88 # 5710 <malloc+0x192>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     780:	f8450513          	addi	a0,a0,-124 # 5700 <malloc+0x182>
     784:	133040ef          	jal	50b6 <open>
     788:	84aa                	mv	s1,a0
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     7a4:	f6050513          	addi	a0,a0,-160 # 5700 <malloc+0x182>
     7a8:	10f040ef          	jal	50b6 <open>
     7ac:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     7ae:	4581                	li	a1,0
     7b0:	00005517          	auipc	a0,0x5
     7b4:	f5050513          	addi	a0,a0,-176 # 5700 <malloc+0x182>
     7b8:	0ff040ef          	jal	50b6 <open>
     7bc:	892a                	mv	s2,a0
  ...
  write(fd1, "abcdef", 6);
     ...
     7e6:	19658593          	addi	a1,a1,406 # 5978 <malloc+0x3fa>
     7ea:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     81c:	ee850513          	addi	a0,a0,-280 # 5700 <malloc+0x182>
     820:	0a7040ef          	jal	50c6 <unlink>
  close(fd1);
     824:	854e                	mv	a0,s3
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     850:	0cc50513          	addi	a0,a0,204 # 5918 <malloc+0x39a>
     854:	473040ef          	jal	54c6 <printf>
    exit(1);
     858:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     864:	0d850513          	addi	a0,a0,216 # 5938 <malloc+0x3ba>
     868:	45f040ef          	jal	54c6 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     86c:	8656                	mv	a2,s5
     86e:	85d2                	mv	a1,s4
     870:	00005517          	auipc	a0,0x5
     874:	0d850513          	addi	a0,a0,216 # 5948 <malloc+0x3ca>
     878:	44f040ef          	jal	54c6 <printf>
    exit(1);
     87c:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     888:	0e450513          	addi	a0,a0,228 # 5968 <malloc+0x3ea>
     88c:	43b040ef          	jal	54c6 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     890:	8656                	mv	a2,s5
     892:	85d2                	mv	a1,s4
     894:	00005517          	auipc	a0,0x5
     898:	0b450513          	addi	a0,a0,180 # 5948 <malloc+0x3ca>
     89c:	42b040ef          	jal	54c6 <printf>
    exit(1);
     8a0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     8ae:	0d650513          	addi	a0,a0,214 # 5980 <malloc+0x402>
     8b2:	415040ef          	jal	54c6 <printf>
    exit(1);
     8b6:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     8c4:	0e050513          	addi	a0,a0,224 # 59a0 <malloc+0x422>
     8c8:	3ff040ef          	jal	54c6 <printf>
    exit(1);
     8cc:	4505                	li	a0,1
...
00000000000008d2 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     8f2:	0d250513          	addi	a0,a0,210 # 59c0 <malloc+0x442>
     8f6:	7c0040ef          	jal	50b6 <open>
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     908:	0e4a0a13          	addi	s4,s4,228 # 59e8 <malloc+0x46a>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     90c:	00005b17          	auipc	s6,0x5
     910:	114b0b13          	addi	s6,s6,276 # 5a20 <malloc+0x4a2>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     946:	07e50513          	addi	a0,a0,126 # 59c0 <malloc+0x442>
     94a:	76c040ef          	jal	50b6 <open>
     94e:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(unlink("small") < 0){
     ...
     976:	04e50513          	addi	a0,a0,78 # 59c0 <malloc+0x442>
     97a:	74c040ef          	jal	50c6 <unlink>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     99e:	02e50513          	addi	a0,a0,46 # 59c8 <malloc+0x44a>
     9a2:	325040ef          	jal	54c6 <printf>
    exit(1);
     9a6:	4505                	li	a0,1
     ...
     9b4:	04850513          	addi	a0,a0,72 # 59f8 <malloc+0x47a>
     9b8:	30f040ef          	jal	54c6 <printf>
      exit(1);
     9bc:	4505                	li	a0,1
     ...
     9ca:	06a50513          	addi	a0,a0,106 # 5a30 <malloc+0x4b2>
     9ce:	2f9040ef          	jal	54c6 <printf>
      exit(1);
     9d2:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     9de:	07e50513          	addi	a0,a0,126 # 5a58 <malloc+0x4da>
     9e2:	2e5040ef          	jal	54c6 <printf>
    exit(1);
     9e6:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     9f2:	08a50513          	addi	a0,a0,138 # 5a78 <malloc+0x4fa>
     9f6:	2d1040ef          	jal	54c6 <printf>
    exit(1);
     9fa:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     a06:	08e50513          	addi	a0,a0,142 # 5a90 <malloc+0x512>
     a0a:	2bd040ef          	jal	54c6 <printf>
    exit(1);
     a0e:	4505                	li	a0,1
...
0000000000000a14 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     a32:	08250513          	addi	a0,a0,130 # 5ab0 <malloc+0x532>
     a36:	680040ef          	jal	50b6 <open>
  if(fd < 0){
  ...
  fd = open("big", O_RDONLY);
     ...
     a76:	03e50513          	addi	a0,a0,62 # 5ab0 <malloc+0x532>
     a7a:	63c040ef          	jal	50b6 <open>
     a7e:	8a2a                	mv	s4,a0
  n = 0;
     a80:	4481                	li	s1,0
    i = read(fd, buf, BSIZE);
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     ab4:	00850513          	addi	a0,a0,8 # 5ab8 <malloc+0x53a>
     ab8:	20f040ef          	jal	54c6 <printf>
    exit(1);
     abc:	4505                	li	a0,1
     ...
     aca:	01250513          	addi	a0,a0,18 # 5ad8 <malloc+0x55a>
     ace:	1f9040ef          	jal	54c6 <printf>
      exit(1);
     ad2:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     ade:	02650513          	addi	a0,a0,38 # 5b00 <malloc+0x582>
     ae2:	1e5040ef          	jal	54c6 <printf>
    exit(1);
     ae6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     afe:	fb650513          	addi	a0,a0,-74 # 5ab0 <malloc+0x532>
     b02:	5c4040ef          	jal	50c6 <unlink>
     ...
     b26:	ffe50513          	addi	a0,a0,-2 # 5b20 <malloc+0x5a2>
     b2a:	19d040ef          	jal	54c6 <printf>
        exit(1);
     b2e:	4505                	li	a0,1
     ...
     b3c:	01050513          	addi	a0,a0,16 # 5b48 <malloc+0x5ca>
     b40:	187040ef          	jal	54c6 <printf>
      exit(1);
     b44:	4505                	li	a0,1
     ...
     b52:	01250513          	addi	a0,a0,18 # 5b60 <malloc+0x5e2>
     b56:	171040ef          	jal	54c6 <printf>
      exit(1);
     b5a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b66:	02650513          	addi	a0,a0,38 # 5b88 <malloc+0x60a>
     b6a:	15d040ef          	jal	54c6 <printf>
    exit(1);
     b6e:	4505                	li	a0,1
...
0000000000000b74 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b8c:	01850513          	addi	a0,a0,24 # 5ba0 <malloc+0x622>
     b90:	526040ef          	jal	50b6 <open>
  if(fd < 0){
  ...
  write(fd, "hello", SZ);
     ...
     ba0:	03458593          	addi	a1,a1,52 # 5bd0 <malloc+0x652>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bb4:	ff050513          	addi	a0,a0,-16 # 5ba0 <malloc+0x622>
     bb8:	4fe040ef          	jal	50b6 <open>
     bbc:	84aa                	mv	s1,a0
  if(fd < 0){
     bbe:	0a054463          	bltz	a0,c66 <unlinkread+0xf2>
  if(unlink("unlinkread") != 0){
     bc2:	00005517          	auipc	a0,0x5
     bc6:	fde50513          	addi	a0,a0,-34 # 5ba0 <malloc+0x622>
     bca:	4fc040ef          	jal	50c6 <unlink>
     bce:	e555                	bnez	a0,c7a <unlinkread+0x106>
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     bd0:	20200593          	li	a1,514
     bd4:	00005517          	auipc	a0,0x5
     bd8:	fcc50513          	addi	a0,a0,-52 # 5ba0 <malloc+0x622>
     bdc:	4da040ef          	jal	50b6 <open>
     be0:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     be2:	460d                	li	a2,3
     be4:	00005597          	auipc	a1,0x5
     be8:	03458593          	addi	a1,a1,52 # 5c18 <malloc+0x69a>
  ...
  unlink("unlinkread");
     ...
     c3c:	f6850513          	addi	a0,a0,-152 # 5ba0 <malloc+0x622>
     c40:	486040ef          	jal	50c6 <unlink>
}
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c58:	f5c50513          	addi	a0,a0,-164 # 5bb0 <malloc+0x632>
     c5c:	06b040ef          	jal	54c6 <printf>
    exit(1);
     c60:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c6c:	f7050513          	addi	a0,a0,-144 # 5bd8 <malloc+0x65a>
     c70:	057040ef          	jal	54c6 <printf>
    exit(1);
     c74:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c80:	f7c50513          	addi	a0,a0,-132 # 5bf8 <malloc+0x67a>
     c84:	043040ef          	jal	54c6 <printf>
    exit(1);
     c88:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c94:	f9050513          	addi	a0,a0,-112 # 5c20 <malloc+0x6a2>
     c98:	02f040ef          	jal	54c6 <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ca8:	f9c50513          	addi	a0,a0,-100 # 5c40 <malloc+0x6c2>
     cac:	01b040ef          	jal	54c6 <printf>
    exit(1);
     cb0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cbc:	fa850513          	addi	a0,a0,-88 # 5c60 <malloc+0x6e2>
     cc0:	007040ef          	jal	54c6 <printf>
    exit(1);
     cc4:	4505                	li	a0,1
...
0000000000000cca <linktest>:
{
  ...
  unlink("lf1");
     ...
     cdc:	fa850513          	addi	a0,a0,-88 # 5c80 <malloc+0x702>
     ce0:	3e6040ef          	jal	50c6 <unlink>
  unlink("lf2");
     ce4:	00005517          	auipc	a0,0x5
     ce8:	fa450513          	addi	a0,a0,-92 # 5c88 <malloc+0x70a>
     cec:	3da040ef          	jal	50c6 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     cf0:	20200593          	li	a1,514
     cf4:	00005517          	auipc	a0,0x5
     cf8:	f8c50513          	addi	a0,a0,-116 # 5c80 <malloc+0x702>
     cfc:	3ba040ef          	jal	50b6 <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d0c:	ec858593          	addi	a1,a1,-312 # 5bd0 <malloc+0x652>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d24:	f6858593          	addi	a1,a1,-152 # 5c88 <malloc+0x70a>
     d28:	00005517          	auipc	a0,0x5
     d2c:	f5850513          	addi	a0,a0,-168 # 5c80 <malloc+0x702>
     d30:	3a6040ef          	jal	50d6 <link>
     d34:	0c054963          	bltz	a0,e06 <linktest+0x13c>
  unlink("lf1");
     d38:	00005517          	auipc	a0,0x5
     d3c:	f4850513          	addi	a0,a0,-184 # 5c80 <malloc+0x702>
     d40:	386040ef          	jal	50c6 <unlink>
  if(open("lf1", 0) >= 0){
     d44:	4581                	li	a1,0
     d46:	00005517          	auipc	a0,0x5
     d4a:	f3a50513          	addi	a0,a0,-198 # 5c80 <malloc+0x702>
     d4e:	368040ef          	jal	50b6 <open>
     d52:	0c055463          	bgez	a0,e1a <linktest+0x150>
  fd = open("lf2", 0);
     d56:	4581                	li	a1,0
     d58:	00005517          	auipc	a0,0x5
     d5c:	f3050513          	addi	a0,a0,-208 # 5c88 <malloc+0x70a>
     d60:	356040ef          	jal	50b6 <open>
     d64:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     d88:	f0458593          	addi	a1,a1,-252 # 5c88 <malloc+0x70a>
     d8c:	852e                	mv	a0,a1
     d8e:	348040ef          	jal	50d6 <link>
     d92:	0c055263          	bgez	a0,e56 <linktest+0x18c>
  unlink("lf2");
     d96:	00005517          	auipc	a0,0x5
     d9a:	ef250513          	addi	a0,a0,-270 # 5c88 <malloc+0x70a>
     d9e:	328040ef          	jal	50c6 <unlink>
  if(link("lf2", "lf1") >= 0){
     da2:	00005597          	auipc	a1,0x5
     da6:	ede58593          	addi	a1,a1,-290 # 5c80 <malloc+0x702>
     daa:	00005517          	auipc	a0,0x5
     dae:	ede50513          	addi	a0,a0,-290 # 5c88 <malloc+0x70a>
     db2:	324040ef          	jal	50d6 <link>
     db6:	0a055a63          	bgez	a0,e6a <linktest+0x1a0>
  if(link(".", "lf1") >= 0){
     dba:	00005597          	auipc	a1,0x5
     dbe:	ec658593          	addi	a1,a1,-314 # 5c80 <malloc+0x702>
     dc2:	00005517          	auipc	a0,0x5
     dc6:	fce50513          	addi	a0,a0,-50 # 5d90 <malloc+0x812>
     dca:	30c040ef          	jal	50d6 <link>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     de4:	eb050513          	addi	a0,a0,-336 # 5c90 <malloc+0x712>
     de8:	6de040ef          	jal	54c6 <printf>
    exit(1);
     dec:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     df8:	eb450513          	addi	a0,a0,-332 # 5ca8 <malloc+0x72a>
     dfc:	6ca040ef          	jal	54c6 <printf>
    exit(1);
     e00:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     e0c:	eb850513          	addi	a0,a0,-328 # 5cc0 <malloc+0x742>
     e10:	6b6040ef          	jal	54c6 <printf>
    exit(1);
     e14:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     e20:	ec450513          	addi	a0,a0,-316 # 5ce0 <malloc+0x762>
     e24:	6a2040ef          	jal	54c6 <printf>
    exit(1);
     e28:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     e34:	ee050513          	addi	a0,a0,-288 # 5d10 <malloc+0x792>
     e38:	68e040ef          	jal	54c6 <printf>
    exit(1);
     e3c:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     e48:	ee450513          	addi	a0,a0,-284 # 5d28 <malloc+0x7aa>
     e4c:	67a040ef          	jal	54c6 <printf>
    exit(1);
     e50:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e5c:	ee850513          	addi	a0,a0,-280 # 5d40 <malloc+0x7c2>
     e60:	666040ef          	jal	54c6 <printf>
    exit(1);
     e64:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e70:	efc50513          	addi	a0,a0,-260 # 5d68 <malloc+0x7ea>
     e74:	652040ef          	jal	54c6 <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e84:	f1850513          	addi	a0,a0,-232 # 5d98 <malloc+0x81a>
     e88:	63e040ef          	jal	54c6 <printf>
    exit(1);
     e8c:	4505                	li	a0,1
...
0000000000000e92 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     eae:	f0e98993          	addi	s3,s3,-242 # 5db8 <malloc+0x83a>
     eb2:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     eb4:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     ee6:	ee650513          	addi	a0,a0,-282 # 5dc8 <malloc+0x84a>
     eea:	5dc040ef          	jal	54c6 <printf>
      exit(1);
     eee:	4505                	li	a0,1
...
0000000000000ef4 <bigdir>:
{
  ...
  unlink("bd");
     ...
     f10:	edc50513          	addi	a0,a0,-292 # 5de8 <malloc+0x86a>
     f14:	1b2040ef          	jal	50c6 <unlink>
  fd = open("bd", O_CREATE);
     f18:	20000593          	li	a1,512
     f1c:	00005517          	auipc	a0,0x5
     f20:	ecc50513          	addi	a0,a0,-308 # 5de8 <malloc+0x86a>
     f24:	192040ef          	jal	50b6 <open>
  if(fd < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     f3e:	eae98993          	addi	s3,s3,-338 # 5de8 <malloc+0x86a>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f8a:	e6250513          	addi	a0,a0,-414 # 5de8 <malloc+0x86a>
     f8e:	138040ef          	jal	50c6 <unlink>
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     ff6:	dfe50513          	addi	a0,a0,-514 # 5df0 <malloc+0x872>
     ffa:	4cc040ef          	jal	54c6 <printf>
    exit(1);
     ffe:	4505                	li	a0,1
    ...
    1010:	e0450513          	addi	a0,a0,-508 # 5e10 <malloc+0x892>
    1014:	4b2040ef          	jal	54c6 <printf>
      exit(1);
    1018:	4505                	li	a0,1
    ...
    1024:	e1850513          	addi	a0,a0,-488 # 5e38 <malloc+0x8ba>
    1028:	49e040ef          	jal	54c6 <printf>
      exit(1);
    102c:	4505                	li	a0,1
...
000000000000105e <badarg>:
{
    ...
    1082:	62a98993          	addi	s3,s3,1578 # 56a8 <malloc+0x12a>
    argv[0] = (char*)0xffffffff;
...
00000000000010a0 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    114a:	aaa78793          	addi	a5,a5,-1366 # 7bf0 <malloc+0x2672>
    ...
    116e:	53e50513          	addi	a0,a0,1342 # 56a8 <malloc+0x12a>
    1172:	73d030ef          	jal	50ae <exec>
    if(ret != -1){
    1176:	57fd                	li	a5,-1
    ...
    1182:	d6250513          	addi	a0,a0,-670 # 5ee0 <malloc+0x962>
    1186:	340040ef          	jal	54c6 <printf>
      exit(1);
    118a:	4505                	li	a0,1
    ...
    119a:	cc250513          	addi	a0,a0,-830 # 5e58 <malloc+0x8da>
    119e:	328040ef          	jal	54c6 <printf>
    exit(1);
    11a2:	4505                	li	a0,1
    ...
    11b2:	cca50513          	addi	a0,a0,-822 # 5e78 <malloc+0x8fa>
    11b6:	310040ef          	jal	54c6 <printf>
    exit(1);
    11ba:	4505                	li	a0,1
    ...
    11cc:	cd050513          	addi	a0,a0,-816 # 5e98 <malloc+0x91a>
    11d0:	2f6040ef          	jal	54c6 <printf>
    exit(1);
    11d4:	4505                	li	a0,1
    ...
    11e4:	ce050513          	addi	a0,a0,-800 # 5ec0 <malloc+0x942>
    11e8:	2de040ef          	jal	54c6 <printf>
    exit(1);
    11ec:	4505                	li	a0,1
    11ee:	5fd030ef          	jal	4fea <exit>
    printf("fork failed\n");
    11f2:	00006517          	auipc	a0,0x6
    11f6:	2ee50513          	addi	a0,a0,750 # 74e0 <malloc+0x1f62>
    11fa:	2cc040ef          	jal	54c6 <printf>
    exit(1);
    11fe:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1230:	cdc50513          	addi	a0,a0,-804 # 5f08 <malloc+0x98a>
    1234:	292040ef          	jal	54c6 <printf>
    exit(1);
    1238:	4505                	li	a0,1
...
000000000000123e <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    1252:	4b250513          	addi	a0,a0,1202 # 5700 <malloc+0x182>
    1256:	661030ef          	jal	50b6 <open>
  ...
  if(pid == 0){
    ...
    1282:	48298993          	addi	s3,s3,1154 # 5700 <malloc+0x182>
      int n = write(fd, "1234567890", 10);
    1286:	4a29                	li	s4,10
    1288:	00005b17          	auipc	s6,0x5
    128c:	ce0b0b13          	addi	s6,s6,-800 # 5f68 <malloc+0x9ea>
    ...
    12f2:	c4a50513          	addi	a0,a0,-950 # 5f38 <malloc+0x9ba>
    12f6:	1d0040ef          	jal	54c6 <printf>
    exit(1);
    12fa:	4505                	li	a0,1
    ...
    1306:	c4e50513          	addi	a0,a0,-946 # 5f50 <malloc+0x9d2>
    130a:	1bc040ef          	jal	54c6 <printf>
        exit(1);
    130e:	4505                	li	a0,1
    ...
    131c:	c6050513          	addi	a0,a0,-928 # 5f78 <malloc+0x9fa>
    1320:	1a6040ef          	jal	54c6 <printf>
        exit(1);
    1324:	4505                	li	a0,1
    ...
    1342:	3c2a0a13          	addi	s4,s4,962 # 5700 <malloc+0x182>
    int n = write(fd, "xxx", 3);
    1346:	498d                	li	s3,3
    1348:	00005b17          	auipc	s6,0x5
    134c:	c50b0b13          	addi	s6,s6,-944 # 5f98 <malloc+0xa1a>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    1350:	85d6                	mv	a1,s5
    1352:	8552                	mv	a0,s4
    1354:	563030ef          	jal	50b6 <open>
    1358:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  unlink("truncfile");
    ...
    1386:	37e50513          	addi	a0,a0,894 # 5700 <malloc+0x182>
    138a:	53d030ef          	jal	50c6 <unlink>
  exit(xstatus);
    ...
    13a0:	bb450513          	addi	a0,a0,-1100 # 5f50 <malloc+0x9d2>
    13a4:	122040ef          	jal	54c6 <printf>
      exit(1);
    13a8:	4505                	li	a0,1
    ...
    13ba:	bea50513          	addi	a0,a0,-1046 # 5fa0 <malloc+0xa22>
    13be:	108040ef          	jal	54c6 <printf>
      exit(1);
    13c2:	4505                	li	a0,1
...
00000000000013c8 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    13d8:	2d478793          	addi	a5,a5,724 # 56a8 <malloc+0x12a>
    13dc:	fcf43023          	sd	a5,-64(s0)
    13e0:	00005797          	auipc	a5,0x5
    13e4:	be078793          	addi	a5,a5,-1056 # 5fc0 <malloc+0xa42>
    13e8:	fcf43423          	sd	a5,-56(s0)
    13ec:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    13f0:	00005517          	auipc	a0,0x5
    13f4:	bd850513          	addi	a0,a0,-1064 # 5fc8 <malloc+0xa4a>
    13f8:	4cf030ef          	jal	50c6 <unlink>
  pid = fork();
  ...
  if(pid == 0) {
    ...
    1418:	bb450513          	addi	a0,a0,-1100 # 5fc8 <malloc+0xa4a>
    141c:	49b030ef          	jal	50b6 <open>
    if(fd < 0) {
    ...
    1430:	bbc50513          	addi	a0,a0,-1092 # 5fe8 <malloc+0xa6a>
    1434:	092040ef          	jal	54c6 <printf>
      exit(1);
    1438:	4505                	li	a0,1
    ...
    1446:	af650513          	addi	a0,a0,-1290 # 5f38 <malloc+0x9ba>
    144a:	07c040ef          	jal	54c6 <printf>
     exit(1);
    144e:	4505                	li	a0,1
    ...
    145a:	b7a50513          	addi	a0,a0,-1158 # 5fd0 <malloc+0xa52>
    145e:	068040ef          	jal	54c6 <printf>
      exit(1);
    1462:	4505                	li	a0,1
    ...
    1470:	23c50513          	addi	a0,a0,572 # 56a8 <malloc+0x12a>
    1474:	43b030ef          	jal	50ae <exec>
  ...
  if(xstatus != 0)
    ...
    1498:	b6450513          	addi	a0,a0,-1180 # 5ff8 <malloc+0xa7a>
    149c:	02a040ef          	jal	54c6 <printf>
      exit(1);
    14a0:	4505                	li	a0,1
    ...
    14ac:	b6850513          	addi	a0,a0,-1176 # 6010 <malloc+0xa92>
    14b0:	016040ef          	jal	54c6 <printf>
    14b4:	bfd1                	j	1488 <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    14b6:	4581                	li	a1,0
    14b8:	00005517          	auipc	a0,0x5
    14bc:	b1050513          	addi	a0,a0,-1264 # 5fc8 <malloc+0xa4a>
    14c0:	3f7030ef          	jal	50b6 <open>
  if(fd < 0) {
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    14de:	59e50513          	addi	a0,a0,1438 # 5a78 <malloc+0x4fa>
    14e2:	7e5030ef          	jal	54c6 <printf>
    exit(1);
    14e6:	4505                	li	a0,1
    ...
    14f2:	a6250513          	addi	a0,a0,-1438 # 5f50 <malloc+0x9d2>
    14f6:	7d1030ef          	jal	54c6 <printf>
    exit(1);
    14fa:	4505                	li	a0,1
    14fc:	2ef030ef          	jal	4fea <exit>
  unlink("echo-ok");
    1500:	00005517          	auipc	a0,0x5
    1504:	ac850513          	addi	a0,a0,-1336 # 5fc8 <malloc+0xa4a>
    1508:	3bf030ef          	jal	50c6 <unlink>
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    152a:	b0250513          	addi	a0,a0,-1278 # 6028 <malloc+0xaaa>
    152e:	799030ef          	jal	54c6 <printf>
    exit(1);
    1532:	4505                	li	a0,1
...
000000000000153e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    15d6:	a6e50513          	addi	a0,a0,-1426 # 6040 <malloc+0xac2>
    15da:	6ed030ef          	jal	54c6 <printf>
    exit(1);
    15de:	4505                	li	a0,1
    ...
    1612:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0x65>
{
    ...
    1650:	a0c50513          	addi	a0,a0,-1524 # 6058 <malloc+0xada>
    1654:	673030ef          	jal	54c6 <printf>
        exit(1);
    1658:	4505                	li	a0,1
    ...
    1664:	a1050513          	addi	a0,a0,-1520 # 6070 <malloc+0xaf2>
    1668:	65f030ef          	jal	54c6 <printf>
          return;
    ...
    1696:	9f650513          	addi	a0,a0,-1546 # 6088 <malloc+0xb0a>
    169a:	62d030ef          	jal	54c6 <printf>
      exit(1);
    169e:	4505                	li	a0,1
    ...
    16d2:	9da50513          	addi	a0,a0,-1574 # 60a8 <malloc+0xb2a>
    16d6:	5f1030ef          	jal	54c6 <printf>
    exit(1);
    16da:	4505                	li	a0,1
...
00000000000016e0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    173a:	80250513          	addi	a0,a0,-2046 # 5f38 <malloc+0x9ba>
    173e:	589030ef          	jal	54c6 <printf>
      exit(1);
    1742:	4505                	li	a0,1
    ...
    174e:	97650513          	addi	a0,a0,-1674 # 60c0 <malloc+0xb42>
    1752:	575030ef          	jal	54c6 <printf>
        exit(1);
    1756:	4505                	li	a0,1
    ...
    1762:	97a50513          	addi	a0,a0,-1670 # 60d8 <malloc+0xb5a>
    1766:	561030ef          	jal	54c6 <printf>
        exit(1);
    176a:	4505                	li	a0,1
...
0000000000001776 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    17be:	77e50513          	addi	a0,a0,1918 # 5f38 <malloc+0x9ba>
    17c2:	505030ef          	jal	54c6 <printf>
      exit(1);
    17c6:	4505                	li	a0,1
    ...
    17d6:	76650513          	addi	a0,a0,1894 # 5f38 <malloc+0x9ba>
    17da:	4ed030ef          	jal	54c6 <printf>
        exit(1);
    17de:	4505                	li	a0,1
...
00000000000017e8 <forkfork>:
{
    ...
    1834:	8c850513          	addi	a0,a0,-1848 # 60f8 <malloc+0xb7a>
    1838:	48f030ef          	jal	54c6 <printf>
      exit(1);
    183c:	4505                	li	a0,1
    183e:	7ac030ef          	jal	4fea <exit>
{
    ...
    1870:	89c50513          	addi	a0,a0,-1892 # 6108 <malloc+0xb8a>
    1874:	453030ef          	jal	54c6 <printf>
      exit(1);
    1878:	4505                	li	a0,1
...
000000000000187e <reparent2>:
{
  ...
  exit(0);
    ...
    18aa:	c3a50513          	addi	a0,a0,-966 # 74e0 <malloc+0x1f62>
    18ae:	419030ef          	jal	54c6 <printf>
      exit(1);
    18b2:	4505                	li	a0,1
...
00000000000018c6 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1936:	60650513          	addi	a0,a0,1542 # 5f38 <malloc+0x9ba>
    193a:	38d030ef          	jal	54c6 <printf>
      exit(1);
    193e:	4505                	li	a0,1
    ...
    1962:	67250513          	addi	a0,a0,1650 # 5fd0 <malloc+0xa52>
    1966:	361030ef          	jal	54c6 <printf>
          exit(1);
    196a:	4505                	li	a0,1
    ...
    19c2:	76a50513          	addi	a0,a0,1898 # 6128 <malloc+0xbaa>
    19c6:	301030ef          	jal	54c6 <printf>
            exit(1);
    19ca:	4505                	li	a0,1
    ...
    1a0c:	73850513          	addi	a0,a0,1848 # 6140 <malloc+0xbc2>
    1a10:	2b7030ef          	jal	54c6 <printf>
        exit(1);
    1a14:	4505                	li	a0,1
    ...
    1a28:	74450513          	addi	a0,a0,1860 # 6168 <malloc+0xbea>
    1a2c:	29b030ef          	jal	54c6 <printf>
        exit(1);
    1a30:	4505                	li	a0,1
...
0000000000001ab2 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1ad4:	c4850513          	addi	a0,a0,-952 # 5718 <malloc+0x19a>
    1ad8:	5ee030ef          	jal	50c6 <unlink>
  pid = fork();
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b14:	c08b0b13          	addi	s6,s6,-1016 # 5718 <malloc+0x19a>
      link("cat", "x");
    1b18:	00004c97          	auipc	s9,0x4
    1b1c:	678c8c93          	addi	s9,s9,1656 # 6190 <malloc+0xc12>
    ...
    1b2c:	41050513          	addi	a0,a0,1040 # 5f38 <malloc+0x9ba>
    1b30:	197030ef          	jal	54c6 <printf>
    exit(1);
    1b34:	4505                	li	a0,1
...
0000000000001bac <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1bd8:	60c50513          	addi	a0,a0,1548 # 61e0 <malloc+0xc62>
    1bdc:	0eb030ef          	jal	54c6 <printf>
    exit(1);
    1be0:	4505                	li	a0,1
    ...
    1bf0:	5ac50513          	addi	a0,a0,1452 # 6198 <malloc+0xc1a>
    1bf4:	0d3030ef          	jal	54c6 <printf>
    exit(1);
    1bf8:	4505                	li	a0,1
    ...
    1c04:	5b050513          	addi	a0,a0,1456 # 61b0 <malloc+0xc32>
    1c08:	0bf030ef          	jal	54c6 <printf>
      exit(1);
    1c0c:	4505                	li	a0,1
    ...
    1c18:	5b450513          	addi	a0,a0,1460 # 61c8 <malloc+0xc4a>
    1c1c:	0ab030ef          	jal	54c6 <printf>
    exit(1);
    1c20:	4505                	li	a0,1
...
0000000000001c54 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1cbc:	28050513          	addi	a0,a0,640 # 5f38 <malloc+0x9ba>
    1cc0:	007030ef          	jal	54c6 <printf>
      exit(1);
    1cc4:	4505                	li	a0,1
    ...
    1cd6:	53650513          	addi	a0,a0,1334 # 6208 <malloc+0xc8a>
    1cda:	7ec030ef          	jal	54c6 <printf>
      exit(1);
    1cde:	4505                	li	a0,1
...
0000000000001cea <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1d4a:	1f250513          	addi	a0,a0,498 # 5f38 <malloc+0x9ba>
    1d4e:	778030ef          	jal	54c6 <printf>
      exit(1);
    1d52:	4505                	li	a0,1
    ...
    1d6e:	4be50513          	addi	a0,a0,1214 # 6228 <malloc+0xcaa>
    1d72:	754030ef          	jal	54c6 <printf>
      exit(1);
    1d76:	4505                	li	a0,1
...
static inline uint64 r_sp() {
  ...
  asm volatile("mv %0, sp" : "=r"(x));
    ...
    1dbe:	48650513          	addi	a0,a0,1158 # 6240 <malloc+0xcc2>
    1dc2:	704030ef          	jal	54c6 <printf>
    exit(1);
    1dc6:	4505                	li	a0,1
    ...
    1dd2:	16a50513          	addi	a0,a0,362 # 5f38 <malloc+0x9ba>
    1dd6:	6f0030ef          	jal	54c6 <printf>
    exit(1);
    1dda:	4505                	li	a0,1
...
0000000000001de6 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1dfc:	df878793          	addi	a5,a5,-520 # 7bf0 <malloc+0x2672>
  ...
  exit(0);
    ...
    1e66:	40650513          	addi	a0,a0,1030 # 6268 <malloc+0xcea>
    1e6a:	65c030ef          	jal	54c6 <printf>
      exit(0);
    1e6e:	4501                	li	a0,0
    ...
    1e7a:	0c250513          	addi	a0,a0,194 # 5f38 <malloc+0x9ba>
    1e7e:	648030ef          	jal	54c6 <printf>
      exit(1);
    1e82:	4505                	li	a0,1
...
0000000000001e8e <manywrites>:
{
  ...
  exit(0);
    ...
    1ef2:	5f250513          	addi	a0,a0,1522 # 74e0 <malloc+0x1f62>
    1ef6:	5d0030ef          	jal	54c6 <printf>
      exit(1);
    1efa:	4505                	li	a0,1
    ...
    1f92:	2fa50513          	addi	a0,a0,762 # 6288 <malloc+0xd0a>
    1f96:	530030ef          	jal	54c6 <printf>
            exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	7d250513          	addi	a0,a0,2002 # 5778 <malloc+0x1fa>
    1fae:	518030ef          	jal	54c6 <printf>
            exit(1);
    1fb2:	4505                	li	a0,1
...
0000000000001fc8 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    2064:	24050513          	addi	a0,a0,576 # 62a0 <malloc+0xd22>
    2068:	45e030ef          	jal	54c6 <printf>
    exit(1);
    206c:	4505                	li	a0,1
    ...
    207a:	de250513          	addi	a0,a0,-542 # 5e58 <malloc+0x8da>
    207e:	448030ef          	jal	54c6 <printf>
    exit(1);
    2082:	4505                	li	a0,1
    ...
    2090:	dec50513          	addi	a0,a0,-532 # 5e78 <malloc+0x8fa>
    2094:	432030ef          	jal	54c6 <printf>
    exit(1);
    2098:	4505                	li	a0,1
    ...
    20a8:	df450513          	addi	a0,a0,-524 # 5e98 <malloc+0x91a>
    20ac:	41a030ef          	jal	54c6 <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    ...
    20be:	e0650513          	addi	a0,a0,-506 # 5ec0 <malloc+0x942>
    20c2:	404030ef          	jal	54c6 <printf>
    exit(1);
    20c6:	4505                	li	a0,1
...
00000000000020cc <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    20fa:	1ea50513          	addi	a0,a0,490 # 62e0 <malloc+0xd62>
    20fe:	7b9020ef          	jal	50b6 <open>
    2102:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  if(n >= 0){
    ...
    2122:	1e250513          	addi	a0,a0,482 # 6300 <malloc+0xd82>
    2126:	3a0030ef          	jal	54c6 <printf>
    exit(1);
    212a:	4505                	li	a0,1
    ...
    2138:	17450513          	addi	a0,a0,372 # 62a8 <malloc+0xd2a>
    213c:	38a030ef          	jal	54c6 <printf>
    exit(1);
    2140:	4505                	li	a0,1
    ...
    214c:	17850513          	addi	a0,a0,376 # 62c0 <malloc+0xd42>
    2150:	376030ef          	jal	54c6 <printf>
    exit(1);
    2154:	4505                	li	a0,1
    2156:	695020ef          	jal	4fea <exit>
    printf("open(rwsbrk) failed\n");
    215a:	00004517          	auipc	a0,0x4
    215e:	18e50513          	addi	a0,a0,398 # 62e8 <malloc+0xd6a>
    2162:	364030ef          	jal	54c6 <printf>
    exit(1);
    2166:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2176:	16e50513          	addi	a0,a0,366 # 62e0 <malloc+0xd62>
    217a:	74d020ef          	jal	50c6 <unlink>
  fd = open("README", O_RDONLY);
    217e:	4581                	li	a1,0
    2180:	00003517          	auipc	a0,0x3
    2184:	70050513          	addi	a0,a0,1792 # 5880 <malloc+0x302>
    2188:	72f020ef          	jal	50b6 <open>
    218c:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  if(n >= 0){
    ...
    21a6:	18e50513          	addi	a0,a0,398 # 6330 <malloc+0xdb2>
    21aa:	31c030ef          	jal	54c6 <printf>
    exit(1);
    21ae:	4505                	li	a0,1
    21b0:	63b020ef          	jal	4fea <exit>
    printf("open(README) failed\n");
    21b4:	00003517          	auipc	a0,0x3
    21b8:	6d450513          	addi	a0,a0,1748 # 5888 <malloc+0x30a>
    21bc:	30a030ef          	jal	54c6 <printf>
    exit(1);
    21c0:	4505                	li	a0,1
...
00000000000021d2 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2226:	13650513          	addi	a0,a0,310 # 6358 <malloc+0xdda>
    222a:	29c030ef          	jal	54c6 <printf>
    exit(1);
    222e:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    227e:	0fe50513          	addi	a0,a0,254 # 6378 <malloc+0xdfa>
    2282:	244030ef          	jal	54c6 <printf>
    exit(1);
    2286:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    22c8:	11450513          	addi	a0,a0,276 # 63d8 <malloc+0xe5a>
    22cc:	1fa030ef          	jal	54c6 <printf>
    exit(1);
    22d0:	4505                	li	a0,1
    ...
    22e2:	0ba50513          	addi	a0,a0,186 # 6398 <malloc+0xe1a>
    22e6:	1e0030ef          	jal	54c6 <printf>
      exit(1);
    22ea:	4505                	li	a0,1
    ...
    22f6:	0c650513          	addi	a0,a0,198 # 63b8 <malloc+0xe3a>
    22fa:	1cc030ef          	jal	54c6 <printf>
    exit(1);
    22fe:	4505                	li	a0,1
...
000000000000231e <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    23e2:	01a50513          	addi	a0,a0,26 # 63f8 <malloc+0xe7a>
    23e6:	0e0030ef          	jal	54c6 <printf>
    exit(1);
    23ea:	4505                	li	a0,1
    ...
    23f6:	04e50513          	addi	a0,a0,78 # 6440 <malloc+0xec2>
    23fa:	0cc030ef          	jal	54c6 <printf>
    exit(1);
    23fe:	4505                	li	a0,1
    ...
    240e:	05650513          	addi	a0,a0,86 # 6460 <malloc+0xee2>
    2412:	0b4030ef          	jal	54c6 <printf>
    exit(1);
    2416:	4505                	li	a0,1
    ...
    2426:	07e50513          	addi	a0,a0,126 # 64a0 <malloc+0xf22>
    242a:	09c030ef          	jal	54c6 <printf>
    exit(1);
    242e:	4505                	li	a0,1
    ...
    243a:	09a50513          	addi	a0,a0,154 # 64d0 <malloc+0xf52>
    243e:	088030ef          	jal	54c6 <printf>
    exit(1);
    2442:	4505                	li	a0,1
    ...
    2452:	0ba50513          	addi	a0,a0,186 # 6508 <malloc+0xf8a>
    2456:	070030ef          	jal	54c6 <printf>
    exit(1);
    245a:	4505                	li	a0,1
...
0000000000002460 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2480:	0b450513          	addi	a0,a0,180 # 6530 <malloc+0xfb2>
    2484:	433020ef          	jal	50b6 <open>
    2488:	84aa                	mv	s1,a0
  unlink("sbrk");
    248a:	00004517          	auipc	a0,0x4
    248e:	0a650513          	addi	a0,a0,166 # 6530 <malloc+0xfb2>
    2492:	435020ef          	jal	50c6 <unlink>
  if(fd < 0)  {
  ...
  if(pipe((int *) a) != 0){
    ...
    24ce:	06e50513          	addi	a0,a0,110 # 6538 <malloc+0xfba>
    24d2:	7f5020ef          	jal	54c6 <printf>
    exit(1);
    24d6:	4505                	li	a0,1
    ...
    24e2:	07250513          	addi	a0,a0,114 # 6550 <malloc+0xfd2>
    24e6:	7e1020ef          	jal	54c6 <printf>
    exit(1);
    24ea:	4505                	li	a0,1
    ...
    24f6:	b4e50513          	addi	a0,a0,-1202 # 6040 <malloc+0xac2>
    24fa:	7cd020ef          	jal	54c6 <printf>
    exit(1);
    24fe:	4505                	li	a0,1
...
0000000000002504 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2518:	05450513          	addi	a0,a0,84 # 6568 <malloc+0xfea>
    251c:	39b020ef          	jal	50b6 <open>
  if (fd < 0) {
  ...
  close(fd);
    ...
    2550:	a0450513          	addi	a0,a0,-1532 # 5f50 <malloc+0x9d2>
    2554:	773020ef          	jal	54c6 <printf>
    exit(1);
    2558:	4505                	li	a0,1
...
000000000000255e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2586:	f5e50513          	addi	a0,a0,-162 # 74e0 <malloc+0x1f62>
    258a:	73d020ef          	jal	54c6 <printf>
    exit(1);
    258e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    25c0:	f2450513          	addi	a0,a0,-220 # 74e0 <malloc+0x1f62>
    25c4:	703020ef          	jal	54c6 <printf>
    exit(1);
    25c8:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2600:	ee450513          	addi	a0,a0,-284 # 74e0 <malloc+0x1f62>
    2604:	6c3020ef          	jal	54c6 <printf>
    exit(1);
    2608:	4505                	li	a0,1
...
00000000000026ea <execout>:
{
  ...
  exit(0);
    ...
    2726:	dbe50513          	addi	a0,a0,-578 # 74e0 <malloc+0x1f62>
    272a:	59d020ef          	jal	54c6 <printf>
      exit(1);
    272e:	4505                	li	a0,1
    ...
    276c:	f4078793          	addi	a5,a5,-192 # 56a8 <malloc+0x12a>
    2770:	faf43423          	sd	a5,-88(s0)
    2774:	00003797          	auipc	a5,0x3
    2778:	fa478793          	addi	a5,a5,-92 # 5718 <malloc+0x19a>
    277c:	faf43823          	sd	a5,-80(s0)
    2780:	fa043c23          	sd	zero,-72(s0)
      exec("echo", args);
    2784:	fa840593          	addi	a1,s0,-88
    2788:	00003517          	auipc	a0,0x3
    278c:	f2050513          	addi	a0,a0,-224 # 56a8 <malloc+0x12a>
    2790:	11f020ef          	jal	50ae <exec>
      exit(0);
    2794:	4501                	li	a0,0
...
000000000000279a <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    27aa:	f9a50513          	addi	a0,a0,-102 # 6740 <malloc+0x11c2>
    27ae:	131020ef          	jal	50de <mkdir>
    27b2:	e555                	bnez	a0,285e <fourteen+0xc4>
  if(mkdir("12345678901234/123456789012345") != 0){
    27b4:	00004517          	auipc	a0,0x4
    27b8:	de450513          	addi	a0,a0,-540 # 6598 <malloc+0x101a>
    27bc:	123020ef          	jal	50de <mkdir>
    27c0:	e94d                	bnez	a0,2872 <fourteen+0xd8>
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    27c2:	20000593          	li	a1,512
    27c6:	00004517          	auipc	a0,0x4
    27ca:	e2a50513          	addi	a0,a0,-470 # 65f0 <malloc+0x1072>
    27ce:	0e9020ef          	jal	50b6 <open>
  if(fd < 0){
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27e0:	e8c50513          	addi	a0,a0,-372 # 6668 <malloc+0x10ea>
    27e4:	0d3020ef          	jal	50b6 <open>
  if(fd < 0){
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    27f4:	ee850513          	addi	a0,a0,-280 # 66d8 <malloc+0x115a>
    27f8:	0e7020ef          	jal	50de <mkdir>
    27fc:	c94d                	beqz	a0,28ae <fourteen+0x114>
  if(mkdir("123456789012345/12345678901234") == 0){
    27fe:	00004517          	auipc	a0,0x4
    2802:	f3250513          	addi	a0,a0,-206 # 6730 <malloc+0x11b2>
    2806:	0d9020ef          	jal	50de <mkdir>
    280a:	cd45                	beqz	a0,28c2 <fourteen+0x128>
  unlink("123456789012345/12345678901234");
    280c:	00004517          	auipc	a0,0x4
    2810:	f2450513          	addi	a0,a0,-220 # 6730 <malloc+0x11b2>
    2814:	0b3020ef          	jal	50c6 <unlink>
  unlink("12345678901234/12345678901234");
    2818:	00004517          	auipc	a0,0x4
    281c:	ec050513          	addi	a0,a0,-320 # 66d8 <malloc+0x115a>
    2820:	0a7020ef          	jal	50c6 <unlink>
  unlink("12345678901234/12345678901234/12345678901234");
    2824:	00004517          	auipc	a0,0x4
    2828:	e4450513          	addi	a0,a0,-444 # 6668 <malloc+0x10ea>
    282c:	09b020ef          	jal	50c6 <unlink>
  unlink("123456789012345/123456789012345/123456789012345");
    2830:	00004517          	auipc	a0,0x4
    2834:	dc050513          	addi	a0,a0,-576 # 65f0 <malloc+0x1072>
    2838:	08f020ef          	jal	50c6 <unlink>
  unlink("12345678901234/123456789012345");
    283c:	00004517          	auipc	a0,0x4
    2840:	d5c50513          	addi	a0,a0,-676 # 6598 <malloc+0x101a>
    2844:	083020ef          	jal	50c6 <unlink>
  unlink("12345678901234");
    2848:	00004517          	auipc	a0,0x4
    284c:	ef850513          	addi	a0,a0,-264 # 6740 <malloc+0x11c2>
    2850:	077020ef          	jal	50c6 <unlink>
}
    ...
    2864:	d1050513          	addi	a0,a0,-752 # 6570 <malloc+0xff2>
    2868:	45f020ef          	jal	54c6 <printf>
    exit(1);
    286c:	4505                	li	a0,1
    ...
    2878:	d4450513          	addi	a0,a0,-700 # 65b8 <malloc+0x103a>
    287c:	44b020ef          	jal	54c6 <printf>
    exit(1);
    2880:	4505                	li	a0,1
    ...
    288c:	d9850513          	addi	a0,a0,-616 # 6620 <malloc+0x10a2>
    2890:	437020ef          	jal	54c6 <printf>
    exit(1);
    2894:	4505                	li	a0,1
    ...
    28a0:	dfc50513          	addi	a0,a0,-516 # 6698 <malloc+0x111a>
    28a4:	423020ef          	jal	54c6 <printf>
    exit(1);
    28a8:	4505                	li	a0,1
    ...
    28b4:	e4850513          	addi	a0,a0,-440 # 66f8 <malloc+0x117a>
    28b8:	40f020ef          	jal	54c6 <printf>
    exit(1);
    28bc:	4505                	li	a0,1
    ...
    28c8:	e8c50513          	addi	a0,a0,-372 # 6750 <malloc+0x11d2>
    28cc:	3fb020ef          	jal	54c6 <printf>
    exit(1);
    28d0:	4505                	li	a0,1
...
00000000000028d6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    291a:	e7250513          	addi	a0,a0,-398 # 6788 <malloc+0x120a>
    291e:	7a8020ef          	jal	50c6 <unlink>
    ...
    2950:	e4c50513          	addi	a0,a0,-436 # 6798 <malloc+0x121a>
    2954:	373020ef          	jal	54c6 <printf>
      break;
  ...
  for(int i = 0; i < nzz; i++){
    ...
    unlink(name);
    29a8:	854a                	mv	a0,s2
    29aa:	71c020ef          	jal	50c6 <unlink>
    int fd = open(name, O_CREATE|O_RDWR|O_TRUNC);
    29ae:	85d2                	mv	a1,s4
    29b0:	854a                	mv	a0,s2
    29b2:	704020ef          	jal	50b6 <open>
    if(fd < 0)
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    29c8:	dc450513          	addi	a0,a0,-572 # 6788 <malloc+0x120a>
    29cc:	712020ef          	jal	50de <mkdir>
    29d0:	12050363          	beqz	a0,2af6 <diskfull+0x220>
  unlink("diskfulldir");
    29d4:	00004517          	auipc	a0,0x4
    29d8:	db450513          	addi	a0,a0,-588 # 6788 <malloc+0x120a>
    29dc:	6ea020ef          	jal	50c6 <unlink>
  for(int i = 0; i < nzz; i++){
    29e0:	4481                	li	s1,0
    name[0] = 'z';
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    unlink(name);
    2ac8:	855a                	mv	a0,s6
    2aca:	5fc020ef          	jal	50c6 <unlink>
    int fd = open(name, O_CREATE|O_RDWR|O_TRUNC);
    2ace:	85de                	mv	a1,s7
    2ad0:	855a                	mv	a0,s6
    2ad2:	5e4020ef          	jal	50b6 <open>
    2ad6:	89aa                	mv	s3,a0
    if(fd < 0){
    ...
    2afe:	cbe50513          	addi	a0,a0,-834 # 67b8 <malloc+0x123a>
    2b02:	1c5020ef          	jal	54c6 <printf>
...
0000000000002b08 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2b18:	cd450513          	addi	a0,a0,-812 # 67e8 <malloc+0x126a>
    2b1c:	5c2020ef          	jal	50de <mkdir>
    2b20:	02054f63          	bltz	a0,2b5e <iputtest+0x56>
  if(chdir("iputdir") < 0){
    2b24:	00004517          	auipc	a0,0x4
    2b28:	cc450513          	addi	a0,a0,-828 # 67e8 <malloc+0x126a>
    2b2c:	5ba020ef          	jal	50e6 <chdir>
    2b30:	04054163          	bltz	a0,2b72 <iputtest+0x6a>
  if(unlink("../iputdir") < 0){
    2b34:	00004517          	auipc	a0,0x4
    2b38:	cf450513          	addi	a0,a0,-780 # 6828 <malloc+0x12aa>
    2b3c:	58a020ef          	jal	50c6 <unlink>
    2b40:	04054363          	bltz	a0,2b86 <iputtest+0x7e>
  if(chdir("/") < 0){
    2b44:	00004517          	auipc	a0,0x4
    2b48:	d1450513          	addi	a0,a0,-748 # 6858 <malloc+0x12da>
    2b4c:	59a020ef          	jal	50e6 <chdir>
    ...
    2b64:	c9050513          	addi	a0,a0,-880 # 67f0 <malloc+0x1272>
    2b68:	15f020ef          	jal	54c6 <printf>
    exit(1);
    2b6c:	4505                	li	a0,1
    ...
    2b78:	c9450513          	addi	a0,a0,-876 # 6808 <malloc+0x128a>
    2b7c:	14b020ef          	jal	54c6 <printf>
    exit(1);
    2b80:	4505                	li	a0,1
    ...
    2b8c:	cb050513          	addi	a0,a0,-848 # 6838 <malloc+0x12ba>
    2b90:	137020ef          	jal	54c6 <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    ...
    2ba0:	cc450513          	addi	a0,a0,-828 # 6860 <malloc+0x12e2>
    2ba4:	123020ef          	jal	54c6 <printf>
    exit(1);
    2ba8:	4505                	li	a0,1
...
0000000000002bae <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2bc8:	c2450513          	addi	a0,a0,-988 # 67e8 <malloc+0x126a>
    2bcc:	512020ef          	jal	50de <mkdir>
    2bd0:	02054f63          	bltz	a0,2c0e <exitiputtest+0x60>
    if(chdir("iputdir") < 0){
    2bd4:	00004517          	auipc	a0,0x4
    2bd8:	c1450513          	addi	a0,a0,-1004 # 67e8 <malloc+0x126a>
    2bdc:	50a020ef          	jal	50e6 <chdir>
    2be0:	04054163          	bltz	a0,2c22 <exitiputtest+0x74>
    if(unlink("../iputdir") < 0){
    2be4:	00004517          	auipc	a0,0x4
    2be8:	c4450513          	addi	a0,a0,-956 # 6828 <malloc+0x12aa>
    2bec:	4da020ef          	jal	50c6 <unlink>
    ...
    2c00:	33c50513          	addi	a0,a0,828 # 5f38 <malloc+0x9ba>
    2c04:	0c3020ef          	jal	54c6 <printf>
    exit(1);
    2c08:	4505                	li	a0,1
    ...
    2c14:	be050513          	addi	a0,a0,-1056 # 67f0 <malloc+0x1272>
    2c18:	0af020ef          	jal	54c6 <printf>
      exit(1);
    2c1c:	4505                	li	a0,1
    ...
    2c28:	c5450513          	addi	a0,a0,-940 # 6878 <malloc+0x12fa>
    2c2c:	09b020ef          	jal	54c6 <printf>
      exit(1);
    2c30:	4505                	li	a0,1
    ...
    2c3c:	c0050513          	addi	a0,a0,-1024 # 6838 <malloc+0x12ba>
    2c40:	087020ef          	jal	54c6 <printf>
      exit(1);
    2c44:	4505                	li	a0,1
...
0000000000002c5a <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    2c6a:	c2a50513          	addi	a0,a0,-982 # 6890 <malloc+0x1312>
    2c6e:	470020ef          	jal	50de <mkdir>
    2c72:	02054f63          	bltz	a0,2cb0 <dirtest+0x56>
  if(chdir("dir0") < 0){
    2c76:	00004517          	auipc	a0,0x4
    2c7a:	c1a50513          	addi	a0,a0,-998 # 6890 <malloc+0x1312>
    2c7e:	468020ef          	jal	50e6 <chdir>
    2c82:	04054163          	bltz	a0,2cc4 <dirtest+0x6a>
  if(chdir("..") < 0){
    2c86:	00004517          	auipc	a0,0x4
    2c8a:	c2a50513          	addi	a0,a0,-982 # 68b0 <malloc+0x1332>
    2c8e:	458020ef          	jal	50e6 <chdir>
    2c92:	04054363          	bltz	a0,2cd8 <dirtest+0x7e>
  if(unlink("dir0") < 0){
    2c96:	00004517          	auipc	a0,0x4
    2c9a:	bfa50513          	addi	a0,a0,-1030 # 6890 <malloc+0x1312>
    2c9e:	428020ef          	jal	50c6 <unlink>
    ...
    2cb6:	b3e50513          	addi	a0,a0,-1218 # 67f0 <malloc+0x1272>
    2cba:	00d020ef          	jal	54c6 <printf>
    exit(1);
    2cbe:	4505                	li	a0,1
    ...
    2cca:	bd250513          	addi	a0,a0,-1070 # 6898 <malloc+0x131a>
    2cce:	7f8020ef          	jal	54c6 <printf>
    exit(1);
    2cd2:	4505                	li	a0,1
    ...
    2cde:	bde50513          	addi	a0,a0,-1058 # 68b8 <malloc+0x133a>
    2ce2:	7e4020ef          	jal	54c6 <printf>
    exit(1);
    2ce6:	4505                	li	a0,1
    ...
    2cf2:	be250513          	addi	a0,a0,-1054 # 68d0 <malloc+0x1352>
    2cf6:	7d0020ef          	jal	54c6 <printf>
    exit(1);
    2cfa:	4505                	li	a0,1
...
0000000000002d00 <subdir>:
{
  ...
  unlink("ff");
    ...
    2d12:	d0a50513          	addi	a0,a0,-758 # 6a18 <malloc+0x149a>
    2d16:	3b0020ef          	jal	50c6 <unlink>
  if(mkdir("dd") != 0){
    2d1a:	00004517          	auipc	a0,0x4
    2d1e:	bce50513          	addi	a0,a0,-1074 # 68e8 <malloc+0x136a>
    2d22:	3bc020ef          	jal	50de <mkdir>
    2d26:	2e051263          	bnez	a0,300a <subdir+0x30a>
  fd = open("dd/ff", O_CREATE | O_RDWR);
    2d2a:	20200593          	li	a1,514
    2d2e:	00004517          	auipc	a0,0x4
    2d32:	bda50513          	addi	a0,a0,-1062 # 6908 <malloc+0x138a>
    2d36:	380020ef          	jal	50b6 <open>
    2d3a:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    2d46:	cd658593          	addi	a1,a1,-810 # 6a18 <malloc+0x149a>
  ...
  if(unlink("dd") >= 0){
    ...
    2d58:	b9450513          	addi	a0,a0,-1132 # 68e8 <malloc+0x136a>
    2d5c:	36a020ef          	jal	50c6 <unlink>
    2d60:	2c055963          	bgez	a0,3032 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2d64:	00004517          	auipc	a0,0x4
    2d68:	bfc50513          	addi	a0,a0,-1028 # 6960 <malloc+0x13e2>
    2d6c:	372020ef          	jal	50de <mkdir>
    2d70:	2c051b63          	bnez	a0,3046 <subdir+0x346>
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    2d74:	20200593          	li	a1,514
    2d78:	00004517          	auipc	a0,0x4
    2d7c:	c1050513          	addi	a0,a0,-1008 # 6988 <malloc+0x140a>
    2d80:	336020ef          	jal	50b6 <open>
    2d84:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    2d90:	c2c58593          	addi	a1,a1,-980 # 69b8 <malloc+0x143a>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2da4:	c2050513          	addi	a0,a0,-992 # 69c0 <malloc+0x1442>
    2da8:	30e020ef          	jal	50b6 <open>
    2dac:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2de0:	c3458593          	addi	a1,a1,-972 # 6a10 <malloc+0x1492>
    2de4:	00004517          	auipc	a0,0x4
    2de8:	ba450513          	addi	a0,a0,-1116 # 6988 <malloc+0x140a>
    2dec:	2ea020ef          	jal	50d6 <link>
    2df0:	2a051363          	bnez	a0,3096 <subdir+0x396>
  if(unlink("dd/dd/ff") != 0){
    2df4:	00004517          	auipc	a0,0x4
    2df8:	b9450513          	addi	a0,a0,-1132 # 6988 <malloc+0x140a>
    2dfc:	2ca020ef          	jal	50c6 <unlink>
    2e00:	2a051563          	bnez	a0,30aa <subdir+0x3aa>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    2e04:	4581                	li	a1,0
    2e06:	00004517          	auipc	a0,0x4
    2e0a:	b8250513          	addi	a0,a0,-1150 # 6988 <malloc+0x140a>
    2e0e:	2a8020ef          	jal	50b6 <open>
    2e12:	2a055663          	bgez	a0,30be <subdir+0x3be>
  if(chdir("dd") != 0){
    2e16:	00004517          	auipc	a0,0x4
    2e1a:	ad250513          	addi	a0,a0,-1326 # 68e8 <malloc+0x136a>
    2e1e:	2c8020ef          	jal	50e6 <chdir>
    2e22:	2a051863          	bnez	a0,30d2 <subdir+0x3d2>
  if(chdir("dd/../../dd") != 0){
    2e26:	00004517          	auipc	a0,0x4
    2e2a:	c8250513          	addi	a0,a0,-894 # 6aa8 <malloc+0x152a>
    2e2e:	2b8020ef          	jal	50e6 <chdir>
    2e32:	2a051a63          	bnez	a0,30e6 <subdir+0x3e6>
  if(chdir("dd/../../../dd") != 0){
    2e36:	00004517          	auipc	a0,0x4
    2e3a:	ca250513          	addi	a0,a0,-862 # 6ad8 <malloc+0x155a>
    2e3e:	2a8020ef          	jal	50e6 <chdir>
    2e42:	2a051c63          	bnez	a0,30fa <subdir+0x3fa>
  if(chdir("./..") != 0){
    2e46:	00004517          	auipc	a0,0x4
    2e4a:	cca50513          	addi	a0,a0,-822 # 6b10 <malloc+0x1592>
    2e4e:	298020ef          	jal	50e6 <chdir>
    2e52:	2a051e63          	bnez	a0,310e <subdir+0x40e>
  fd = open("dd/dd/ffff", 0);
    2e56:	4581                	li	a1,0
    2e58:	00004517          	auipc	a0,0x4
    2e5c:	bb850513          	addi	a0,a0,-1096 # 6a10 <malloc+0x1492>
    2e60:	256020ef          	jal	50b6 <open>
    2e64:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2e8a:	b0250513          	addi	a0,a0,-1278 # 6988 <malloc+0x140a>
    2e8e:	228020ef          	jal	50b6 <open>
    2e92:	2a055c63          	bgez	a0,314a <subdir+0x44a>
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    2e96:	20200593          	li	a1,514
    2e9a:	00004517          	auipc	a0,0x4
    2e9e:	d0650513          	addi	a0,a0,-762 # 6ba0 <malloc+0x1622>
    2ea2:	214020ef          	jal	50b6 <open>
    2ea6:	2a055c63          	bgez	a0,315e <subdir+0x45e>
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    2eaa:	20200593          	li	a1,514
    2eae:	00004517          	auipc	a0,0x4
    2eb2:	d2250513          	addi	a0,a0,-734 # 6bd0 <malloc+0x1652>
    2eb6:	200020ef          	jal	50b6 <open>
    2eba:	2a055c63          	bgez	a0,3172 <subdir+0x472>
  if(open("dd", O_CREATE) >= 0){
    2ebe:	20000593          	li	a1,512
    2ec2:	00004517          	auipc	a0,0x4
    2ec6:	a2650513          	addi	a0,a0,-1498 # 68e8 <malloc+0x136a>
    2eca:	1ec020ef          	jal	50b6 <open>
    2ece:	2a055c63          	bgez	a0,3186 <subdir+0x486>
  if(open("dd", O_RDWR) >= 0){
    2ed2:	4589                	li	a1,2
    2ed4:	00004517          	auipc	a0,0x4
    2ed8:	a1450513          	addi	a0,a0,-1516 # 68e8 <malloc+0x136a>
    2edc:	1da020ef          	jal	50b6 <open>
    2ee0:	2a055d63          	bgez	a0,319a <subdir+0x49a>
  if(open("dd", O_WRONLY) >= 0){
    2ee4:	4585                	li	a1,1
    2ee6:	00004517          	auipc	a0,0x4
    2eea:	a0250513          	addi	a0,a0,-1534 # 68e8 <malloc+0x136a>
    2eee:	1c8020ef          	jal	50b6 <open>
    2ef2:	2a055e63          	bgez	a0,31ae <subdir+0x4ae>
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2ef6:	00004597          	auipc	a1,0x4
    2efa:	d6a58593          	addi	a1,a1,-662 # 6c60 <malloc+0x16e2>
    2efe:	00004517          	auipc	a0,0x4
    2f02:	ca250513          	addi	a0,a0,-862 # 6ba0 <malloc+0x1622>
    2f06:	1d0020ef          	jal	50d6 <link>
    2f0a:	2a050c63          	beqz	a0,31c2 <subdir+0x4c2>
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    2f0e:	00004597          	auipc	a1,0x4
    2f12:	d5258593          	addi	a1,a1,-686 # 6c60 <malloc+0x16e2>
    2f16:	00004517          	auipc	a0,0x4
    2f1a:	cba50513          	addi	a0,a0,-838 # 6bd0 <malloc+0x1652>
    2f1e:	1b8020ef          	jal	50d6 <link>
    2f22:	2a050a63          	beqz	a0,31d6 <subdir+0x4d6>
  if(link("dd/ff", "dd/dd/ffff") == 0){
    2f26:	00004597          	auipc	a1,0x4
    2f2a:	aea58593          	addi	a1,a1,-1302 # 6a10 <malloc+0x1492>
    2f2e:	00004517          	auipc	a0,0x4
    2f32:	9da50513          	addi	a0,a0,-1574 # 6908 <malloc+0x138a>
    2f36:	1a0020ef          	jal	50d6 <link>
    2f3a:	2a050863          	beqz	a0,31ea <subdir+0x4ea>
  if(mkdir("dd/ff/ff") == 0){
    2f3e:	00004517          	auipc	a0,0x4
    2f42:	c6250513          	addi	a0,a0,-926 # 6ba0 <malloc+0x1622>
    2f46:	198020ef          	jal	50de <mkdir>
    2f4a:	2a050a63          	beqz	a0,31fe <subdir+0x4fe>
  if(mkdir("dd/xx/ff") == 0){
    2f4e:	00004517          	auipc	a0,0x4
    2f52:	c8250513          	addi	a0,a0,-894 # 6bd0 <malloc+0x1652>
    2f56:	188020ef          	jal	50de <mkdir>
    2f5a:	2a050c63          	beqz	a0,3212 <subdir+0x512>
  if(mkdir("dd/dd/ffff") == 0){
    2f5e:	00004517          	auipc	a0,0x4
    2f62:	ab250513          	addi	a0,a0,-1358 # 6a10 <malloc+0x1492>
    2f66:	178020ef          	jal	50de <mkdir>
    2f6a:	2a050e63          	beqz	a0,3226 <subdir+0x526>
  if(unlink("dd/xx/ff") == 0){
    2f6e:	00004517          	auipc	a0,0x4
    2f72:	c6250513          	addi	a0,a0,-926 # 6bd0 <malloc+0x1652>
    2f76:	150020ef          	jal	50c6 <unlink>
    2f7a:	2c050063          	beqz	a0,323a <subdir+0x53a>
  if(unlink("dd/ff/ff") == 0){
    2f7e:	00004517          	auipc	a0,0x4
    2f82:	c2250513          	addi	a0,a0,-990 # 6ba0 <malloc+0x1622>
    2f86:	140020ef          	jal	50c6 <unlink>
    2f8a:	2c050263          	beqz	a0,324e <subdir+0x54e>
  if(chdir("dd/ff") == 0){
    2f8e:	00004517          	auipc	a0,0x4
    2f92:	97a50513          	addi	a0,a0,-1670 # 6908 <malloc+0x138a>
    2f96:	150020ef          	jal	50e6 <chdir>
    2f9a:	2c050463          	beqz	a0,3262 <subdir+0x562>
  if(chdir("dd/xx") == 0){
    2f9e:	00004517          	auipc	a0,0x4
    2fa2:	e1250513          	addi	a0,a0,-494 # 6db0 <malloc+0x1832>
    2fa6:	140020ef          	jal	50e6 <chdir>
    2faa:	2c050663          	beqz	a0,3276 <subdir+0x576>
  if(unlink("dd/dd/ffff") != 0){
    2fae:	00004517          	auipc	a0,0x4
    2fb2:	a6250513          	addi	a0,a0,-1438 # 6a10 <malloc+0x1492>
    2fb6:	110020ef          	jal	50c6 <unlink>
    2fba:	2c051863          	bnez	a0,328a <subdir+0x58a>
  if(unlink("dd/ff") != 0){
    2fbe:	00004517          	auipc	a0,0x4
    2fc2:	94a50513          	addi	a0,a0,-1718 # 6908 <malloc+0x138a>
    2fc6:	100020ef          	jal	50c6 <unlink>
    2fca:	2c051a63          	bnez	a0,329e <subdir+0x59e>
  if(unlink("dd") == 0){
    2fce:	00004517          	auipc	a0,0x4
    2fd2:	91a50513          	addi	a0,a0,-1766 # 68e8 <malloc+0x136a>
    2fd6:	0f0020ef          	jal	50c6 <unlink>
    2fda:	2c050c63          	beqz	a0,32b2 <subdir+0x5b2>
  if(unlink("dd/dd") < 0){
    2fde:	00004517          	auipc	a0,0x4
    2fe2:	e4250513          	addi	a0,a0,-446 # 6e20 <malloc+0x18a2>
    2fe6:	0e0020ef          	jal	50c6 <unlink>
    2fea:	2c054e63          	bltz	a0,32c6 <subdir+0x5c6>
  if(unlink("dd") < 0){
    2fee:	00004517          	auipc	a0,0x4
    2ff2:	8fa50513          	addi	a0,a0,-1798 # 68e8 <malloc+0x136a>
    2ff6:	0d0020ef          	jal	50c6 <unlink>
    ...
    3010:	8e450513          	addi	a0,a0,-1820 # 68f0 <malloc+0x1372>
    3014:	4b2020ef          	jal	54c6 <printf>
    exit(1);
    3018:	4505                	li	a0,1
    ...
    3024:	8f050513          	addi	a0,a0,-1808 # 6910 <malloc+0x1392>
    3028:	49e020ef          	jal	54c6 <printf>
    exit(1);
    302c:	4505                	li	a0,1
    ...
    3038:	8fc50513          	addi	a0,a0,-1796 # 6930 <malloc+0x13b2>
    303c:	48a020ef          	jal	54c6 <printf>
    exit(1);
    3040:	4505                	li	a0,1
    ...
    304c:	92050513          	addi	a0,a0,-1760 # 6968 <malloc+0x13ea>
    3050:	476020ef          	jal	54c6 <printf>
    exit(1);
    3054:	4505                	li	a0,1
    ...
    3060:	93c50513          	addi	a0,a0,-1732 # 6998 <malloc+0x141a>
    3064:	462020ef          	jal	54c6 <printf>
    exit(1);
    3068:	4505                	li	a0,1
    ...
    3074:	96050513          	addi	a0,a0,-1696 # 69d0 <malloc+0x1452>
    3078:	44e020ef          	jal	54c6 <printf>
    exit(1);
    307c:	4505                	li	a0,1
    ...
    3088:	96c50513          	addi	a0,a0,-1684 # 69f0 <malloc+0x1472>
    308c:	43a020ef          	jal	54c6 <printf>
    exit(1);
    3090:	4505                	li	a0,1
    ...
    309c:	98850513          	addi	a0,a0,-1656 # 6a20 <malloc+0x14a2>
    30a0:	426020ef          	jal	54c6 <printf>
    exit(1);
    30a4:	4505                	li	a0,1
    ...
    30b0:	99c50513          	addi	a0,a0,-1636 # 6a48 <malloc+0x14ca>
    30b4:	412020ef          	jal	54c6 <printf>
    exit(1);
    30b8:	4505                	li	a0,1
    ...
    30c4:	9a850513          	addi	a0,a0,-1624 # 6a68 <malloc+0x14ea>
    30c8:	3fe020ef          	jal	54c6 <printf>
    exit(1);
    30cc:	4505                	li	a0,1
    ...
    30d8:	9bc50513          	addi	a0,a0,-1604 # 6a90 <malloc+0x1512>
    30dc:	3ea020ef          	jal	54c6 <printf>
    exit(1);
    30e0:	4505                	li	a0,1
    ...
    30ec:	9d050513          	addi	a0,a0,-1584 # 6ab8 <malloc+0x153a>
    30f0:	3d6020ef          	jal	54c6 <printf>
    exit(1);
    30f4:	4505                	li	a0,1
    ...
    3100:	9ec50513          	addi	a0,a0,-1556 # 6ae8 <malloc+0x156a>
    3104:	3c2020ef          	jal	54c6 <printf>
    exit(1);
    3108:	4505                	li	a0,1
    ...
    3114:	a0850513          	addi	a0,a0,-1528 # 6b18 <malloc+0x159a>
    3118:	3ae020ef          	jal	54c6 <printf>
    exit(1);
    311c:	4505                	li	a0,1
    ...
    3128:	a0c50513          	addi	a0,a0,-1524 # 6b30 <malloc+0x15b2>
    312c:	39a020ef          	jal	54c6 <printf>
    exit(1);
    3130:	4505                	li	a0,1
    ...
    313c:	a1850513          	addi	a0,a0,-1512 # 6b50 <malloc+0x15d2>
    3140:	386020ef          	jal	54c6 <printf>
    exit(1);
    3144:	4505                	li	a0,1
    ...
    3150:	a2450513          	addi	a0,a0,-1500 # 6b70 <malloc+0x15f2>
    3154:	372020ef          	jal	54c6 <printf>
    exit(1);
    3158:	4505                	li	a0,1
    ...
    3164:	a5050513          	addi	a0,a0,-1456 # 6bb0 <malloc+0x1632>
    3168:	35e020ef          	jal	54c6 <printf>
    exit(1);
    316c:	4505                	li	a0,1
    ...
    3178:	a6c50513          	addi	a0,a0,-1428 # 6be0 <malloc+0x1662>
    317c:	34a020ef          	jal	54c6 <printf>
    exit(1);
    3180:	4505                	li	a0,1
    ...
    318c:	a7850513          	addi	a0,a0,-1416 # 6c00 <malloc+0x1682>
    3190:	336020ef          	jal	54c6 <printf>
    exit(1);
    3194:	4505                	li	a0,1
    ...
    31a0:	a8450513          	addi	a0,a0,-1404 # 6c20 <malloc+0x16a2>
    31a4:	322020ef          	jal	54c6 <printf>
    exit(1);
    31a8:	4505                	li	a0,1
    ...
    31b4:	a9050513          	addi	a0,a0,-1392 # 6c40 <malloc+0x16c2>
    31b8:	30e020ef          	jal	54c6 <printf>
    exit(1);
    31bc:	4505                	li	a0,1
    ...
    31c8:	aac50513          	addi	a0,a0,-1364 # 6c70 <malloc+0x16f2>
    31cc:	2fa020ef          	jal	54c6 <printf>
    exit(1);
    31d0:	4505                	li	a0,1
    ...
    31dc:	ac050513          	addi	a0,a0,-1344 # 6c98 <malloc+0x171a>
    31e0:	2e6020ef          	jal	54c6 <printf>
    exit(1);
    31e4:	4505                	li	a0,1
    ...
    31f0:	ad450513          	addi	a0,a0,-1324 # 6cc0 <malloc+0x1742>
    31f4:	2d2020ef          	jal	54c6 <printf>
    exit(1);
    31f8:	4505                	li	a0,1
    ...
    3204:	ae850513          	addi	a0,a0,-1304 # 6ce8 <malloc+0x176a>
    3208:	2be020ef          	jal	54c6 <printf>
    exit(1);
    320c:	4505                	li	a0,1
    ...
    3218:	af450513          	addi	a0,a0,-1292 # 6d08 <malloc+0x178a>
    321c:	2aa020ef          	jal	54c6 <printf>
    exit(1);
    3220:	4505                	li	a0,1
    ...
    322c:	b0050513          	addi	a0,a0,-1280 # 6d28 <malloc+0x17aa>
    3230:	296020ef          	jal	54c6 <printf>
    exit(1);
    3234:	4505                	li	a0,1
    ...
    3240:	b1450513          	addi	a0,a0,-1260 # 6d50 <malloc+0x17d2>
    3244:	282020ef          	jal	54c6 <printf>
    exit(1);
    3248:	4505                	li	a0,1
    ...
    3254:	b2050513          	addi	a0,a0,-1248 # 6d70 <malloc+0x17f2>
    3258:	26e020ef          	jal	54c6 <printf>
    exit(1);
    325c:	4505                	li	a0,1
    ...
    3268:	b2c50513          	addi	a0,a0,-1236 # 6d90 <malloc+0x1812>
    326c:	25a020ef          	jal	54c6 <printf>
    exit(1);
    3270:	4505                	li	a0,1
    ...
    327c:	b4050513          	addi	a0,a0,-1216 # 6db8 <malloc+0x183a>
    3280:	246020ef          	jal	54c6 <printf>
    exit(1);
    3284:	4505                	li	a0,1
    ...
    3290:	7bc50513          	addi	a0,a0,1980 # 6a48 <malloc+0x14ca>
    3294:	232020ef          	jal	54c6 <printf>
    exit(1);
    3298:	4505                	li	a0,1
    ...
    32a4:	b3850513          	addi	a0,a0,-1224 # 6dd8 <malloc+0x185a>
    32a8:	21e020ef          	jal	54c6 <printf>
    exit(1);
    32ac:	4505                	li	a0,1
    ...
    32b8:	b4450513          	addi	a0,a0,-1212 # 6df8 <malloc+0x187a>
    32bc:	20a020ef          	jal	54c6 <printf>
    exit(1);
    32c0:	4505                	li	a0,1
    ...
    32cc:	b6050513          	addi	a0,a0,-1184 # 6e28 <malloc+0x18aa>
    32d0:	1f6020ef          	jal	54c6 <printf>
    exit(1);
    32d4:	4505                	li	a0,1
    ...
    32e0:	b6c50513          	addi	a0,a0,-1172 # 6e48 <malloc+0x18ca>
    32e4:	1e2020ef          	jal	54c6 <printf>
    exit(1);
    32e8:	4505                	li	a0,1
...
00000000000032ee <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    32fe:	b6650513          	addi	a0,a0,-1178 # 6e60 <malloc+0x18e2>
    3302:	5dd010ef          	jal	50de <mkdir>
    3306:	e53d                	bnez	a0,3374 <rmdot+0x86>
  if(chdir("dots") != 0){
    3308:	00004517          	auipc	a0,0x4
    330c:	b5850513          	addi	a0,a0,-1192 # 6e60 <malloc+0x18e2>
    3310:	5d7010ef          	jal	50e6 <chdir>
    3314:	e935                	bnez	a0,3388 <rmdot+0x9a>
  if(unlink(".") == 0){
    3316:	00003517          	auipc	a0,0x3
    331a:	a7a50513          	addi	a0,a0,-1414 # 5d90 <malloc+0x812>
    331e:	5a9010ef          	jal	50c6 <unlink>
    3322:	cd2d                	beqz	a0,339c <rmdot+0xae>
  if(unlink("..") == 0){
    3324:	00003517          	auipc	a0,0x3
    3328:	58c50513          	addi	a0,a0,1420 # 68b0 <malloc+0x1332>
    332c:	59b010ef          	jal	50c6 <unlink>
    3330:	c141                	beqz	a0,33b0 <rmdot+0xc2>
  if(chdir("/") != 0){
    3332:	00003517          	auipc	a0,0x3
    3336:	52650513          	addi	a0,a0,1318 # 6858 <malloc+0x12da>
    333a:	5ad010ef          	jal	50e6 <chdir>
    333e:	e159                	bnez	a0,33c4 <rmdot+0xd6>
  if(unlink("dots/.") == 0){
    3340:	00004517          	auipc	a0,0x4
    3344:	b8850513          	addi	a0,a0,-1144 # 6ec8 <malloc+0x194a>
    3348:	57f010ef          	jal	50c6 <unlink>
    334c:	c551                	beqz	a0,33d8 <rmdot+0xea>
  if(unlink("dots/..") == 0){
    334e:	00004517          	auipc	a0,0x4
    3352:	ba250513          	addi	a0,a0,-1118 # 6ef0 <malloc+0x1972>
    3356:	571010ef          	jal	50c6 <unlink>
    335a:	c949                	beqz	a0,33ec <rmdot+0xfe>
  if(unlink("dots") != 0){
    335c:	00004517          	auipc	a0,0x4
    3360:	b0450513          	addi	a0,a0,-1276 # 6e60 <malloc+0x18e2>
    3364:	563010ef          	jal	50c6 <unlink>
    ...
    337a:	af250513          	addi	a0,a0,-1294 # 6e68 <malloc+0x18ea>
    337e:	148020ef          	jal	54c6 <printf>
    exit(1);
    3382:	4505                	li	a0,1
    ...
    338e:	af650513          	addi	a0,a0,-1290 # 6e80 <malloc+0x1902>
    3392:	134020ef          	jal	54c6 <printf>
    exit(1);
    3396:	4505                	li	a0,1
    ...
    33a2:	afa50513          	addi	a0,a0,-1286 # 6e98 <malloc+0x191a>
    33a6:	120020ef          	jal	54c6 <printf>
    exit(1);
    33aa:	4505                	li	a0,1
    ...
    33b6:	afe50513          	addi	a0,a0,-1282 # 6eb0 <malloc+0x1932>
    33ba:	10c020ef          	jal	54c6 <printf>
    exit(1);
    33be:	4505                	li	a0,1
    ...
    33ca:	49a50513          	addi	a0,a0,1178 # 6860 <malloc+0x12e2>
    33ce:	0f8020ef          	jal	54c6 <printf>
    exit(1);
    33d2:	4505                	li	a0,1
    ...
    33de:	af650513          	addi	a0,a0,-1290 # 6ed0 <malloc+0x1952>
    33e2:	0e4020ef          	jal	54c6 <printf>
    exit(1);
    33e6:	4505                	li	a0,1
    ...
    33f2:	b0a50513          	addi	a0,a0,-1270 # 6ef8 <malloc+0x197a>
    33f6:	0d0020ef          	jal	54c6 <printf>
    exit(1);
    33fa:	4505                	li	a0,1
    ...
    3406:	b1650513          	addi	a0,a0,-1258 # 6f18 <malloc+0x199a>
    340a:	0bc020ef          	jal	54c6 <printf>
    exit(1);
    340e:	4505                	li	a0,1
...
0000000000003414 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    342a:	b1250513          	addi	a0,a0,-1262 # 6f38 <malloc+0x19ba>
    342e:	489010ef          	jal	50b6 <open>
  if(fd < 0){
  ...
  if(chdir("dirfile") == 0){
    ...
    343e:	afe50513          	addi	a0,a0,-1282 # 6f38 <malloc+0x19ba>
    3442:	4a5010ef          	jal	50e6 <chdir>
    3446:	c569                	beqz	a0,3510 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    3448:	4581                	li	a1,0
    344a:	00004517          	auipc	a0,0x4
    344e:	b3650513          	addi	a0,a0,-1226 # 6f80 <malloc+0x1a02>
    3452:	465010ef          	jal	50b6 <open>
  if(fd >= 0){
    3456:	0c055763          	bgez	a0,3524 <dirfile+0x110>
  fd = open("dirfile/xx", O_CREATE);
    345a:	20000593          	li	a1,512
    345e:	00004517          	auipc	a0,0x4
    3462:	b2250513          	addi	a0,a0,-1246 # 6f80 <malloc+0x1a02>
    3466:	451010ef          	jal	50b6 <open>
  if(fd >= 0){
    346a:	0c055763          	bgez	a0,3538 <dirfile+0x124>
  if(mkdir("dirfile/xx") == 0){
    346e:	00004517          	auipc	a0,0x4
    3472:	b1250513          	addi	a0,a0,-1262 # 6f80 <malloc+0x1a02>
    3476:	469010ef          	jal	50de <mkdir>
    347a:	0c050963          	beqz	a0,354c <dirfile+0x138>
  if(unlink("dirfile/xx") == 0){
    347e:	00004517          	auipc	a0,0x4
    3482:	b0250513          	addi	a0,a0,-1278 # 6f80 <malloc+0x1a02>
    3486:	441010ef          	jal	50c6 <unlink>
    348a:	0c050b63          	beqz	a0,3560 <dirfile+0x14c>
  if(link("README", "dirfile/xx") == 0){
    348e:	00004597          	auipc	a1,0x4
    3492:	af258593          	addi	a1,a1,-1294 # 6f80 <malloc+0x1a02>
    3496:	00002517          	auipc	a0,0x2
    349a:	3ea50513          	addi	a0,a0,1002 # 5880 <malloc+0x302>
    349e:	439010ef          	jal	50d6 <link>
    34a2:	0c050963          	beqz	a0,3574 <dirfile+0x160>
  if(unlink("dirfile") != 0){
    34a6:	00004517          	auipc	a0,0x4
    34aa:	a9250513          	addi	a0,a0,-1390 # 6f38 <malloc+0x19ba>
    34ae:	419010ef          	jal	50c6 <unlink>
    34b2:	0c051b63          	bnez	a0,3588 <dirfile+0x174>
  fd = open(".", O_RDWR);
    34b6:	4589                	li	a1,2
    34b8:	00003517          	auipc	a0,0x3
    34bc:	8d850513          	addi	a0,a0,-1832 # 5d90 <malloc+0x812>
    34c0:	3f7010ef          	jal	50b6 <open>
  if(fd >= 0){
    34c4:	0c055c63          	bgez	a0,359c <dirfile+0x188>
  fd = open(".", 0);
    34c8:	4581                	li	a1,0
    34ca:	00003517          	auipc	a0,0x3
    34ce:	8c650513          	addi	a0,a0,-1850 # 5d90 <malloc+0x812>
    34d2:	3e5010ef          	jal	50b6 <open>
    34d6:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    34d8:	4605                	li	a2,1
    34da:	00002597          	auipc	a1,0x2
    34de:	23e58593          	addi	a1,a1,574 # 5718 <malloc+0x19a>
  ...
  close(fd);
    ...
    3502:	a4250513          	addi	a0,a0,-1470 # 6f40 <malloc+0x19c2>
    3506:	7c1010ef          	jal	54c6 <printf>
    exit(1);
    350a:	4505                	li	a0,1
    ...
    3516:	a4e50513          	addi	a0,a0,-1458 # 6f60 <malloc+0x19e2>
    351a:	7ad010ef          	jal	54c6 <printf>
    exit(1);
    351e:	4505                	li	a0,1
    ...
    352a:	a6a50513          	addi	a0,a0,-1430 # 6f90 <malloc+0x1a12>
    352e:	799010ef          	jal	54c6 <printf>
    exit(1);
    3532:	4505                	li	a0,1
    ...
    353e:	a5650513          	addi	a0,a0,-1450 # 6f90 <malloc+0x1a12>
    3542:	785010ef          	jal	54c6 <printf>
    exit(1);
    3546:	4505                	li	a0,1
    ...
    3552:	a6a50513          	addi	a0,a0,-1430 # 6fb8 <malloc+0x1a3a>
    3556:	771010ef          	jal	54c6 <printf>
    exit(1);
    355a:	4505                	li	a0,1
    ...
    3566:	a7e50513          	addi	a0,a0,-1410 # 6fe0 <malloc+0x1a62>
    356a:	75d010ef          	jal	54c6 <printf>
    exit(1);
    356e:	4505                	li	a0,1
    ...
    357a:	a9250513          	addi	a0,a0,-1390 # 7008 <malloc+0x1a8a>
    357e:	749010ef          	jal	54c6 <printf>
    exit(1);
    3582:	4505                	li	a0,1
    ...
    358e:	aa650513          	addi	a0,a0,-1370 # 7030 <malloc+0x1ab2>
    3592:	735010ef          	jal	54c6 <printf>
    exit(1);
    3596:	4505                	li	a0,1
    ...
    35a2:	ab250513          	addi	a0,a0,-1358 # 7050 <malloc+0x1ad2>
    35a6:	721010ef          	jal	54c6 <printf>
    exit(1);
    35aa:	4505                	li	a0,1
    ...
    35b6:	ac650513          	addi	a0,a0,-1338 # 7078 <malloc+0x1afa>
    35ba:	70d010ef          	jal	54c6 <printf>
    exit(1);
    35be:	4505                	li	a0,1
...
00000000000035c4 <iref>:
{
    ...
    35e4:	ab0a8a93          	addi	s5,s5,-1360 # 7090 <malloc+0x1b12>
    mkdir("");
    35e8:	00003497          	auipc	s1,0x3
    35ec:	5b048493          	addi	s1,s1,1456 # 6b98 <malloc+0x161a>
    link("README", "");
    35f0:	00002b17          	auipc	s6,0x2
    35f4:	290b0b13          	addi	s6,s6,656 # 5880 <malloc+0x302>
    fd = open("", O_CREATE);
    35f8:	20000a13          	li	s4,512
    fd = open("xx", O_CREATE);
    35fc:	00004997          	auipc	s3,0x4
    3600:	98c98993          	addi	s3,s3,-1652 # 6f88 <malloc+0x1a0a>
    3604:	a835                	j	3640 <iref+0x7c>
      printf("%s: mkdir irefd failed\n", s);
    3606:	85de                	mv	a1,s7
    3608:	00004517          	auipc	a0,0x4
    360c:	a9050513          	addi	a0,a0,-1392 # 7098 <malloc+0x1b1a>
    3610:	6b7010ef          	jal	54c6 <printf>
      exit(1);
    3614:	4505                	li	a0,1
    ...
    3620:	a9450513          	addi	a0,a0,-1388 # 70b0 <malloc+0x1b32>
    3624:	6a3010ef          	jal	54c6 <printf>
      exit(1);
    3628:	4505                	li	a0,1
    ...
    unlink("xx");
    3634:	854e                	mv	a0,s3
    3636:	291010ef          	jal	50c6 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    363a:	397d                	addiw	s2,s2,-1
    363c:	04090063          	beqz	s2,367c <iref+0xb8>
    if(mkdir("irefd") != 0){
    3640:	8556                	mv	a0,s5
    3642:	29d010ef          	jal	50de <mkdir>
    3646:	f161                	bnez	a0,3606 <iref+0x42>
    if(chdir("irefd") != 0){
    3648:	8556                	mv	a0,s5
    364a:	29d010ef          	jal	50e6 <chdir>
    364e:	f571                	bnez	a0,361a <iref+0x56>
    mkdir("");
    3650:	8526                	mv	a0,s1
    3652:	28d010ef          	jal	50de <mkdir>
    link("README", "");
    3656:	85a6                	mv	a1,s1
    3658:	855a                	mv	a0,s6
    365a:	27d010ef          	jal	50d6 <link>
    fd = open("", O_CREATE);
    365e:	85d2                	mv	a1,s4
    3660:	8526                	mv	a0,s1
    3662:	255010ef          	jal	50b6 <open>
    if(fd >= 0)
    3666:	fc0554e3          	bgez	a0,362e <iref+0x6a>
    fd = open("xx", O_CREATE);
    366a:	85d2                	mv	a1,s4
    366c:	854e                	mv	a0,s3
    366e:	249010ef          	jal	50b6 <open>
    if(fd >= 0)
    ...
    3684:	23098993          	addi	s3,s3,560 # 68b0 <malloc+0x1332>
    unlink("irefd");
    3688:	00004917          	auipc	s2,0x4
    368c:	a0890913          	addi	s2,s2,-1528 # 7090 <malloc+0x1b12>
    chdir("..");
    3690:	854e                	mv	a0,s3
    3692:	255010ef          	jal	50e6 <chdir>
    unlink("irefd");
    3696:	854a                	mv	a0,s2
    3698:	22f010ef          	jal	50c6 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    369c:	34fd                	addiw	s1,s1,-1
    369e:	f8ed                	bnez	s1,3690 <iref+0xcc>
  chdir("/");
    36a0:	00003517          	auipc	a0,0x3
    36a4:	1b850513          	addi	a0,a0,440 # 6858 <malloc+0x12da>
    36a8:	23f010ef          	jal	50e6 <chdir>
}
...
00000000000036c2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    36d2:	9fa50513          	addi	a0,a0,-1542 # 70c8 <malloc+0x1b4a>
    36d6:	209010ef          	jal	50de <mkdir>
  ...
  if(pid == 0){
    ...
    36ee:	9de50513          	addi	a0,a0,-1570 # 70c8 <malloc+0x1b4a>
    36f2:	1c5010ef          	jal	50b6 <open>
    if(fd >= 0){
    36f6:	04054063          	bltz	a0,3736 <openiputtest+0x74>
      printf("%s: open directory for write succeeded\n", s);
    36fa:	85a6                	mv	a1,s1
    36fc:	00004517          	auipc	a0,0x4
    3700:	9ec50513          	addi	a0,a0,-1556 # 70e8 <malloc+0x1b6a>
    3704:	5c3010ef          	jal	54c6 <printf>
      exit(1);
    3708:	4505                	li	a0,1
    ...
    3714:	9c050513          	addi	a0,a0,-1600 # 70d0 <malloc+0x1b52>
    3718:	5af010ef          	jal	54c6 <printf>
    exit(1);
    371c:	4505                	li	a0,1
    371e:	0cd010ef          	jal	4fea <exit>
    printf("%s: fork failed\n", s);
    3722:	85a6                	mv	a1,s1
    3724:	00003517          	auipc	a0,0x3
    3728:	81450513          	addi	a0,a0,-2028 # 5f38 <malloc+0x9ba>
    372c:	59b010ef          	jal	54c6 <printf>
    exit(1);
    3730:	4505                	li	a0,1
  ...
  pause(1);
    373c:	4505                	li	a0,1
    373e:	1c9010ef          	jal	5106 <pause>
  if(unlink("oidir") != 0){
    3742:	00004517          	auipc	a0,0x4
    3746:	98650513          	addi	a0,a0,-1658 # 70c8 <malloc+0x1b4a>
    374a:	17d010ef          	jal	50c6 <unlink>
    374e:	c919                	beqz	a0,3764 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    3750:	85a6                	mv	a1,s1
    3752:	00003517          	auipc	a0,0x3
    3756:	9d650513          	addi	a0,a0,-1578 # 6128 <malloc+0xbaa>
    375a:	56d010ef          	jal	54c6 <printf>
    exit(1);
    375e:	4505                	li	a0,1
...
0000000000003774 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3784:	99050513          	addi	a0,a0,-1648 # 7110 <malloc+0x1b92>
    3788:	13f010ef          	jal	50c6 <unlink>
  int pid = fork();
  ...
  pause(20); // two seconds
    3796:	4551                	li	a0,20
    3798:	16f010ef          	jal	5106 <pause>
  close(open("stopforking", O_CREATE|O_RDWR));
    379c:	20200593          	li	a1,514
    37a0:	00004517          	auipc	a0,0x4
    37a4:	97050513          	addi	a0,a0,-1680 # 7110 <malloc+0x1b92>
    37a8:	10f010ef          	jal	50b6 <open>
  ...
  pause(10); // one second
    ...
    37cc:	93050513          	addi	a0,a0,-1744 # 60f8 <malloc+0xb7a>
    37d0:	4f7010ef          	jal	54c6 <printf>
    exit(1);
    37d4:	4505                	li	a0,1
    ...
    37e0:	93450513          	addi	a0,a0,-1740 # 7110 <malloc+0x1b92>
    37e4:	0d3010ef          	jal	50b6 <open>
      if(fd >= 0){
    ...
    37fc:	91850513          	addi	a0,a0,-1768 # 7110 <malloc+0x1b92>
    3800:	0b7010ef          	jal	50b6 <open>
...
0000000000003810 <killstatus>:
{
    ...
    pause(1);
    383e:	8556                	mv	a0,s5
    3840:	0c7010ef          	jal	5106 <pause>
    kill(pid1);
    3844:	8526                	mv	a0,s1
    3846:	061010ef          	jal	50a6 <kill>
    wait(&xst);
    384a:	8552                	mv	a0,s4
  ...
  exit(0);
    ...
    386a:	6d250513          	addi	a0,a0,1746 # 5f38 <malloc+0x9ba>
    386e:	459010ef          	jal	54c6 <printf>
      exit(1);
    3872:	4505                	li	a0,1
    3874:	776010ef          	jal	4fea <exit>
        getpid();
    3878:	07f010ef          	jal	50f6 <getpid>
      while(1) {
    387c:	bff5                	j	3878 <killstatus+0x68>
       printf("%s: status should be -1\n", s);
    387e:	85da                	mv	a1,s6
    3880:	00004517          	auipc	a0,0x4
    3884:	8a050513          	addi	a0,a0,-1888 # 7120 <malloc+0x1ba2>
    3888:	43f010ef          	jal	54c6 <printf>
       exit(1);
    388c:	4505                	li	a0,1
...
0000000000003892 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    38b8:	84450513          	addi	a0,a0,-1980 # 60f8 <malloc+0xb7a>
    38bc:	40b010ef          	jal	54c6 <printf>
    exit(1);
    38c0:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    38da:	66250513          	addi	a0,a0,1634 # 5f38 <malloc+0x9ba>
    38de:	3e9010ef          	jal	54c6 <printf>
    exit(1);
    38e2:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    390a:	e1258593          	addi	a1,a1,-494 # 5718 <malloc+0x19a>
    ...
    392c:	61050513          	addi	a0,a0,1552 # 5f38 <malloc+0x9ba>
    3930:	397010ef          	jal	54c6 <printf>
     exit(1);
    3934:	4505                	li	a0,1
    ...
    3940:	80450513          	addi	a0,a0,-2044 # 7140 <malloc+0x1bc2>
    3944:	383010ef          	jal	54c6 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3970:	7ec50513          	addi	a0,a0,2028 # 7158 <malloc+0x1bda>
    3974:	353010ef          	jal	54c6 <printf>
}
  ...
  printf("kill... ");
    ...
    3994:	7e050513          	addi	a0,a0,2016 # 7170 <malloc+0x1bf2>
    3998:	32f010ef          	jal	54c6 <printf>
  kill(pid1);
    399c:	8526                	mv	a0,s1
    399e:	708010ef          	jal	50a6 <kill>
  kill(pid2);
    39a2:	854e                	mv	a0,s3
    39a4:	702010ef          	jal	50a6 <kill>
  kill(pid3);
    39a8:	8552                	mv	a0,s4
    39aa:	6fc010ef          	jal	50a6 <kill>
  printf("wait... ");
    39ae:	00003517          	auipc	a0,0x3
    39b2:	7d250513          	addi	a0,a0,2002 # 7180 <malloc+0x1c02>
    39b6:	311010ef          	jal	54c6 <printf>
  wait(0);
    39ba:	4501                	li	a0,0
...
00000000000039ce <reparent>:
{
  ...
  exit(0);
    ...
    3a12:	52a50513          	addi	a0,a0,1322 # 5f38 <malloc+0x9ba>
    3a16:	2b1010ef          	jal	54c6 <printf>
      exit(1);
    3a1a:	4505                	li	a0,1
    ...
    3a26:	69e50513          	addi	a0,a0,1694 # 60c0 <malloc+0xb42>
    3a2a:	29d010ef          	jal	54c6 <printf>
        exit(1);
    3a2e:	4505                	li	a0,1
...
0000000000003a4e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3a8e:	5b650513          	addi	a0,a0,1462 # 6040 <malloc+0xac2>
    3a92:	235010ef          	jal	54c6 <printf>
    exit(1);
    3a96:	4505                	li	a0,1
  ...
  c = sbrk(PGSIZE);
    ...
    3b30:	66c50513          	addi	a0,a0,1644 # 7198 <malloc+0x1c1a>
    3b34:	193010ef          	jal	54c6 <printf>
  ...
  if(pid == 0){
    ...
    3b7a:	67250513          	addi	a0,a0,1650 # 71e8 <malloc+0x1c6a>
    3b7e:	149010ef          	jal	54c6 <printf>
    exit(1);
    3b82:	4505                	li	a0,1
    ...
    3b8e:	63e50513          	addi	a0,a0,1598 # 71c8 <malloc+0x1c4a>
    3b92:	135010ef          	jal	54c6 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba2:	39a50513          	addi	a0,a0,922 # 5f38 <malloc+0x9ba>
    3ba6:	121010ef          	jal	54c6 <printf>
    exit(1);
    3baa:	4505                	li	a0,1
...
0000000000003be2 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3c26:	6084                	ld	s1,0(s1)
      free(m1);
    3c28:	0d1010ef          	jal	54f8 <free>
    while(m1){
    3c2c:	fce5                	bnez	s1,3c24 <mem+0x42>
    m1 = malloc(1024*20);
    3c2e:	6515                	lui	a0,0x5
    3c30:	14f010ef          	jal	557e <malloc>
    if(m1 == 0){
    3c34:	c511                	beqz	a0,3c40 <mem+0x5e>
    free(m1);
    3c36:	0c3010ef          	jal	54f8 <free>
    exit(0);
    3c3a:	4501                	li	a0,0
    ...
    3c46:	5d650513          	addi	a0,a0,1494 # 7218 <malloc+0x1c9a>
    3c4a:	07d010ef          	jal	54c6 <printf>
      exit(1);
    3c4e:	4505                	li	a0,1
...
0000000000003c5a <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3c6e:	5ce50513          	addi	a0,a0,1486 # 7238 <malloc+0x1cba>
    3c72:	454010ef          	jal	50c6 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3c76:	20200593          	li	a1,514
    3c7a:	00003517          	auipc	a0,0x3
    3c7e:	5be50513          	addi	a0,a0,1470 # 7238 <malloc+0x1cba>
    3c82:	434010ef          	jal	50b6 <open>
  if(fd < 0){
  ...
  if(pid == 0) {
    ...
    3ce6:	56650513          	addi	a0,a0,1382 # 7248 <malloc+0x1cca>
    3cea:	7dc010ef          	jal	54c6 <printf>
    exit(1);
    3cee:	4505                	li	a0,1
    ...
    3cfc:	57850513          	addi	a0,a0,1400 # 7270 <malloc+0x1cf2>
    3d00:	7c6010ef          	jal	54c6 <printf>
      exit(1);
    3d04:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3d30:	50c50513          	addi	a0,a0,1292 # 7238 <malloc+0x1cba>
    3d34:	382010ef          	jal	50b6 <open>
    3d38:	8baa                	mv	s7,a0
  nc = np = 0;
    3d3a:	89d2                	mv	s3,s4
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3d68:	52c50513          	addi	a0,a0,1324 # 7290 <malloc+0x1d12>
    3d6c:	75a010ef          	jal	54c6 <printf>
    exit(1);
    3d70:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3d98:	4a450513          	addi	a0,a0,1188 # 7238 <malloc+0x1cba>
    3d9c:	32a010ef          	jal	50c6 <unlink>
  if(nc == N*SZ && np == N*SZ){
    ...
    3dba:	50250513          	addi	a0,a0,1282 # 72b8 <malloc+0x1d3a>
    3dbe:	708010ef          	jal	54c6 <printf>
    exit(1);
    3dc2:	4505                	li	a0,1
...
0000000000003dc8 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3dec:	4e878793          	addi	a5,a5,1256 # 72d0 <malloc+0x1d52>
    3df0:	f6f43823          	sd	a5,-144(s0)
    3df4:	00003797          	auipc	a5,0x3
    3df8:	4e478793          	addi	a5,a5,1252 # 72d8 <malloc+0x1d5a>
    3dfc:	f6f43c23          	sd	a5,-136(s0)
    3e00:	00003797          	auipc	a5,0x3
    3e04:	4e078793          	addi	a5,a5,1248 # 72e0 <malloc+0x1d62>
    3e08:	f8f43023          	sd	a5,-128(s0)
    3e0c:	00003797          	auipc	a5,0x3
    3e10:	4dc78793          	addi	a5,a5,1244 # 72e8 <malloc+0x1d6a>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e76:	0c650513          	addi	a0,a0,198 # 5f38 <malloc+0x9ba>
    3e7a:	64c010ef          	jal	54c6 <printf>
      exit(1);
    3e7e:	4505                	li	a0,1
    ...
    3ed6:	0fe50513          	addi	a0,a0,254 # 5fd0 <malloc+0xa52>
    3eda:	5ec010ef          	jal	54c6 <printf>
        exit(1);
    3ede:	4505                	li	a0,1
    3ee0:	10a010ef          	jal	4fea <exit>
          printf("write failed %d\n", n);
    3ee4:	00003517          	auipc	a0,0x3
    3ee8:	40c50513          	addi	a0,a0,1036 # 72f0 <malloc+0x1d72>
    3eec:	5da010ef          	jal	54c6 <printf>
          exit(1);
    3ef0:	4505                	li	a0,1
    ...
    3f02:	40a50513          	addi	a0,a0,1034 # 7308 <malloc+0x1d8a>
    3f06:	5c0010ef          	jal	54c6 <printf>
          exit(1);
    3f0a:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3f6c:	3b050513          	addi	a0,a0,944 # 7318 <malloc+0x1d9a>
    3f70:	556010ef          	jal	54c6 <printf>
      exit(1);
    3f74:	4505                	li	a0,1
...
0000000000003f98 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3fda:	35ac8c93          	addi	s9,s9,858 # 7330 <malloc+0x1db2>
      wait(&xstatus);
  ...
  for(i = 0; i < N; i++){
    ...
    401e:	098010ef          	jal	50b6 <open>
      if(fd < 0){
    4022:	1c055f63          	bgez	a0,4200 <concreate+0x268>
        printf("concreate create %s failed\n", file);
    4026:	f9840593          	addi	a1,s0,-104
    402a:	00003517          	auipc	a0,0x3
    402e:	30e50513          	addi	a0,a0,782 # 7338 <malloc+0x1dba>
    4032:	494010ef          	jal	54c6 <printf>
        exit(1);
    4036:	4505                	li	a0,1
    ...
    4044:	2f050513          	addi	a0,a0,752 # 7330 <malloc+0x1db2>
    4048:	08e010ef          	jal	50d6 <link>
      exit(0);
    404c:	4501                	li	a0,0
  ...
  fd = open(".", 0);
    ...
    406c:	d2850513          	addi	a0,a0,-728 # 5d90 <malloc+0x812>
    4070:	046010ef          	jal	50b6 <open>
    4074:	892a                	mv	s2,a0
  n = 0;
    4076:	8b26                	mv	s6,s1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    40da:	28250513          	addi	a0,a0,642 # 7358 <malloc+0x1dda>
    40de:	3e8010ef          	jal	54c6 <printf>
        exit(1);
    40e2:	4505                	li	a0,1
    ...
    40f2:	28a50513          	addi	a0,a0,650 # 7378 <malloc+0x1dfa>
    40f6:	3d0010ef          	jal	54c6 <printf>
        exit(1);
    40fa:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4124:	28050513          	addi	a0,a0,640 # 73a0 <malloc+0x1e22>
    4128:	39e010ef          	jal	54c6 <printf>
    exit(1);
    412c:	4505                	li	a0,1
    ...
    4138:	e0450513          	addi	a0,a0,-508 # 5f38 <malloc+0x9ba>
    413c:	38a010ef          	jal	54c6 <printf>
      exit(1);
    4140:	4505                	li	a0,1
    ...
    4146:	4581                	li	a1,0
    4148:	854e                	mv	a0,s3
    414a:	76d000ef          	jal	50b6 <open>
    414e:	6c5000ef          	jal	5012 <close>
      close(open(file, 0));
    4152:	4581                	li	a1,0
    4154:	854e                	mv	a0,s3
    4156:	761000ef          	jal	50b6 <open>
    415a:	6b9000ef          	jal	5012 <close>
      close(open(file, 0));
    415e:	4581                	li	a1,0
    4160:	854e                	mv	a0,s3
    4162:	755000ef          	jal	50b6 <open>
    4166:	6ad000ef          	jal	5012 <close>
      close(open(file, 0));
    416a:	4581                	li	a1,0
    416c:	854e                	mv	a0,s3
    416e:	749000ef          	jal	50b6 <open>
    4172:	6a1000ef          	jal	5012 <close>
      close(open(file, 0));
    4176:	4581                	li	a1,0
    4178:	854e                	mv	a0,s3
    417a:	73d000ef          	jal	50b6 <open>
    417e:	695000ef          	jal	5012 <close>
      close(open(file, 0));
    4182:	4581                	li	a1,0
    4184:	854e                	mv	a0,s3
    4186:	731000ef          	jal	50b6 <open>
  ...
  for(i = 0; i < N; i++){
    ...
    41d2:	dbb5                	beqz	a5,4146 <concreate+0x1ae>
      unlink(file);
    41d4:	854e                	mv	a0,s3
    41d6:	6f1000ef          	jal	50c6 <unlink>
      unlink(file);
    41da:	854e                	mv	a0,s3
    41dc:	6eb000ef          	jal	50c6 <unlink>
      unlink(file);
    41e0:	854e                	mv	a0,s3
    41e2:	6e5000ef          	jal	50c6 <unlink>
      unlink(file);
    41e6:	854e                	mv	a0,s3
    41e8:	6df000ef          	jal	50c6 <unlink>
      unlink(file);
    41ec:	854e                	mv	a0,s3
    41ee:	6d9000ef          	jal	50c6 <unlink>
      unlink(file);
    41f2:	854e                	mv	a0,s3
    41f4:	6d3000ef          	jal	50c6 <unlink>
...
0000000000004278 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    4292:	14a50513          	addi	a0,a0,330 # 73d8 <malloc+0x1e5a>
    4296:	631000ef          	jal	50c6 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    429a:	20200593          	li	a1,514
    429e:	00003517          	auipc	a0,0x3
    42a2:	13a50513          	addi	a0,a0,314 # 73d8 <malloc+0x1e5a>
    42a6:	611000ef          	jal	50b6 <open>
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    42ea:	0f250513          	addi	a0,a0,242 # 73d8 <malloc+0x1e5a>
    42ee:	5c9000ef          	jal	50b6 <open>
    42f2:	8aaa                	mv	s5,a0
  total = 0;
    42f4:	4a01                	li	s4,0
  for(i = 0; ; i++){
  ...
  for(i = 0; ; i++){
    ...
    4344:	0a850513          	addi	a0,a0,168 # 73e8 <malloc+0x1e6a>
    4348:	17e010ef          	jal	54c6 <printf>
    exit(1);
    434c:	4505                	li	a0,1
    ...
    4358:	0b450513          	addi	a0,a0,180 # 7408 <malloc+0x1e8a>
    435c:	16a010ef          	jal	54c6 <printf>
      exit(1);
    4360:	4505                	li	a0,1
    ...
    436c:	0c050513          	addi	a0,a0,192 # 7428 <malloc+0x1eaa>
    4370:	156010ef          	jal	54c6 <printf>
    exit(1);
    4374:	4505                	li	a0,1
    ...
    4380:	0cc50513          	addi	a0,a0,204 # 7448 <malloc+0x1eca>
    4384:	142010ef          	jal	54c6 <printf>
      exit(1);
    4388:	4505                	li	a0,1
    ...
    4394:	0d850513          	addi	a0,a0,216 # 7468 <malloc+0x1eea>
    4398:	12e010ef          	jal	54c6 <printf>
      exit(1);
    439c:	4505                	li	a0,1
    ...
    43a8:	0dc50513          	addi	a0,a0,220 # 7480 <malloc+0x1f02>
    43ac:	11a010ef          	jal	54c6 <printf>
      exit(1);
    43b0:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    43ca:	01250513          	addi	a0,a0,18 # 73d8 <malloc+0x1e5a>
    43ce:	4f9000ef          	jal	50c6 <unlink>
}
    ...
    43ec:	0b850513          	addi	a0,a0,184 # 74a0 <malloc+0x1f22>
    43f0:	0d6010ef          	jal	54c6 <printf>
    exit(1);
    43f4:	4505                	li	a0,1
...
00000000000043fa <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    440a:	0ba50513          	addi	a0,a0,186 # 74c0 <malloc+0x1f42>
    440e:	4b9000ef          	jal	50c6 <unlink>
  pid = fork();
  ...
  fd = open("bigarg-ok", 0);
    ...
    4430:	09450513          	addi	a0,a0,148 # 74c0 <malloc+0x1f42>
    4434:	483000ef          	jal	50b6 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    448e:	21e50513          	addi	a0,a0,542 # 56a8 <malloc+0x12a>
    4492:	41d000ef          	jal	50ae <exec>
    fd = open("bigarg-ok", O_CREATE);
    4496:	20000593          	li	a1,512
    449a:	00003517          	auipc	a0,0x3
    449e:	02650513          	addi	a0,a0,38 # 74c0 <malloc+0x1f42>
    44a2:	415000ef          	jal	50b6 <open>
    close(fd);
    ...
    44b6:	01e50513          	addi	a0,a0,30 # 74d0 <malloc+0x1f52>
    44ba:	00c010ef          	jal	54c6 <printf>
    exit(1);
    44be:	4505                	li	a0,1
    ...
    44ce:	02650513          	addi	a0,a0,38 # 74f0 <malloc+0x1f72>
    44d2:	7f5000ef          	jal	54c6 <printf>
    exit(1);
    44d6:	4505                	li	a0,1
...
00000000000044dc <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4526:	fee50513          	addi	a0,a0,-18 # 7510 <malloc+0x1f92>
    452a:	79d000ef          	jal	54c6 <printf>
    exit(1);
    452e:	4505                	li	a0,1
    4530:	2bb000ef          	jal	4fea <exit>
      printf("failed to read value from memory\n");
    4534:	00003517          	auipc	a0,0x3
    4538:	ff450513          	addi	a0,a0,-12 # 7528 <malloc+0x1faa>
    453c:	78b000ef          	jal	54c6 <printf>
      exit(1);
    4540:	4505                	li	a0,1
...
0000000000004546 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    45b4:	f6050513          	addi	a0,a0,-160 # 7510 <malloc+0x1f92>
    45b8:	70f000ef          	jal	54c6 <printf>
    exit(1);
    45bc:	4505                	li	a0,1
    45be:	22d000ef          	jal	4fea <exit>
      printf("error forking\n");
    45c2:	00003517          	auipc	a0,0x3
    45c6:	f8e50513          	addi	a0,a0,-114 # 7550 <malloc+0x1fd2>
    45ca:	6fd000ef          	jal	54c6 <printf>
      exit(1);
    45ce:	4505                	li	a0,1
    ...
    45ea:	f7a50513          	addi	a0,a0,-134 # 7560 <malloc+0x1fe2>
    45ee:	6d9000ef          	jal	54c6 <printf>
        exit(1);
    45f2:	4505                	li	a0,1
...
00000000000045f8 <lazy_copy>:
{
    ...
    4642:	f3a50513          	addi	a0,a0,-198 # 7578 <malloc+0x1ffa>
    4646:	681000ef          	jal	54c6 <printf>
      exit(1);
    464a:	4505                	li	a0,1
    464c:	19f000ef          	jal	4fea <exit>
  unsigned long bad[] = {
    4650:	00003797          	auipc	a5,0x3
    4654:	5a078793          	addi	a5,a5,1440 # 7bf0 <malloc+0x2672>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    4684:	200a8a93          	addi	s5,s5,512 # 5880 <malloc+0x302>
    ...
    4694:	100b0b13          	addi	s6,s6,256 # 5790 <malloc+0x212>
    int fd = open("README", 0);
    4698:	4581                	li	a1,0
    469a:	8556                	mv	a0,s5
    469c:	21b000ef          	jal	50b6 <open>
    46a0:	84aa                	mv	s1,a0
  ...
  exit(0);
    ...
    46f0:	ebc50513          	addi	a0,a0,-324 # 75a8 <malloc+0x202a>
    46f4:	5d3000ef          	jal	54c6 <printf>
    46f8:	4505                	li	a0,1
    46fa:	0f1000ef          	jal	4fea <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    46fe:	00003517          	auipc	a0,0x3
    4702:	ec250513          	addi	a0,a0,-318 # 75c0 <malloc+0x2042>
    4706:	5c1000ef          	jal	54c6 <printf>
    470a:	4505                	li	a0,1
    470c:	0df000ef          	jal	4fea <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    4710:	00003517          	auipc	a0,0x3
    4714:	ec050513          	addi	a0,a0,-320 # 75d0 <malloc+0x2052>
    4718:	5af000ef          	jal	54c6 <printf>
    471c:	4505                	li	a0,1
    471e:	0cd000ef          	jal	4fea <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    4722:	00003517          	auipc	a0,0x3
    4726:	ec650513          	addi	a0,a0,-314 # 75e8 <malloc+0x206a>
    472a:	59d000ef          	jal	54c6 <printf>
    472e:	4505                	li	a0,1
...
0000000000004734 <lazy_sbrk>:
{
  ...
  if (p1 < 0 || p1 != p) {
    ...
    4786:	e7e50513          	addi	a0,a0,-386 # 7600 <malloc+0x2082>
    478a:	53d000ef          	jal	54c6 <printf>
    exit(1);
    478e:	4505                	li	a0,1
  ...
  if (p < 0 || (uint64)p != TRAPFRAME-PGSIZE) {
    ...
    47ae:	e8650513          	addi	a0,a0,-378 # 7630 <malloc+0x20b2>
    47b2:	515000ef          	jal	54c6 <printf>
    exit(1);
    47b6:	4505                	li	a0,1
  ...
  if (p[1] != 0) {
    ...
    47d4:	e9850513          	addi	a0,a0,-360 # 7668 <malloc+0x20ea>
    47d8:	4ef000ef          	jal	54c6 <printf>
    exit(1);
    47dc:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    47f4:	ea050513          	addi	a0,a0,-352 # 7690 <malloc+0x2112>
    47f8:	4cf000ef          	jal	54c6 <printf>
    exit(1);
    47fc:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4814:	ea850513          	addi	a0,a0,-344 # 76b8 <malloc+0x213a>
    4818:	4af000ef          	jal	54c6 <printf>
    exit(1);
    481c:	4505                	li	a0,1
...
0000000000004828 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    484a:	ea250513          	addi	a0,a0,-350 # 76e8 <malloc+0x216a>
    484e:	479000ef          	jal	54c6 <printf>
  for(nfiles = 0; ; nfiles++){
    4852:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4900:	dfc50513          	addi	a0,a0,-516 # 76f8 <malloc+0x217a>
    4904:	3c3000ef          	jal	54c6 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    4908:	20200593          	li	a1,514
    490c:	856a                	mv	a0,s10
    490e:	7a8000ef          	jal	50b6 <open>
    4912:	892a                	mv	s2,a0
    if(fd < 0){
    ...
    4920:	dec50513          	addi	a0,a0,-532 # 7708 <malloc+0x218a>
    4924:	3a3000ef          	jal	54c6 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    49e4:	d4850513          	addi	a0,a0,-696 # 7728 <malloc+0x21aa>
    49e8:	2df000ef          	jal	54c6 <printf>
}
    ...
    4a36:	ce650513          	addi	a0,a0,-794 # 7718 <malloc+0x219a>
    4a3a:	28d000ef          	jal	54c6 <printf>
    close(fd);
    4a3e:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4a60:	ce450513          	addi	a0,a0,-796 # 7740 <malloc+0x21c2>
    4a64:	263000ef          	jal	54c6 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4a84:	ce850513          	addi	a0,a0,-792 # 7768 <malloc+0x21ea>
    4a88:	23f000ef          	jal	54c6 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4aa4:	cb050513          	addi	a0,a0,-848 # 7750 <malloc+0x21d2>
    4aa8:	21f000ef          	jal	54c6 <printf>
    exit(1);
    4aac:	4505                	li	a0,1
    ...
    4ac0:	cb450513          	addi	a0,a0,-844 # 7770 <malloc+0x21f2>
    4ac4:	203000ef          	jal	54c6 <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    4b12:	c6a50513          	addi	a0,a0,-918 # 7778 <malloc+0x21fa>
    4b16:	1b1000ef          	jal	54c6 <printf>
          return -1;
    4b1a:	59fd                	li	s3,-1
...
drivetests(int quick, int continuous, char *justone) {
    ...
    4bb0:	be4c0c13          	addi	s8,s8,-1052 # 7790 <malloc+0x2212>
    ...
    4bca:	c02d8d93          	addi	s11,s11,-1022 # 77c8 <malloc+0x224a>
    ...
    4bdc:	bd050513          	addi	a0,a0,-1072 # 77a8 <malloc+0x222a>
    4be0:	0e7000ef          	jal	54c6 <printf>
    ...
    4c4e:	bae50513          	addi	a0,a0,-1106 # 77f8 <malloc+0x227a>
    4c52:	075000ef          	jal	54c6 <printf>
      return 1;
    4c56:	4505                	li	a0,1
  return 0;
}
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4cb4:	b6058593          	addi	a1,a1,-1184 # 7810 <malloc+0x2292>
  ...
  int continuous = 0;
    ...
    4d08:	b1c50513          	addi	a0,a0,-1252 # 7820 <malloc+0x22a2>
    4d0c:	7ba000ef          	jal	54c6 <printf>
    exit(1);
    4d10:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4d26:	b2e50513          	addi	a0,a0,-1234 # 7850 <malloc+0x22d2>
    4d2a:	79c000ef          	jal	54c6 <printf>
  exit(0);
    4d2e:	4501                	li	a0,0
...
sbrk(int n) {
  ...
  return sys_sbrk(n, SBRK_EAGER);
    4fbe:	4585                	li	a1,1
    4fc0:	13e000ef          	jal	50fe <sys_sbrk>
}
...
sbrklazy(int n) {
  ...
  return sys_sbrk(n, SBRK_LAZY);
    4fd4:	4589                	li	a1,2
    4fd6:	128000ef          	jal	50fe <sys_sbrk>
}
...
000000000000506a <recvmsg>:
.global recvmsg
recvmsg:
 li a7, SYS_recvmsg
    506a:	02000893          	li	a7,32
 ecall
    506e:	00000073          	ecall
 ret
    5072:	8082                	ret

0000000000005074 <broadcast>:
.global broadcast
broadcast:
 li a7, SYS_broadcast
    5074:	02100893          	li	a7,33
 ecall
    5078:	00000073          	ecall
 ret
    507c:	8082                	ret

000000000000507e <getprocsinfo>:
.global getprocsinfo
getprocsinfo:
 li a7, SYS_getprocsinfo
    507e:	02200893          	li	a7,34
 ecall
    5082:	00000073          	ecall
 ret
    5086:	8082                	ret

0000000000005088 <getppid>:
.global getppid
getppid:
 li a7, SYS_getppid
    5088:	02300893          	li	a7,35
 ecall
    508c:	00000073          	ecall
 ret
    5090:	8082                	ret

0000000000005092 <sleep2>:
.global sleep2
sleep2:
 li a7, SYS_sleep2
    5092:	02400893          	li	a7,36
 ecall
    5096:	00000073          	ecall
 ret
    509a:	8082                	ret

000000000000509c <signal>:
.global signal
signal:
 li a7, SYS_signal
    509c:	02500893          	li	a7,37
 ecall
    50a0:	00000073          	ecall
 ret
    50a4:	8082                	ret

00000000000050a6 <kill>:
.global kill
kill:
 li a7, SYS_kill
    50a6:	4899                	li	a7,6
...
0000000000005116 <setchildlimit>:
.global setchildlimit
setchildlimit:
 li a7, SYS_setchildlimit
    5116:	02600893          	li	a7,38
 ecall
    511a:	00000073          	ecall
 ret
    511e:	8082                	ret

0000000000005120 <putc>:
...
putc(int fd, char c)
{
    5120:	1101                	addi	sp,sp,-32
    5122:	ec06                	sd	ra,24(sp)
    5124:	e822                	sd	s0,16(sp)
    5126:	1000                	addi	s0,sp,32
    5128:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    512c:	4605                	li	a2,1
    512e:	fef40593          	addi	a1,s0,-17
    5132:	ed9ff0ef          	jal	500a <write>
}
...
000000000000513e <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
    513e:	715d                	addi	sp,sp,-80
    5140:	e486                	sd	ra,72(sp)
    5142:	e0a2                	sd	s0,64(sp)
    5144:	f84a                	sd	s2,48(sp)
    5146:	f44e                	sd	s3,40(sp)
    5148:	0880                	addi	s0,sp,80
    514a:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
    514c:	c6d1                	beqz	a3,51d8 <printint+0x9a>
    514e:	0805d563          	bgez	a1,51d8 <printint+0x9a>
    neg = 1;
    x = -xx;
    5152:	40b005b3          	neg	a1,a1
    neg = 1;
    5156:	4305                	li	t1,1
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
    5160:	00003817          	auipc	a6,0x3
    5164:	b3880813          	addi	a6,a6,-1224 # 7c98 <digits>
    5168:	88ba                	mv	a7,a4
    516a:	0017051b          	addiw	a0,a4,1
    516e:	872a                	mv	a4,a0
    5170:	02c5f7b3          	remu	a5,a1,a2
    5174:	97c2                	add	a5,a5,a6
    5176:	0007c783          	lbu	a5,0(a5)
    517a:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    517e:	87ae                	mv	a5,a1
    5180:	02c5d5b3          	divu	a1,a1,a2
    5184:	0685                	addi	a3,a3,1
    5186:	fec7f1e3          	bgeu	a5,a2,5168 <printint+0x2a>
  if(neg)
    518a:	00030c63          	beqz	t1,51a2 <printint+0x64>
    buf[i++] = '-';
    518e:	fd050793          	addi	a5,a0,-48
    5192:	00878533          	add	a0,a5,s0
    5196:	02d00793          	li	a5,45
    519a:	fef50423          	sb	a5,-24(a0)
    519e:	0028871b          	addiw	a4,a7,2

  while(--i >= 0)
    51a2:	02e05563          	blez	a4,51cc <printint+0x8e>
    51a6:	fc26                	sd	s1,56(sp)
    51a8:	377d                	addiw	a4,a4,-1
    51aa:	00e984b3          	add	s1,s3,a4
    51ae:	19fd                	addi	s3,s3,-1 # fff <bigdir+0x10b>
    51b0:	99ba                	add	s3,s3,a4
    51b2:	1702                	slli	a4,a4,0x20
    51b4:	9301                	srli	a4,a4,0x20
    51b6:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    51ba:	0004c583          	lbu	a1,0(s1)
    51be:	854a                	mv	a0,s2
    51c0:	f61ff0ef          	jal	5120 <putc>
  while(--i >= 0)
    51c4:	14fd                	addi	s1,s1,-1
    51c6:	ff349ae3          	bne	s1,s3,51ba <printint+0x7c>
    51ca:	74e2                	ld	s1,56(sp)
}
    51cc:	60a6                	ld	ra,72(sp)
    51ce:	6406                	ld	s0,64(sp)
    51d0:	7942                	ld	s2,48(sp)
    51d2:	79a2                	ld	s3,40(sp)
    51d4:	6161                	addi	sp,sp,80
    51d6:	8082                	ret
  neg = 0;
    51d8:	4301                	li	t1,0
    51da:	bfbd                	j	5158 <printint+0x1a>

00000000000051dc <vprintf>:
}
...
{
    51dc:	711d                	addi	sp,sp,-96
    51de:	ec86                	sd	ra,88(sp)
    51e0:	e8a2                	sd	s0,80(sp)
    51e2:	e4a6                	sd	s1,72(sp)
    51e4:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    51e6:	0005c483          	lbu	s1,0(a1)
    51ea:	22048363          	beqz	s1,5410 <vprintf+0x234>
    51ee:	e0ca                	sd	s2,64(sp)
    51f0:	fc4e                	sd	s3,56(sp)
    51f2:	f852                	sd	s4,48(sp)
    51f4:	f456                	sd	s5,40(sp)
    51f6:	f05a                	sd	s6,32(sp)
    51f8:	ec5e                	sd	s7,24(sp)
    51fa:	e862                	sd	s8,16(sp)
    51fc:	8b2a                	mv	s6,a0
    51fe:	8a2e                	mv	s4,a1
    5200:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    5208:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    520c:	06400c13          	li	s8,100
    5210:	a00d                	j	5232 <vprintf+0x56>
        putc(fd, c0);
    5212:	85a6                	mv	a1,s1
    5214:	855a                	mv	a0,s6
    5216:	f0bff0ef          	jal	5120 <putc>
    521a:	a019                	j	5220 <vprintf+0x44>
    } else if(state == '%'){
    521c:	03598363          	beq	s3,s5,5242 <vprintf+0x66>
  for(i = 0; fmt[i]; i++){
    5220:	0019079b          	addiw	a5,s2,1
    5224:	893e                	mv	s2,a5
    5226:	873e                	mv	a4,a5
    5228:	97d2                	add	a5,a5,s4
    522a:	0007c483          	lbu	s1,0(a5)
    522e:	1c048a63          	beqz	s1,5402 <vprintf+0x226>
    c0 = fmt[i] & 0xff;
    5232:	0004879b          	sext.w	a5,s1
    if(state == 0){
    5236:	fe0993e3          	bnez	s3,521c <vprintf+0x40>
      if(c0 == '%'){
    523a:	fd579ce3          	bne	a5,s5,5212 <vprintf+0x36>
        state = '%';
    523e:	89be                	mv	s3,a5
    5240:	b7c5                	j	5220 <vprintf+0x44>
      if(c0) c1 = fmt[i+1] & 0xff;
    5242:	00ea06b3          	add	a3,s4,a4
    5246:	0016c603          	lbu	a2,1(a3)
      if(c1) c2 = fmt[i+2] & 0xff;
    524a:	1c060863          	beqz	a2,541a <vprintf+0x23e>
      if(c0 == 'd'){
    524e:	03878763          	beq	a5,s8,527c <vprintf+0xa0>
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    5252:	f9478693          	addi	a3,a5,-108
    5256:	0016b693          	seqz	a3,a3
    525a:	f9c60593          	addi	a1,a2,-100
    525e:	e99d                	bnez	a1,5294 <vprintf+0xb8>
    5260:	ca95                	beqz	a3,5294 <vprintf+0xb8>
        printint(fd, va_arg(ap, uint64), 10, 1);
    5262:	008b8493          	addi	s1,s7,8
    5266:	4685                	li	a3,1
    5268:	4629                	li	a2,10
    526a:	000bb583          	ld	a1,0(s7)
    526e:	855a                	mv	a0,s6
    5270:	ecfff0ef          	jal	513e <printint>
        i += 1;
    5274:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    5276:	8ba6                	mv	s7,s1
      ...
      state = 0;
    5278:	4981                	li	s3,0
    527a:	b75d                	j	5220 <vprintf+0x44>
        printint(fd, va_arg(ap, int), 10, 1);
    527c:	008b8493          	addi	s1,s7,8
    5280:	4685                	li	a3,1
    5282:	4629                	li	a2,10
    5284:	000ba583          	lw	a1,0(s7)
    5288:	855a                	mv	a0,s6
    528a:	eb5ff0ef          	jal	513e <printint>
    528e:	8ba6                	mv	s7,s1
      state = 0;
    5290:	4981                	li	s3,0
    5292:	b779                	j	5220 <vprintf+0x44>
      if(c1) c2 = fmt[i+2] & 0xff;
    5294:	9752                	add	a4,a4,s4
    5296:	00274583          	lbu	a1,2(a4)
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    529a:	f9460713          	addi	a4,a2,-108
    529e:	00173713          	seqz	a4,a4
    52a2:	8f75                	and	a4,a4,a3
    52a4:	f9c58513          	addi	a0,a1,-100
    52a8:	18051363          	bnez	a0,542e <vprintf+0x252>
    52ac:	18070163          	beqz	a4,542e <vprintf+0x252>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    52bc:	855a                	mv	a0,s6
    52be:	e81ff0ef          	jal	513e <printint>
        i += 2;
    ...
    52d6:	855a                	mv	a0,s6
    52d8:	e67ff0ef          	jal	513e <printint>
    52dc:	8ba6                	mv	s7,s1
      state = 0;
    52de:	4981                	li	s3,0
    52e0:	b781                	j	5220 <vprintf+0x44>
    ...
    52ee:	855a                	mv	a0,s6
    52f0:	e4fff0ef          	jal	513e <printint>
        i += 1;
    ...
    5308:	855a                	mv	a0,s6
    530a:	e35ff0ef          	jal	513e <printint>
        i += 2;
    ...
    5312:	4981                	li	s3,0
        i += 2;
    5314:	b731                	j	5220 <vprintf+0x44>
        printint(fd, va_arg(ap, uint32), 16, 0);
    5316:	008b8493          	addi	s1,s7,8
    531a:	4681                	li	a3,0
    531c:	4641                	li	a2,16
    531e:	000be583          	lwu	a1,0(s7)
    5322:	855a                	mv	a0,s6
    5324:	e1bff0ef          	jal	513e <printint>
    5328:	8ba6                	mv	s7,s1
      state = 0;
    532a:	4981                	li	s3,0
    532c:	bdd5                	j	5220 <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 16, 0);
    532e:	008b8493          	addi	s1,s7,8
    5332:	4681                	li	a3,0
    5334:	4641                	li	a2,16
    5336:	000bb583          	ld	a1,0(s7)
    533a:	855a                	mv	a0,s6
    533c:	e03ff0ef          	jal	513e <printint>
        i += 1;
    5340:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 16, 0);
    5342:	8ba6                	mv	s7,s1
      state = 0;
    5344:	4981                	li	s3,0
    5346:	bde9                	j	5220 <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 16, 0);
    5348:	008b8493          	addi	s1,s7,8
    534c:	4681                	li	a3,0
    534e:	4641                	li	a2,16
    5350:	000bb583          	ld	a1,0(s7)
    5354:	855a                	mv	a0,s6
    5356:	de9ff0ef          	jal	513e <printint>
        i += 2;
    535a:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    535c:	8ba6                	mv	s7,s1
      state = 0;
    535e:	4981                	li	s3,0
        i += 2;
    5360:	b5c1                	j	5220 <vprintf+0x44>
    5362:	e466                	sd	s9,8(sp)
        printptr(fd, va_arg(ap, uint64));
    5364:	008b8793          	addi	a5,s7,8
    5368:	8cbe                	mv	s9,a5
    536a:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    536e:	03000593          	li	a1,48
    5372:	855a                	mv	a0,s6
    5374:	dadff0ef          	jal	5120 <putc>
  putc(fd, 'x');
    5378:	07800593          	li	a1,120
    537c:	855a                	mv	a0,s6
    537e:	da3ff0ef          	jal	5120 <putc>
    5382:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5384:	00003b97          	auipc	s7,0x3
    5388:	914b8b93          	addi	s7,s7,-1772 # 7c98 <digits>
    538c:	03c9d793          	srli	a5,s3,0x3c
    5390:	97de                	add	a5,a5,s7
    5392:	0007c583          	lbu	a1,0(a5)
    5396:	855a                	mv	a0,s6
    5398:	d89ff0ef          	jal	5120 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    539c:	0992                	slli	s3,s3,0x4
    539e:	34fd                	addiw	s1,s1,-1
    53a0:	f4f5                	bnez	s1,538c <vprintf+0x1b0>
        printptr(fd, va_arg(ap, uint64));
    53a2:	8be6                	mv	s7,s9
      state = 0;
    53a4:	4981                	li	s3,0
    53a6:	6ca2                	ld	s9,8(sp)
    53a8:	bda5                	j	5220 <vprintf+0x44>
        putc(fd, va_arg(ap, uint32));
    53aa:	008b8493          	addi	s1,s7,8
    53ae:	000bc583          	lbu	a1,0(s7)
    53b2:	855a                	mv	a0,s6
    53b4:	d6dff0ef          	jal	5120 <putc>
    53b8:	8ba6                	mv	s7,s1
      state = 0;
    53ba:	4981                	li	s3,0
    53bc:	b595                	j	5220 <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
    53be:	008b8993          	addi	s3,s7,8
    53c2:	000bb483          	ld	s1,0(s7)
    53c6:	cc91                	beqz	s1,53e2 <vprintf+0x206>
        for(; *s; s++)
    53c8:	0004c583          	lbu	a1,0(s1)
    53cc:	c985                	beqz	a1,53fc <vprintf+0x220>
          putc(fd, *s);
    53ce:	855a                	mv	a0,s6
    53d0:	d51ff0ef          	jal	5120 <putc>
        for(; *s; s++)
    53d4:	0485                	addi	s1,s1,1
    53d6:	0004c583          	lbu	a1,0(s1)
    53da:	f9f5                	bnez	a1,53ce <vprintf+0x1f2>
        if((s = va_arg(ap, char*)) == 0)
    53dc:	8bce                	mv	s7,s3
      state = 0;
    53de:	4981                	li	s3,0
    53e0:	b581                	j	5220 <vprintf+0x44>
          s = "(null)";
    53e2:	00003497          	auipc	s1,0x3
    53e6:	80648493          	addi	s1,s1,-2042 # 7be8 <malloc+0x266a>
        for(; *s; s++)
    53ea:	02800593          	li	a1,40
    53ee:	b7c5                	j	53ce <vprintf+0x1f2>
        putc(fd, '%');
    53f0:	85be                	mv	a1,a5
    53f2:	855a                	mv	a0,s6
    53f4:	d2dff0ef          	jal	5120 <putc>
      state = 0;
    53f8:	4981                	li	s3,0
    53fa:	b51d                	j	5220 <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
    53fc:	8bce                	mv	s7,s3
      state = 0;
    53fe:	4981                	li	s3,0
    5400:	b505                	j	5220 <vprintf+0x44>
    5402:	6906                	ld	s2,64(sp)
    5404:	79e2                	ld	s3,56(sp)
    5406:	7a42                	ld	s4,48(sp)
    5408:	7aa2                	ld	s5,40(sp)
    540a:	7b02                	ld	s6,32(sp)
    540c:	6be2                	ld	s7,24(sp)
    540e:	6c42                	ld	s8,16(sp)
    }
  }
}
    5410:	60e6                	ld	ra,88(sp)
    5412:	6446                	ld	s0,80(sp)
    5414:	64a6                	ld	s1,72(sp)
    5416:	6125                	addi	sp,sp,96
    5418:	8082                	ret
      if(c0 == 'd'){
    541a:	06400713          	li	a4,100
    541e:	e4e78fe3          	beq	a5,a4,527c <vprintf+0xa0>
      } else if(c0 == 'l' && c1 == 'd'){
    5422:	f9478693          	addi	a3,a5,-108
    5426:	0016b693          	seqz	a3,a3
      c1 = c2 = 0;
    542a:	85b2                	mv	a1,a2
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    542c:	4701                	li	a4,0
      } else if(c0 == 'u'){
    542e:	07500513          	li	a0,117
    5432:	e8a78ce3          	beq	a5,a0,52ca <vprintf+0xee>
      } else if(c0 == 'l' && c1 == 'u'){
    5436:	f8b60513          	addi	a0,a2,-117
    543a:	e119                	bnez	a0,5440 <vprintf+0x264>
    543c:	ea0693e3          	bnez	a3,52e2 <vprintf+0x106>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    5440:	f8b58513          	addi	a0,a1,-117
    5444:	e119                	bnez	a0,544a <vprintf+0x26e>
    5446:	ea071be3          	bnez	a4,52fc <vprintf+0x120>
      } else if(c0 == 'x'){
    544a:	07800513          	li	a0,120
    544e:	eca784e3          	beq	a5,a0,5316 <vprintf+0x13a>
      } else if(c0 == 'l' && c1 == 'x'){
    5452:	f8860613          	addi	a2,a2,-120
    5456:	e219                	bnez	a2,545c <vprintf+0x280>
    5458:	ec069be3          	bnez	a3,532e <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    545c:	f8858593          	addi	a1,a1,-120
    5460:	e199                	bnez	a1,5466 <vprintf+0x28a>
    5462:	ee0713e3          	bnez	a4,5348 <vprintf+0x16c>
      } else if(c0 == 'p'){
    5466:	07000713          	li	a4,112
    546a:	eee78ce3          	beq	a5,a4,5362 <vprintf+0x186>
      } else if(c0 == 'c'){
    546e:	06300713          	li	a4,99
    5472:	f2e78ce3          	beq	a5,a4,53aa <vprintf+0x1ce>
      } else if(c0 == 's'){
    5476:	07300713          	li	a4,115
    547a:	f4e782e3          	beq	a5,a4,53be <vprintf+0x1e2>
      } else if(c0 == '%'){
    547e:	02500713          	li	a4,37
    5482:	f6e787e3          	beq	a5,a4,53f0 <vprintf+0x214>
        putc(fd, '%');
    5486:	02500593          	li	a1,37
    548a:	855a                	mv	a0,s6
    548c:	c95ff0ef          	jal	5120 <putc>
        putc(fd, c0);
    5490:	85a6                	mv	a1,s1
    5492:	855a                	mv	a0,s6
    5494:	c8dff0ef          	jal	5120 <putc>
      state = 0;
    5498:	4981                	li	s3,0
    549a:	b359                	j	5220 <vprintf+0x44>

000000000000549c <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    549c:	715d                	addi	sp,sp,-80
    549e:	ec06                	sd	ra,24(sp)
    54a0:	e822                	sd	s0,16(sp)
    54a2:	1000                	addi	s0,sp,32
    54a4:	e010                	sd	a2,0(s0)
    54a6:	e414                	sd	a3,8(s0)
    54a8:	e818                	sd	a4,16(s0)
    54aa:	ec1c                	sd	a5,24(s0)
    54ac:	03043023          	sd	a6,32(s0)
    54b0:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    54b4:	8622                	mv	a2,s0
    54b6:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    54ba:	d23ff0ef          	jal	51dc <vprintf>
}
    54be:	60e2                	ld	ra,24(sp)
    54c0:	6442                	ld	s0,16(sp)
    54c2:	6161                	addi	sp,sp,80
    54c4:	8082                	ret

00000000000054c6 <printf>:

void
printf(const char *fmt, ...)
{
    54c6:	711d                	addi	sp,sp,-96
    54c8:	ec06                	sd	ra,24(sp)
    54ca:	e822                	sd	s0,16(sp)
    54cc:	1000                	addi	s0,sp,32
    54ce:	e40c                	sd	a1,8(s0)
    54d0:	e810                	sd	a2,16(s0)
    54d2:	ec14                	sd	a3,24(s0)
    54d4:	f018                	sd	a4,32(s0)
    54d6:	f41c                	sd	a5,40(s0)
    54d8:	03043823          	sd	a6,48(s0)
    54dc:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    54e0:	00840613          	addi	a2,s0,8
    54e4:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    54e8:	85aa                	mv	a1,a0
    54ea:	4505                	li	a0,1
    54ec:	cf1ff0ef          	jal	51dc <vprintf>
}
    54f0:	60e2                	ld	ra,24(sp)
    54f2:	6442                	ld	s0,16(sp)
    54f4:	6125                	addi	sp,sp,96
    54f6:	8082                	ret

00000000000054f8 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    54f8:	1141                	addi	sp,sp,-16
    54fa:	e406                	sd	ra,8(sp)
    54fc:	e022                	sd	s0,0(sp)
    54fe:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5500:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5504:	00005797          	auipc	a5,0x5
    5508:	f8c7b783          	ld	a5,-116(a5) # a490 <freep>
    550c:	a039                	j	551a <free+0x22>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    550e:	6398                	ld	a4,0(a5)
    5510:	00e7e463          	bltu	a5,a4,5518 <free+0x20>
    5514:	00e6ea63          	bltu	a3,a4,5528 <free+0x30>
{
    5518:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    551a:	fed7fae3          	bgeu	a5,a3,550e <free+0x16>
    551e:	6398                	ld	a4,0(a5)
    5520:	00e6e463          	bltu	a3,a4,5528 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5524:	fee7eae3          	bltu	a5,a4,5518 <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
    5528:	ff852583          	lw	a1,-8(a0)
    552c:	6390                	ld	a2,0(a5)
    552e:	02059813          	slli	a6,a1,0x20
    5532:	01c85713          	srli	a4,a6,0x1c
    5536:	9736                	add	a4,a4,a3
    5538:	02e60563          	beq	a2,a4,5562 <free+0x6a>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    553c:	fec53823          	sd	a2,-16(a0)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    5540:	4790                	lw	a2,8(a5)
    5542:	02061593          	slli	a1,a2,0x20
    5546:	01c5d713          	srli	a4,a1,0x1c
    554a:	973e                	add	a4,a4,a5
    554c:	02e68263          	beq	a3,a4,5570 <free+0x78>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    5550:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5552:	00005717          	auipc	a4,0x5
    5556:	f2f73f23          	sd	a5,-194(a4) # a490 <freep>
}
    555a:	60a2                	ld	ra,8(sp)
    555c:	6402                	ld	s0,0(sp)
    555e:	0141                	addi	sp,sp,16
    5560:	8082                	ret
    bp->s.size += p->s.ptr->s.size;
    5562:	4618                	lw	a4,8(a2)
    5564:	9f2d                	addw	a4,a4,a1
    5566:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    556a:	6398                	ld	a4,0(a5)
    556c:	6310                	ld	a2,0(a4)
    556e:	b7f9                	j	553c <free+0x44>
    p->s.size += bp->s.size;
    5570:	ff852703          	lw	a4,-8(a0)
    5574:	9f31                	addw	a4,a4,a2
    5576:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5578:	ff053683          	ld	a3,-16(a0)
    557c:	bfd1                	j	5550 <free+0x58>

000000000000557e <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    557e:	7139                	addi	sp,sp,-64
    5580:	fc06                	sd	ra,56(sp)
    5582:	f822                	sd	s0,48(sp)
    5584:	f04a                	sd	s2,32(sp)
    5586:	ec4e                	sd	s3,24(sp)
    5588:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    558a:	02051993          	slli	s3,a0,0x20
    558e:	0209d993          	srli	s3,s3,0x20
    5592:	09bd                	addi	s3,s3,15
    5594:	0049d993          	srli	s3,s3,0x4
    5598:	2985                	addiw	s3,s3,1
    559a:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    559c:	00005517          	auipc	a0,0x5
    55a0:	ef453503          	ld	a0,-268(a0) # a490 <freep>
    55a4:	c905                	beqz	a0,55d4 <malloc+0x56>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    55a6:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    55a8:	4798                	lw	a4,8(a5)
    55aa:	09377663          	bgeu	a4,s3,5636 <malloc+0xb8>
    55ae:	f426                	sd	s1,40(sp)
    55b0:	e852                	sd	s4,16(sp)
    55b2:	e456                	sd	s5,8(sp)
    55b4:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    55b6:	8a4e                	mv	s4,s3
    55b8:	6705                	lui	a4,0x1
    55ba:	00e9f363          	bgeu	s3,a4,55c0 <malloc+0x42>
    55be:	6a05                	lui	s4,0x1
    55c0:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    55c4:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    55c8:	00005497          	auipc	s1,0x5
    55cc:	ec848493          	addi	s1,s1,-312 # a490 <freep>
  if(p == SBRK_ERROR)
    55d0:	5afd                	li	s5,-1
    55d2:	a83d                	j	5610 <malloc+0x92>
    55d4:	f426                	sd	s1,40(sp)
    55d6:	e852                	sd	s4,16(sp)
    55d8:	e456                	sd	s5,8(sp)
    55da:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    55dc:	0000b797          	auipc	a5,0xb
    55e0:	6dc78793          	addi	a5,a5,1756 # 10cb8 <base>
    55e4:	00005717          	auipc	a4,0x5
    55e8:	eaf73623          	sd	a5,-340(a4) # a490 <freep>
    55ec:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    55ee:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    55f2:	b7d1                	j	55b6 <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    55f4:	6398                	ld	a4,0(a5)
    55f6:	e118                	sd	a4,0(a0)
    55f8:	a899                	j	564e <malloc+0xd0>
  hp->s.size = nu;
    55fa:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    55fe:	0541                	addi	a0,a0,16
    5600:	ef9ff0ef          	jal	54f8 <free>
  return freep;
    5604:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    5606:	c125                	beqz	a0,5666 <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5608:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    560a:	4798                	lw	a4,8(a5)
    560c:	03277163          	bgeu	a4,s2,562e <malloc+0xb0>
    if(p == freep)
    5610:	6098                	ld	a4,0(s1)
    5612:	853e                	mv	a0,a5
    5614:	fef71ae3          	bne	a4,a5,5608 <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
    5618:	8552                	mv	a0,s4
    561a:	99dff0ef          	jal	4fb6 <sbrk>
  if(p == SBRK_ERROR)
    561e:	fd551ee3          	bne	a0,s5,55fa <malloc+0x7c>
        return 0;
    5622:	4501                	li	a0,0
    5624:	74a2                	ld	s1,40(sp)
    5626:	6a42                	ld	s4,16(sp)
    5628:	6aa2                	ld	s5,8(sp)
    562a:	6b02                	ld	s6,0(sp)
    562c:	a03d                	j	565a <malloc+0xdc>
    562e:	74a2                	ld	s1,40(sp)
    5630:	6a42                	ld	s4,16(sp)
    5632:	6aa2                	ld	s5,8(sp)
    5634:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    5636:	fae90fe3          	beq	s2,a4,55f4 <malloc+0x76>
        p->s.size -= nunits;
    563a:	4137073b          	subw	a4,a4,s3
    563e:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5640:	02071693          	slli	a3,a4,0x20
    5644:	01c6d713          	srli	a4,a3,0x1c
    5648:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    564a:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    564e:	00005717          	auipc	a4,0x5
    5652:	e4a73123          	sd	a0,-446(a4) # a490 <freep>
      return (void*)(p + 1);
    5656:	01078513          	addi	a0,a5,16
  }
}
    565a:	70e2                	ld	ra,56(sp)
    565c:	7442                	ld	s0,48(sp)
    565e:	7902                	ld	s2,32(sp)
    5660:	69e2                	ld	s3,24(sp)
    5662:	6121                	addi	sp,sp,64
    5664:	8082                	ret
    5666:	74a2                	ld	s1,40(sp)
    5668:	6a42                	ld	s4,16(sp)
    566a:	6aa2                	ld	s5,8(sp)
    566c:	6b02                	ld	s6,0(sp)
    566e:	b7f5                	j	565a <malloc+0xdc>
