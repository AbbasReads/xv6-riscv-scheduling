...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d0:	dd4a8a93          	addi	s5,s5,-556 # 12a0 <malloc+0x16e>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e2:	da250513          	addi	a0,a0,-606 # 1280 <malloc+0x14e>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     59e:	d0e60613          	addi	a2,a2,-754 # 12a8 <malloc+0x176>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5ce:	cfeb0b13          	addi	s6,s6,-770 # 12c8 <malloc+0x196>
  ...
  return ret;
     ...
     5f8:	cbc50513          	addi	a0,a0,-836 # 12b0 <malloc+0x17e>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     64a:	c7250513          	addi	a0,a0,-910 # 12b8 <malloc+0x186>
...
000000000000066c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     688:	c4c60613          	addi	a2,a2,-948 # 12d0 <malloc+0x19e>
     68c:	85ce                	mv	a1,s3
     68e:	854a                	mv	a0,s2
...
00000000000006c6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     6e4:	bf8a0a13          	addi	s4,s4,-1032 # 12d8 <malloc+0x1a6>
  ...
  if(peek(ps, es, ";")){
     ...
     70e:	bd660613          	addi	a2,a2,-1066 # 12e0 <malloc+0x1ae>
     712:	85ce                	mv	a1,s3
     714:	854a                	mv	a0,s2
...
000000000000074e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     764:	b4860613          	addi	a2,a2,-1208 # 12a8 <malloc+0x176>
  ...
  if(!peek(ps, es, ")"))
     ...
     788:	b7460613          	addi	a2,a2,-1164 # 12f8 <malloc+0x1c6>
     78c:	85ca                	mv	a1,s2
     78e:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7be:	b2e50513          	addi	a0,a0,-1234 # 12e8 <malloc+0x1b6>
     7c2:	889ff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7c6:	00001517          	auipc	a0,0x1
     7ca:	b3a50513          	addi	a0,a0,-1222 # 1300 <malloc+0x1ce>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     7f2:	b7270713          	addi	a4,a4,-1166 # 1360 <malloc+0x22e>
...
0000000000000852 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     87e:	9be60613          	addi	a2,a2,-1602 # 1238 <malloc+0x106>
     882:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8ac:	a7058593          	addi	a1,a1,-1424 # 1318 <malloc+0x1e6>
     8b0:	4509                	li	a0,2
     8b2:	7a2000ef          	jal	1054 <fprintf>
    panic("syntax");
     8b6:	00001517          	auipc	a0,0x1
     8ba:	9fa50513          	addi	a0,a0,-1542 # 12b0 <malloc+0x17e>
...
00000000000008c2 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8da:	a5248493          	addi	s1,s1,-1454 # 1328 <malloc+0x1f6>
     8de:	4589                	li	a1,2
     8e0:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(cmd[0] == 'c' && cmd[1] == 'd' && cmd[2] == ' '){
     ...
     97e:	9b658593          	addi	a1,a1,-1610 # 1330 <malloc+0x1fe>
     982:	4509                	li	a0,2
     984:	6d0000ef          	jal	1054 <fprintf>
...
{
     d14:	715d                	addi	sp,sp,-80
     d16:	e486                	sd	ra,72(sp)
     d18:	e0a2                	sd	s0,64(sp)
     d1a:	f84a                	sd	s2,48(sp)
     d1c:	0880                	addi	s0,sp,80
     d1e:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  if(sgn && xx < 0){
     ...
     d22:	0805c363          	bltz	a1,da8 <printint+0x94>
  neg = 0;
     d26:	4881                	li	a7,0
     d28:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     d32:	64a50513          	addi	a0,a0,1610 # 1378 <digits>
     d36:	883e                	mv	a6,a5
     d38:	2785                	addiw	a5,a5,1
     d3a:	02c5f733          	remu	a4,a1,a2
     d3e:	972a                	add	a4,a4,a0
     d40:	00074703          	lbu	a4,0(a4)
     d44:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
     d48:	872e                	mv	a4,a1
     d4a:	02c5d5b3          	divu	a1,a1,a2
     d4e:	0685                	addi	a3,a3,1
     d50:	fec773e3          	bgeu	a4,a2,d36 <printint+0x22>
  if(neg)
     d54:	00088b63          	beqz	a7,d6a <printint+0x56>
    buf[i++] = '-';
     d58:	fd078793          	addi	a5,a5,-48
     d5c:	97a2                	add	a5,a5,s0
     d5e:	02d00713          	li	a4,45
     d62:	fee78423          	sb	a4,-24(a5)
     d66:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
     d6a:	02f05a63          	blez	a5,d9e <printint+0x8a>
     d6e:	fc26                	sd	s1,56(sp)
     d70:	f44e                	sd	s3,40(sp)
     d72:	fb840713          	addi	a4,s0,-72
     d76:	00f704b3          	add	s1,a4,a5
     d7a:	fff70993          	addi	s3,a4,-1
     d7e:	99be                	add	s3,s3,a5
     d80:	37fd                	addiw	a5,a5,-1
     d82:	1782                	slli	a5,a5,0x20
     d84:	9381                	srli	a5,a5,0x20
     d86:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
     d8a:	fff4c583          	lbu	a1,-1(s1)
     d8e:	854a                	mv	a0,s2
     d90:	f67ff0ef          	jal	cf6 <putc>
  while(--i >= 0)
     d94:	14fd                	addi	s1,s1,-1
     d96:	ff349ae3          	bne	s1,s3,d8a <printint+0x76>
     d9a:	74e2                	ld	s1,56(sp)
     d9c:	79a2                	ld	s3,40(sp)
}
     d9e:	60a6                	ld	ra,72(sp)
     da0:	6406                	ld	s0,64(sp)
     da2:	7942                	ld	s2,48(sp)
...
vprintf(int fd, const char *fmt, va_list ap)
{
     ...
     db6:	e0ca                	sd	s2,64(sp)
     db8:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
     dba:	0005c903          	lbu	s2,0(a1)
     dbe:	28090663          	beqz	s2,104a <vprintf+0x29a>
     dc2:	e4a6                	sd	s1,72(sp)
     dc4:	fc4e                	sd	s3,56(sp)
     dc6:	f852                	sd	s4,48(sp)
     dc8:	f456                	sd	s5,40(sp)
     dca:	f05a                	sd	s6,32(sp)
     dcc:	ec5e                	sd	s7,24(sp)
     dce:	e862                	sd	s8,16(sp)
     dd0:	e466                	sd	s9,8(sp)
     dd2:	8b2a                	mv	s6,a0
     dd4:	8a2e                	mv	s4,a1
     dd6:	8bb2                	mv	s7,a2
  ...
  for(i = 0; fmt[i]; i++){
     ...
     dde:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
     de2:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
     de6:	06c00c93          	li	s9,108
     dea:	a005                	j	e0a <vprintf+0x5a>
        putc(fd, c0);
     dec:	85ca                	mv	a1,s2
     dee:	855a                	mv	a0,s6
     df0:	f07ff0ef          	jal	cf6 <putc>
     df4:	a019                	j	dfa <vprintf+0x4a>
    } else if(state == '%'){
     df6:	03598263          	beq	s3,s5,e1a <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
     dfa:	2485                	addiw	s1,s1,1
     dfc:	8726                	mv	a4,s1
     dfe:	009a07b3          	add	a5,s4,s1
     e02:	0007c903          	lbu	s2,0(a5)
     e06:	22090a63          	beqz	s2,103a <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
     e0a:	0009079b          	sext.w	a5,s2
    if(state == 0){
     e0e:	fe0994e3          	bnez	s3,df6 <vprintf+0x46>
      if(c0 == '%'){
     e12:	fd579de3          	bne	a5,s5,dec <vprintf+0x3c>
        state = '%';
     e16:	89be                	mv	s3,a5
     e18:	b7cd                	j	dfa <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
     e1a:	00ea06b3          	add	a3,s4,a4
     e1e:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
     e22:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
     e24:	c681                	beqz	a3,e2c <vprintf+0x7c>
     e26:	9752                	add	a4,a4,s4
     e28:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     e2c:	05878363          	beq	a5,s8,e72 <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
     e30:	05978d63          	beq	a5,s9,e8a <vprintf+0xda>
     ...
     e34:	07500713          	li	a4,117
     e38:	0ee78763          	beq	a5,a4,f26 <vprintf+0x176>
     ...
     e3c:	07800713          	li	a4,120
     e40:	12e78963          	beq	a5,a4,f72 <vprintf+0x1c2>
     ...
     e44:	07000713          	li	a4,112
     e48:	14e78e63          	beq	a5,a4,fa4 <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
     e4c:	06300713          	li	a4,99
     e50:	18e78e63          	beq	a5,a4,fec <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
     e54:	07300713          	li	a4,115
     e58:	1ae78463          	beq	a5,a4,1000 <vprintf+0x250>
     ...
     e60:	04e79563          	bne	a5,a4,eaa <vprintf+0xfa>
        putc(fd, '%');
     e64:	02500593          	li	a1,37
     e68:	855a                	mv	a0,s6
     e6a:	e8dff0ef          	jal	cf6 <putc>
     ...
     e7e:	855a                	mv	a0,s6
     e80:	e95ff0ef          	jal	d14 <printint>
     e84:	8bca                	mv	s7,s2
      state = 0;
     e86:	4981                	li	s3,0
     e88:	bf8d                	j	dfa <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
     e8a:	06400793          	li	a5,100
     e8e:	02f68963          	beq	a3,a5,ec0 <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     e92:	06c00793          	li	a5,108
     e96:	04f68263          	beq	a3,a5,eda <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
     e9a:	07500793          	li	a5,117
     e9e:	0af68063          	beq	a3,a5,f3e <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
     ea2:	07800793          	li	a5,120
     ea6:	0ef68263          	beq	a3,a5,f8a <vprintf+0x1da>
        putc(fd, '%');
     eaa:	02500593          	li	a1,37
     eae:	855a                	mv	a0,s6
     eb0:	e47ff0ef          	jal	cf6 <putc>
        putc(fd, c0);
     eb4:	85ca                	mv	a1,s2
     eb6:	855a                	mv	a0,s6
     eb8:	e3fff0ef          	jal	cf6 <putc>
      state = 0;
     ebc:	4981                	li	s3,0
     ebe:	bf35                	j	dfa <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     ed6:	4981                	li	s3,0
        i += 1;
     ed8:	b70d                	j	dfa <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     eda:	06400793          	li	a5,100
     ede:	02f60763          	beq	a2,a5,f0c <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     ee2:	07500793          	li	a5,117
     ee6:	06f60963          	beq	a2,a5,f58 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
     eea:	07800793          	li	a5,120
     eee:	faf61ee3          	bne	a2,a5,eaa <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     f22:	4981                	li	s3,0
        i += 2;
     f24:	bdd9                	j	dfa <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 10, 0);
     f26:	008b8913          	addi	s2,s7,8
     f2a:	4681                	li	a3,0
     f2c:	4629                	li	a2,10
     f2e:	000be583          	lwu	a1,0(s7)
     f32:	855a                	mv	a0,s6
     f34:	de1ff0ef          	jal	d14 <printint>
     f38:	8bca                	mv	s7,s2
      state = 0;
     f3a:	4981                	li	s3,0
     f3c:	bd7d                	j	dfa <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
     ...
     f6e:	4981                	li	s3,0
        i += 2;
     f70:	b569                	j	dfa <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
     f72:	008b8913          	addi	s2,s7,8
     f76:	4681                	li	a3,0
     f78:	4641                	li	a2,16
     f7a:	000be583          	lwu	a1,0(s7)
     f7e:	855a                	mv	a0,s6
     f80:	d95ff0ef          	jal	d14 <printint>
     f84:	8bca                	mv	s7,s2
      state = 0;
     f86:	4981                	li	s3,0
     f88:	bd8d                	j	dfa <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
     f8a:	008b8913          	addi	s2,s7,8
     f8e:	4681                	li	a3,0
     f90:	4641                	li	a2,16
     f92:	000bb583          	ld	a1,0(s7)
     f96:	855a                	mv	a0,s6
     f98:	d7dff0ef          	jal	d14 <printint>
        i += 1;
  ...
  putc(fd, '0');
     ...
     fb2:	855a                	mv	a0,s6
     fb4:	d43ff0ef          	jal	cf6 <putc>
  putc(fd, 'x');
     fb8:	07800593          	li	a1,120
     fbc:	855a                	mv	a0,s6
     fbe:	d39ff0ef          	jal	cf6 <putc>
     fc2:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fc4:	00000b97          	auipc	s7,0x0
     fc8:	3b4b8b93          	addi	s7,s7,948 # 1378 <digits>
     fcc:	03c9d793          	srli	a5,s3,0x3c
     fd0:	97de                	add	a5,a5,s7
     fd2:	0007c583          	lbu	a1,0(a5)
     fd6:	855a                	mv	a0,s6
     fd8:	d1fff0ef          	jal	cf6 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     fdc:	0992                	slli	s3,s3,0x4
     fde:	397d                	addiw	s2,s2,-1
     fe0:	fe0916e3          	bnez	s2,fcc <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
     fe4:	8bea                	mv	s7,s10
      state = 0;
     fe6:	4981                	li	s3,0
     fe8:	6d02                	ld	s10,0(sp)
     fea:	bd01                	j	dfa <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
     fec:	008b8913          	addi	s2,s7,8
     ff0:	000bc583          	lbu	a1,0(s7)
     ff4:	855a                	mv	a0,s6
     ff6:	d01ff0ef          	jal	cf6 <putc>
     ffa:	8bca                	mv	s7,s2
      state = 0;
     ffc:	4981                	li	s3,0
     ffe:	bbf5                	j	dfa <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    1000:	008b8993          	addi	s3,s7,8
    1004:	000bb903          	ld	s2,0(s7)
    1008:	00090f63          	beqz	s2,1026 <vprintf+0x276>
        for(; *s; s++)
    100c:	00094583          	lbu	a1,0(s2)
    1010:	c195                	beqz	a1,1034 <vprintf+0x284>
          putc(fd, *s);
    1012:	855a                	mv	a0,s6
    1014:	ce3ff0ef          	jal	cf6 <putc>
        for(; *s; s++)
    1018:	0905                	addi	s2,s2,1
    101a:	00094583          	lbu	a1,0(s2)
    101e:	f9f5                	bnez	a1,1012 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    1020:	8bce                	mv	s7,s3
      state = 0;
    1022:	4981                	li	s3,0
    1024:	bbd9                	j	dfa <vprintf+0x4a>
          s = "(null)";
    1026:	00000917          	auipc	s2,0x0
    102a:	31a90913          	addi	s2,s2,794 # 1340 <malloc+0x20e>
        for(; *s; s++)
    102e:	02800593          	li	a1,40
    1032:	b7c5                	j	1012 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    1034:	8bce                	mv	s7,s3
      state = 0;
    1036:	4981                	li	s3,0
    1038:	b3c9                	j	dfa <vprintf+0x4a>
    103a:	64a6                	ld	s1,72(sp)
    103c:	79e2                	ld	s3,56(sp)
    103e:	7a42                	ld	s4,48(sp)
    1040:	7aa2                	ld	s5,40(sp)
    1042:	7b02                	ld	s6,32(sp)
    1044:	6be2                	ld	s7,24(sp)
    1046:	6c42                	ld	s8,16(sp)
    1048:	6ca2                	ld	s9,8(sp)
    }
  }
}
    104a:	60e6                	ld	ra,88(sp)
    104c:	6446                	ld	s0,80(sp)
    104e:	6906                	ld	s2,64(sp)
    1050:	6125                	addi	sp,sp,96
    1052:	8082                	ret

0000000000001054 <fprintf>:
...
fprintf(int fd, const char *fmt, ...)
{
    ...
    105c:	e010                	sd	a2,0(s0)
    105e:	e414                	sd	a3,8(s0)
    1060:	e818                	sd	a4,16(s0)
    1062:	ec1c                	sd	a5,24(s0)
    1064:	03043023          	sd	a6,32(s0)
    1068:	03143423          	sd	a7,40(s0)
  va_list ap;
...
free(void *ap)
{
  ...
  if(p + p->s.size == bp){
    ...
    10de:	a091                	j	1122 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    10e0:	6398                	ld	a4,0(a5)
    10e2:	00e7e463          	bltu	a5,a4,10ea <free+0x3a>
    10e6:	00e6ea63          	bltu	a3,a4,10fa <free+0x4a>
{
    10ea:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10ec:	fed7fae3          	bgeu	a5,a3,10e0 <free+0x30>
    10f0:	6398                	ld	a4,0(a5)
    10f2:	00e6e463          	bltu	a3,a4,10fa <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    10f6:	fee7eae3          	bltu	a5,a4,10ea <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    ...
    110a:	fae60de3          	beq	a2,a4,10c4 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
  ...
  if(p + p->s.size == bp){
    ...
    111e:	fae68ae3          	beq	a3,a4,10d2 <free+0x22>
    p->s.ptr = bp->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1156:	c915                	beqz	a0,118a <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    115c:	08977a63          	bgeu	a4,s1,11f0 <malloc+0xbe>
  ...
  if(nu < 4096)
    1168:	8a4e                	mv	s4,s3
    116a:	0009871b          	sext.w	a4,s3
    116e:	6685                	lui	a3,0x1
    1170:	00d77363          	bgeu	a4,a3,1176 <malloc+0x44>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    117e:	00001917          	auipc	s2,0x1
    1182:	e9290913          	addi	s2,s2,-366 # 2010 <freep>
  if(p == SBRK_ERROR)
    1186:	5afd                	li	s5,-1
    1188:	a081                	j	11c8 <malloc+0x96>
    ...
    if(p->s.size >= nunits){
    11a8:	b7c1                	j	1168 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    11aa:	6398                	ld	a4,0(a5)
    11ac:	e118                	sd	a4,0(a0)
    11ae:	a8a9                	j	1208 <malloc+0xd6>
  hp->s.size = nu;
    11b0:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    11b4:	0541                	addi	a0,a0,16
    11b6:	efbff0ef          	jal	10b0 <free>
  return freep;
    11ba:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    11be:	c12d                	beqz	a0,1220 <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    11c0:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    11c2:	4798                	lw	a4,8(a5)
    11c4:	02977263          	bgeu	a4,s1,11e8 <malloc+0xb6>
    if(p == freep)
    11c8:	00093703          	ld	a4,0(s2)
    11cc:	853e                	mv	a0,a5
    11ce:	fef719e3          	bne	a4,a5,11c0 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    11d2:	8552                	mv	a0,s4
    11d4:	a27ff0ef          	jal	bfa <sbrk>
  if(p == SBRK_ERROR)
    11d8:	fd551ce3          	bne	a0,s5,11b0 <malloc+0x7e>
        return 0;
    11dc:	4501                	li	a0,0
    ...
    11e6:	a03d                	j	1214 <malloc+0xe2>
    11e8:	7902                	ld	s2,32(sp)
    11ea:	6a42                	ld	s4,16(sp)
    11ec:	6aa2                	ld	s5,8(sp)
    11ee:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    11f0:	fae48de3          	beq	s1,a4,11aa <malloc+0x78>
        p->s.size -= nunits;
