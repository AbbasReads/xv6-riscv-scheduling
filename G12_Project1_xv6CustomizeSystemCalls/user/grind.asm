...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      92:	369000ef          	jal	bfa <mkdir>
  if(chdir("grindir") != 0){
      96:	00001517          	auipc	a0,0x1
      9a:	0da50513          	addi	a0,a0,218 # 1170 <malloc+0x102>
      9e:	365000ef          	jal	c02 <chdir>
  ...
  int fd = -1;
    ...
    int what = rand() % 23;
     ...
     17a:	269000ef          	jal	be2 <unlink>
      chdir("/");
     17e:	00001517          	auipc	a0,0x1
     182:	02250513          	addi	a0,a0,34 # 11a0 <malloc+0x132>
     186:	27d000ef          	jal	c02 <chdir>
     ...
     390:	bb9d                	j	106 <go+0x92>
        kill(getpid());
     392:	081000ef          	jal	c12 <getpid>
     396:	02d000ef          	jal	bc2 <kill>
        exit(0);
     39a:	4501                	li	a0,0
...
iter()
{
  ...
  exit(0);
    ...
    kill(pid1);
     89a:	8526                	mv	a0,s1
     89c:	326000ef          	jal	bc2 <kill>
    kill(pid2);
     8a0:	854a                	mv	a0,s2
     8a2:	320000ef          	jal	bc2 <kill>
