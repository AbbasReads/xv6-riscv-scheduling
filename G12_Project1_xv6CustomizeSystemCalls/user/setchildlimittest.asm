...
user/_setchildlimittest:     file format elf64-littleriscv
...
fail(const char *msg)
{
   ...
   8:	85aa                	mv	a1,a0
  printf("setchildlimittest: FAIL: %s\n", msg);
...
000000000000001c <main>:
  printf("setchildlimittest: PASS: %s\n", msg);
}
...
main(void)
{
  ...
  30:	b0c50513          	addi	a0,a0,-1268 # b38 <malloc+0x122>
  ...
  54:	b1050513          	addi	a0,a0,-1264 # b60 <malloc+0x14a>
  ...
  78:	b1450513          	addi	a0,a0,-1260 # b88 <malloc+0x172>
  ...
  8e:	b2650513          	addi	a0,a0,-1242 # bb0 <malloc+0x19a>
  92:	f6fff0ef          	jal	0 <fail>
  printf("setchildlimittest: PASS: %s\n", msg);
  96:	00001597          	auipc	a1,0x1
  9a:	b5258593          	addi	a1,a1,-1198 # be8 <malloc+0x1d2>
  9e:	00001517          	auipc	a0,0x1
  a2:	b6a50513          	addi	a0,a0,-1174 # c08 <malloc+0x1f2>
  ...
  d4:	b5850513          	addi	a0,a0,-1192 # c28 <malloc+0x212>
  d8:	f29ff0ef          	jal	0 <fail>
    fail("wait after reaching limit (child 2)");
  dc:	00001517          	auipc	a0,0x1
  e0:	b7450513          	addi	a0,a0,-1164 # c50 <malloc+0x23a>
  e4:	f1dff0ef          	jal	0 <fail>
    fail("fork should succeed again after children are reaped");
  e8:	00001517          	auipc	a0,0x1
  ec:	b9050513          	addi	a0,a0,-1136 # c78 <malloc+0x262>
 ...
 104:	bd058593          	addi	a1,a1,-1072 # cd0 <malloc+0x2ba>
 108:	00001517          	auipc	a0,0x1
 10c:	b0050513          	addi	a0,a0,-1280 # c08 <malloc+0x1f2>
 ...
 120:	be450513          	addi	a0,a0,-1052 # d00 <malloc+0x2ea>
 124:	eddff0ef          	jal	0 <fail>
    fail("wait for post-reap child");
 128:	00001517          	auipc	a0,0x1
 12c:	b8850513          	addi	a0,a0,-1144 # cb0 <malloc+0x29a>
 ...
 142:	bea50513          	addi	a0,a0,-1046 # d28 <malloc+0x312>
 146:	ebbff0ef          	jal	0 <fail>
  printf("setchildlimittest: PASS: %s\n", msg);
 14a:	00001597          	auipc	a1,0x1
 14e:	c0658593          	addi	a1,a1,-1018 # d50 <malloc+0x33a>
 152:	00001517          	auipc	a0,0x1
 156:	ab650513          	addi	a0,a0,-1354 # c08 <malloc+0x1f2>
 ...
 16a:	c0250513          	addi	a0,a0,-1022 # d68 <malloc+0x352>
 ...
 186:	c0e50513          	addi	a0,a0,-1010 # d90 <malloc+0x37a>
 ...
 19e:	c4e58593          	addi	a1,a1,-946 # de8 <malloc+0x3d2>
 1a2:	00001517          	auipc	a0,0x1
 1a6:	a6650513          	addi	a0,a0,-1434 # c08 <malloc+0x1f2>
 1aa:	7b4000ef          	jal	95e <printf>
    fail("wait for unlimited-mode child");
  pass("limit=-1 disables restriction");

  printf("setchildlimittest: all checks passed\n");
 ...
 1c4:	c0850513          	addi	a0,a0,-1016 # dc8 <malloc+0x3b2>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 5fc:	84080813          	addi	a6,a6,-1984 # e38 <digits>
 600:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 820:	61cb8b93          	addi	s7,s7,1564 # e38 <digits>
 ...
 87e:	5b648493          	addi	s1,s1,1462 # e30 <malloc+0x41a>
        for(; *s; s++)
