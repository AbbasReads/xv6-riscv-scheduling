...
int main() {
  ...
  28:	fdc50513          	addi	a0,a0,-36 # 0 <myhandler>
  2c:	36e000ef          	jal	39a <signal>

  int pid = fork();
  30:	2aa000ef          	jal	2da <fork>

  if(pid == 0){
  34:	e111                	bnez	a0,38 <main+0x1c>
    while(1);   // child runs forever
  36:	a001                	j	36 <main+0x1a>
  38:	e426                	sd	s1,8(sp)
  3a:	84aa                	mv	s1,a0
  } else {
    sleep2(10);
  3c:	4529                	li	a0,10
  3e:	354000ef          	jal	392 <sleep2>
    kill(pid);   // send signal
  42:	8526                	mv	a0,s1
  44:	2ce000ef          	jal	312 <kill>
  }

  exit(0);
  48:	4501                	li	a0,0
  4a:	298000ef          	jal	2e2 <exit>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3de:	52650513          	addi	a0,a0,1318 # 900 <digits>
 3e2:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 674:	290b8b93          	addi	s7,s7,656 # 900 <digits>
 ...
 6d6:	22690913          	addi	s2,s2,550 # 8f8 <malloc+0x11a>
        for(; *s; s++)
