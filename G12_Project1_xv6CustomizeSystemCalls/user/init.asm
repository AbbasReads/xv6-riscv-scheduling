...
main(void)
{
  ...
  dup(0);  // stdout
  1e:	4501                	li	a0,0
  20:	3c8000ef          	jal	3e8 <dup>
  dup(0);  // stderr
  24:	4501                	li	a0,0
  26:	3c2000ef          	jal	3e8 <dup>
