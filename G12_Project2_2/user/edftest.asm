...
user/_edftest:     file format elf64-littleriscv
...
void task(char *name, int deadline, int work)
{
  ...
  14:	852e                	mv	a0,a1
  16:	44c000ef          	jal	462 <setdeadline>
  printf("%s: deadline=%d started\n", name, deadline);
  1a:	864a                	mv	a2,s2
  1c:	85ce                	mv	a1,s3
  1e:	00001517          	auipc	a0,0x1
  22:	98250513          	addi	a0,a0,-1662 # 9a0 <malloc+0xfa>
  26:	7cc000ef          	jal	7f2 <printf>
  // simulate work
  int sum = 0;
  for(int i = 0; i < work; i++)
  2a:	02905763          	blez	s1,58 <task+0x58>
  2e:	4781                	li	a5,0
  int sum = 0;
  30:	4681                	li	a3,0
    sum += i;
  ...
  36:	fef49ee3          	bne	s1,a5,32 <task+0x32>
  printf("%s: deadline=%d completed, sum=%d\n", name, deadline, sum);
  3a:	864a                	mv	a2,s2
  3c:	85ce                	mv	a1,s3
  3e:	00001517          	auipc	a0,0x1
  42:	98250513          	addi	a0,a0,-1662 # 9c0 <malloc+0x11a>
  46:	7ac000ef          	jal	7f2 <printf>
}
  4a:	70a2                	ld	ra,40(sp)
  4c:	7402                	ld	s0,32(sp)
  4e:	64e2                	ld	s1,24(sp)
...
main(void)
{
  ...
  68:	98450513          	addi	a0,a0,-1660 # 9e8 <malloc+0x142>
  6c:	786000ef          	jal	7f2 <printf>
  printf("Process with earliest deadline runs first\n\n");
  70:	00001517          	auipc	a0,0x1
  74:	99850513          	addi	a0,a0,-1640 # a08 <malloc+0x162>
  78:	77a000ef          	jal	7f2 <printf>

  // Fork 3 processes with different deadlines
  int pid1 = fork();
  7c:	33e000ef          	jal	3ba <fork>
  if(pid1 == 0){
  80:	ed19                	bnez	a0,9e <main+0x42>
    task("Task-A", 30, 500000);  // earliest deadline
  82:	0007a637          	lui	a2,0x7a
  86:	12060613          	addi	a2,a2,288 # 7a120 <base+0x79110>
  8a:	45f9                	li	a1,30
  8c:	00001517          	auipc	a0,0x1
  90:	9ac50513          	addi	a0,a0,-1620 # a38 <malloc+0x192>
  94:	f6dff0ef          	jal	0 <task>
    exit(0);
  98:	4501                	li	a0,0
  9a:	328000ef          	jal	3c2 <exit>
  }
  wait(0);
  9e:	4501                	li	a0,0
  a0:	32a000ef          	jal	3ca <wait>

  int pid2 = fork();
  a4:	316000ef          	jal	3ba <fork>
  if(pid2 == 0){
  a8:	e105                	bnez	a0,c8 <main+0x6c>
    task("Task-B", 60, 500000);  // medium deadline
  aa:	0007a637          	lui	a2,0x7a
  ae:	12060613          	addi	a2,a2,288 # 7a120 <base+0x79110>
  b2:	03c00593          	li	a1,60
  b6:	00001517          	auipc	a0,0x1
  ba:	98a50513          	addi	a0,a0,-1654 # a40 <malloc+0x19a>
  be:	f43ff0ef          	jal	0 <task>
    exit(0);
  c2:	4501                	li	a0,0
  c4:	2fe000ef          	jal	3c2 <exit>
  }
  wait(0);
  c8:	4501                	li	a0,0
  ca:	300000ef          	jal	3ca <wait>

  int pid3 = fork();
  ce:	2ec000ef          	jal	3ba <fork>
  if(pid3 == 0){
  d2:	e105                	bnez	a0,f2 <main+0x96>
    task("Task-C", 90, 500000);  // latest deadline
  d4:	0007a637          	lui	a2,0x7a
  d8:	12060613          	addi	a2,a2,288 # 7a120 <base+0x79110>
  dc:	05a00593          	li	a1,90
  e0:	00001517          	auipc	a0,0x1
  e4:	96850513          	addi	a0,a0,-1688 # a48 <malloc+0x1a2>
  e8:	f19ff0ef          	jal	0 <task>
    exit(0);
  ec:	4501                	li	a0,0
  ee:	2d4000ef          	jal	3c2 <exit>
  }
  wait(0);
  f2:	4501                	li	a0,0
  f4:	2d6000ef          	jal	3ca <wait>

  printf("\n=== EDF Test Complete ===\n");
  f8:	00001517          	auipc	a0,0x1
  fc:	95850513          	addi	a0,a0,-1704 # a50 <malloc+0x1aa>
 100:	6f2000ef          	jal	7f2 <printf>
  printf("Task-A (deadline=30) ran first\n");
 104:	00001517          	auipc	a0,0x1
 108:	96c50513          	addi	a0,a0,-1684 # a70 <malloc+0x1ca>
 10c:	6e6000ef          	jal	7f2 <printf>
  printf("Task-B (deadline=60) ran second\n");
 110:	00001517          	auipc	a0,0x1
 114:	98050513          	addi	a0,a0,-1664 # a90 <malloc+0x1ea>
 118:	6da000ef          	jal	7f2 <printf>
  printf("Task-C (deadline=90) ran last\n");
 11c:	00001517          	auipc	a0,0x1
 120:	99c50513          	addi	a0,a0,-1636 # ab8 <malloc+0x212>
 124:	6ce000ef          	jal	7f2 <printf>

  exit(0);
 128:	4501                	li	a0,0
 12a:	298000ef          	jal	3c2 <exit>
...
0000000000000462 <setdeadline>:
.global setdeadline
setdeadline:
 li a7, SYS_setdeadline
 462:	48d9                	li	a7,22
 ecall
 464:	00000073          	ecall
 ret
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 4a6:	63e50513          	addi	a0,a0,1598 # ae0 <digits>
 4aa:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 73c:	3a8b8b93          	addi	s7,s7,936 # ae0 <digits>
 ...
 79e:	33e90913          	addi	s2,s2,830 # ad8 <malloc+0x232>
        for(; *s; s++)
